 ...
 * const ipsIds = config.requireObject("ipsIds");
 * const status = config.requireObject("status");
 * const test = new huaweicloud.cfw.IpsRuleModeChange("test", {
 *     objectId: objectId,
 *     ipsIds: ipsIds,
 *     status: status,
 * });
...
export class IpsRuleModeChange extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:Cfw/ipsRuleModeChange:IpsRuleModeChange';
