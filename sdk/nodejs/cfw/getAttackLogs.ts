...
export function getAttackLogs(args: GetAttackLogsArgs, opts?: pulumi.InvokeOptions): Promise<GetAttackLogsResult> {
    ...
    return pulumi.runtime.invoke("huaweicloud:Cfw/getAttackLogs:getAttackLogs", {
        "app": args.app,
...
export function getAttackLogsOutput(args: GetAttackLogsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAttackLogsResult> {
    return pulumi.output(args).apply(a => getAttackLogs(a, opts))
}
