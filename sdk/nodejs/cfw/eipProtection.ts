 ...
 *
 * > A protection object (`objectId`) can only create one `huaweicloud.Cfw.EipProtection` resource for managing
 * protected EIPs.
 *
 * ## Import
 *
...
export class EipProtection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:Cfw/eipProtection:EipProtection';
