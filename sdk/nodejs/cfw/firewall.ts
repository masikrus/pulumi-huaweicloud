 ...
 *
 * const test = new huaweicloud.Cfw.Firewall("test", {
 *     flavor: {
 ...
 *     eastWestFirewallErId: huaweicloud_er_instance.test.id,
...
export class Firewall extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:Cfw/firewall:Firewall';
