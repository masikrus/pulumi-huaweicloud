 ...
 * const test = huaweicloud.Cfw.getServiceGroupMembers({
 *     groupId: groupId,
 * });
 * ```
 */
export function getServiceGroupMembers(args: GetServiceGroupMembersArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceGroupMembersResult> {
    ...
    return pulumi.runtime.invoke("huaweicloud:Cfw/getServiceGroupMembers:getServiceGroupMembers", {
...
export function getServiceGroupMembersOutput(args: GetServiceGroupMembersOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetServiceGroupMembersResult> {
    return pulumi.output(args).apply(a => getServiceGroupMembers(a, opts))
}
