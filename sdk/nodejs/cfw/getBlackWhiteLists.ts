...
export function getBlackWhiteLists(args: GetBlackWhiteListsArgs, opts?: pulumi.InvokeOptions): Promise<GetBlackWhiteListsResult> {
    ...
    return pulumi.runtime.invoke("huaweicloud:Cfw/getBlackWhiteLists:getBlackWhiteLists", {
...
export function getBlackWhiteListsOutput(args: GetBlackWhiteListsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetBlackWhiteListsResult> {
    return pulumi.output(args).apply(a => getBlackWhiteLists(a, opts))
}
