 ...
 * const defaultDnsServers = config.requireObject("defaultDnsServers");
 * const customDnsServers = config.requireObject("customDnsServers");
 * const healthCheckDomainName = config.requireObject("healthCheckDomainName");
 * const test = new huaweicloud.cfw.DnsResolution("test", {
 ...
 * ## Import
 *
 * The DNS resolution resource can be imported using the firewall instance ID, e.g. bash
 *
 * ```sh
...
export class DnsResolution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:Cfw/dnsResolution:DnsResolution';
