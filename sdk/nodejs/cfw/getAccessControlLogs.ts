...
export function getAccessControlLogs(args: GetAccessControlLogsArgs, opts?: pulumi.InvokeOptions): Promise<GetAccessControlLogsResult> {
    ...
    return pulumi.runtime.invoke("huaweicloud:Cfw/getAccessControlLogs:getAccessControlLogs", {
        "action": args.action,
        "app": args.app,
...
export function getAccessControlLogsOutput(args: GetAccessControlLogsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAccessControlLogsResult> {
    return pulumi.output(args).apply(a => getAccessControlLogs(a, opts))
}
