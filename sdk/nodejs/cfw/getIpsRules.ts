 ...
 * const test = huaweicloud.Cfw.getIpsRules({
 *     objectId: objectId,
 * });
 * ```
 */
export function getIpsRules(args: GetIpsRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetIpsRulesResult> {
    ...
    return pulumi.runtime.invoke("huaweicloud:Cfw/getIpsRules:getIpsRules", {
...
export function getIpsRulesOutput(args: GetIpsRulesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetIpsRulesResult> {
    return pulumi.output(args).apply(a => getIpsRules(a, opts))
}
