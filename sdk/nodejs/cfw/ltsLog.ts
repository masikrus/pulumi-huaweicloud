 ...
 * const ltsAttackLogStreamId = config.requireObject("ltsAttackLogStreamId");
 * const ltsFlowLogStreamId = config.requireObject("ltsFlowLogStreamId");
 * const ltsAccessLogStreamId = config.requireObject("ltsAccessLogStreamId");
 * const fwInstanceId = config.requireObject("fwInstanceId");
 * const ltsLogGroupId = config.requireObject("ltsLogGroupId");
 * const test = new huaweicloud.cfw.LtsLog("test", {
 ...
 * ## Import
 *
 * The lts log resource can be imported using the firewall instance ID, e.g. bash
 *
 * ```sh
...
export class LtsLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:Cfw/ltsLog:LtsLog';
