 ...
 * const test = new huaweicloud.ims.CbrWholeImage("test", {backupId: backupId});
 * ```
 *
 * ## Import
 *
 ...
 *  } }
 */
export class CbrWholeImage extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CbrWholeImageState, opts?: pulumi.CustomResourceOptions): CbrWholeImage {
        return new CbrWholeImage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:Ims/cbrWholeImage:CbrWholeImage';

    /**
     * Returns true if the given object is an instance of CbrWholeImage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CbrWholeImage {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CbrWholeImage.__pulumiType;
    }
    ...
    /**
     * Create a CbrWholeImage resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CbrWholeImageArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CbrWholeImageArgs | CbrWholeImageState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CbrWholeImageState | undefined;
            ...
            const args = argsOrState as CbrWholeImageArgs | undefined;
        ...
        super(CbrWholeImage.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface CbrWholeImageState {
    /**
     * The time when the image status changes to active, in RFC3339 format.
     */
 ...
 */
export interface CbrWholeImageArgs {
    /**
     * Specifies the CBR instance backup ID used to create the image.
     * Changing this parameter will create a new resource.
     */
