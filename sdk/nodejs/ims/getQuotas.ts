 ...
 *
 * const test = pulumi.output(huaweicloud.Ims.getQuotas());
 * ```
 */
export function getQuotas(args?: GetQuotasArgs, opts?: pulumi.InvokeOptions): Promise<GetQuotasResult> {
    ...
    return pulumi.runtime.invoke("huaweicloud:Ims/getQuotas:getQuotas", {
        "region": args.region,
    }, opts);
}
...
export interface GetQuotasResult {
     ...
     * The quota details.
     */
    readonly quotas: outputs.Ims.GetQuotasQuota[];
