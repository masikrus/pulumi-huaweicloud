 ...
 * const test = huaweicloud.Er.getPropagations({
...
export function getPropagations(args: GetPropagationsArgs, opts?: pulumi.InvokeOptions): Promise<GetPropagationsResult> {
    ...
    return pulumi.runtime.invoke("huaweicloud:Er/getPropagations:getPropagations", {
...
export function getPropagationsOutput(args: GetPropagationsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPropagationsResult> {
    return pulumi.output(args).apply(a => getPropagations(a, opts))
}
