 ...
 * const bgpAsNumber = config.requireObject("bgpAsNumber");
 * const availabilityZones = config.requireObject("availabilityZones");
 * const test = new huaweicloud.er.Instance("test", {
...
export class Instance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:Er/instance:Instance';
