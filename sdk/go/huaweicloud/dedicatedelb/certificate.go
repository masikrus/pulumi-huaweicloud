...
//			_, err := DedicatedElb.NewCertificate(ctx, "certificate1", &DedicatedElb.CertificateArgs{
...
func NewCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:DedicatedElb/certificate:Certificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificate(ctx *pulumi.Context,
	...
	var resource Certificate
	err := ctx.ReadResource("huaweicloud:DedicatedElb/certificate:Certificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
