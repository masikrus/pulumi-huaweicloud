...
//			_, err := Cfw.GetAttackLogs(ctx, &cfw.GetAttackLogsArgs{
...
func GetAttackLogs(ctx *pulumi.Context, args *GetAttackLogsArgs, opts ...pulumi.InvokeOption) (*GetAttackLogsResult, error) {
	...
	err := ctx.Invoke("huaweicloud:Cfw/getAttackLogs:getAttackLogs", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAttackLogsOutput(ctx *pulumi.Context, args GetAttackLogsOutputArgs, opts ...pulumi.InvokeOption) GetAttackLogsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetAttackLogsResult, error) {
			args := v.(GetAttackLogsArgs)
			r, err := GetAttackLogs(ctx, &args, opts...)
			var s GetAttackLogsResult
			if r != nil {
				s = *r
			}
			return s, err
