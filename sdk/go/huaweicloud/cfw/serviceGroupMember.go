...
func NewServiceGroupMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/serviceGroupMember:ServiceGroupMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceGroupMember(ctx *pulumi.Context,
	...
	var resource ServiceGroupMember
	err := ctx.ReadResource("huaweicloud:Cfw/serviceGroupMember:ServiceGroupMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
