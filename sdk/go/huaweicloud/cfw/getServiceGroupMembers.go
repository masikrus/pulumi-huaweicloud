...
func GetServiceGroupMembers(ctx *pulumi.Context, args *GetServiceGroupMembersArgs, opts ...pulumi.InvokeOption) (*GetServiceGroupMembersResult, error) {
	...
	err := ctx.Invoke("huaweicloud:Cfw/getServiceGroupMembers:getServiceGroupMembers", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetServiceGroupMembersOutput(ctx *pulumi.Context, args GetServiceGroupMembersOutputArgs, opts ...pulumi.InvokeOption) GetServiceGroupMembersResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetServiceGroupMembersResult, error) {
			args := v.(GetServiceGroupMembersArgs)
			r, err := GetServiceGroupMembers(ctx, &args, opts...)
			var s GetServiceGroupMembersResult
			if r != nil {
				s = *r
			}
			return s, err
