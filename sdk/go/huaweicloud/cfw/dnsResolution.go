...
func NewDnsResolution(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/dnsResolution:DnsResolution", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsResolution(ctx *pulumi.Context,
	...
	var resource DnsResolution
	err := ctx.ReadResource("huaweicloud:Cfw/dnsResolution:DnsResolution", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
