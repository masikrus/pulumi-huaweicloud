...
func NewAclRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/aclRule:AclRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAclRule(ctx *pulumi.Context,
	...
	var resource AclRule
	err := ctx.ReadResource("huaweicloud:Cfw/aclRule:AclRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
