...
func NewCaptureTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/captureTask:CaptureTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCaptureTask(ctx *pulumi.Context,
	...
	var resource CaptureTask
	err := ctx.ReadResource("huaweicloud:Cfw/captureTask:CaptureTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
