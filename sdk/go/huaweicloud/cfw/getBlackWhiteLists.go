...
func GetBlackWhiteLists(ctx *pulumi.Context, args *GetBlackWhiteListsArgs, opts ...pulumi.InvokeOption) (*GetBlackWhiteListsResult, error) {
	...
	err := ctx.Invoke("huaweicloud:Cfw/getBlackWhiteLists:getBlackWhiteLists", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetBlackWhiteListsOutput(ctx *pulumi.Context, args GetBlackWhiteListsOutputArgs, opts ...pulumi.InvokeOption) GetBlackWhiteListsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetBlackWhiteListsResult, error) {
			args := v.(GetBlackWhiteListsArgs)
			r, err := GetBlackWhiteLists(ctx, &args, opts...)
			var s GetBlackWhiteListsResult
			if r != nil {
				s = *r
			}
			return s, err
