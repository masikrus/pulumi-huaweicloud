...
//				return err
//			}
//			_, err = Cfw.NewServiceGroup(ctx, "testServiceGroup", &Cfw.ServiceGroupArgs{
...
// ## Import
//
// The service group can be imported using the `id`, e.g. bash
//
// ```sh
//
...
func NewServiceGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/serviceGroup:ServiceGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceGroup(ctx *pulumi.Context,
	...
	var resource ServiceGroup
	err := ctx.ReadResource("huaweicloud:Cfw/serviceGroup:ServiceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
