...
func NewIpsRuleModeChange(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/ipsRuleModeChange:IpsRuleModeChange", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpsRuleModeChange(ctx *pulumi.Context,
	...
	var resource IpsRuleModeChange
	err := ctx.ReadResource("huaweicloud:Cfw/ipsRuleModeChange:IpsRuleModeChange", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
