...
//				return err
//			}
//			_, err = Cfw.NewBlackWhiteList(ctx, "testBlackWhiteList", &Cfw.BlackWhiteListArgs{
...
func NewBlackWhiteList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/blackWhiteList:BlackWhiteList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlackWhiteList(ctx *pulumi.Context,
	...
	var resource BlackWhiteList
	err := ctx.ReadResource("huaweicloud:Cfw/blackWhiteList:BlackWhiteList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
