...
// ## Import
//
// The protection resource can be imported using their `object_id` or `id`, e.g. bash
//
// ```sh
//
...
func NewEipProtection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/eipProtection:EipProtection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEipProtection(ctx *pulumi.Context,
	...
	var resource EipProtection
	err := ctx.ReadResource("huaweicloud:Cfw/eipProtection:EipProtection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
