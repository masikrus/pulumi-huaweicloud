...
func NewLtsLog(ctx *pulumi.Context,
	...
	var resource LtsLog
	err := ctx.RegisterResource("huaweicloud:Cfw/ltsLog:LtsLog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLtsLog(ctx *pulumi.Context,
	...
	var resource LtsLog
	err := ctx.ReadResource("huaweicloud:Cfw/ltsLog:LtsLog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
