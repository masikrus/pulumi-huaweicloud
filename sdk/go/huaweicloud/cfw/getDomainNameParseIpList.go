...
//				DomainName: pulumi.StringRef("www.baidu.com"),
//			}, nil)
//			if err != nil {
//				return err
//			}
...
func GetDomainNameParseIpList(ctx *pulumi.Context, args *GetDomainNameParseIpListArgs, opts ...pulumi.InvokeOption) (*GetDomainNameParseIpListResult, error) {
	...
	err := ctx.Invoke("huaweicloud:Cfw/getDomainNameParseIpList:getDomainNameParseIpList", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDomainNameParseIpListOutput(ctx *pulumi.Context, args GetDomainNameParseIpListOutputArgs, opts ...pulumi.InvokeOption) GetDomainNameParseIpListResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetDomainNameParseIpListResult, error) {
			args := v.(GetDomainNameParseIpListArgs)
			r, err := GetDomainNameParseIpList(ctx, &args, opts...)
			var s GetDomainNameParseIpListResult
			if r != nil {
				s = *r
			}
			return s, err
