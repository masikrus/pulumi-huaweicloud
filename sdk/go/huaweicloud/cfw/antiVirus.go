...
func NewAntiVirus(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/antiVirus:AntiVirus", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAntiVirus(ctx *pulumi.Context,
	...
	var resource AntiVirus
	err := ctx.ReadResource("huaweicloud:Cfw/antiVirus:AntiVirus", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
