...
func NewAlarmConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Cfw/alarmConfig:AlarmConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlarmConfig(ctx *pulumi.Context,
	...
	var resource AlarmConfig
	err := ctx.ReadResource("huaweicloud:Cfw/alarmConfig:AlarmConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
