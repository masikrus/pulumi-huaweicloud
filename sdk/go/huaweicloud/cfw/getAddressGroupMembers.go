...
func GetAddressGroupMembers(ctx *pulumi.Context, args *GetAddressGroupMembersArgs, opts ...pulumi.InvokeOption) (*GetAddressGroupMembersResult, error) {
	...
	err := ctx.Invoke("huaweicloud:Cfw/getAddressGroupMembers:getAddressGroupMembers", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAddressGroupMembersOutput(ctx *pulumi.Context, args GetAddressGroupMembersOutputArgs, opts ...pulumi.InvokeOption) GetAddressGroupMembersResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetAddressGroupMembersResult, error) {
			args := v.(GetAddressGroupMembersArgs)
			r, err := GetAddressGroupMembers(ctx, &args, opts...)
			var s GetAddressGroupMembersResult
			if r != nil {
				s = *r
			}
			return s, err
