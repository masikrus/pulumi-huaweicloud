...
// ## Import
//
// Propagations can be imported using their `id` and the related `instance_id` and `route_table_id`, separated by slashes (/), e.g. bash
//
// ```sh
//
//	$ pulumi import huaweicloud:Er/propagation:Propagation test <instance_id>/<route_table_id>/<id>
//
// ```
...
func NewPropagation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Er/propagation:Propagation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPropagation(ctx *pulumi.Context,
	...
	var resource Propagation
	err := ctx.ReadResource("huaweicloud:Er/propagation:Propagation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
