...
func NewStaticRoute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Er/staticRoute:StaticRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticRoute(ctx *pulumi.Context,
	...
	var resource StaticRoute
	err := ctx.ReadResource("huaweicloud:Er/staticRoute:StaticRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
