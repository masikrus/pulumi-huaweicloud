...
// ## Import
//
// The flow log can be imported using the related `instance_id` and their `id`, separated by a slash (/), e.g. bash
//
// ```sh
//
...
func NewFlowLog(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Er/flowLog:FlowLog", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlowLog(ctx *pulumi.Context,
	...
	var resource FlowLog
	err := ctx.ReadResource("huaweicloud:Er/flowLog:FlowLog", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
