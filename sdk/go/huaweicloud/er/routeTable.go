...
func NewRouteTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Er/routeTable:RouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteTable(ctx *pulumi.Context,
	...
	var resource RouteTable
	err := ctx.ReadResource("huaweicloud:Er/routeTable:RouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
