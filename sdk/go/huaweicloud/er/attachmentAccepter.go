...
func NewAttachmentAccepter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("huaweicloud:Er/attachmentAccepter:AttachmentAccepter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachmentAccepter(ctx *pulumi.Context,
	...
	var resource AttachmentAccepter
	err := ctx.ReadResource("huaweicloud:Er/attachmentAccepter:AttachmentAccepter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
