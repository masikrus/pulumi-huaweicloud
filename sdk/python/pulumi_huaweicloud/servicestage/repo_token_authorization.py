...
@pulumi.type_token("huaweicloud:ServiceStage/repoTokenAuthorization:RepoTokenAuthorization")
class RepoTokenAuthorization(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.servicestage.RepoTokenAuthorization("test",
            type="github",
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'RepoTokenAuthorization':
        """
