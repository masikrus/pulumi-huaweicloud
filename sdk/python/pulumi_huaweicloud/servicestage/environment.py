...
class EnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EnvironmentOptionalResourceArgs']]] optional_resources: Specifies the optional resources.
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the ServiceStage environment.
...
@pulumi.type_token("huaweicloud:ServiceStage/environment:Environment")
class Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 optional_resources: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentOptionalResourceArgs', 'EnvironmentOptionalResourceArgsDict']]]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        test = huaweicloud.servicestage.Environment("test",
            name=env_name,
            vpc_id=vpc_id,
            basic_resources=[
                {
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the environment name.
               The name can contain of `2` to `64` characters, only letters, digits, hyphens (-) and underscores (_) are allowed.
               The name must start with a letter and end with a letter or a digit.
        :param pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentOptionalResourceArgs', 'EnvironmentOptionalResourceArgsDict']]]] optional_resources: Specifies the optional resources.
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the ServiceStage environment.
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the VPC ID to which the environment belongs.
    ...
    def get(resource_name: str,
            ...
            optional_resources: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentOptionalResourceArgs', 'EnvironmentOptionalResourceArgsDict']]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'Environment':
        """
