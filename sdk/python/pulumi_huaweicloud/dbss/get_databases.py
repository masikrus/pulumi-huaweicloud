...
class GetDatabasesResult:
    ...
    """
    def __init__(__self__, databases=None, id=None, instance_id=None, region=None, status=None):
...
def get_databases(instance_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.dbss.get_databases(instance_id=instance_id)
    ```


    :param _builtins.str instance_id: Specifies the audit instance ID to which the databases belong.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:dbss/getDatabases:getDatabases', __args__, opts=opts, typ=GetDatabasesResult).value
...
def get_databases_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:dbss/getDatabases:getDatabases', __args__, opts=opts, typ=GetDatabasesResult)
