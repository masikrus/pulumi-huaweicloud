...
def get_availability_zones(display_name: Optional[_builtins.str] = None,
...
def get_availability_zones_output(display_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
