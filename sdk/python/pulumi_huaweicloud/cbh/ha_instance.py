...
__all__ = ['HaInstanceArgs', 'HaInstance']

@pulumi.input_type
class HaInstanceArgs:
...
class HaInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.cbh.HaInstance("test",
            name=name,
            flavor_id=flavor_id,
            vpc_id=vpc_id,
            subnet_id=subnet_id,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(HaInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = HaInstanceArgs.__new__(HaInstanceArgs)
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'HaInstance':
        """
        Get an existing HaInstance resource's state with the given name, id, and optional extra
        ...
        __props__ = _HaInstanceState.__new__(_HaInstanceState)
        ...
        __props__.__dict__["vpc_id"] = vpc_id
        return HaInstance(resource_name, opts=opts, __props__=__props__)
