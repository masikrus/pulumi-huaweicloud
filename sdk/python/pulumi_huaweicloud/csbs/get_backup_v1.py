...
__all__ = [
    'GetBackupV1Result',
    'AwaitableGetBackupV1Result',
    'get_backup_v1',
    'get_backup_v1_output',
]

@pulumi.output_type
class GetBackupV1Result:
    """
    A collection of values returned by getBackupV1.
    """
    ...
    def vm_metadatas(self) -> Sequence['outputs.GetBackupV1VmMetadataResult']:
        return pulumi.get(self, "vm_metadatas")

    @_builtins.property
    @pulumi.getter(name="volumeBackups")
    def volume_backups(self) -> Sequence['outputs.GetBackupV1VolumeBackupResult']:
        return pulumi.get(self, "volume_backups")


class AwaitableGetBackupV1Result(GetBackupV1Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBackupV1Result(
...
def get_backup_v1(backup_name: Optional[_builtins.str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBackupV1Result:
    """
...
def get_backup_v1_output(backup_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBackupV1Result]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
