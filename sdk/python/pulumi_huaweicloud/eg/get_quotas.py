...
class GetQuotasResult:
    ...
    def quotas(self) -> Sequence['outputs.GetQuotasQuotaResult']:
        """
        The list of resource quotas that matched filter parameters.  
...
def get_quotas(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.eg.get_quotas()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:eg/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult).value
...
def get_quotas_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:eg/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult)
