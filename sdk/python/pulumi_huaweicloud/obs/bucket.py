...
class BucketArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project id of the OBS bucket.
               Defaults to `0`.
        :param pulumi.Input[_builtins.bool] force_destroy: A boolean that indicates all objects should be deleted from the bucket, so that the
               bucket can be destroyed without error. Default to `false`.
        :param pulumi.Input[_builtins.str] kms_key_id: Specifies the ID of a KMS key. If omitted, the default master key will be used. This
               field is used only when `sse_algorithm` value is **kms**.
        :param pulumi.Input[_builtins.str] kms_key_project_id: Specifies the project ID to which the KMS key belongs. This field is valid
        ...
        :param pulumi.Input[_builtins.str] policy_format: Specifies the policy format, the supported values are *obs* and *s3*. Defaults
               to *obs*.
        :param pulumi.Input[_builtins.int] quota: Specifies bucket storage quota. Must be a positive integer in the unit of byte. The maximum
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region where this bucket will be created. If not specified, used
               the region by the provider. Changing this will create a new bucket.
        :param pulumi.Input[_builtins.str] sse_algorithm: Specifies the mode of encryption algorithm. The valid values are:
               ...
               Defaults to **kms**.
        :param pulumi.Input[_builtins.str] storage_class: Specifies the storage class of the bucket. OBS provides three storage classes:
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] user_domain_names: Specifies the user domain names. The restriction requirements for this field
               are as follows:
        ...
        :param pulumi.Input[_builtins.bool] versioning: Whether enable versioning. Once you version-enable a bucket, it can never return to an
...
@pulumi.type_token("huaweicloud:Obs/bucket:Bucket")
