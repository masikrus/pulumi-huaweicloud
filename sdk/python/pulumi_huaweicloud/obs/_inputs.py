...
__all__ = [
    'BucketAclAccountPermissionArgs',
    'BucketAclAccountPermissionArgsDict',
    'BucketAclLogDeliveryUserPermissionArgs',
    'BucketAclLogDeliveryUserPermissionArgsDict',
    'BucketAclOwnerPermissionArgs',
    'BucketAclOwnerPermissionArgsDict',
    'BucketAclPublicPermissionArgs',
    'BucketAclPublicPermissionArgsDict',
    'BucketCorsRuleArgs',
    ...
    'BucketObjectAclAccountPermissionArgs',
    'BucketObjectAclAccountPermissionArgsDict',
    'BucketObjectAclOwnerPermissionArgs',
    'BucketObjectAclOwnerPermissionArgsDict',
    'BucketObjectAclPublicPermissionArgs',
    'BucketObjectAclPublicPermissionArgsDict',
...
class BucketCorsRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_methods: Specifies the acceptable operation type of buckets and objects. The methods
               include `GET`, `PUT`, `POST`, `DELETE` or `HEAD`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_origins: Requests from this origin can access the bucket. Multiple matching rules are
               allowed. One rule occupies one line, and allows one wildcard character (*) at most.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_headers: Specifies the allowed header of cross-origin requests. Only CORS requests
               matching the allowed header are valid.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] expose_headers: Specifies the exposed header in CORS responses, providing additional information
               for clients.
        :param pulumi.Input[_builtins.int] max_age_seconds: Specifies the duration that your browser can cache CORS responses, expressed in
               seconds. The default value is 100.
        """
...
class BucketLifecycleRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BucketLifecycleRuleNoncurrentVersionTransitionArgs']]] noncurrent_version_transitions: Specifies a period when noncurrent object versions are
               automatically transitioned to `WARM` or `COLD` storage class (documented below).
        :param pulumi.Input[_builtins.str] prefix: Object key prefix identifying one or more objects to which the rule applies. If omitted,
               all objects in the bucket will be managed by the lifecycle rule. The prefix cannot start or end with a slash (/),
               cannot have consecutive slashes (/), and cannot contain the following special characters: \\:*?"<>|.
               When configuring multiple `lifecycle_rule`, field `prefix` in multiple `lifecycle_rule` cannot have an inclusive
               relationship.
...
class BucketLifecycleRuleAbortIncompleteMultipartUploadArgs:
    def __init__(__self__, *,
                 days: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] days: Specifies the number of days since the initiation of an incomplete multipart upload that OBS
               will wait before deleting the not merged parts (fragments) of the upload.
               The valid value ranges from 1 to 2,147,483,647.
        """
...
class BucketLifecycleRuleExpirationArgs:
    def __init__(__self__, *,
                 days: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] days: Specifies the number of days when objects that have been last updated are automatically
               deleted. The expiration time must be greater than the transition times.
        """
        pulumi.set(__self__, "days", days)
...
class BucketLifecycleRuleNoncurrentVersionTransitionArgs:
    def __init__(__self__, *,
                 ...
                 storage_class: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.int] days: Specifies the number of days when noncurrent object versions are automatically transitioned
               to the specified storage class.
        :param pulumi.Input[_builtins.str] storage_class: The class of storage used to store the object. Only `WARM` and `COLD` are
               supported.
        """
        pulumi.set(__self__, "days", days)
...
class BucketLoggingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] target_bucket: The name of the bucket that will receive the log objects. The acl policy of the
               target bucket should be `log-delivery-write`.
        :param pulumi.Input[_builtins.str] agency: Specifies the IAM agency of OBS cloud service.
...
class BucketObjectAclAccountPermissionArgs:
    def __init__(__self__, *,
                 account_id: pulumi.Input[_builtins.str],
                 access_to_acls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 access_to_objects: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        :param pulumi.Input[_builtins.str] account_id: Specifies the account id to authorize. The account id cannot be the object owner,
               and must be unique.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] access_to_acls: Specifies the access to acl. Valid values are **READ_ACP** and **WRITE_ACP**.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] access_to_objects: Specifies the access to object. Only **READ** supported.
        """
        pulumi.set(__self__, "account_id", account_id)
        if access_to_acls is not None:
            pulumi.set(__self__, "access_to_acls", access_to_acls)
    ...
    def access_to_objects(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Specifies the access to object. Only **READ** supported.
        """
        return pulumi.get(self, "access_to_objects")

    @access_to_objects.setter
    def access_to_objects(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class BucketReplicationRuleArgs:
    def __init__(__self__, *,
                 ...
                 history_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 id: Optional[pulumi.Input[_builtins.str]] = None,
                 prefix: Optional[pulumi.Input[_builtins.str]] = None,
                 storage_class: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.bool] enabled: Specifies cross-region replication rule status. Defaults to `true`.
        :param pulumi.Input[_builtins.bool] history_enabled: Specifies cross-region replication history rule status. Defaults to `false`.
               If the value is `true`, historical objects meeting this rule are copied.
        :param pulumi.Input[_builtins.str] id: The name of the bucket.
               * `rule/id` - The ID of a rule in UUID format.
        :param pulumi.Input[_builtins.str] prefix: Specifies the prefix of an object key name, applicable to one or more objects.
               The maximum length of a prefix is 1024 characters.
               Duplicated prefixes are not supported. If omitted, all objects in the bucket will be managed by the lifecycle rule.
               To copy a folder, end the prefix with a slash (/), for example, imgs/.
        :param pulumi.Input[_builtins.str] storage_class: Specifies the storage class for replicated objects. Valid values are `STANDARD`,
               `WARM` (Infrequent Access) and `COLD` (Archive).
               If omitted, the storage class of object copies is the same as that of objects in the source bucket.
        """
    ...
    def history_enabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Specifies cross-region replication history rule status. Defaults to `false`.
        If the value is `true`, historical objects meeting this rule are copied.
        """
    ...
    def history_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class BucketWebsiteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] error_document: Specifies the error page returned when an error occurs during static website
               access. Only HTML, JPG, PNG, BMP, and WEBP files under the root directory are supported.
        :param pulumi.Input[_builtins.str] index_document: Unless using `redirect_all_requests_to`. Specifies the default homepage of the
               static website, only HTML web pages are supported. OBS only allows files such as `index.html` in the root directory of
               a bucket to function as the default homepage. That is to say, do not set the default homepage with a multi-level
               directory structure (for example, /page/index.html).
        :param pulumi.Input[_builtins.str] redirect_all_requests_to: A hostname to redirect all website requests for this bucket to.
               Hostname can optionally be prefixed with a protocol (`http://` or `https://`) to use when redirecting requests. The
               default is the protocol that is used in the original request.
        :param pulumi.Input[_builtins.str] routing_rules: A JSON or XML format containing routing rules describing redirect behavior and
               when redirects are applied. Each rule contains a `Condition` and a `Redirect` as shown in the following table:
