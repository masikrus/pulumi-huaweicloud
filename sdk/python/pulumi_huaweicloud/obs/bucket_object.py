...
class BucketObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] content_type: A standard MIME type describing the format of the object data, e.g.
               application/octet-stream. All Valid MIME Types are valid for this input.
        :param pulumi.Input[_builtins.bool] encryption: Whether enable server-side encryption of the object in SSE-KMS mode.
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the OBS bucket object resource. If omitted, the
...
@pulumi.type_token("huaweicloud:Obs/bucketObject:BucketObject")
class BucketObject(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        examplebucket_object = huaweicloud.obs.BucketObject("examplebucket_object",
            bucket="your_bucket_name",
            key="someobject",
            source="index.html",
            encryption=True)
