...
__all__ = [
    'BucketAclAccountPermission',
    'BucketAclLogDeliveryUserPermission',
    'BucketAclOwnerPermission',
    'BucketAclPublicPermission',
    'BucketCorsRule',
    'BucketLifecycleRule',
    ...
    'BucketLogging',
    'BucketObjectAclAccountPermission',
    'BucketObjectAclOwnerPermission',
    'BucketObjectAclPublicPermission',
...
@pulumi.output_type
class BucketAclAccountPermission(dict):
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BucketAclAccountPermission. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BucketAclAccountPermission.__key_warning(key)
...
@pulumi.output_type
class BucketAclLogDeliveryUserPermission(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "accessToAcls":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BucketAclLogDeliveryUserPermission. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BucketAclLogDeliveryUserPermission.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class BucketAclOwnerPermission(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "accessToAcls":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BucketAclOwnerPermission. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BucketAclOwnerPermission.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class BucketAclPublicPermission(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "accessToAcls":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BucketAclPublicPermission. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BucketAclPublicPermission.__key_warning(key)
        return super().__getitem__(key)
...
class BucketCorsRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] allowed_methods: Specifies the acceptable operation type of buckets and objects. The methods
               include `GET`, `PUT`, `POST`, `DELETE` or `HEAD`.
        :param Sequence[_builtins.str] allowed_origins: Requests from this origin can access the bucket. Multiple matching rules are
               allowed. One rule occupies one line, and allows one wildcard character (*) at most.
        :param Sequence[_builtins.str] allowed_headers: Specifies the allowed header of cross-origin requests. Only CORS requests
               matching the allowed header are valid.
        :param Sequence[_builtins.str] expose_headers: Specifies the exposed header in CORS responses, providing additional information
               for clients.
        :param _builtins.int max_age_seconds: Specifies the duration that your browser can cache CORS responses, expressed in
...
class BucketLifecycleRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str prefix: Object key prefix identifying one or more objects to which the rule applies. If omitted,
...
class BucketLifecycleRuleAbortIncompleteMultipartUpload(dict):
    def __init__(__self__, *,
                 days: _builtins.int):
        """
        :param _builtins.int days: Specifies the number of days since the initiation of an incomplete multipart upload that OBS
...
class BucketLifecycleRuleExpiration(dict):
    def __init__(__self__, *,
                 days: _builtins.int):
        """
        :param _builtins.int days: Specifies the number of days when objects that have been last updated are automatically
...
class BucketLifecycleRuleNoncurrentVersionTransition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int days: Specifies the number of days when noncurrent object versions are automatically transitioned
               to the specified storage class.
        :param _builtins.str storage_class: The class of storage used to store the object. Only `WARM` and `COLD` are
               supported.
        """
        pulumi.set(__self__, "days", days)
...
class BucketLogging(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str target_bucket: The name of the bucket that will receive the log objects. The acl policy of the
               target bucket should be `log-delivery-write`.
        :param _builtins.str agency: Specifies the IAM agency of OBS cloud service.
...
@pulumi.output_type
class BucketObjectAclAccountPermission(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "accountId":
            ...
            suggest = "access_to_acls"
        elif key == "accessToObjects":
            suggest = "access_to_objects"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BucketObjectAclAccountPermission. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BucketObjectAclAccountPermission.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 account_id: _builtins.str,
                 access_to_acls: Optional[Sequence[_builtins.str]] = None,
                 access_to_objects: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str account_id: Specifies the account id to authorize. The account id cannot be the object owner,
               and must be unique.
        :param Sequence[_builtins.str] access_to_acls: Specifies the access to acl. Valid values are **READ_ACP** and **WRITE_ACP**.
        :param Sequence[_builtins.str] access_to_objects: Specifies the access to object. Only **READ** supported.
        """
        pulumi.set(__self__, "account_id", account_id)
        if access_to_acls is not None:
            pulumi.set(__self__, "access_to_acls", access_to_acls)
        if access_to_objects is not None:
            pulumi.set(__self__, "access_to_objects", access_to_objects)
    ...
    @_builtins.property
    @pulumi.getter(name="accessToObjects")
    def access_to_objects(self) -> Optional[Sequence[_builtins.str]]:
        """
        Specifies the access to object. Only **READ** supported.
        """
        return pulumi.get(self, "access_to_objects")


@pulumi.output_type
class BucketObjectAclOwnerPermission(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "accessToAcls":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BucketObjectAclOwnerPermission. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BucketObjectAclOwnerPermission.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class BucketObjectAclPublicPermission(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "accessToAcls":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BucketObjectAclPublicPermission. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BucketObjectAclPublicPermission.__key_warning(key)
        return super().__getitem__(key)
...
class BucketReplicationRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 history_enabled: Optional[_builtins.bool] = None,
                 id: Optional[_builtins.str] = None,
                 prefix: Optional[_builtins.str] = None,
                 storage_class: Optional[_builtins.str] = None):
        """
        :param _builtins.bool enabled: Specifies cross-region replication rule status. Defaults to `true`.
        :param _builtins.bool history_enabled: Specifies cross-region replication history rule status. Defaults to `false`.
               If the value is `true`, historical objects meeting this rule are copied.
        :param _builtins.str id: The name of the bucket.
               * `rule/id` - The ID of a rule in UUID format.
        :param _builtins.str prefix: Specifies the prefix of an object key name, applicable to one or more objects.
        ...
        :param _builtins.str storage_class: Specifies the storage class for replicated objects. Valid values are `STANDARD`,
    ...
    def history_enabled(self) -> Optional[_builtins.bool]:
        """
...
class BucketWebsite(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str error_document: Specifies the error page returned when an error occurs during static website
               access. Only HTML, JPG, PNG, BMP, and WEBP files under the root directory are supported.
        :param _builtins.str index_document: Unless using `redirect_all_requests_to`. Specifies the default homepage of the
        ...
        :param _builtins.str redirect_all_requests_to: A hostname to redirect all website requests for this bucket to.
        ...
        :param _builtins.str routing_rules: A JSON or XML format containing routing rules describing redirect behavior and
