...
class BucketPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy_format: Specifies the policy format, the supported values are *obs* and *s3*. Defaults
               to *obs* .
        :param pulumi.Input[_builtins.str] region: The region in which to create the OBS bucket policy resource. If omitted, the
...
@pulumi.type_token("huaweicloud:Obs/bucketPolicy:BucketPolicy")
