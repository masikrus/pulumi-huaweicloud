...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] network_id: The subnet ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] node_type: The flavor of the cluster.  
        ...
        :param pulumi.Input[_builtins.str] dss_pool_id: Dedicated storage pool ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] elb_id: Specifies the ID of the ELB load balancer.
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project ID.
        :param pulumi.Input[_builtins.bool] force_backup: Specified whether to automatically execute snapshot when shrinking the number of nodes.
        ...
        :param pulumi.Input[_builtins.int] keep_last_manual_snapshot: The number of latest manual snapshots that need to be
               retained when deleting the cluster.
        :param pulumi.Input[_builtins.str] kms_key_id: The KMS key ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.bool] logical_cluster_enable: Specifies whether to enable logical cluster. The switch needs to be turned
               on before creating a logical cluster.
        :param pulumi.Input[_builtins.bool] lts_enable: Specifies whether to enable LTS. The default value is **false**.
        ...
        :param pulumi.Input[_builtins.int] number_of_cn: The number of CN.  
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] availability_zone: The availability zone in which to create the cluster instance.
               If there are multiple available zones, separate by commas, e.g. **cn-north-4a,cn-north-4b,cn-north-4g**.
               Currently, multi-AZ clusters only support selecting `3` AZs. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] created: The creation time of the cluster.  
        ...
        :param pulumi.Input[_builtins.int] port: Service port of a cluster (8000 to 10000). The default value is 8000.  
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] private_ips: The private IP address of the ELB load balancer.
...
@pulumi.type_token("huaweicloud:Dws/cluster:Cluster")
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.int] port: Service port of a cluster (8000 to 10000). The default value is 8000.  
               Changing this parameter will create a new resource.
        :param pulumi.Input[Union['ClusterPublicIpArgs', 'ClusterPublicIpArgsDict']] public_ip: The information about public IP.  
        ...
        :param pulumi.Input[_builtins.str] version: The cluster version.
               [For details](https://support.huaweicloud.com/intl/en-us/bulletin-dws/dws_12_0000.html).
               Changing this parameter will create a new resource.
        :param pulumi.Input[Union['ClusterVolumeArgs', 'ClusterVolumeArgsDict']] volume: The information about the volume.
               Changing this parameter will create a new resource.
               For local disks, this parameter can not be specified.
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterElbArgs', 'ClusterElbArgsDict']]]] elbs: The ELB information bound to the cluster.
               The elb structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterEndpointArgs', 'ClusterEndpointArgsDict']]]] endpoints: Private network connection information about the cluster.
               The Endpoint structure is documented below.
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project ID.
        :param pulumi.Input[_builtins.bool] force_backup: Specified whether to automatically execute snapshot when shrinking the number of nodes.
               The default value is **true**.
        ...
        :param pulumi.Input[_builtins.int] port: Service port of a cluster (8000 to 10000). The default value is 8000.  
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] private_ips: The private IP address of the ELB load balancer.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterPublicEndpointArgs', 'ClusterPublicEndpointArgsDict']]]] public_endpoints: Public network connection information about the cluster.
               The PublicEndpoint structure is documented below.
        :param pulumi.Input[Union['ClusterPublicIpArgs', 'ClusterPublicIpArgsDict']] public_ip: The information about public IP.  
