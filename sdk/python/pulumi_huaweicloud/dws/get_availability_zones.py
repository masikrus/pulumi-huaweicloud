...
def get_availability_zones(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Dws.get_availability_zones()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dws/getAvailabilityZones:getAvailabilityZones', __args__, opts=opts, typ=GetAvailabilityZonesResult).value
...
def get_availability_zones_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dws/getAvailabilityZones:getAvailabilityZones', __args__, opts=opts, typ=GetAvailabilityZonesResult)
