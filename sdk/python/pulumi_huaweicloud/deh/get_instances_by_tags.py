...
def get_instances_by_tags(action: Optional[_builtins.str] = None,
                          matches: Optional[Sequence[Union['GetInstancesByTagsMatchArgs', 'GetInstancesByTagsMatchArgsDict']]] = None,
    ...
    test = huaweicloud.Deh.get_instances_by_tags(action=action)
    ```
    ...
    :param Sequence[Union['GetInstancesByTagsMatchArgs', 'GetInstancesByTagsMatchArgsDict']] matches: Specifies the search criteria. Only **resource_name** for key is supported.
           The matches structure is documented below.
    :param Sequence[Union['GetInstancesByTagsNotTagArgs', 'GetInstancesByTagsNotTagArgsDict']] not_tags: Specifies the excluded tags. Each tag contains a maximum of 10 keys, and each key contains
    ...
    :param Sequence[Union['GetInstancesByTagsNotTagsAnyArgs', 'GetInstancesByTagsNotTagsAnyArgsDict']] not_tags_anies: Specifies any excluded tags. Each tag contains a maximum of 10 keys, and each key
    ...
    :param Sequence[Union['GetInstancesByTagsTagArgs', 'GetInstancesByTagsTagArgsDict']] tags: Specifies the tags. A maximum of 10 keys can be queried at a time, and each key can contain
           ...
           data is returned.
           The tags structure is documented below.
    :param Sequence[Union['GetInstancesByTagsTagsAnyArgs', 'GetInstancesByTagsTagsAnyArgsDict']] tags_anies: Specifies any included tags. Each tag contains a maximum of 10 keys, and each key contains
           a maximum of 10 values. The structure body cannot be missing, and the key cannot be left blank or set to an empty string.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Deh/getInstancesByTags:getInstancesByTags', __args__, opts=opts, typ=GetInstancesByTagsResult).value
...
def get_instances_by_tags_output(action: Optional[pulumi.Input[_builtins.str]] = None,
                                 matches: Optional[pulumi.Input[Optional[Sequence[Union['GetInstancesByTagsMatchArgs', 'GetInstancesByTagsMatchArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Deh/getInstancesByTags:getInstancesByTags', __args__, opts=opts, typ=GetInstancesByTagsResult)
