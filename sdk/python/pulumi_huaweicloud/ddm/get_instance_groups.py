...
class GetInstanceGroupsResult:
    ...
    def group_lists(self) -> Sequence['outputs.GetInstanceGroupsGroupListResult']:
        """
        Indicates the list of DDM instance group.
        The group_list structure is documented below.
        """
...
def get_instance_groups(instance_id: Optional[_builtins.str] = None,
...
def get_instance_groups_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
