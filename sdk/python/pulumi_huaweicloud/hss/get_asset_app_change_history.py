...
__all__ = [
    'GetAssetAppChangeHistoryResult',
    'AwaitableGetAssetAppChangeHistoryResult',
    'get_asset_app_change_history',
    'get_asset_app_change_history_output',
]

@pulumi.output_type
class GetAssetAppChangeHistoryResult:
    """
    A collection of values returned by getAssetAppChangeHistory.
    """
    def __init__(__self__, app_name=None, data_lists=None, end_time=None, enterprise_project_id=None, host_id=None, host_ip=None, host_name=None, id=None, region=None, sort_dir=None, sort_key=None, start_time=None, variation_type=None):
    ...
    def data_lists(self) -> Sequence['outputs.GetAssetAppChangeHistoryDataListResult']:
        """
        The list of software change history.
        """
...
class AwaitableGetAssetAppChangeHistoryResult(GetAssetAppChangeHistoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssetAppChangeHistoryResult(
...
def get_asset_app_change_history(app_name: Optional[_builtins.str] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAssetAppChangeHistoryResult:
    """
    ...
    test = huaweicloud.Hss.get_asset_app_change_history()
    ```
    ...
    :param _builtins.str sort_dir: Specifies the sort order. The default value is **desc**.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Hss/getAssetAppChangeHistory:getAssetAppChangeHistory', __args__, opts=opts, typ=GetAssetAppChangeHistoryResult).value

    return AwaitableGetAssetAppChangeHistoryResult(
...
def get_asset_app_change_history_output(app_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAssetAppChangeHistoryResult]:
    """
    Use this data source to get the historical change records of software information.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Hss/getAssetAppChangeHistory:getAssetAppChangeHistory', __args__, opts=opts, typ=GetAssetAppChangeHistoryResult)
    return __ret__.apply(lambda __response__: GetAssetAppChangeHistoryResult(
