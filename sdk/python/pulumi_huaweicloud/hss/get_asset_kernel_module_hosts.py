...
__all__ = [
    'GetAssetKernelModuleHostsResult',
    'AwaitableGetAssetKernelModuleHostsResult',
    'get_asset_kernel_module_hosts',
    'get_asset_kernel_module_hosts_output',
]

@pulumi.output_type
class GetAssetKernelModuleHostsResult:
    """
    A collection of values returned by getAssetKernelModuleHosts.
    """
    def __init__(__self__, data_lists=None, enterprise_project_id=None, host_ip=None, host_name=None, id=None, name=None, part_match=None, region=None):
    ...
    def data_lists(self) -> Sequence['outputs.GetAssetKernelModuleHostsDataListResult']:
        """
        The list of hosts.
...
class AwaitableGetAssetKernelModuleHostsResult(GetAssetKernelModuleHostsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssetKernelModuleHostsResult(
...
def get_asset_kernel_module_hosts(enterprise_project_id: Optional[_builtins.str] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAssetKernelModuleHostsResult:
    """
    ...
    test = huaweicloud.Hss.get_asset_kernel_module_hosts(name=name)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Hss/getAssetKernelModuleHosts:getAssetKernelModuleHosts', __args__, opts=opts, typ=GetAssetKernelModuleHostsResult).value

    return AwaitableGetAssetKernelModuleHostsResult(
...
def get_asset_kernel_module_hosts_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAssetKernelModuleHostsResult]:
    """
    Use this data source to get the list of servers for a specified kernel module.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Hss/getAssetKernelModuleHosts:getAssetKernelModuleHosts', __args__, opts=opts, typ=GetAssetKernelModuleHostsResult)
    return __ret__.apply(lambda __response__: GetAssetKernelModuleHostsResult(
