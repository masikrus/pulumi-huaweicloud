...
__all__ = [
    'GetProductInfosResult',
    'AwaitableGetProductInfosResult',
    'get_product_infos',
    'get_product_infos_output',
]

@pulumi.output_type
class GetProductInfosResult:
    """
    A collection of values returned by getProductInfos.
    """
    def __init__(__self__, data_lists=None, enterprise_project_id=None, id=None, region=None, site_code=None):
    ...
    def data_lists(self) -> Sequence['outputs.GetProductInfosDataListResult']:
        """
...
class AwaitableGetProductInfosResult(GetProductInfosResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetProductInfosResult(
...
def get_product_infos(enterprise_project_id: Optional[_builtins.str] = None,
                      region: Optional[_builtins.str] = None,
                      site_code: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProductInfosResult:
    """
    ...
    :param _builtins.str site_code: Specifies the site information. The valid values are as follows:
...
def get_product_infos_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             site_code: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetProductInfosResult]:
    """
    Use this data source to get the list of HSS product information within HuaweiCloud.
