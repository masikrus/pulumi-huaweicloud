...
__all__ = [
    'GetAppWhitelistOptionalHostsResult',
    'AwaitableGetAppWhitelistOptionalHostsResult',
    'get_app_whitelist_optional_hosts',
    'get_app_whitelist_optional_hosts_output',
]

@pulumi.output_type
class GetAppWhitelistOptionalHostsResult:
    """
    A collection of values returned by getAppWhitelistOptionalHosts.
    """
    def __init__(__self__, data_lists=None, enterprise_project_id=None, group_id=None, host_id=None, host_name=None, id=None, policy_id=None, private_ip=None, public_ip=None, region=None, version=None):
    ...
    def data_lists(self) -> Sequence['outputs.GetAppWhitelistOptionalHostsDataListResult']:
        """
...
class AwaitableGetAppWhitelistOptionalHostsResult(GetAppWhitelistOptionalHostsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppWhitelistOptionalHostsResult(
...
def get_app_whitelist_optional_hosts(enterprise_project_id: Optional[_builtins.str] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAppWhitelistOptionalHostsResult:
    """
    ...
    test = huaweicloud.Hss.get_app_whitelist_optional_hosts()
    ```
    ...
    :param _builtins.str version: Specifies the host protection version.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Hss/getAppWhitelistOptionalHosts:getAppWhitelistOptionalHosts', __args__, opts=opts, typ=GetAppWhitelistOptionalHostsResult).value

    return AwaitableGetAppWhitelistOptionalHostsResult(
...
def get_app_whitelist_optional_hosts_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            ...
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAppWhitelistOptionalHostsResult]:
    """
    Use this data source to get the list of optional servers for the process whitelist.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Hss/getAppWhitelistOptionalHosts:getAppWhitelistOptionalHosts', __args__, opts=opts, typ=GetAppWhitelistOptionalHostsResult)
    return __ret__.apply(lambda __response__: GetAppWhitelistOptionalHostsResult(
