...
class GetPluginsResult:
    ...
    """
    def __init__(__self__, code=None, data_lists=None, enterprise_project_id=None, id=None, name=None, region=None, total_num=None):
    ...
    def data_lists(self) -> Sequence['outputs.GetPluginsDataListResult']:
        """
...
def get_plugins(code: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Hss.get_plugins()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Hss/getPlugins:getPlugins', __args__, opts=opts, typ=GetPluginsResult).value
...
def get_plugins_output(code: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Hss/getPlugins:getPlugins', __args__, opts=opts, typ=GetPluginsResult)
