...
class GetInstancesResult:
    ...
    """
    def __init__(__self__, cluster_id=None, id=None, is_normal=None, name=None, region=None, results=None, sort_dir=None, sort_key=None):
        ...
        if is_normal and not isinstance(is_normal, str):
            raise TypeError("Expected argument 'is_normal' to be a str")
    ...
    def cluster_id(self) -> Optional[_builtins.str]:
        """
        The cluster ID to which the instance belongs.
        """
    ...
    def is_normal(self) -> Optional[_builtins.str]:
        """
        The instance health status.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetInstancesResultResult']:
        """
...
def get_instances(cluster_id: Optional[_builtins.str] = None,
                  is_normal: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cpcs.get_instances()
    ```


    :param _builtins.str cluster_id: Specifies the cluster ID.
    :param _builtins.str is_normal: Specifies the instance health status.
    ...
    __args__['isNormal'] = is_normal
    __args__['name'] = name
    __args__['region'] = region
    __args__['sortDir'] = sort_dir
    __args__['sortKey'] = sort_key
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cpcs/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value

    return AwaitableGetInstancesResult(
        cluster_id=pulumi.get(__ret__, 'cluster_id'),
        id=pulumi.get(__ret__, 'id'),
        is_normal=pulumi.get(__ret__, 'is_normal'),
...
def get_instances_output(cluster_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         is_normal: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cpcs/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
    return __ret__.apply(lambda __response__: GetInstancesResult(
        cluster_id=pulumi.get(__response__, 'cluster_id'),
        id=pulumi.get(__response__, 'id'),
        is_normal=pulumi.get(__response__, 'is_normal'),
