...
class InfluxInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] flavor: Specifies the instance specifications. For details,
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] password: Specifies the database password. The value must be `8` to `32` characters in
        ...
        :param pulumi.Input[_builtins.str] subnet_id: Specifies the network ID of a subnet. Changing this parameter will create
               a new resource.
        :param pulumi.Input[_builtins.int] volume_size: Specifies the storage space in GB. The value must be a multiple of `10`. For a
        ...
        :param pulumi.Input[_builtins.str] dedicated_resource_name: Specifies the dedicated resource name. Changing this
        ...
        :param pulumi.Input[_builtins.int] node_num: Specifies the number of nodes, ranges from `3` to `16`. Defaults to `3`.
        ...
        :param pulumi.Input[_builtins.str] period_unit: Specifies the charging period unit of the instance.
               ...
               Changing this will do nothing.
        :param pulumi.Input[_builtins.str] region: The region in which to create the influx instance resource. If omitted, the
...
@pulumi.type_token("huaweicloud:GaussDBforNoSQL/influxInstance:InfluxInstance")
class InfluxInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_renew: Optional[pulumi.Input[_builtins.str]] = None,
                 availability_zone: Optional[pulumi.Input[_builtins.str]] = None,
                 backup_strategy: Optional[pulumi.Input[Union['InfluxInstanceBackupStrategyArgs', 'InfluxInstanceBackupStrategyArgsDict']]] = None,
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
                 datastore: Optional[pulumi.Input[Union['InfluxInstanceDatastoreArgs', 'InfluxInstanceDatastoreArgsDict']]] = None,
                 dedicated_resource_id: Optional[pulumi.Input[_builtins.str]] = None,
                 dedicated_resource_name: Optional[pulumi.Input[_builtins.str]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 flavor: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        instance1 = huaweicloud.gaussdbfornosql.InfluxInstance("instance_1",
        ...
        :param pulumi.Input[_builtins.str] availability_zone: Specifies the AZ name. For a three-AZ deployment instance,
               use commas (,) to separate the AZs, for example, `cn-north-4a,cn-north-4b,cn-north-4c`.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Union['InfluxInstanceBackupStrategyArgs', 'InfluxInstanceBackupStrategyArgsDict']] backup_strategy: Specifies the advanced backup policy. Structure is documented below.
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the instance. Valid values are **prePaid**
               and **postPaid**, defaults to **postPaid**. Changing this will do nothing.
        :param pulumi.Input[_builtins.str] configuration_id: Specifies the Parameter Template ID.
        :param pulumi.Input[Union['InfluxInstanceDatastoreArgs', 'InfluxInstanceDatastoreArgsDict']] datastore: Specifies the database information. Structure is documented below. Changing
               this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] dedicated_resource_id: Specifies the dedicated resource ID. Changing this parameter
               will create a new resource.
        :param pulumi.Input[_builtins.str] dedicated_resource_name: Specifies the dedicated resource name. Changing this
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            node_num: Optional[pulumi.Input[_builtins.int]] = None,
            nodes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['InfluxInstanceNodeArgs', 'InfluxInstanceNodeArgsDict']]]]] = None,
            password: Optional[pulumi.Input[_builtins.str]] = None,
            period: Optional[pulumi.Input[_builtins.int]] = None,
            period_unit: Optional[pulumi.Input[_builtins.str]] = None,
            port: Optional[pulumi.Input[_builtins.int]] = None,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            volume_size: Optional[pulumi.Input[_builtins.int]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'InfluxInstance':
        """
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the instance name, which can be the same as an existing instance name. The
               ...
               letters, digits, hyphens (-), and underscores (_).
        :param pulumi.Input[_builtins.int] node_num: Specifies the number of nodes, ranges from `3` to `16`. Defaults to `3`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InfluxInstanceNodeArgs', 'InfluxInstanceNodeArgsDict']]]] nodes: Indicates the instance nodes information. Structure is documented below.
        :param pulumi.Input[_builtins.str] password: Specifies the database password. The value must be `8` to `32` characters in
               length, including uppercase and lowercase letters, digits, and special characters, such as ~!@#%^*-_=+? You are
               advised to enter a strong password to improve security, preventing security risks such as brute force cracking.
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the instance.  
