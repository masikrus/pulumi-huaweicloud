...
def get_cassandra_instances(name: Optional[_builtins.str] = None,
...
def get_cassandra_instances_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   subnet_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   vpc_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCassandraInstancesResult]:
    """
    Use this data source to get available HuaweiCloud GeminiDB Cassandra instances.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:GaussDBforNoSQL/getCassandraInstances:getCassandraInstances', __args__, opts=opts, typ=GetCassandraInstancesResult)
    return __ret__.apply(lambda __response__: GetCassandraInstancesResult(
