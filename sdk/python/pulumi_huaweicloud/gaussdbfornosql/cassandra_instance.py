...
__all__ = ['CassandraInstanceArgs', 'CassandraInstance']

@pulumi.input_type
class CassandraInstanceArgs:
    def __init__(__self__, *,
                 ...
                 backup_strategy: Optional[pulumi.Input['CassandraInstanceBackupStrategyArgs']] = None,
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
                 datastore: Optional[pulumi.Input['CassandraInstanceDatastoreArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] flavor: Specifies the instance specifications. For details,
        ...
        :param pulumi.Input[_builtins.str] subnet_id: Specifies the network ID of a subnet. Changing this parameter will create a
               new resource.
        :param pulumi.Input[_builtins.int] volume_size: Specifies the storage space in GB. The value must be a multiple of 10. For a GaussDB
        ...
        :param pulumi.Input[_builtins.str] dedicated_resource_name: Specifies the dedicated resource name.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project id, Only valid for users who
        ...
        :param pulumi.Input[_builtins.int] node_num: Specifies the number of nodes, ranges from `3` to `200`. Defaults to `3`.
        ...
        :param pulumi.Input[_builtins.str] period_unit: Specifies the charging period unit of the instance.
               ...
               Changing this will do nothing.
        :param pulumi.Input[_builtins.str] region: The region in which to create the Cassandra instance resource. If omitted, the
        ...
        :param pulumi.Input[_builtins.str] security_group_id: Specifies the security group ID. Required if the selected subnet doesn't
               enable network ACL.
        :param pulumi.Input[_builtins.bool] ssl: Specifies whether to enable or disable SSL. Defaults to **false**. Changing this
    ...
    def backup_strategy(self) -> Optional[pulumi.Input['CassandraInstanceBackupStrategyArgs']]:
        """
    ...
    def backup_strategy(self, value: Optional[pulumi.Input['CassandraInstanceBackupStrategyArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def datastore(self) -> Optional[pulumi.Input['CassandraInstanceDatastoreArgs']]:
        """
    ...
    @datastore.setter
    def datastore(self, value: Optional[pulumi.Input['CassandraInstanceDatastoreArgs']]):
...
class _CassandraInstanceState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 node_num: Optional[pulumi.Input[_builtins.int]] = None,
                 nodes: Optional[pulumi.Input[Sequence[pulumi.Input['CassandraInstanceNodeArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.bool] force_import: If specified, try to import the instance instead of creating if the name already
               existed.
        :param pulumi.Input[_builtins.str] lb_ip_address: Indicates the LB IP address of the db.
        :param pulumi.Input[_builtins.str] lb_port: Indicates the LB port of the db.
        :param pulumi.Input[_builtins.str] mode: Indicates the instance type.
        :param pulumi.Input[_builtins.str] name: Specifies the instance name, which can be the same as an existing instance name. The value
               must be `4` to `64` characters in length and start with a letter. It is case-sensitive and can contain only letters,
               digits, hyphens (-), and underscores (_).
        :param pulumi.Input[_builtins.int] node_num: Specifies the number of nodes, ranges from `3` to `200`. Defaults to `3`.
        ...
        :param pulumi.Input[_builtins.str] period_unit: Specifies the charging period unit of the instance.
               Valid values are *month* and *year*. This parameter is mandatory if `charging_mode` is set to **prePaid**.
               Changing this will do nothing.
        :param pulumi.Input[_builtins.int] port: Indicates the database port.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] private_ips: Indicates the IP address list of the db.
        :param pulumi.Input[_builtins.str] region: The region in which to create the Cassandra instance resource. If omitted, the
               provider-level region will be used. Changing this creates a new Cassandra instance resource.
        :param pulumi.Input[_builtins.str] security_group_id: Specifies the security group ID. Required if the selected subnet doesn't
               enable network ACL.
    ...
    @_builtins.property
    @pulumi.getter
    def nodes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CassandraInstanceNodeArgs']]]]:
        """
    ...
    @nodes.setter
    def nodes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CassandraInstanceNodeArgs']]]]):
...
@pulumi.type_token("huaweicloud:GaussDBforNoSQL/cassandraInstance:CassandraInstance")
class CassandraInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 auto_renew: Optional[pulumi.Input[_builtins.str]] = None,
                 availability_zone: Optional[pulumi.Input[_builtins.str]] = None,
                 backup_strategy: Optional[pulumi.Input[Union['CassandraInstanceBackupStrategyArgs', 'CassandraInstanceBackupStrategyArgsDict']]] = None,
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
                 datastore: Optional[pulumi.Input[Union['CassandraInstanceDatastoreArgs', 'CassandraInstanceDatastoreArgsDict']]] = None,
                 dedicated_resource_id: Optional[pulumi.Input[_builtins.str]] = None,
                 dedicated_resource_name: Optional[pulumi.Input[_builtins.str]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 flavor: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        instance1 = huaweicloud.gaussdbfornosql.CassandraInstance("instance_1",
        ...
        :param pulumi.Input[_builtins.str] availability_zone: Specifies the AZ name. For a three-AZ deployment instance,
               use commas (,) to separate the AZs, for example, `cn-north-4a,cn-north-4b,cn-north-4c`.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Union['CassandraInstanceBackupStrategyArgs', 'CassandraInstanceBackupStrategyArgsDict']] backup_strategy: Specifies the advanced backup policy. Structure is documented below.
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the instance. Valid values are **prePaid**
               and **postPaid**, defaults to **postPaid**. Changing this will do nothing.
        :param pulumi.Input[_builtins.str] configuration_id: Specifies the Parameter Template ID.
        :param pulumi.Input[Union['CassandraInstanceDatastoreArgs', 'CassandraInstanceDatastoreArgsDict']] datastore: Specifies the database information. Structure is documented below. Changing
               this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] dedicated_resource_id: Specifies the dedicated resource ID. Changing this parameter
               will create a new resource.
        :param pulumi.Input[_builtins.str] dedicated_resource_name: Specifies the dedicated resource name.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CassandraInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CassandraInstanceArgs.__new__(CassandraInstanceArgs)
        ...
        super(CassandraInstance, __self__).__init__(
            'huaweicloud:GaussDBforNoSQL/cassandraInstance:CassandraInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            node_num: Optional[pulumi.Input[_builtins.int]] = None,
            nodes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CassandraInstanceNodeArgs', 'CassandraInstanceNodeArgsDict']]]]] = None,
            password: Optional[pulumi.Input[_builtins.str]] = None,
            period: Optional[pulumi.Input[_builtins.int]] = None,
            period_unit: Optional[pulumi.Input[_builtins.str]] = None,
            port: Optional[pulumi.Input[_builtins.int]] = None,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            volume_size: Optional[pulumi.Input[_builtins.int]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'CassandraInstance':
        """
        Get an existing CassandraInstance resource's state with the given name, id, and optional extra
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the instance name, which can be the same as an existing instance name. The value
               ...
               digits, hyphens (-), and underscores (_).
        :param pulumi.Input[_builtins.int] node_num: Specifies the number of nodes, ranges from `3` to `200`. Defaults to `3`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CassandraInstanceNodeArgs', 'CassandraInstanceNodeArgsDict']]]] nodes: Indicates the instance nodes information. Structure is documented below.
        :param pulumi.Input[_builtins.str] password: Specifies the database password. The value must be `8` to `32` characters in length,
               including uppercase and lowercase letters, digits, and special characters, such as ~!@#%^*-_=+? You are advised to
               enter a strong password to improve security, preventing security risks such as brute force cracking.
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the instance.  
        ...
        __props__ = _CassandraInstanceState.__new__(_CassandraInstanceState)
        ...
        __props__.__dict__["volume_size"] = volume_size
        __props__.__dict__["vpc_id"] = vpc_id
        return CassandraInstance(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="backupStrategy")
    def backup_strategy(self) -> pulumi.Output['outputs.CassandraInstanceBackupStrategy']:
        """
        Specifies the advanced backup policy. Structure is documented below.
        """
        return pulumi.get(self, "backup_strategy")
    ...
    @_builtins.property
    @pulumi.getter
    def datastore(self) -> pulumi.Output['outputs.CassandraInstanceDatastore']:
        """
        Specifies the database information. Structure is documented below. Changing
        this parameter will create a new resource.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def nodes(self) -> pulumi.Output[Sequence['outputs.CassandraInstanceNode']]:
        """
        Indicates the instance nodes information. Structure is documented below.
        """
        return pulumi.get(self, "nodes")
