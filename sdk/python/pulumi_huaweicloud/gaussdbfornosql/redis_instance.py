...
class RedisInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subnet_id: Specifies the network ID of a subnet. Changing this parameter will create a
               new resource.
        :param pulumi.Input[_builtins.int] volume_size: Specifies the storage space in GB. For a GaussDB for Redis instance, the minimum and
        ...
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the GaussDB for Redis instance. Valid values are
        ...
        :param pulumi.Input[_builtins.bool] force_import: If specified, try to import the instance instead of creating if the name already
               existed.
        :param pulumi.Input[_builtins.str] mode: Specifies the instance type. Value options: **Cluster**, **Replication**.
               Defaults to **Cluster**.
        ...
        :param pulumi.Input[_builtins.int] node_num: Specifies the number of nodes, ranges from `2` to `12`. Defaults to `3`.
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the GaussDB for Redis instance.  
               If `period_unit` is set to **month** , the value ranges from `1` to `9`.
               If `period_unit` is set to **year**, the value ranges from `1` to `3`.
               This parameter is mandatory if `charging_mode` is set to **prePaid**.
               Changing this will do nothing.
        :param pulumi.Input[_builtins.str] period_unit: Specifies the charging period unit of the GaussDB for Redis instance. Valid values
        ...
        :param pulumi.Input[_builtins.int] port: Specifies the port number for accessing the instance. You can specify a port number
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] region: The region in which to create the Redis instance resource.
        ...
        :param pulumi.Input[_builtins.str] security_group_id: Specifies the security group ID. Required if the selected subnet doesn't
               enable network ACL.
        :param pulumi.Input[_builtins.bool] ssl: Specifies whether SSL is enabled. Defaults to **false**.
...
@pulumi.type_token("huaweicloud:GaussDBforNoSQL/redisInstance:RedisInstance")
class RedisInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_renew: Optional[pulumi.Input[_builtins.str]] = None,
                 availability_zone: Optional[pulumi.Input[_builtins.str]] = None,
                 availability_zone_detail: Optional[pulumi.Input[Union['RedisInstanceAvailabilityZoneDetailArgs', 'RedisInstanceAvailabilityZoneDetailArgsDict']]] = None,
                 backup_strategy: Optional[pulumi.Input[Union['RedisInstanceBackupStrategyArgs', 'RedisInstanceBackupStrategyArgsDict']]] = None,
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 datastore: Optional[pulumi.Input[Union['RedisInstanceDatastoreArgs', 'RedisInstanceDatastoreArgsDict']]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 flavor: Optional[pulumi.Input[_builtins.str]] = None,
                 force_import: Optional[pulumi.Input[_builtins.bool]] = None,
                 mode: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        test = huaweicloud.gaussdbfornosql.RedisInstance("test",
        ...
        :param pulumi.Input[_builtins.str] availability_zone: Specifies the AZ name.
               ...
               For a three-AZ deployment instance, use commas (,) to separate the AZs, for example, `cn-north-4a,cn-north-4b,cn-north-4c`.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Union['RedisInstanceAvailabilityZoneDetailArgs', 'RedisInstanceAvailabilityZoneDetailArgsDict']] availability_zone_detail: Specifies Multi-AZ details of the active/standby instance.
               The system ignores this parameter if single-AZ deployment is selected. Currently, only GeminiDB Redis instances are
               supported.
               
               The availability_zone_detail structure is documented below.
        :param pulumi.Input[Union['RedisInstanceBackupStrategyArgs', 'RedisInstanceBackupStrategyArgsDict']] backup_strategy: Specifies the advanced backup policy. Structure is documented below. Do nothing
               in update method if change this parameter.
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the GaussDB for Redis instance. Valid values are
               **prePaid** and **postPaid**, defaults to **postPaid**. Do nothing in update method if change this parameter.
        :param pulumi.Input[Union['RedisInstanceDatastoreArgs', 'RedisInstanceDatastoreArgsDict']] datastore: Specifies the database information. Structure is documented below. Changing
               this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project ID, Only valid for users who
               have enabled the enterprise multi-project service.
        :param pulumi.Input[_builtins.str] flavor: Specifies the instance specifications. For details,
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            node_num: Optional[pulumi.Input[_builtins.int]] = None,
            nodes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RedisInstanceNodeArgs', 'RedisInstanceNodeArgsDict']]]]] = None,
            password: Optional[pulumi.Input[_builtins.str]] = None,
            period: Optional[pulumi.Input[_builtins.int]] = None,
            period_unit: Optional[pulumi.Input[_builtins.str]] = None,
            port: Optional[pulumi.Input[_builtins.int]] = None,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            volume_size: Optional[pulumi.Input[_builtins.int]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'RedisInstance':
        """
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the instance name, which can be the same as an existing instance name. The value
               ...
               digits, hyphens (-), and underscores (_). Chinese characters must be in UTF-8 or Unicode format.
        :param pulumi.Input[_builtins.int] node_num: Specifies the number of nodes, ranges from `2` to `12`. Defaults to `3`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RedisInstanceNodeArgs', 'RedisInstanceNodeArgsDict']]]] nodes: Indicates the instance nodes information. Structure is documented below.
        :param pulumi.Input[_builtins.str] password: Specifies the database password. The value must be `8` to `32` characters in length,
               including uppercase and lowercase letters, digits, and special characters, such as ~!@#%^*-_=+? You are advised to
               enter a strong password to improve security, preventing security risks such as brute force cracking.
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the GaussDB for Redis instance.  
