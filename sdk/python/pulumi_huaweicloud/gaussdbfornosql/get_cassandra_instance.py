...
def get_cassandra_instance(name: Optional[_builtins.str] = None,
...
def get_cassandra_instance_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  subnet_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  vpc_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCassandraInstanceResult]:
    """
    Use this data source to get available HuaweiCloud GeminiDB Cassandra instance.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:GaussDBforNoSQL/getCassandraInstance:getCassandraInstance', __args__, opts=opts, typ=GetCassandraInstanceResult)
    return __ret__.apply(lambda __response__: GetCassandraInstanceResult(
