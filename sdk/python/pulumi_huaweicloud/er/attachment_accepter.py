...
@pulumi.type_token("huaweicloud:Er/attachmentAccepter:AttachmentAccepter")
class AttachmentAccepter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.er.AttachmentAccepter("test",
    ...
    def _internal_init(__self__,
        ...
        super(AttachmentAccepter, __self__).__init__(
            'huaweicloud:Er/attachmentAccepter:AttachmentAccepter',
            resource_name,
            __props__,
            opts)
