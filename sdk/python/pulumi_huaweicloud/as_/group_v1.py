...
class GroupV1Args:
    def __init__(__self__, *,
                 networks: pulumi.Input[Sequence[pulumi.Input['GroupV1NetworkArgs']]],
                 ...
                 lbaas_listeners: Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1LbaasListenerArgs']]]] = None,
                 ...
                 security_groups: Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1SecurityGroupArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.int] health_periodic_audit_grace_period: The health check grace period for instances, in seconds.
        :param pulumi.Input[_builtins.int] health_periodic_audit_time: The health check period for instances, in minutes.
        ...
        :param pulumi.Input[_builtins.str] scaling_configuration_id: schema: Required
        """
    ...
    @_builtins.property
    @pulumi.getter
    def networks(self) -> pulumi.Input[Sequence[pulumi.Input['GroupV1NetworkArgs']]]:
        return pulumi.get(self, "networks")

    @networks.setter
    def networks(self, value: pulumi.Input[Sequence[pulumi.Input['GroupV1NetworkArgs']]]):
    ...
    def lbaas_listeners(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1LbaasListenerArgs']]]]:
        return pulumi.get(self, "lbaas_listeners")

    @lbaas_listeners.setter
    def lbaas_listeners(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1LbaasListenerArgs']]]]):
    ...
    def security_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1SecurityGroupArgs']]]]:
        return pulumi.get(self, "security_groups")

    @security_groups.setter
    def security_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1SecurityGroupArgs']]]]):
...
class _GroupV1State:
    def __init__(__self__, *,
                 ...
                 min_instance_number: Optional[pulumi.Input[_builtins.int]] = None,
                 multi_az_scaling_policy: Optional[pulumi.Input[_builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1NetworkArgs']]]] = None,
                 notifications: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 scaling_configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.int] health_periodic_audit_grace_period: The health check grace period for instances, in seconds.
        :param pulumi.Input[_builtins.int] health_periodic_audit_time: The health check period for instances, in minutes.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] instances: The instances id list in the as group.
        :param pulumi.Input[_builtins.str] lb_listener_id: The system supports the binding of up to six ELB listeners, the IDs of which are separated using a comma.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] notifications: schema: Deprecated; The notification mode has been canceled
        :param pulumi.Input[_builtins.str] scaling_configuration_id: schema: Required
        """
    ...
    @_builtins.property
    @pulumi.getter
    def networks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1NetworkArgs']]]]:
        return pulumi.get(self, "networks")

    @networks.setter
    def networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['GroupV1NetworkArgs']]]]):
        pulumi.set(self, "networks", value)
...
@pulumi.type_token("huaweicloud:As/groupV1:GroupV1")
class GroupV1(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 instance_terminate_policy: Optional[pulumi.Input[_builtins.str]] = None,
                 lb_listener_id: Optional[pulumi.Input[_builtins.str]] = None,
                 lbaas_listeners: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GroupV1LbaasListenerArgs', 'GroupV1LbaasListenerArgsDict']]]]] = None,
                 max_instance_number: Optional[pulumi.Input[_builtins.int]] = None,
                 min_instance_number: Optional[pulumi.Input[_builtins.int]] = None,
                 multi_az_scaling_policy: Optional[pulumi.Input[_builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GroupV1NetworkArgs', 'GroupV1NetworkArgsDict']]]]] = None,
                 notifications: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 scaling_configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
                 scaling_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                 security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GroupV1SecurityGroupArgs', 'GroupV1SecurityGroupArgsDict']]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        super(GroupV1, __self__).__init__(
            'huaweicloud:As/groupV1:GroupV1',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'GroupV1':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="lbaasListeners")
    def lbaas_listeners(self) -> pulumi.Output[Sequence['outputs.GroupV1LbaasListener']]:
        return pulumi.get(self, "lbaas_listeners")
    ...
    @_builtins.property
    @pulumi.getter
    def networks(self) -> pulumi.Output[Sequence['outputs.GroupV1Network']]:
        return pulumi.get(self, "networks")
    ...
    @_builtins.property
    @pulumi.getter(name="securityGroups")
    def security_groups(self) -> pulumi.Output[Sequence['outputs.GroupV1SecurityGroup']]:
        return pulumi.get(self, "security_groups")
