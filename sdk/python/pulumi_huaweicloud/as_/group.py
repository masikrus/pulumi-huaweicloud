...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] cool_down_time: Specifies the cooling duration (in seconds). The value ranges from `0` to `86,400`.
               Defaults to `300`.
        ...
        :param pulumi.Input[_builtins.bool] delete_publicip: Specifies whether to release the EIPs bound to ECSs when the ECSs are removed
        ...
        :param pulumi.Input[_builtins.bool] delete_volume: Specifies whether to delete the data disks attached to ECSs when the ECSs are removed.
               Defaults to **false**.
        ...
        :param pulumi.Input[_builtins.bool] enable: Specifies whether to enable the AS Group. Defaults to **true**.
        ...
        :param pulumi.Input[_builtins.int] max_instance_number: Specifies the maximum number of instances. The value ranges from `0` to `300`.
               Defaults to `0`.
        :param pulumi.Input[_builtins.int] min_instance_number: Specifies the minimum number of instances. Defaults to `0`.
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] cool_down_time: Specifies the cooling duration (in seconds). The value ranges from `0` to `86,400`.
               Defaults to `300`.
        :param pulumi.Input[_builtins.str] create_time: The creation time of the AS group.
        ...
        :param pulumi.Input[_builtins.int] desire_instance_number: Specifies the expected number of instances. The default value is the
               minimum number of instances. The value ranges from the minimum number of instances to the maximum number of instances.
        :param pulumi.Input[_builtins.str] detail: The details about the AS group. If a scaling action fails, this parameter is used to record errors.
        :param pulumi.Input[_builtins.bool] enable: Specifies whether to enable the AS Group. Defaults to **true**.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project ID of the AS group.
        ...
        :param pulumi.Input[_builtins.bool] is_scaling: The scaling flag of the AS group.
        :param pulumi.Input[_builtins.str] lb_listener_id: The system supports the binding of up to six ELB listeners, the IDs of which are separated using a comma.
        :param pulumi.Input[Sequence[pulumi.Input['GroupLbaasListenerArgs']]] lbaas_listeners: Specifies an array of one or more enhanced load balancer. The system supports
               the binding of up to six load balancers. The lbaas_listeners structure is documented below.
        :param pulumi.Input[_builtins.int] max_instance_number: Specifies the maximum number of instances. The value ranges from `0` to `300`.
        ...
        :param pulumi.Input[_builtins.str] scaling_configuration_id: Specifies the configuration ID which defines configurations
               of instances in the AS group.
        :param pulumi.Input[_builtins.str] scaling_configuration_name: The name of the AS configuration to which the AS group belongs.
        :param pulumi.Input[_builtins.str] scaling_group_name: Specifies the name of the scaling group. The name can contain
               letters, digits, underscores(_), and hyphens(-),and cannot exceed 64 characters.
        :param pulumi.Input[Sequence[pulumi.Input['GroupSecurityGroupArgs']]] security_groups: Specifies an array of one or more security group IDs to associate with the group.
               The security_groups structure is documented below.
...
@pulumi.type_token("huaweicloud:As/group:Group")
class Group(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        my_as_group = huaweicloud.as_.Group("my_as_group",
        ...
        vpc_id = config.require_object("vpcId")
        subnet_id = config.require_object("subnetId")
        my_as_group_only_remove_members = huaweicloud.as_.Group("my_as_group_only_remove_members",
        ...
        test = huaweicloud.elb.Loadbalancer("test",
            name="test_name",
            vip_subnet_id=ipv4_subnet_id)
        test_listener = huaweicloud.elb.Listener("test",
            name="test_name",
            protocol="HTTP",
            protocol_port=8080,
            loadbalancer_id=test.id)
        test_pool = huaweicloud.elb.Pool("test",
            name="test_name",
            protocol="HTTP",
            lb_method="ROUND_ROBIN",
            listener_id=test_listener.id)
        my_as_group_with_enhanced_lb = huaweicloud.as_.Group("my_as_group_with_enhanced_lb",
