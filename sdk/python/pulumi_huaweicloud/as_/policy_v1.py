...
class PolicyV1Args:
    def __init__(__self__, *,
                 ...
                 scaling_policy_action: Optional[pulumi.Input['PolicyV1ScalingPolicyActionArgs']] = None,
                 scheduled_policy: Optional[pulumi.Input['PolicyV1ScheduledPolicyArgs']] = None):
        """
        The set of arguments for constructing a PolicyV1 resource.
        """
    ...
    def scaling_policy_action(self) -> Optional[pulumi.Input['PolicyV1ScalingPolicyActionArgs']]:
        return pulumi.get(self, "scaling_policy_action")

    @scaling_policy_action.setter
    def scaling_policy_action(self, value: Optional[pulumi.Input['PolicyV1ScalingPolicyActionArgs']]):
        pulumi.set(self, "scaling_policy_action", value)

    @_builtins.property
    @pulumi.getter(name="scheduledPolicy")
    def scheduled_policy(self) -> Optional[pulumi.Input['PolicyV1ScheduledPolicyArgs']]:
        return pulumi.get(self, "scheduled_policy")

    @scheduled_policy.setter
    def scheduled_policy(self, value: Optional[pulumi.Input['PolicyV1ScheduledPolicyArgs']]):
        pulumi.set(self, "scheduled_policy", value)


@pulumi.input_type
class _PolicyV1State:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[_builtins.str]] = None,
                 alarm_id: Optional[pulumi.Input[_builtins.str]] = None,
                 cool_down_time: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        """
        Input properties used for looking up and filtering PolicyV1 resources.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
        if alarm_id is not None:
...
@pulumi.type_token("huaweicloud:As/policyV1:PolicyV1")
class PolicyV1(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 scaling_group_id: Optional[pulumi.Input[_builtins.str]] = None,
                 scaling_policy_action: Optional[pulumi.Input[Union['PolicyV1ScalingPolicyActionArgs', 'PolicyV1ScalingPolicyActionArgsDict']]] = None,
                 scaling_policy_name: Optional[pulumi.Input[_builtins.str]] = None,
                 scaling_policy_type: Optional[pulumi.Input[_builtins.str]] = None,
                 scheduled_policy: Optional[pulumi.Input[Union['PolicyV1ScheduledPolicyArgs', 'PolicyV1ScheduledPolicyArgsDict']]] = None,
                 __props__=None):
        """
        Create a PolicyV1 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a PolicyV1 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param PolicyV1Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PolicyV1Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PolicyV1Args.__new__(PolicyV1Args)
        ...
        super(PolicyV1, __self__).__init__(
            'huaweicloud:As/policyV1:PolicyV1',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            scaling_policy_type: Optional[pulumi.Input[_builtins.str]] = None,
            scheduled_policy: Optional[pulumi.Input[Union['PolicyV1ScheduledPolicyArgs', 'PolicyV1ScheduledPolicyArgsDict']]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'PolicyV1':
        """
        Get an existing PolicyV1 resource's state with the given name, id, and optional extra
        ...
        __props__ = _PolicyV1State.__new__(_PolicyV1State)
        ...
        return PolicyV1(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="scalingPolicyAction")
    def scaling_policy_action(self) -> pulumi.Output['outputs.PolicyV1ScalingPolicyAction']:
        return pulumi.get(self, "scaling_policy_action")
    ...
    @_builtins.property
    @pulumi.getter(name="scheduledPolicy")
    def scheduled_policy(self) -> pulumi.Output['outputs.PolicyV1ScheduledPolicy']:
        return pulumi.get(self, "scheduled_policy")
