...
def get_quotas(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.As.get_quotas()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:As/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult).value
...
def get_quotas_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:As/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult)
