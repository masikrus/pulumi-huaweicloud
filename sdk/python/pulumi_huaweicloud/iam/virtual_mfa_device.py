...
class _VirtualMfaDeviceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the virtual MFA device name. Changing this will create a new virtual
               MFA device.
        :param pulumi.Input[_builtins.str] qr_code_png: A QR code PNG image that encodes `otpauth://totp/huawei:$domainName@$userName?secret=$Base32String`
...
@pulumi.type_token("huaweicloud:Iam/virtualMfaDevice:VirtualMfaDevice")
class VirtualMfaDevice(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.iam.VirtualMfaDevice("test",
            name=name,
            user_id=user_id)
        ```
