...
class UserRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_id: Specifies the the ID of user to assign the role to.
               Changing this parameter will create a new resource.
        """
...
@pulumi.type_token("huaweicloud:Iam/userRoleAssignment:UserRoleAssignment")
class UserRoleAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.Iam.get_role(display_name="ECS FullAccess")
        test_user = huaweicloud.iam.User("test",
            name="user_1",
            description="A user",
            password=user1_password)
        test_user_role_assignment = huaweicloud.iam.UserRoleAssignment("test",
    ...
    def get(resource_name: str,
            ...
            enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
            role_id: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'UserRoleAssignment':
        """
