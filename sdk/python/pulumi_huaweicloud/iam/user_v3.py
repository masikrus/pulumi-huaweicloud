...
@pulumi.type_token("huaweicloud:Iam/userV3:UserV3")
class UserV3(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(UserV3Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = UserV3Args.__new__(UserV3Args)
        ...
        super(UserV3, __self__).__init__(
            'huaweicloud:Iam/userV3:UserV3',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            password_strength: Optional[pulumi.Input[_builtins.str]] = None,
            phone: Optional[pulumi.Input[_builtins.str]] = None,
            pwd_reset: Optional[pulumi.Input[_builtins.bool]] = None) -> 'UserV3':
        """
        Get an existing UserV3 resource's state with the given name, id, and optional extra
        ...
        __props__ = _UserV3State.__new__(_UserV3State)
        ...
        __props__.__dict__["phone"] = phone
        __props__.__dict__["pwd_reset"] = pwd_reset
        return UserV3(resource_name, opts=opts, __props__=__props__)
