...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] external_identity_type: Specifies the type of the IAM user in the external system.
...
@pulumi.type_token("huaweicloud:Iam/user:User")
