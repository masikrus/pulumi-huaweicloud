...
class PasswordPolicyArgs:
    def __init__(__self__, *,
                 ...
                 number_of_recent_passwords_disallowed: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def number_of_recent_passwords_disallowed(self, value: Optional[pulumi.Input[_builtins.int]]):
...
@pulumi.type_token("huaweicloud:Iam/passwordPolicy:PasswordPolicy")
