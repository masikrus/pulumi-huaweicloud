...
__all__ = ['RoleAssignmentV3Args', 'RoleAssignmentV3']

@pulumi.input_type
class RoleAssignmentV3Args:
...
@pulumi.type_token("huaweicloud:Iam/roleAssignmentV3:RoleAssignmentV3")
class RoleAssignmentV3(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RoleAssignmentV3Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(RoleAssignmentV3, __self__).__init__(
            'huaweicloud:Iam/roleAssignmentV3:RoleAssignmentV3',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[_builtins.str]] = None,
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            role_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'RoleAssignmentV3':
        """
        Get an existing RoleAssignmentV3 resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["project_id"] = project_id
        __props__.__dict__["role_id"] = role_id
        return RoleAssignmentV3(resource_name, opts=opts, __props__=__props__)
