...
class GetRegionsResult:
    ...
    """
    def __init__(__self__, id=None, region_id=None, regions=None):
    ...
    def regions(self) -> Sequence['outputs.GetRegionsRegionResult']:
        """
        The information of region list.  
...
def get_regions(region_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Iam.get_regions(region_id=region_id)
    ```


    :param _builtins.str region_id: Specifies the id of the region to be queried.
    """
    __args__ = dict()
    __args__['regionId'] = region_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('huaweicloud:Iam/getRegions:getRegions', __args__, opts=opts, typ=GetRegionsResult).value

    return AwaitableGetRegionsResult(
        id=pulumi.get(__ret__, 'id'),
        region_id=pulumi.get(__ret__, 'region_id'),
        regions=pulumi.get(__ret__, 'regions'))
def get_regions_output(region_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Iam/getRegions:getRegions', __args__, opts=opts, typ=GetRegionsResult)
