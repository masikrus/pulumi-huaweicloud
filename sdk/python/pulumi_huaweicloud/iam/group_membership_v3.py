...
__all__ = ['GroupMembershipV3Args', 'GroupMembershipV3']
...
class GroupMembershipV3(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GroupMembershipV3Args, pulumi.ResourceOptions, *args, **kwargs)
