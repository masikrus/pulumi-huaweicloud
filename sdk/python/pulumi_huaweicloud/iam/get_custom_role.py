...
def get_custom_role(description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str description: Specifies the description of the custom policy.
    :param _builtins.str domain_id: Specifies the domain the policy belongs to.
    :param _builtins.str id: Specifies the ID of the custom policy. It's required if `name` is not specified.
    :param _builtins.str name: Specifies the name of the custom policy. It's required if `id` is not specified.
    :param _builtins.int references: Specifies the number of citations for the custom policy.
    :param _builtins.str type: Specifies the display mode of the custom policy. Valid options are as follows:
...
def get_custom_role_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Iam/getCustomRole:getCustomRole', __args__, opts=opts, typ=GetCustomRoleResult)
