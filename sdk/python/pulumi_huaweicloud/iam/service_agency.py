...
__all__ = ['ServiceAgencyArgs', 'ServiceAgency']

@pulumi.input_type
class ServiceAgencyArgs:
    def __init__(__self__, *,
                 delegated_service_name: pulumi.Input[_builtins.str],
    ...
    def delegated_service_name(self, value: pulumi.Input[_builtins.str]):
...
class ServiceAgency(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceAgencyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceAgencyArgs.__new__(ServiceAgencyArgs)

            if delegated_service_name is None and not opts.urn:
                raise TypeError("Missing required property 'delegated_service_name'")
    ...
    def get(resource_name: str,
        ...
        __props__ = _ServiceAgencyState.__new__(_ServiceAgencyState)
