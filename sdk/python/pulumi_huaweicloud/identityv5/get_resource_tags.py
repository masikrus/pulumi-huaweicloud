...
class GetResourceTagsResult:
    ...
    """
    def __init__(__self__, id=None, resource_id=None, resource_type=None, tags=None):
...
def get_resource_tags(resource_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.IdentityV5.get_resource_tags(resource_id=resource_id,
        resource_type="user")
    ```


    :param _builtins.str resource_id: Specifies the resource ID to be queried.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:IdentityV5/getResourceTags:getResourceTags', __args__, opts=opts, typ=GetResourceTagsResult).value
...
def get_resource_tags_output(resource_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:IdentityV5/getResourceTags:getResourceTags', __args__, opts=opts, typ=GetResourceTagsResult)
