...
class StreamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_favorite: Specifies whether to favorite the log stream.  
               Defaults to **false**.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the log stream resource. If omitted, the
               provider-level region will be used. Changing this creates a new log stream resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs of the log stream.
...
@pulumi.type_token("huaweicloud:Lts/stream:Stream")
