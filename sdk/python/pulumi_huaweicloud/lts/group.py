...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project ID to which the log group belongs.
               ...
               will be used.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the log group resource. If omitted, the
               provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the log group.
        """
...
@pulumi.type_token("huaweicloud:Lts/group:Group")
