...
__all__ = ['SqlAlarmRuleArgs', 'SqlAlarmRule']

@pulumi.input_type
class SqlAlarmRuleArgs:
    def __init__(__self__, *,
                 alarm_level: pulumi.Input[_builtins.str],
                 condition_expression: pulumi.Input[_builtins.str],
                 frequency: pulumi.Input['SqlAlarmRuleFrequencyArgs'],
                 sql_requests: pulumi.Input[Sequence[pulumi.Input['SqlAlarmRuleSqlRequestArgs']]],
                 ...
                 notification_rule: Optional[pulumi.Input['SqlAlarmRuleNotificationRuleArgs']] = None,
                 notification_save_rule: Optional[pulumi.Input['SqlAlarmRuleNotificationSaveRuleArgs']] = None,
        ...
        :param pulumi.Input['SqlAlarmRuleFrequencyArgs'] frequency: Specifies the alarm frequency configurations.
               The Frequency structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['SqlAlarmRuleSqlRequestArgs']]] sql_requests: Specifies the SQL requests.
               The SQLRequests structure is documented below.
        ...
        :param pulumi.Input[_builtins.str] alarm_rule_alias: Specifies the alias name of the SQL alarm rule.  
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description of the SQL alarm rule.
        :param pulumi.Input[_builtins.str] name: Specifies the topic name.
        :param pulumi.Input[_builtins.int] notification_frequency: Specifies the notification frequency of the SQL alarm rule,
               in minutes.
               ...
               + **180**
               + **360**
        :param pulumi.Input['SqlAlarmRuleNotificationRuleArgs'] notification_rule: The notification rule of the SQL alarm rule.
        :param pulumi.Input['SqlAlarmRuleNotificationSaveRuleArgs'] notification_save_rule: Specifies the notification rule.  
    ...
    @_builtins.property
    @pulumi.getter
    def frequency(self) -> pulumi.Input['SqlAlarmRuleFrequencyArgs']:
        """
    ...
    @frequency.setter
    def frequency(self, value: pulumi.Input['SqlAlarmRuleFrequencyArgs']):
        pulumi.set(self, "frequency", value)

    @_builtins.property
    @pulumi.getter(name="sqlRequests")
    def sql_requests(self) -> pulumi.Input[Sequence[pulumi.Input['SqlAlarmRuleSqlRequestArgs']]]:
        """
        Specifies the SQL requests.
        The SQLRequests structure is documented below.
        """
        return pulumi.get(self, "sql_requests")

    @sql_requests.setter
    def sql_requests(self, value: pulumi.Input[Sequence[pulumi.Input['SqlAlarmRuleSqlRequestArgs']]]):
        pulumi.set(self, "sql_requests", value)
    ...
    def alarm_rule_alias(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the alias name of the SQL alarm rule.  
        The maximum lanegth is `128` characters, only Chinese characters, letters, digits, hyphens (-) and underscores (_)
        are allowed.
        The name cannot start with and end with a hyphen or a underscore.
        """
    ...
    def notification_frequency(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Specifies the notification frequency of the SQL alarm rule,
        in minutes.
        Defaults to `0`, `0` means immediately notification.
        This parameter is available only when `send_notifications` parameter is set to **true**.
        The valid values are as follows:
    ...
    def notification_rule(self) -> Optional[pulumi.Input['SqlAlarmRuleNotificationRuleArgs']]:
        """
    ...
    def notification_rule(self, value: Optional[pulumi.Input['SqlAlarmRuleNotificationRuleArgs']]):
        pulumi.set(self, "notification_rule", value)

    @_builtins.property
    @pulumi.getter(name="notificationSaveRule")
    def notification_save_rule(self) -> Optional[pulumi.Input['SqlAlarmRuleNotificationSaveRuleArgs']]:
        """
    ...
    def notification_save_rule(self, value: Optional[pulumi.Input['SqlAlarmRuleNotificationSaveRuleArgs']]):
...
class _SqlAlarmRuleState:
    def __init__(__self__, *,
                 ...
                 frequency: Optional[pulumi.Input['SqlAlarmRuleFrequencyArgs']] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 notification_frequency: Optional[pulumi.Input[_builtins.int]] = None,
                 notification_rule: Optional[pulumi.Input['SqlAlarmRuleNotificationRuleArgs']] = None,
                 notification_save_rule: Optional[pulumi.Input['SqlAlarmRuleNotificationSaveRuleArgs']] = None,
                 ...
                 send_notifications: Optional[pulumi.Input[_builtins.bool]] = None,
                 send_recovery_notifications: Optional[pulumi.Input[_builtins.bool]] = None,
                 sql_requests: Optional[pulumi.Input[Sequence[pulumi.Input['SqlAlarmRuleSqlRequestArgs']]]] = None,
                 status: Optional[pulumi.Input[_builtins.str]] = None,
                 trigger_condition_count: Optional[pulumi.Input[_builtins.int]] = None,
                 trigger_condition_frequency: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def frequency(self) -> Optional[pulumi.Input['SqlAlarmRuleFrequencyArgs']]:
        """
        Specifies the alarm frequency configurations.
        The Frequency structure is documented below.
        """
    ...
    @frequency.setter
    def frequency(self, value: Optional[pulumi.Input['SqlAlarmRuleFrequencyArgs']]):
        pulumi.set(self, "frequency", value)
    ...
    @_builtins.property
    @pulumi.getter(name="sqlRequests")
    def sql_requests(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SqlAlarmRuleSqlRequestArgs']]]]:
        """
        Specifies the SQL requests.
        The SQLRequests structure is documented below.
        """
    ...
    @sql_requests.setter
    def sql_requests(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SqlAlarmRuleSqlRequestArgs']]]]):
        pulumi.set(self, "sql_requests", value)
...
@pulumi.type_token("huaweicloud:Lts/sqlAlarmRule:SqlAlarmRule")
class SqlAlarmRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 condition_expression: Optional[pulumi.Input[_builtins.str]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 frequency: Optional[pulumi.Input[Union['SqlAlarmRuleFrequencyArgs', 'SqlAlarmRuleFrequencyArgsDict']]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 notification_frequency: Optional[pulumi.Input[_builtins.int]] = None,
                 notification_rule: Optional[pulumi.Input[Union['SqlAlarmRuleNotificationRuleArgs', 'SqlAlarmRuleNotificationRuleArgsDict']]] = None,
                 notification_save_rule: Optional[pulumi.Input[Union['SqlAlarmRuleNotificationSaveRuleArgs', 'SqlAlarmRuleNotificationSaveRuleArgsDict']]] = None,
                 recovery_frequency: Optional[pulumi.Input[_builtins.int]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 send_notifications: Optional[pulumi.Input[_builtins.bool]] = None,
                 send_recovery_notifications: Optional[pulumi.Input[_builtins.bool]] = None,
                 sql_requests: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SqlAlarmRuleSqlRequestArgs', 'SqlAlarmRuleSqlRequestArgsDict']]]]] = None,
                 status: Optional[pulumi.Input[_builtins.str]] = None,
                 trigger_condition_count: Optional[pulumi.Input[_builtins.int]] = None,
                 trigger_condition_frequency: Optional[pulumi.Input[_builtins.int]] = None,
                 __props__=None):
        ...
        test = huaweicloud.lts.SqlAlarmRule("test",
            name="terraform_test",
        ...
        :param pulumi.Input[_builtins.str] condition_expression: Specifies the condition expression.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the SQL alarm rule.
        :param pulumi.Input[Union['SqlAlarmRuleFrequencyArgs', 'SqlAlarmRuleFrequencyArgsDict']] frequency: Specifies the alarm frequency configurations.
               The Frequency structure is documented below.
        :param pulumi.Input[_builtins.str] name: Specifies the topic name.
        :param pulumi.Input[_builtins.int] notification_frequency: Specifies the notification frequency of the SQL alarm rule,
               in minutes.
               ...
               + **180**
               + **360**
        :param pulumi.Input[Union['SqlAlarmRuleNotificationRuleArgs', 'SqlAlarmRuleNotificationRuleArgsDict']] notification_rule: The notification rule of the SQL alarm rule.
        :param pulumi.Input[Union['SqlAlarmRuleNotificationSaveRuleArgs', 'SqlAlarmRuleNotificationSaveRuleArgsDict']] notification_save_rule: Specifies the notification rule.  
               The NotificationRule structure is documented below.
               This parameter is available only when `send_notifications` parameter is set to **true**.
        :param pulumi.Input[_builtins.int] recovery_frequency: Specifies the frequency to recover the alarm.
               Defaults to `3`.
        ...
        :param pulumi.Input[_builtins.bool] send_recovery_notifications: Specifies whether to send recovery notifications.  
               Defaults to **false**
        :param pulumi.Input[Sequence[pulumi.Input[Union['SqlAlarmRuleSqlRequestArgs', 'SqlAlarmRuleSqlRequestArgsDict']]]] sql_requests: Specifies the SQL requests.
               The SQLRequests structure is documented below.
        :param pulumi.Input[_builtins.str] status: Specifies the status. The value can be: **RUNNING** and **STOPPING**.
               Defaults to **RUNNING**
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SqlAlarmRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SqlAlarmRuleArgs.__new__(SqlAlarmRuleArgs)
            ...
            if condition_expression is None and not opts.urn:
                raise TypeError("Missing required property 'condition_expression'")
            ...
            if sql_requests is None and not opts.urn:
                raise TypeError("Missing required property 'sql_requests'")
            __props__.__dict__["sql_requests"] = sql_requests
        ...
        super(SqlAlarmRule, __self__).__init__(
            'huaweicloud:Lts/sqlAlarmRule:SqlAlarmRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            trigger_condition_count: Optional[pulumi.Input[_builtins.int]] = None,
            trigger_condition_frequency: Optional[pulumi.Input[_builtins.int]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'SqlAlarmRule':
        """
        Get an existing SqlAlarmRule resource's state with the given name, id, and optional extra
        ...
        __props__ = _SqlAlarmRuleState.__new__(_SqlAlarmRuleState)
        ...
        return SqlAlarmRule(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def frequency(self) -> pulumi.Output['outputs.SqlAlarmRuleFrequency']:
        """
        Specifies the alarm frequency configurations.
        The Frequency structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="notificationFrequency")
    def notification_frequency(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the notification frequency of the SQL alarm rule,
        in minutes.
        Defaults to `0`, `0` means immediately notification.
    ...
    @_builtins.property
    @pulumi.getter(name="notificationRule")
    def notification_rule(self) -> pulumi.Output['outputs.SqlAlarmRuleNotificationRule']:
        """
        The notification rule of the SQL alarm rule.
        """
        return pulumi.get(self, "notification_rule")
    ...
    @_builtins.property
    @pulumi.getter(name="notificationSaveRule")
    def notification_save_rule(self) -> pulumi.Output[Optional['outputs.SqlAlarmRuleNotificationSaveRule']]:
        """
        Specifies the notification rule.  
        The NotificationRule structure is documented below.
        This parameter is available only when `send_notifications` parameter is set to **true**.
    ...
    @_builtins.property
    @pulumi.getter(name="sqlRequests")
    def sql_requests(self) -> pulumi.Output[Sequence['outputs.SqlAlarmRuleSqlRequest']]:
        """
        Specifies the SQL requests.
        The SQLRequests structure is documented below.
        """
