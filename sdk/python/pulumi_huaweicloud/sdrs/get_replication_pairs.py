...
__all__ = [
    'GetReplicationPairsResult',
    'AwaitableGetReplicationPairsResult',
    'get_replication_pairs',
    'get_replication_pairs_output',
]

@pulumi.output_type
class GetReplicationPairsResult:
    """
    A collection of values returned by getReplicationPairs.
    """
    def __init__(__self__, availability_zone=None, id=None, name=None, protected_instance_id=None, protected_instance_ids=None, query_type=None, region=None, replication_pairs=None, server_group_id=None, server_group_ids=None, status=None):
        ...
        if protected_instance_id and not isinstance(protected_instance_id, str):
            raise TypeError("Expected argument 'protected_instance_id' to be a str")
        ...
        if replication_pairs and not isinstance(replication_pairs, list):
            raise TypeError("Expected argument 'replication_pairs' to be a list")
        pulumi.set(__self__, "replication_pairs", replication_pairs)
    ...
    def protected_instance_id(self) -> Optional[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter(name="replicationPairs")
    def replication_pairs(self) -> Sequence['outputs.GetReplicationPairsReplicationPairResult']:
        """
        The information about replication pairs.
        """
        return pulumi.get(self, "replication_pairs")
    ...
    def status(self) -> Optional[_builtins.str]:
        """
        The status of the replication pair.
...
class AwaitableGetReplicationPairsResult(GetReplicationPairsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetReplicationPairsResult(
            availability_zone=self.availability_zone,
            id=self.id,
            name=self.name,
            protected_instance_id=self.protected_instance_id,
            protected_instance_ids=self.protected_instance_ids,
            query_type=self.query_type,
            region=self.region,
            replication_pairs=self.replication_pairs,
            server_group_id=self.server_group_id,
            server_group_ids=self.server_group_ids,
            status=self.status)


def get_replication_pairs(availability_zone: Optional[_builtins.str] = None,
                          name: Optional[_builtins.str] = None,
                          protected_instance_id: Optional[_builtins.str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReplicationPairsResult:
    """
    ...
    :param _builtins.str availability_zone: Specifies the AZ of the current production site of the protection group.
    :param _builtins.str name: Specifies the name of the replication pair. Fuzzy search is supported.
    :param _builtins.str protected_instance_id: Specifies the ID of the protected instance bound to the replication pair.
    :param _builtins.str protected_instance_ids: Specifies the list of protected instance IDs (URL-encoded).
    ...
    :param _builtins.str region: Specifies the region where the SDRS replication pairs are located.
    ...
    :param _builtins.str server_group_ids: Specifies the list of protection group IDs (URL-encoded).
    ...
    __args__['name'] = name
    __args__['protectedInstanceId'] = protected_instance_id
    ...
    return AwaitableGetReplicationPairsResult(
        ...
        protected_instance_id=pulumi.get(__ret__, 'protected_instance_id'),
        protected_instance_ids=pulumi.get(__ret__, 'protected_instance_ids'),
        query_type=pulumi.get(__ret__, 'query_type'),
        region=pulumi.get(__ret__, 'region'),
        replication_pairs=pulumi.get(__ret__, 'replication_pairs'),
        server_group_id=pulumi.get(__ret__, 'server_group_id'),
        server_group_ids=pulumi.get(__ret__, 'server_group_ids'),
        status=pulumi.get(__ret__, 'status'))
def get_replication_pairs_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 protected_instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetReplicationPairsResult]:
    """
    Use this data source to query SDRS replication pairs within HuaweiCloud.
    ...
    return __ret__.apply(lambda __response__: GetReplicationPairsResult(
        ...
        protected_instance_id=pulumi.get(__response__, 'protected_instance_id'),
        ...
        replication_pairs=pulumi.get(__response__, 'replication_pairs'),
