...
class ApiArgs:
    def __init__(__self__, *,
                 ...
                 example_success_response: pulumi.Input[_builtins.str],
                 group_id: pulumi.Input[_builtins.str],
                 request_method: pulumi.Input[_builtins.str],
                 request_uri: pulumi.Input[_builtins.str],
                 ...
                 example_failure_response: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] example_success_response: Specifies the example response for a successful request. The length
        ...
        :param pulumi.Input[_builtins.str] request_uri: Specifies the request path of the API. The value must comply with URI
               specifications.
        ...
        :param pulumi.Input[_builtins.str] example_failure_response: Specifies the example response for a failed request The length cannot
        ...
        :param pulumi.Input[_builtins.int] visibility: Specifies whether the API is available to the public. The value can be 1 (public) and
    ...
    def example_success_response(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def example_success_response(self, value: pulumi.Input[_builtins.str]):
    ...
    def request_uri(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @request_uri.setter
    def request_uri(self, value: pulumi.Input[_builtins.str]):
    ...
    def example_failure_response(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def example_failure_response(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def visibility(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @visibility.setter
    def visibility(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _ApiState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 example_failure_response: Optional[pulumi.Input[_builtins.str]] = None,
                 example_success_response: Optional[pulumi.Input[_builtins.str]] = None,
                 function_backend: Optional[pulumi.Input['ApiFunctionBackendArgs']] = None,
                 ...
                 request_parameters: Optional[pulumi.Input[Sequence[pulumi.Input['ApiRequestParameterArgs']]]] = None,
                 request_protocol: Optional[pulumi.Input[_builtins.str]] = None,
                 request_uri: Optional[pulumi.Input[_builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 version: Optional[pulumi.Input[_builtins.str]] = None,
                 visibility: Optional[pulumi.Input[_builtins.int]] = None):
        """
        ...
        :param pulumi.Input['ApiFunctionBackendArgs'] function_backend: Specifies the configuration when backend_type selected 'FUNCTION' (documented
               below).
        :param pulumi.Input[_builtins.str] group_id: Specifies the ID of the API group. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] group_name: The name of the API group to which the API belongs.
        :param pulumi.Input['ApiHttpBackendArgs'] http_backend: Specifies the configuration when backend_type selected 'HTTP' (documented below).
        :param pulumi.Input['ApiMockBackendArgs'] mock_backend: Specifies the configuration when backend_type selected 'MOCK' (documented below).
        :param pulumi.Input[_builtins.str] name: Specifies the name of the API. An API name consists of 3–64 characters, starting with a
               letter. Only letters, digits, and underscores (_) are allowed.
    ...
    @_builtins.property
    @pulumi.getter(name="exampleSuccessResponse")
    def example_success_response(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the example response for a successful request. The length
        cannot exceed 20,480 characters.
        """
    ...
    @example_success_response.setter
    def example_success_response(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "example_success_response", value)
...
@pulumi.type_token("huaweicloud:SharedApig/api:Api")
class Api(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auth_type: Optional[pulumi.Input[_builtins.str]] = None,
                 backend_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApiBackendParameterArgs', 'ApiBackendParameterArgsDict']]]]] = None,
                 backend_type: Optional[pulumi.Input[_builtins.str]] = None,
                 cors: Optional[pulumi.Input[_builtins.bool]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 example_failure_response: Optional[pulumi.Input[_builtins.str]] = None,
                 example_success_response: Optional[pulumi.Input[_builtins.str]] = None,
                 function_backend: Optional[pulumi.Input[Union['ApiFunctionBackendArgs', 'ApiFunctionBackendArgsDict']]] = None,
                 group_id: Optional[pulumi.Input[_builtins.str]] = None,
                 http_backend: Optional[pulumi.Input[Union['ApiHttpBackendArgs', 'ApiHttpBackendArgsDict']]] = None,
                 mock_backend: Optional[pulumi.Input[Union['ApiMockBackendArgs', 'ApiMockBackendArgsDict']]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 request_method: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        tf_apigw_group = huaweicloud.sharedapig.Group("tf_apigw_group",
            name="tf_apigw_group",
            description="your descpiption")
        tf_apigw_api = huaweicloud.sharedapig.Api("tf_apigw_api",
        ...
        :param pulumi.Input[_builtins.str] auth_type: Specifies the security authentication mode. The value can be 'APP', 'IAM', and '
               NONE'.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApiBackendParameterArgs', 'ApiBackendParameterArgsDict']]]] backend_parameters: the backend parameter list (documented below).
        :param pulumi.Input[_builtins.str] backend_type: Specifies the service backend type. The value can be:
               + 'HTTP': the web service backend
               + 'FUNCTION': the FunctionGraph service backend
               + 'MOCK': the Mock service backend
        ...
        :param pulumi.Input[_builtins.str] example_success_response: Specifies the example response for a successful request. The length
               cannot exceed 20,480 characters.
        :param pulumi.Input[Union['ApiFunctionBackendArgs', 'ApiFunctionBackendArgsDict']] function_backend: Specifies the configuration when backend_type selected 'FUNCTION' (documented
               below).
        :param pulumi.Input[_builtins.str] group_id: Specifies the ID of the API group. Changing this creates a new resource.
        :param pulumi.Input[Union['ApiHttpBackendArgs', 'ApiHttpBackendArgsDict']] http_backend: Specifies the configuration when backend_type selected 'HTTP' (documented below).
        :param pulumi.Input[Union['ApiMockBackendArgs', 'ApiMockBackendArgsDict']] mock_backend: Specifies the configuration when backend_type selected 'MOCK' (documented below).
        :param pulumi.Input[_builtins.str] name: Specifies the name of the API. An API name consists of 3–64 characters, starting with a
               letter. Only letters, digits, and underscores (_) are allowed.
        :param pulumi.Input[_builtins.str] region: The region in which to create the API resource. If omitted, the provider-level
               region will be used. Changing this creates a new API resource.
        :param pulumi.Input[_builtins.str] request_method: Specifies the request method, including 'GET','POST','PUT' and etc..
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApiRequestParameterArgs', 'ApiRequestParameterArgsDict']]]] request_parameters: the request parameter list (documented below).
        :param pulumi.Input[_builtins.str] request_protocol: Specifies the request protocol. The value can be 'HTTP', 'HTTPS', and 'BOTH'
               which means the API can be accessed through both 'HTTP' and 'HTTPS'. Defaults to 'HTTPS'.
        :param pulumi.Input[_builtins.str] request_uri: Specifies the request path of the API. The value must comply with URI
               specifications.
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None,
            visibility: Optional[pulumi.Input[_builtins.int]] = None) -> 'Api':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="exampleFailureResponse")
    def example_failure_response(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the example response for a failed request The length cannot
        exceed 20,480 characters.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="exampleSuccessResponse")
    def example_success_response(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the example response for a successful request. The length
        cannot exceed 20,480 characters.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requestProtocol")
    def request_protocol(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the request protocol. The value can be 'HTTP', 'HTTPS', and 'BOTH'
        which means the API can be accessed through both 'HTTP' and 'HTTPS'. Defaults to 'HTTPS'.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requestUri")
    def request_uri(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the request path of the API. The value must comply with URI
        specifications.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def visibility(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies whether the API is available to the public. The value can be 1 (public) and
        2 (private). Defaults to 2.
        """
