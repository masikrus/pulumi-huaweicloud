...
class VolumeV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] availability_zone: The availability zone for the volume. Changing this creates a new
               volume.
        :param pulumi.Input[_builtins.bool] cascade: Default:false. Specifies to delete all snapshots associated with the EVS disk.
        :param pulumi.Input[_builtins.str] consistency_group_id: The consistency group to place the volume in.
        :param pulumi.Input[_builtins.str] description: A description of the volume. Changing this updates the volume's description.
        :param pulumi.Input[_builtins.str] image_id: The image ID from which to create the volume. Changing this creates a new
               volume.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: Metadata key/value pairs to associate with the volume. Changing this updates the existing
               volume metadata.
        :param pulumi.Input[_builtins.str] name: A unique name for the volume. Changing this updates the volume's name.
        :param pulumi.Input[_builtins.str] region: The region in which to create the volume. If omitted, the `region` argument of
               the provider is used. Changing this creates a new volume.
        :param pulumi.Input[_builtins.str] snapshot_id: The snapshot ID from which to create the volume. Changing this creates a
               new volume.
        :param pulumi.Input[_builtins.str] source_replica: The volume ID to replicate with.
        :param pulumi.Input[_builtins.str] source_vol_id: The volume ID from which to create the volume. Changing this creates a
               new volume.
        :param pulumi.Input[_builtins.str] volume_type: The type of volume to create. Available types are
    ...
    def availability_zone(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The availability zone for the volume. Changing this creates a new
        volume.
        """
    ...
    def cascade(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Default:false. Specifies to delete all snapshots associated with the EVS disk.
        """
    ...
    def image_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The image ID from which to create the volume. Changing this creates a new
        volume.
        """
    ...
    def metadata(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Metadata key/value pairs to associate with the volume. Changing this updates the existing
        volume metadata.
        """
    ...
    def region(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The region in which to create the volume. If omitted, the `region` argument of
        the provider is used. Changing this creates a new volume.
        """
    ...
    def snapshot_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The snapshot ID from which to create the volume. Changing this creates a
        new volume.
        """
    ...
    def source_vol_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The volume ID from which to create the volume. Changing this creates a
        new volume.
        """
...
class _VolumeV2State:
    ...
    def attachments(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['VolumeV2AttachmentArgs']]]]:
        """
        If a volume is attached to an instance, this attribute will display the Attachment ID, Instance ID, and
        the Device as the Instance sees it.
        """
...
class VolumeV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        !> **WARNING:** It has been deprecated, use `Evs.Volume` instead.
        ...
        volume1 = huaweicloud.blockstorage.VolumeV2("volume_1",
            region="RegionOne",
            name="volume_1",
    ...
    def get(resource_name: str,
            ...
            source_replica: Optional[pulumi.Input[_builtins.str]] = None,
            source_vol_id: Optional[pulumi.Input[_builtins.str]] = None,
            volume_type: Optional[pulumi.Input[_builtins.str]] = None) -> 'VolumeV2':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VolumeV2AttachmentArgs', 'VolumeV2AttachmentArgsDict']]]] attachments: If a volume is attached to an instance, this attribute will display the Attachment ID, Instance ID, and
               the Device as the Instance sees it.
        :param pulumi.Input[_builtins.str] availability_zone: The availability zone for the volume. Changing this creates a new
               volume.
        :param pulumi.Input[_builtins.bool] cascade: Default:false. Specifies to delete all snapshots associated with the EVS disk.
