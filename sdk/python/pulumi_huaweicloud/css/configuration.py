...
@pulumi.type_token("huaweicloud:Css/configuration:Configuration")
class Configuration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.css.Configuration("test",
    ...
    def _internal_init(__self__,
        ...
        super(Configuration, __self__).__init__(
            'huaweicloud:Css/configuration:Configuration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            reindex_remote_whitelist: Optional[pulumi.Input[_builtins.str]] = None,
            thread_pool_force_merge_size: Optional[pulumi.Input[_builtins.str]] = None) -> 'Configuration':
        """
