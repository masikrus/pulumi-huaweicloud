...
def get_flavors(memory: Optional[_builtins.int] = None,
    ...
    test = huaweicloud.Css.get_flavors(type="ess",
        version="7.9.3",
        vcpus=4,
        memory=32)
    ```
...
def get_flavors_output(memory: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Css/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult)
