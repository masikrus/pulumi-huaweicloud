...
__all__ = ['CertificateImportArgs', 'CertificateImport']

@pulumi.input_type
class CertificateImportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] private_key: Specifies the private encrypted key of the SSL certificate.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] certificate_chain: Specifies the certificate chain of the SSL certificate.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] enc_certificate: Specifies the encrypted content of the certificate encrypted with
               SM series cryptographic algorithms.
               Using the escape character `\\n` or `\\r\\n` to replace carriage return and line feed characters.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] enc_private_key: Specifies the encrypted private key of the certificate encrypted with
               SM series cryptographic algorithms.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CertificateImportTargetArgs']]] targets: Specifies the service information that needs to push the SSL certificate.
    ...
    def certificate(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the content of the SSL certificate.
        The certificate content can include intermediate certificates and root certificates.
        If the certificate chain is passed in using the field `certificate_chain`, then the field `certificate` only takes
        the certificate content itself. Using the escape character `\\n` or `\\r\\n` to replace carriage return and line feed.
    ...
    def private_key(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the private encrypted key of the SSL certificate.
        The private key protected by password cannot be uploaded. The carriage return character must be replaced with the
        escape character `\\n` or `\\r\\n`.
    ...
    def certificate_chain(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the certificate chain of the SSL certificate.
        The certificate chain can also be passed in through `certificate`. Using the escape character `\\n` or `\\r\\n` to
        replace carriage return and line feed characters.
    ...
    def enc_certificate(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the encrypted content of the certificate encrypted with
        SM series cryptographic algorithms.
        Using the escape character `\\n` or `\\r\\n` to replace carriage return and line feed characters.
    ...
    def enc_private_key(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the encrypted private key of the certificate encrypted with
        SM series cryptographic algorithms.
        Password-protected private keys cannot be uploaded, and using the escape character `\\n` or `\\r\\n` to replace carriage
        return and line feed characters.
    ...
    def region(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the region in which to import SSL certificate.
        If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def targets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CertificateImportTargetArgs']]]]:
        """
        Specifies the service information that needs to push the SSL certificate.
        The target structure is documented below.
    ...
    @targets.setter
    def targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CertificateImportTargetArgs']]]]):
        pulumi.set(self, "targets", value)


@pulumi.input_type
class _CertificateImportState:
    def __init__(__self__, *,
                 authentifications: Optional[pulumi.Input[Sequence[pulumi.Input['CertificateImportAuthentificationArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.int] domain_count: The number of domain names that can be bound to the certificate.
        :param pulumi.Input[_builtins.str] enc_certificate: Specifies the encrypted content of the certificate encrypted with
               SM series cryptographic algorithms.
               Using the escape character `\\n` or `\\r\\n` to replace carriage return and line feed characters.
        ...
        :param pulumi.Input[_builtins.str] not_before: The time when the certificate takes effect. If no valid value is obtained, this parameter is left blank.
        :param pulumi.Input[_builtins.str] private_key: Specifies the private encrypted key of the SSL certificate.
               The private key protected by password cannot be uploaded. The carriage return character must be replaced with the
               escape character `\\n` or `\\r\\n`.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] push_support: Whether the certificate support push.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to import SSL certificate.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] status: The certificate status. Valid values are as follows:
    ...
    @_builtins.property
    @pulumi.getter
    def authentifications(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CertificateImportAuthentificationArgs']]]]:
        """
        The domain ownership verification information.
        The authentifications structure is documented below.
        """
        return pulumi.get(self, "authentifications")

    @authentifications.setter
    def authentifications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CertificateImportAuthentificationArgs']]]]):
    ...
    def domain_count(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        The number of domain names that can be bound to the certificate.
        """
    ...
    def not_after(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The time when the certificate becomes invalid. If no valid value is obtained, this parameter is left blank.
        """
    ...
    def not_before(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The time when the certificate takes effect. If no valid value is obtained, this parameter is left blank.
        """
    ...
    def push_support(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Whether the certificate support push.
        """
    ...
    def status(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The certificate status. Valid values are as follows:
        + `PAID` - The certificate has been paid, and needs to be applied for from the CA.
        + `ISSUED` - The certificate has been issued.
        + `CHECKING` - The certificate application is under review.
        + `CANCELCHECKING` - The application of certificate cancellation is under review.
...
class CertificateImport(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to import SSL certificate.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CertificateImportTargetArgs', 'CertificateImportTargetArgsDict']]]] targets: Specifies the service information that needs to push the SSL certificate.
               The target structure is documented below.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CertificateImportArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CertificateImportArgs.__new__(CertificateImportArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            authentifications: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CertificateImportAuthentificationArgs', 'CertificateImportAuthentificationArgsDict']]]]] = None,
            certificate: Optional[pulumi.Input[_builtins.str]] = None,
            certificate_chain: Optional[pulumi.Input[_builtins.str]] = None,
            domain: Optional[pulumi.Input[_builtins.str]] = None,
            domain_count: Optional[pulumi.Input[_builtins.int]] = None,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CertificateImportTargetArgs', 'CertificateImportTargetArgsDict']]]]] = None) -> 'CertificateImport':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CertificateImportAuthentificationArgs', 'CertificateImportAuthentificationArgsDict']]]] authentifications: The domain ownership verification information.
               The authentifications structure is documented below.
        :param pulumi.Input[_builtins.str] certificate: Specifies the content of the SSL certificate.
               The certificate content can include intermediate certificates and root certificates.
               If the certificate chain is passed in using the field `certificate_chain`, then the field `certificate` only takes
        ...
        __props__ = _CertificateImportState.__new__(_CertificateImportState)
        ...
        __props__.__dict__["targets"] = targets
        return CertificateImport(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def authentifications(self) -> pulumi.Output[Sequence['outputs.CertificateImportAuthentification']]:
        """
        The domain ownership verification information.
        The authentifications structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def targets(self) -> pulumi.Output[Optional[Sequence['outputs.CertificateImportTarget']]]:
        """
        Specifies the service information that needs to push the SSL certificate.
        The target structure is documented below.
