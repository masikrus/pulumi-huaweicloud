...
__all__ = [
    'GetFileSystemV2Result',
    'AwaitableGetFileSystemV2Result',
    'get_file_system_v2',
    'get_file_system_v2_output',
]

@pulumi.output_type
class GetFileSystemV2Result:
    """
    A collection of values returned by getFileSystemV2.
    """
...
class AwaitableGetFileSystemV2Result(GetFileSystemV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFileSystemV2Result(
...
def get_file_system_v2(id: Optional[_builtins.str] = None,
                       name: Optional[_builtins.str] = None,
                       region: Optional[_builtins.str] = None,
                       status: Optional[_builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFileSystemV2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Sfs/getFileSystemV2:getFileSystemV2', __args__, opts=opts, typ=GetFileSystemV2Result).value

    return AwaitableGetFileSystemV2Result(
...
def get_file_system_v2_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFileSystemV2Result]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Sfs/getFileSystemV2:getFileSystemV2', __args__, opts=opts, typ=GetFileSystemV2Result)
    return __ret__.apply(lambda __response__: GetFileSystemV2Result(
