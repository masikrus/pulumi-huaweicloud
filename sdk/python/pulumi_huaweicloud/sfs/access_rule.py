...
class AccessRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sfs_id: Specifies the UUID of the shared file system. Changing this will create a new
               access rule.
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the sfs access rule resource. If omitted, the
...
@pulumi.type_token("huaweicloud:Sfs/accessRule:AccessRule")
