...
class FileSystemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] availability_zone: Specifies the availability zone name. Changing this parameter will
               create a new resource.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the shared file system, which contains 0 to 255
               characters and can contain only letters, digits, hyphens (-), and underscores (_).
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project id of the shared file system. Changing
               this creates a new resource.
        :param pulumi.Input[_builtins.bool] is_public: Specifies whether a file system can be publicly seen.
               The default value is false.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: Specifies the metadata information used to create the shared file system. The
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the shared file system, which contains 0 to 255 characters and
               can contain only letters, digits, hyphens (-), and underscores (_).
        :param pulumi.Input[_builtins.str] region: The region in which to create the sfs resource. If omitted, the provider-level
               region will be used. Changing this creates a new sfs resource.
        :param pulumi.Input[_builtins.str] share_proto: Specifies the file system sharing protocol.
...
@pulumi.type_token("huaweicloud:Sfs/fileSystem:FileSystem")
