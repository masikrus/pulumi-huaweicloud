...
__all__ = ['FileSystemV2Args', 'FileSystemV2']

@pulumi.input_type
class FileSystemV2Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a FileSystemV2 resource.
        """
...
@pulumi.input_type
class _FileSystemV2State:
    def __init__(__self__, *,
                 access_level: Optional[pulumi.Input[_builtins.str]] = None,
                 access_rule_status: Optional[pulumi.Input[_builtins.str]] = None,
                 access_rules: Optional[pulumi.Input[Sequence[pulumi.Input['FileSystemV2AccessRuleArgs']]]] = None,
                 access_to: Optional[pulumi.Input[_builtins.str]] = None,
                 access_type: Optional[pulumi.Input[_builtins.str]] = None,
                 availability_zone: Optional[pulumi.Input[_builtins.str]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering FileSystemV2 resources.
        """
        if access_level is not None:
            pulumi.set(__self__, "access_level", access_level)
    ...
    def access_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FileSystemV2AccessRuleArgs']]]]:
        return pulumi.get(self, "access_rules")

    @access_rules.setter
    def access_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FileSystemV2AccessRuleArgs']]]]):
...
@pulumi.type_token("huaweicloud:Sfs/fileSystemV2:FileSystemV2")
class FileSystemV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a FileSystemV2 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FileSystemV2Args,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a FileSystemV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param FileSystemV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FileSystemV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FileSystemV2Args.__new__(FileSystemV2Args)
        ...
        super(FileSystemV2, __self__).__init__(
            'huaweicloud:Sfs/fileSystemV2:FileSystemV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            access_level: Optional[pulumi.Input[_builtins.str]] = None,
            access_rule_status: Optional[pulumi.Input[_builtins.str]] = None,
            access_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FileSystemV2AccessRuleArgs', 'FileSystemV2AccessRuleArgsDict']]]]] = None,
            access_to: Optional[pulumi.Input[_builtins.str]] = None,
            access_type: Optional[pulumi.Input[_builtins.str]] = None,
            availability_zone: Optional[pulumi.Input[_builtins.str]] = None,
            description: Optional[pulumi.Input[_builtins.str]] = None,
            ...
            size: Optional[pulumi.Input[_builtins.int]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'FileSystemV2':
        """
        Get an existing FileSystemV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _FileSystemV2State.__new__(_FileSystemV2State)
        ...
        __props__.__dict__["tags"] = tags
        return FileSystemV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="accessRules")
    def access_rules(self) -> pulumi.Output[Sequence['outputs.FileSystemV2AccessRule']]:
        return pulumi.get(self, "access_rules")
