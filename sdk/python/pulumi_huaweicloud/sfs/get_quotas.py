...
class GetQuotasResult:
    ...
    def quotas(self) -> Sequence['outputs.GetQuotasQuotaResult']:
        """
        The list of SFS Turbo quotas and their usage.
...
def get_quotas(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Sfs.get_quotas()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Sfs/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult).value
...
def get_quotas_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Sfs/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult)
