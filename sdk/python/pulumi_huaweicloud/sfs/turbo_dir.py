...
class TurboDirArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] uid: Specifies the user ID of the file directory. The minimum value is `0`,
    ...
    def path(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the valid full path of SFS Turbo directory. The parameter
        starts with "/", otherwise the parameter is illegal. Changing this will create a new resource.
        """
    ...
    def gid(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Specifies the group ID of the file directory. The minimum value is `0`,
        the value represents the ID of the super user `root`.
        """
    ...
    def mode(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Specifies the file directory permissions. The valid value ranges from `0` to `777`.
        `0` means no permission, and `777` means the highest authority(read, write and execute). Please refer
        to [document](https://en.wikipedia.org/wiki/Chmod#Numerical_permissions). This field will be set to `0` when
        this field over `777`.
        """
    ...
    def uid(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Specifies the user ID of the file directory. The minimum value is `0`,
        the value represents the ID of the group where the super user `root` belongs.
        """
...
@pulumi.type_token("huaweicloud:Sfs/turboDir:TurboDir")
class TurboDir(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.sfs.TurboDir("test",
            path="/tmp01",
            share_id=share_id,
            mode=777)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TurboDirArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TurboDirArgs.__new__(TurboDirArgs)
        ...
        super(TurboDir, __self__).__init__(
            'huaweicloud:Sfs/turboDir:TurboDir',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            share_id: Optional[pulumi.Input[_builtins.str]] = None,
            uid: Optional[pulumi.Input[_builtins.int]] = None) -> 'TurboDir':
        """
        Get an existing TurboDir resource's state with the given name, id, and optional extra
        ...
        __props__ = _TurboDirState.__new__(_TurboDirState)
        ...
        __props__.__dict__["share_id"] = share_id
        __props__.__dict__["uid"] = uid
        return TurboDir(resource_name, opts=opts, __props__=__props__)
