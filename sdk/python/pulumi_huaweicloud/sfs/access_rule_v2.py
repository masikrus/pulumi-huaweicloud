...
__all__ = ['AccessRuleV2Args', 'AccessRuleV2']

@pulumi.input_type
class AccessRuleV2Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a AccessRuleV2 resource.
        """
...
class _AccessRuleV2State:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering AccessRuleV2 resources.
        """
        if access_level is not None:
            pulumi.set(__self__, "access_level", access_level)
...
@pulumi.type_token("huaweicloud:Sfs/accessRuleV2:AccessRuleV2")
class AccessRuleV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a AccessRuleV2 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AccessRuleV2Args,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a AccessRuleV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param AccessRuleV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AccessRuleV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AccessRuleV2Args.__new__(AccessRuleV2Args)
        ...
        super(AccessRuleV2, __self__).__init__(
            'huaweicloud:Sfs/accessRuleV2:AccessRuleV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            sfs_id: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'AccessRuleV2':
        """
        Get an existing AccessRuleV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _AccessRuleV2State.__new__(_AccessRuleV2State)
        ...
        return AccessRuleV2(resource_name, opts=opts, __props__=__props__)
