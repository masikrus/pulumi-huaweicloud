...
def get_eip(enterprise_project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str port_id: Specifies the port id of the EIP.
    :param _builtins.str public_ip: Specifies the public **IPv4** address of the EIP.
    :param _builtins.str region: Specifies the region in which to obtain the EIP.
...
def get_eip_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Eip/getEip:getEip', __args__, opts=opts, typ=GetEipResult)
