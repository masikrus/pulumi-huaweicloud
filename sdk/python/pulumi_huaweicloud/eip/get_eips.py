...
def get_eips(enterprise_project_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] private_ips: Specifies an array of one or more private ip addresses of the desired EIP.
...
def get_eips_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Eip/getEips:getEips', __args__, opts=opts, typ=GetEipsResult)
