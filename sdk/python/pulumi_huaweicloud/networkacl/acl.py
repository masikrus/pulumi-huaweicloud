...
@pulumi.type_token("huaweicloud:NetworkAcl/acl:Acl")
class Acl(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rule1 = huaweicloud.networkacl.AclRule("rule_1",
            name="my-rule-1",
            ...
            destination_port="23",
            enabled=True)
        rule2 = huaweicloud.networkacl.AclRule("rule_2",
            name="my-rule-2",
            ...
            enabled=False)
        fw_acl = huaweicloud.networkacl.Acl("fw_acl",
            name="my-fw-acl",
            subnets=[subnet.id],
            inbound_rules=[
                rule1.id,
