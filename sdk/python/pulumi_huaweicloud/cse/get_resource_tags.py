...
def get_resource_tags(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cse.get_resource_tags(resource_type="CES-alarm")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cse/getResourceTags:getResourceTags', __args__, opts=opts, typ=GetResourceTagsResult).value
...
def get_resource_tags_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cse/getResourceTags:getResourceTags', __args__, opts=opts, typ=GetResourceTagsResult)
