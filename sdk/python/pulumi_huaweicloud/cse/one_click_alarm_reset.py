...
__all__ = ['OneClickAlarmResetArgs', 'OneClickAlarmReset']

@pulumi.input_type
class OneClickAlarmResetArgs:
    def __init__(__self__, *,
                 one_click_alarm_id: pulumi.Input[_builtins.str],
                 enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a OneClickAlarmReset resource.
...
@pulumi.input_type
class _OneClickAlarmResetState:
    def __init__(__self__, *,
                 enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
                 one_click_alarm_id: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering OneClickAlarmReset resources.
        :param pulumi.Input[_builtins.str] one_click_alarm_id: Specifies the one-click monitoring ID for a service.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used.
               Changing this creates a new resource.
...
@pulumi.type_token("huaweicloud:Cse/oneClickAlarmReset:OneClickAlarmReset")
class OneClickAlarmReset(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.cse.OneClickAlarmReset("test", one_click_alarm_id=one_click_alarm_id)
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param OneClickAlarmResetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OneClickAlarmResetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OneClickAlarmResetArgs.__new__(OneClickAlarmResetArgs)
        ...
        super(OneClickAlarmReset, __self__).__init__(
            'huaweicloud:Cse/oneClickAlarmReset:OneClickAlarmReset',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
            one_click_alarm_id: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'OneClickAlarmReset':
        """
        Get an existing OneClickAlarmReset resource's state with the given name, id, and optional extra
        ...
        __props__ = _OneClickAlarmResetState.__new__(_OneClickAlarmResetState)

        __props__.__dict__["enable_force_new"] = enable_force_new
        __props__.__dict__["one_click_alarm_id"] = one_click_alarm_id
        __props__.__dict__["region"] = region
        return OneClickAlarmReset(resource_name, opts=opts, __props__=__props__)
