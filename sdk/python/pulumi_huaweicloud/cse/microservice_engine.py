...
class MicroserviceEngineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] flavor: Specifies the flavor of the dedicated microservice engine.
               Changing this will create a new engine.
        :param pulumi.Input[_builtins.str] network_id: Specifies the network ID of the subnet to which the dedicated microservice
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] availability_zones: Specifies the list of availability zones.  
               ...
               Changing this will create a new engine.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the dedicated microservice engine.
               The description can contain a maximum of `255` characters.
               Changing this will create a new engine.
        :param pulumi.Input[_builtins.str] eip_id: Specifies the EIP ID to which the dedicated microservice engine assocated.
               Changing this will create a new engine.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project ID to which the dedicated
               microservice engine belongs.
               Changing this will create a new engine.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] extend_params: Specifies the additional parameters for the dedicated microservice engine.
               Changing this will create a new engine.
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the dedicated microservice engine.
               ...
               Changing this will create a new engine.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the dedicated microservice engine.
               If omitted, the provider-level region will be used. Changing this will create a new engine.
        :param pulumi.Input[_builtins.str] version: Specifies the version of the dedicated microservice engine.  
...
class _MicroserviceEngineState:
    def __init__(__self__, *,
                 ...
                 instance_limit: Optional[pulumi.Input[_builtins.int]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 network_id: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 service_limit: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] flavor: Specifies the flavor of the dedicated microservice engine.
               Changing this will create a new engine.
        :param pulumi.Input[_builtins.int] instance_limit: The maximum number of the microservice instance resources.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the dedicated microservice engine.
               The name can contain `3` to `24` characters, only letters, digits and hyphens (-) are allowed.
               The name must start with a letter and cannot end with a hyphen (-).
               Changing this will create a new engine.
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the dedicated microservice engine.
               If omitted, the provider-level region will be used. Changing this will create a new engine.
        :param pulumi.Input[_builtins.int] service_limit: The maximum number of the microservice resources.
    ...
    def instance_limit(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def instance_limit(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def service_limit(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def service_limit(self, value: Optional[pulumi.Input[_builtins.int]]):
...
@pulumi.type_token("huaweicloud:Cse/microserviceEngine:MicroserviceEngine")
class MicroserviceEngine(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            auth_type: Optional[pulumi.Input[_builtins.str]] = None,
            availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            config_center_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MicroserviceEngineConfigCenterAddressArgs', 'MicroserviceEngineConfigCenterAddressArgsDict']]]]] = None,
            description: Optional[pulumi.Input[_builtins.str]] = None,
            eip_id: Optional[pulumi.Input[_builtins.str]] = None,
            enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
            extend_params: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            service_limit: Optional[pulumi.Input[_builtins.int]] = None,
            service_registry_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MicroserviceEngineServiceRegistryAddressArgs', 'MicroserviceEngineServiceRegistryAddressArgsDict']]]]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None) -> 'MicroserviceEngine':
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] availability_zones: Specifies the list of availability zones.  
               Required if the `version` is **CSE2**.
               Changing this will create a new engine.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MicroserviceEngineConfigCenterAddressArgs', 'MicroserviceEngineConfigCenterAddressArgsDict']]]] config_center_addresses: The address of config center.
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the dedicated microservice engine.
               The description can contain a maximum of `255` characters.
               Changing this will create a new engine.
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the dedicated microservice engine.
               If omitted, the provider-level region will be used. Changing this will create a new engine.
        :param pulumi.Input[_builtins.int] service_limit: The maximum number of the microservice resources.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MicroserviceEngineServiceRegistryAddressArgs', 'MicroserviceEngineServiceRegistryAddressArgsDict']]]] service_registry_addresses: The connection address of service center.
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] version: Specifies the version of the dedicated microservice engine.  
               The valid values are as follows:
               + **CSE2**
    ...
    @_builtins.property
    @pulumi.getter(name="extendParams")
    def extend_params(self) -> pulumi.Output[Mapping[str, _builtins.str]]:
        """
        Specifies the additional parameters for the dedicated microservice engine.
        Changing this will create a new engine.
    ...
    @_builtins.property
    @pulumi.getter(name="instanceLimit")
    def instance_limit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum number of the microservice instance resources.
        """
        return pulumi.get(self, "instance_limit")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceLimit")
    def service_limit(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum number of the microservice resources.
        """
        return pulumi.get(self, "service_limit")
