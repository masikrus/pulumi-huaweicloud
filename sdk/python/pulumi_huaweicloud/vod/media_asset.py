...
class MediaAssetArgs:
    def __init__(__self__, *,
                 ...
                 auto_preload: Optional[pulumi.Input[_builtins.bool]] = None,
                 category_id: Optional[pulumi.Input[_builtins.int]] = None,
                 ...
                 review_template_id: Optional[pulumi.Input[_builtins.str]] = None,
                 storage_mode: Optional[pulumi.Input[_builtins.int]] = None,
                 template_group_name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the media asset description, which contains a maximum of `1,024`
               characters.
        :param pulumi.Input[_builtins.str] input_bucket: Specifies the OBS bucket name of media source file.
               Either this field or `url` must be specified. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] input_path: Specifies the media source file path in the OBS bucket.
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] labels: Specifies the labels of the media asset, which contains a maximum of 16 labels
               separated by commas.
        :param pulumi.Input[_builtins.str] name: Specifies the media asset name, which contains a maximum of `128` characters.
        :param pulumi.Input[_builtins.str] output_bucket: Specifies the output OBS bucket name.
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] output_path: Specifies the output file path in the OBS bucket.
               Changing this creates a new resource.
        ...
        :param pulumi.Input[_builtins.str] url: Specifies the URL of media source file. Currently only http and https protocols
               are supported. Either this field or `input_bucket` must be specified. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] workflow_name: Specifies the workflow name. If not empty, the uploaded media will be
    ...
    @auto_preload.setter
    def auto_preload(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "auto_preload", value)

    @_builtins.property
    @pulumi.getter(name="categoryId")
    def category_id(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @category_id.setter
    def category_id(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def review_template_id(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def template_group_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _MediaAssetState:
    def __init__(__self__, *,
                 ...
                 input_path: Optional[pulumi.Input[_builtins.str]] = None,
                 labels: Optional[pulumi.Input[_builtins.str]] = None,
                 media_name: Optional[pulumi.Input[_builtins.str]] = None,
                 media_type: Optional[pulumi.Input[_builtins.str]] = None,
                 media_url: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 output_bucket: Optional[pulumi.Input[_builtins.str]] = None,
                 output_path: Optional[pulumi.Input[_builtins.str]] = None,
                 publish: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] labels: Specifies the labels of the media asset, which contains a maximum of 16 labels
               separated by commas.
        :param pulumi.Input[_builtins.str] media_name: The name of the media file.
        :param pulumi.Input[_builtins.str] media_type: Specifies the media type. Valid values are: **MP4**, **TS**, **MOV**,
               **MXF**, **MPG**, **FLV**, **WMV**, **AVI**, **M4V**, **F4V**, **MPEG**, **3GP**, **ASF**, **MKV**, **HLS**,
               **M3U8**, **MP3**, **OGG**, **WAV**, **WMA**, **APE**, **FLAC**, **AAC**, **AC3**, **MMF**, **AMR**, **M4A**,
               **M4R**, **WV**, **MP2**. Changing this creates a new resource.
               ...
               > When `media_type` is set to **HLS**, `storage_mode` must be set to **1** (user bucket), and the `output_path`
               should be set to the same as the `input_path`.
        :param pulumi.Input[_builtins.str] media_url: The URL of original media file.
        :param pulumi.Input[_builtins.str] name: Specifies the media asset name, which contains a maximum of `128` characters.
        :param pulumi.Input[_builtins.str] output_bucket: Specifies the output OBS bucket name.
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] output_path: Specifies the output file path in the OBS bucket.
    ...
    def media_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @media_name.setter
    def media_name(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def media_url(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @media_url.setter
    def media_url(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("huaweicloud:Vod/mediaAsset:MediaAsset")
class MediaAsset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 storage_mode: Optional[pulumi.Input[_builtins.int]] = None,
                 template_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                 thumbnail: Optional[pulumi.Input[Union['MediaAssetThumbnailArgs', 'MediaAssetThumbnailArgsDict']]] = None,
                 url: Optional[pulumi.Input[_builtins.str]] = None,
                 workflow_name: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            thumbnail: Optional[pulumi.Input[Union['MediaAssetThumbnailArgs', 'MediaAssetThumbnailArgsDict']]] = None,
            url: Optional[pulumi.Input[_builtins.str]] = None,
            workflow_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'MediaAsset':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="inputBucket")
    def input_bucket(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the OBS bucket name of media source file.
        Either this field or `url` must be specified. Changing this creates a new resource.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def labels(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the labels of the media asset, which contains a maximum of 16 labels
        separated by commas.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="mediaName")
    def media_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the media file.
        """
        return pulumi.get(self, "media_name")
    ...
    @_builtins.property
    @pulumi.getter(name="mediaUrl")
    def media_url(self) -> pulumi.Output[_builtins.str]:
        """
        The URL of original media file.
        """
        return pulumi.get(self, "media_url")
    ...
    @_builtins.property
    @pulumi.getter(name="outputBucket")
    def output_bucket(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the output OBS bucket name.
        Changing this creates a new resource.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="storageMode")
    def storage_mode(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the storage mode. The value can be:
        + **0**: copy the media file to VOD bucket.
        + **1**: save the media file in user bucket.
