...
class ApiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] body_description: Specifies the description of the API request body, which can be an example
               request body, media type or parameters.
               The request body does not exceed `20,480` characters.
        :param pulumi.Input[_builtins.str] content_type: Specifies the content type of the request body.  
               The valid values are as follows:
               + **application/json**
               + **application/xml**
               + **multipart/form-data**
               + **text/plain**
        :param pulumi.Input[_builtins.bool] cors: Specifies whether CORS is supported, defaults to **false**.
        ...
        :param pulumi.Input[_builtins.str] failure_response: Specifies the example response for a failure request.  
        ...
        :param pulumi.Input[_builtins.str] matching: Specifies the route matching mode.  
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region where the API is located.  
        ...
        :param pulumi.Input[_builtins.bool] simple_authentication: Specifies whether the authentication of the application code is enabled.  
               The application code must located in the header when `simple_authentication` is true.
        :param pulumi.Input[_builtins.str] success_response: Specifies the example response for a successful request.  
               The response contains a maximum of `20,480` characters.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: Specifies the list of tags configuration.
...
class Api(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dedicatedapig.Api("test",
        ...
        :param pulumi.Input[_builtins.str] authorizer_id: Specifies the ID of the backend custom authorization.
               ...
               <a name="apig_api_conditions"></a>
               The `conditions` block supports:
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApiBackendParamArgs', 'ApiBackendParamArgsDict']]]] backend_params: Specifies an array of one or more backend parameters. The maximum of request
               parameters is 50. The object structure is documented above.
        :param pulumi.Input[_builtins.str] body_description: Specifies the description of the API request body, which can be an example
               request body, media type or parameters.
               The request body does not exceed `20,480` characters.
        ...
        :param pulumi.Input[_builtins.str] failure_response: Specifies the example response for a failure request.  
               The response contains a maximum of `20,480` characters.
        :param pulumi.Input[Union['ApiFuncGraphArgs', 'ApiFuncGraphArgsDict']] func_graph: Specifies the function graph backend details.  
               The object structure is documented below.
               Changing this will create a new API resource.
        ...
        :param pulumi.Input[_builtins.str] matching: Specifies the route matching mode.  
               The valid values are **Exact** and **Prefix**, defaults to **Exact**.
        :param pulumi.Input[Union['ApiMockArgs', 'ApiMockArgsDict']] mock: Specifies the mock backend details.  
               The object structure is documented below.
               Changing this will create a new API resource.
        ...
        :param pulumi.Input[_builtins.str] type: Specifies the condition type of the backend policy.  
               The valid values are **Equal**, **Enumerated** and **Matching**, defaults to **Equal**.
               When the `sys_name` is **req_method**, the valid values are **Equal** and **Enumerated**.
        :param pulumi.Input[Union['ApiWebArgs', 'ApiWebArgsDict']] web: Specifies the web backend details.  
               The object structure is documented below. Changing this will create a new API resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApiWebPolicyArgs', 'ApiWebPolicyArgsDict']]]] web_policies: Specifies the example response for a failed request.  
               The maximum blocks of the policy is 5.
               The object structure is documented below.
