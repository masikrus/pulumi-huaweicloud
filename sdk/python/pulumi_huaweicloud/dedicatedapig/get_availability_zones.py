...
class GetAvailabilityZonesResult:
    ...
    def availability_zones(self) -> Sequence['outputs.GetAvailabilityZonesAvailabilityZoneResult']:
        """
        The list of the availability zones.
        """
...
def get_availability_zones(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.DedicatedApig.get_availability_zones()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:DedicatedApig/getAvailabilityZones:getAvailabilityZones', __args__, opts=opts, typ=GetAvailabilityZonesResult).value
...
def get_availability_zones_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedApig/getAvailabilityZones:getAvailabilityZones', __args__, opts=opts, typ=GetAvailabilityZonesResult)
