...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] security_group_id: Specifies the ID of the security group to which the dedicated instance
               belongs to.
        :param pulumi.Input[_builtins.str] subnet_id: Specifies the ID of the VPC subnet used to create the dedicated instance.  
               Changing this will create a new resource.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the ID of the VPC used to create the dedicated instance.  
               Changing this will create a new resource.
        ...
        :param pulumi.Input[_builtins.int] bandwidth_size: Specifies the egress bandwidth size of the dedicated instance.  
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description of the dedicated instance.  
        ...
        :param pulumi.Input[_builtins.str] ingress_bandwidth_charging_mode: Specifies the ingress bandwidth billing type of the dedicated instance.
               The valid values are as follows:
               + **bandwidth**: Billed by bandwidth.
               + **traffic**: Billed by traffic.
        :param pulumi.Input[_builtins.int] ingress_bandwidth_size: Specifies the ingress bandwidth size of the dedicated instance.  
               The minimum value is `5`
        :param pulumi.Input[_builtins.bool] ipv6_enable: Specifies whether public access with an IPv6 address is supported.  
               Changing this will create a new resource.
        :param pulumi.Input[_builtins.str] loadbalancer_provider: The type of load balancer used by the dedicated instance.  
               The valid value is as follows:
               + **elb**: Elastic load balance.
        :param pulumi.Input[_builtins.str] maintain_begin: Specifies the start time of the maintenance time window.  
               The format is **xx:00:00**, the value of **xx** can be `02`, `06`, `10`, `14`, `18` or `22`.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the dedicated instance.  
               The name can contain `3` to `64` characters, only letters, digits, hyphens (-) and underscores (_) are allowed, and
               must start with a letter.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the dedicated instance resource.  
               If omitted, the provider-level region will be used.
               Changing this will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the dedicated instance.
        :param pulumi.Input[_builtins.str] vpcep_service_name: Specifies the name of the VPC endpoint service.
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subnet_id: Specifies the ID of the VPC subnet used to create the dedicated instance.  
               Changing this will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] supported_features: The supported features of the APIG dedicated instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the dedicated instance.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the ID of the VPC used to create the dedicated instance.  
               Changing this will create a new resource.
        :param pulumi.Input[_builtins.str] vpc_ingress_address: The ingress private IP address of the VPC.
        :param pulumi.Input[_builtins.str] vpcep_service_address: The address (full name) of the VPC endpoint service, in the
...
@pulumi.type_token("huaweicloud:DedicatedApig/instance:Instance")
