...
class ResponseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: Specifies the ID of the dedicated instance to which the API group and the
               API custom response belong.
               Changing this will create a new resource.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the API custom response.  
               The valid length is limited from `1` to `64`, letters, digits, hyphens (-) and underscores (_) are allowed.
        :param pulumi.Input[_builtins.str] region: Specifies the region where the API custom response is located.  
...
@pulumi.type_token("huaweicloud:DedicatedApig/response:Response")
class Response(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        response_headers = config.require_object("responseHeaders")
        test = huaweicloud.dedicatedapig.Response("test",
            rules=[{
                "headers": [{
                    "key": entry["value"]["key"],
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region where the API custom response is located.  
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ResponseRuleArgs', 'ResponseRuleArgsDict']]]] rules: Specifies the API custom response rules definition.  
               The rule structure is documented below.
