...
class ApiPublishmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to publish APIs.  
...
@pulumi.type_token("huaweicloud:DedicatedApig/apiPublishment:ApiPublishment")
class ApiPublishment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        default = huaweicloud.dedicatedapig.ApiPublishment("default",
