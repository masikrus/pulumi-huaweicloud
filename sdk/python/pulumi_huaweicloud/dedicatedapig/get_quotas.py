...
def get_quotas(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.DedicatedApig.get_quotas()
    ```


    :param _builtins.str region: Specifies the region in which to query the quotas.  
           If omitted, the provider-level region will be used.
    """
    __args__ = dict()
    __args__['region'] = region
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('huaweicloud:DedicatedApig/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult).value
...
def get_quotas_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedApig/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult)
