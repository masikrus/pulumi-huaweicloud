...
__all__ = ['ApiActionArgs', 'ApiAction']
...
class ApiActionArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a ApiAction resource.

        :param pulumi.Input[_builtins.str] action: Specifies the operation on the API will be performed.  
        ...
        :param pulumi.Input[_builtins.str] env_id: Specifies the ID of the environment to which the API will be published.
        ...
        :param pulumi.Input[_builtins.str] remark: Specifies the description of the publish action.  
    ...
    def action(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the operation on the API will be performed.  
        The valid values are as follows:
        + **online**: Publish (Release) the API to the specified environment.
        + **offline**: Cancel the publish (release) of the API in the specified environment.
        """
    ...
    def env_id(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the ID of the environment to which the API will be published.
        """
    ...
    def remark(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the description of the publish action.  
        The description contain a maximum of `255` characters.
        Chinese characters must be in **UTF-8** or **Unicode** format.
        """
...
class _ApiActionState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering ApiAction resources.
...
@pulumi.type_token("huaweicloud:DedicatedApig/apiAction:ApiAction")
class ApiAction(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.dedicatedapig.ApiAction("test",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ApiActionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApiActionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApiActionArgs.__new__(ApiActionArgs)
        ...
        super(ApiAction, __self__).__init__(
            'huaweicloud:DedicatedApig/apiAction:ApiAction',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            remark: Optional[pulumi.Input[_builtins.str]] = None,
            version_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ApiAction':
        """
        Get an existing ApiAction resource's state with the given name, id, and optional extra
        ...
        __props__ = _ApiActionState.__new__(_ApiActionState)
        ...
        return ApiAction(resource_name, opts=opts, __props__=__props__)
