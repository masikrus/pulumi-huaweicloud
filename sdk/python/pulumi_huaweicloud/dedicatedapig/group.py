...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] domain_access_enabled: Specifies whether to use the debugging domain name to access the APIs
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GroupEnvironmentArgs']]] environments: Specifies an array of one or more environments of the associated group.  
               ...
               > The `environment` paramater is conflict with `DedicatedApig.EnvironmentVariable` resource.
        :param pulumi.Input[_builtins.bool] force_destroy: Specifies whether to delete all sub-resources (for API) when deleting this group.  
               Defaults to **false**.
...
@pulumi.type_token("huaweicloud:DedicatedApig/group:Group")
class Group(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dedicatedapig.Group("test",
        ...
        :param pulumi.Input[_builtins.bool] domain_access_enabled: Specifies whether to use the debugging domain name to access the APIs
               within the group. The default value is `false`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['GroupEnvironmentArgs', 'GroupEnvironmentArgsDict']]]] environments: Specifies an array of one or more environments of the associated group.  
               The object structure is documented below.
