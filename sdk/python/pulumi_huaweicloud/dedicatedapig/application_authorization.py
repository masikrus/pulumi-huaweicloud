...
__all__ = ['ApplicationAuthorizationArgs', 'ApplicationAuthorization']
...
@pulumi.input_type
class _ApplicationAuthorizationState:
    def __init__(__self__, *,
...
@pulumi.type_token("huaweicloud:DedicatedApig/applicationAuthorization:ApplicationAuthorization")
class ApplicationAuthorization(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = []
        for range in [{"value": i} for i in range(0, len(published_api_ids))]:
            test.append(huaweicloud.dedicatedapig.ApiPublishment(f"test-{range['value']}",
                instance_id=instance_id,
                api_id=published_api_ids[range["value"]],
                env_id=published_env_id))
        test_application_authorization = huaweicloud.dedicatedapig.ApplicationAuthorization("test",
            instance_id=instance_id,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApplicationAuthorizationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApplicationAuthorizationArgs.__new__(ApplicationAuthorizationArgs)
        ...
        super(ApplicationAuthorization, __self__).__init__(
            'huaweicloud:DedicatedApig/applicationAuthorization:ApplicationAuthorization',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            env_id: Optional[pulumi.Input[_builtins.str]] = None,
            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'ApplicationAuthorization':
        """
        Get an existing ApplicationAuthorization resource's state with the given name, id, and optional extra
        ...
        __props__ = _ApplicationAuthorizationState.__new__(_ApplicationAuthorizationState)
        ...
        __props__.__dict__["instance_id"] = instance_id
        __props__.__dict__["region"] = region
        return ApplicationAuthorization(resource_name, opts=opts, __props__=__props__)
