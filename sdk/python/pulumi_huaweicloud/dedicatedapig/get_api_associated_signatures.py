...
__all__ = [
    'GetApiAssociatedSignaturesResult',
    'AwaitableGetApiAssociatedSignaturesResult',
    'get_api_associated_signatures',
    'get_api_associated_signatures_output',
]

@pulumi.output_type
class GetApiAssociatedSignaturesResult:
    """
    A collection of values returned by getApiAssociatedSignatures.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def signatures(self) -> Sequence['outputs.GetApiAssociatedSignaturesSignatureResult']:
        """
        All signatures that match the filter parameters.
...
class AwaitableGetApiAssociatedSignaturesResult(GetApiAssociatedSignaturesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApiAssociatedSignaturesResult(
            api_id=self.api_id,
            env_id=self.env_id,
...
def get_api_associated_signatures(api_id: Optional[_builtins.str] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApiAssociatedSignaturesResult:
    """
    ...
    test = huaweicloud.DedicatedApig.get_api_associated_signatures(instance_id=instance_id,
        api_id=associated_api_id)
    ```


    :param _builtins.str api_id: Specifies the ID of the API bound to the signature.
    ...
    :param _builtins.str instance_id: Specifies the ID of the dedicated instance to which the signatures belong.
    ...
    :param _builtins.str signature_id: Specifies the ID of the signature.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:DedicatedApig/getApiAssociatedSignatures:getApiAssociatedSignatures', __args__, opts=opts, typ=GetApiAssociatedSignaturesResult).value

    return AwaitableGetApiAssociatedSignaturesResult(
...
def get_api_associated_signatures_output(api_id: Optional[pulumi.Input[_builtins.str]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApiAssociatedSignaturesResult]:
    """
    Use this data source to query the signatures associated with the specified API within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedApig/getApiAssociatedSignatures:getApiAssociatedSignatures', __args__, opts=opts, typ=GetApiAssociatedSignaturesResult)
    return __ret__.apply(lambda __response__: GetApiAssociatedSignaturesResult(
