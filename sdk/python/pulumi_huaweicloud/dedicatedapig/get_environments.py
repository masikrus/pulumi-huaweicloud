...
def get_environments(instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance_id: Specifies an ID of the APIG dedicated instance to which the API
           environment belongs.
    ...
    :param _builtins.str region: Specifies the region in which to query the APIG environment list.
...
def get_environments_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedApig/getEnvironments:getEnvironments', __args__, opts=opts, typ=GetEnvironmentsResult)
