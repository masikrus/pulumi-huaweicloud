...
class GetApiResult:
    ...
    def backend_params(self) -> Sequence['outputs.GetApiBackendParamResult']:
        """
    ...
    def body_description(self) -> _builtins.str:
        """
        The description of the API request body.
        """
    ...
    def func_graph_policies(self) -> Sequence['outputs.GetApiFuncGraphPolicyResult']:
        """
        The policy backends of the FunctionGraph.
        The func_graph_policy structure is documented below.
        """
        return pulumi.get(self, "func_graph_policies")

    @_builtins.property
    @pulumi.getter(name="funcGraphs")
    def func_graphs(self) -> Sequence['outputs.GetApiFuncGraphResult']:
        """
        The FunctionGraph backend details.
        The func_graph structure is documented below.
        """
    ...
    def group_id(self) -> _builtins.str:
        """
        The group ID corresponding to the API.
        """
    ...
    def group_name(self) -> _builtins.str:
        """
        The group name corresponding to the API.
        """
    ...
    def mock_policies(self) -> Sequence['outputs.GetApiMockPolicyResult']:
        """
        The policy backends of the mock.
        The mock_policy structure is documented below.
        """
        return pulumi.get(self, "mock_policies")

    @_builtins.property
    @pulumi.getter
    def mocks(self) -> Sequence['outputs.GetApiMockResult']:
        """
        The mock backend details.
        The mock structure is documented below.
        """
    ...
    def request_params(self) -> Sequence['outputs.GetApiRequestParamResult']:
        """
        The configuration list of the front-end parameters.
    ...
    def response_id(self) -> _builtins.str:
        """
        The response ID of the corresponding APIG group.
        """
    ...
    def web_policies(self) -> Sequence['outputs.GetApiWebPolicyResult']:
        """
        The policy backends of the web.
        The web_policy structure is documented below.
        """
        return pulumi.get(self, "web_policies")

    @_builtins.property
    @pulumi.getter
    def webs(self) -> Sequence['outputs.GetApiWebResult']:
        """
        The web backend details.
        The web structure is documented below.
        """
...
def get_api(api_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.DedicatedApig.get_api(instance_id=instance_id,
        api_id=api_id)
    ```


    :param _builtins.str api_id: Specifies the ID of the API.
    :param _builtins.str instance_id: Specifies the ID of the dedicated instance to which the API belong.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:DedicatedApig/getApi:getApi', __args__, opts=opts, typ=GetApiResult).value
...
def get_api_output(api_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedApig/getApi:getApi', __args__, opts=opts, typ=GetApiResult)
