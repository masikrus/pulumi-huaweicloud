...
class ThrottlingPolicyAssociateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy_id: Specifies the ID of the throttling policy.  
               Changing this will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] publish_ids: Specifies the publish IDs corresponding to the APIs bound by the throttling policy.
        :param pulumi.Input[_builtins.str] region: Specifies the region where the dedicated instance and the throttling policy
               are located.
...
@pulumi.type_token("huaweicloud:DedicatedApig/throttlingPolicyAssociate:ThrottlingPolicyAssociate")
class ThrottlingPolicyAssociate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dedicatedapig.ThrottlingPolicyAssociate("test",
    ...
    def get(resource_name: str,
            ...
            policy_id: Optional[pulumi.Input[_builtins.str]] = None,
            publish_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'ThrottlingPolicyAssociate':
        """
