...
class EnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region where the dedicated instance is located.  
...
@pulumi.type_token("huaweicloud:DedicatedApig/environment:Environment")
class Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dedicatedapig.Environment("test",
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'Environment':
        """
