...
class GetAclPoliciesResult:
    ...
    """
    def __init__(__self__, entity_type=None, id=None, instance_id=None, name=None, policies=None, policy_id=None, region=None, type=None):
...
def get_acl_policies(entity_type: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.DedicatedApig.get_acl_policies(instance_id=instance_id,
        name=policy_name)
    ```
    ...
    :param _builtins.str policy_id: Specifies the ID of the ACL policy to be queried.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:DedicatedApig/getAclPolicies:getAclPolicies', __args__, opts=opts, typ=GetAclPoliciesResult).value
...
def get_acl_policies_output(entity_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedApig/getAclPolicies:getAclPolicies', __args__, opts=opts, typ=GetAclPoliciesResult)
