...
class GetChannelsResult:
    ...
    def vpc_channels(self) -> Sequence['outputs.GetChannelsVpcChannelResult']:
        """
        All VPC channels that match the filter parameters.
        The vpc_channels structure is documented below.
        """
...
def get_channels(channel_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.DedicatedApig.get_channels(instance_id=instance_id,
        name=channel_name)
    ```


    :param _builtins.str channel_id: Specifies the VPC channel ID of the to be queried.
    :param _builtins.str instance_id: Specifies the ID of the dedicated instance to which the channels belong.
    :param _builtins.str member_group_id: Specifies the ID of the member group to be queried.
    :param _builtins.str member_group_name: Specifies the name of the member group to be queried.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:DedicatedApig/getChannels:getChannels', __args__, opts=opts, typ=GetChannelsResult).value
...
def get_channels_output(channel_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedApig/getChannels:getChannels', __args__, opts=opts, typ=GetChannelsResult)
