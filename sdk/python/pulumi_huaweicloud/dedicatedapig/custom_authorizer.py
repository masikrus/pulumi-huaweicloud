...
class CustomAuthorizerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] function_alias_uri: Specifies the version alias URI of the FGS function.
        :param pulumi.Input[_builtins.str] function_version: Specifies the version of the FGS function.
        ...
        :param pulumi.Input[_builtins.bool] is_body_send: Specifies whether to send the body.
        ...
        :param pulumi.Input[_builtins.str] network_type: Specifies the framework type of the function.
               + **V1**: Non-VPC network architecture.
               + **V2**: VPC network architecture.
               
               Defaults to **V1**.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the custom authorizer resource.
               If omitted, the provider-level region will be used.
               Changing this will create a new custom authorizer resource.
        :param pulumi.Input[_builtins.str] type: Specifies the custom authorize type.
               The valid values are **FRONTEND** and **BACKEND**. Defaults to **FRONTEND**.
               Changing this will create a new custom authorizer resource.
        :param pulumi.Input[_builtins.str] user_data: Specifies the user data, which can contain a maximum of `2,048` characters.
...
@pulumi.type_token("huaweicloud:DedicatedApig/customAuthorizer:CustomAuthorizer")
class CustomAuthorizer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dedicatedapig.CustomAuthorizer("test",
        ...
        :param pulumi.Input[_builtins.str] function_urn: Specifies the uniform function URN of the function graph resource.
        :param pulumi.Input[_builtins.str] function_version: Specifies the version of the FGS function.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CustomAuthorizerIdentityArgs', 'CustomAuthorizerIdentityArgsDict']]]] identities: Specifies an array of one or more parameter identities of the custom authorizer.
               The object structure is documented below.
