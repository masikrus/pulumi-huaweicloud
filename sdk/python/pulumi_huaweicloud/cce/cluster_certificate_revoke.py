...
@pulumi.type_token("huaweicloud:Cce/clusterCertificateRevoke:ClusterCertificateRevoke")
class ClusterCertificateRevoke(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ClusterCertificateRevoke':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="agencyId")
    def agency_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the agency ID.
        """
        return pulumi.get(self, "agency_id")
