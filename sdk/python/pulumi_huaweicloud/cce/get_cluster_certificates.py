...
def get_cluster_certificates_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cce/getClusterCertificates:getClusterCertificates', __args__, opts=opts, typ=GetClusterCertificatesResult)
