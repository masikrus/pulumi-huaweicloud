...
__all__ = [
    'GetNodeV3Result',
    'AwaitableGetNodeV3Result',
    'get_node_v3',
    'get_node_v3_output',
]

@pulumi.output_type
class GetNodeV3Result:
    """
    A collection of values returned by getNodeV3.
    """
    ...
    def data_volumes(self) -> Sequence['outputs.GetNodeV3DataVolumeResult']:
    ...
    def hostname_configs(self) -> Sequence['outputs.GetNodeV3HostnameConfigResult']:
    ...
    def root_volumes(self) -> Sequence['outputs.GetNodeV3RootVolumeResult']:
...
class AwaitableGetNodeV3Result(GetNodeV3Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNodeV3Result(
...
def get_node_v3(cluster_id: Optional[_builtins.str] = None,
                name: Optional[_builtins.str] = None,
                node_id: Optional[_builtins.str] = None,
                region: Optional[_builtins.str] = None,
                status: Optional[_builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNodeV3Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cce/getNodeV3:getNodeV3', __args__, opts=opts, typ=GetNodeV3Result).value

    return AwaitableGetNodeV3Result(
...
def get_node_v3_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                       name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       node_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNodeV3Result]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cce/getNodeV3:getNodeV3', __args__, opts=opts, typ=GetNodeV3Result)
    return __ret__.apply(lambda __response__: GetNodeV3Result(
