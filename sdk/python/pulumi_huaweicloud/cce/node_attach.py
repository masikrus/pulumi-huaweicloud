...
class NodeAttachArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Specifies the tags of a Kubernetes node, key/value pair format.
               Changing this parameter will reset the node.
        :param pulumi.Input[_builtins.str] lvm_config: Specifies the docker data disk configurations.
        ...
        :param pulumi.Input['NodeAttachStorageArgs'] storage: Specifies the disk initialization management parameter.
               ...
               Changing this parameter will reset the node.
        :param pulumi.Input[_builtins.str] system_disk_kms_key_id: Specifies the KMS key ID. This is used to encrypt the root volume.
               Changing this parameter will reset the node.
...
class _NodeAttachState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project ID of the CCE node.
...
@pulumi.type_token("huaweicloud:Cce/nodeAttach:NodeAttach")
class NodeAttach(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.int] docker_base_size: Specifies the available disk space of a single docker container on the
               node in device mapper mode. Changing this parameter will reset the node.
        :param pulumi.Input[Union['NodeAttachHostnameConfigArgs', 'NodeAttachHostnameConfigArgsDict']] hostname_config: Specifies the hostname config of the kubernetes node,
               which is supported by clusters of v1.23.6-r0 to v1.25 or clusters of v1.25.2-r0 or later versions.
               The object structure is documented below.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] image_id: schema: Internal
        ...
        :param pulumi.Input[_builtins.str] server_id: Specifies the ecs server ID. Changing this parameter will create a new
               resource.
        :param pulumi.Input[Union['NodeAttachStorageArgs', 'NodeAttachStorageArgsDict']] storage: Specifies the disk initialization management parameter.
               This parameter is alternative to `lvm_config` and supported for clusters of v1.15.11 and later.
               Changing this parameter will reset the node.
        :param pulumi.Input[_builtins.str] system_disk_kms_key_id: Specifies the KMS key ID. This is used to encrypt the root volume.
               Changing this parameter will reset the node.
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[_builtins.str] cluster_id: Specifies the ID of the cluster. Changing this parameter will create a new
               resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NodeAttachDataVolumeArgs', 'NodeAttachDataVolumeArgsDict']]]] data_volumes: The configurations of the data disk.
        :param pulumi.Input[_builtins.int] docker_base_size: Specifies the available disk space of a single docker container on the
               node in device mapper mode. Changing this parameter will reset the node.
        :param pulumi.Input[_builtins.str] ecs_group_id: The Ecs group ID.
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project ID of the CCE node.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NodeAttachExtensionNicArgs', 'NodeAttachExtensionNicArgsDict']]]] extension_nics: The extension NICs of the node.
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] flavor_id: The flavor ID of the CCE node.
        :param pulumi.Input[Union['NodeAttachHostnameConfigArgs', 'NodeAttachHostnameConfigArgsDict']] hostname_config: Specifies the hostname config of the kubernetes node,
               which is supported by clusters of v1.23.6-r0 to v1.25 or clusters of v1.25.2-r0 or later versions.
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the CCE node attach resource. If omitted, the
               provider-level region will be used. Changing this creates a new CCE node attach resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NodeAttachRootVolumeArgs', 'NodeAttachRootVolumeArgsDict']]]] root_volumes: The configuration of the system disk.
        :param pulumi.Input[_builtins.str] runtime: Specifies the runtime of the CCE node. Valid values are *docker* and
               *containerd*. Changing this parameter will reset the node.
        :param pulumi.Input[_builtins.str] server_id: Specifies the ecs server ID. Changing this parameter will create a new
               resource.
