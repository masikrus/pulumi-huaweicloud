...
__all__ = ['AutopilotClusterUpgradeArgs', 'AutopilotClusterUpgrade']

@pulumi.input_type
class AutopilotClusterUpgradeArgs:
    def __init__(__self__, *,
                 cluster_id: pulumi.Input[_builtins.str],
                 strategy: pulumi.Input['AutopilotClusterUpgradeStrategyArgs'],
                 target_version: pulumi.Input[_builtins.str],
                 addons: Optional[pulumi.Input[Sequence[pulumi.Input['AutopilotClusterUpgradeAddonArgs']]]] = None,
        ...
        """
        The set of arguments for constructing a AutopilotClusterUpgrade resource.

        :param pulumi.Input[_builtins.str] cluster_id: Specifies the cluster ID.
        :param pulumi.Input['AutopilotClusterUpgradeStrategyArgs'] strategy: Specifies the upgrade strategy.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AutopilotClusterUpgradeAddonArgs']]] addons: Specifies the add-on configuration list
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the CCE Autopilot cluster upgrade resource.
    ...
    @_builtins.property
    @pulumi.getter
    def strategy(self) -> pulumi.Input['AutopilotClusterUpgradeStrategyArgs']:
        """
    ...
    @strategy.setter
    def strategy(self, value: pulumi.Input['AutopilotClusterUpgradeStrategyArgs']):
    ...
    @_builtins.property
    @pulumi.getter
    def addons(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AutopilotClusterUpgradeAddonArgs']]]]:
        """
    ...
    @addons.setter
    def addons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AutopilotClusterUpgradeAddonArgs']]]]):
    ...
    def region(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The region in which to create the CCE Autopilot cluster upgrade resource.
        If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        """
...
@pulumi.input_type
class _AutopilotClusterUpgradeState:
    def __init__(__self__, *,
                 addons: Optional[pulumi.Input[Sequence[pulumi.Input['AutopilotClusterUpgradeAddonArgs']]]] = None,
                 ...
                 nodepool_order: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 strategy: Optional[pulumi.Input['AutopilotClusterUpgradeStrategyArgs']] = None,
                 target_version: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering AutopilotClusterUpgrade resources.
    ...
    @_builtins.property
    @pulumi.getter
    def strategy(self) -> Optional[pulumi.Input['AutopilotClusterUpgradeStrategyArgs']]:
        """
        Specifies the upgrade strategy.
        The strategy structure is documented below.
        """
    ...
    @strategy.setter
    def strategy(self, value: Optional[pulumi.Input['AutopilotClusterUpgradeStrategyArgs']]):
        pulumi.set(self, "strategy", value)
...
@pulumi.type_token("huaweicloud:Cce/autopilotClusterUpgrade:AutopilotClusterUpgrade")
class AutopilotClusterUpgrade(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 addons: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutopilotClusterUpgradeAddonArgs', 'AutopilotClusterUpgradeAddonArgsDict']]]]] = None,
                 cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                 current_version: Optional[pulumi.Input[_builtins.str]] = None,
                 enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
                 is_postcheck: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 nodepool_order: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 strategy: Optional[pulumi.Input[Union['AutopilotClusterUpgradeStrategyArgs', 'AutopilotClusterUpgradeStrategyArgsDict']]] = None,
                 target_version: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        test = huaweicloud.cce.AutopilotClusterUpgrade("test",
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutopilotClusterUpgradeAddonArgs', 'AutopilotClusterUpgradeAddonArgsDict']]]] addons: Specifies the add-on configuration list
               The addons structure is documented below.
        :param pulumi.Input[_builtins.str] cluster_id: Specifies the cluster ID.
        :param pulumi.Input[_builtins.str] current_version: Specifies the current version, e.g. **v1.28.15-r30**.
        :param pulumi.Input[_builtins.bool] is_postcheck: Specifies whether to run postcheck.
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the CCE Autopilot cluster upgrade resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[Union['AutopilotClusterUpgradeStrategyArgs', 'AutopilotClusterUpgradeStrategyArgsDict']] strategy: Specifies the upgrade strategy.
               The strategy structure is documented below.
        :param pulumi.Input[_builtins.str] target_version: Specifies the target version, e.g. **v1.29.13-r10**.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AutopilotClusterUpgradeArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Use this resource to upgrade a CCE Autopilot cluster within HuaweiCloud.
        ...
        :param str resource_name: The name of the resource.
        :param AutopilotClusterUpgradeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AutopilotClusterUpgradeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AutopilotClusterUpgradeArgs.__new__(AutopilotClusterUpgradeArgs)
        ...
        super(AutopilotClusterUpgrade, __self__).__init__(
            'huaweicloud:Cce/autopilotClusterUpgrade:AutopilotClusterUpgrade',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            strategy: Optional[pulumi.Input[Union['AutopilotClusterUpgradeStrategyArgs', 'AutopilotClusterUpgradeStrategyArgsDict']]] = None,
            target_version: Optional[pulumi.Input[_builtins.str]] = None) -> 'AutopilotClusterUpgrade':
        """
        Get an existing AutopilotClusterUpgrade resource's state with the given name, id, and optional extra
        ...
        __props__ = _AutopilotClusterUpgradeState.__new__(_AutopilotClusterUpgradeState)
        ...
        __props__.__dict__["strategy"] = strategy
        __props__.__dict__["target_version"] = target_version
        return AutopilotClusterUpgrade(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def addons(self) -> pulumi.Output[Optional[Sequence['outputs.AutopilotClusterUpgradeAddon']]]:
        """
        Specifies the add-on configuration list
        The addons structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def strategy(self) -> pulumi.Output['outputs.AutopilotClusterUpgradeStrategy']:
        """
        Specifies the upgrade strategy.
        The strategy structure is documented below.
        """
