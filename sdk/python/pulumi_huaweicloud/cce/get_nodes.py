...
def get_nodes(cluster_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ignore_details: Specifies which detail information of the nodes to ignore.
...
def get_nodes_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cce/getNodes:getNodes', __args__, opts=opts, typ=GetNodesResult)
