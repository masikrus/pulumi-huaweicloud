...
__all__ = ['ClusterV3Args', 'ClusterV3']
...
class ClusterV3Args:
    def __init__(__self__, *,
                 ...
                 component_configurations: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3ComponentConfigurationArgs']]]] = None,
                 ...
                 encryption_config: Optional[pulumi.Input['ClusterV3EncryptionConfigArgs']] = None,
                 ...
                 extend_params: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3ExtendParamArgs']]]] = None,
                 ...
                 masters: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3MasterArgs']]]] = None,
    ...
    def component_configurations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3ComponentConfigurationArgs']]]]:
        return pulumi.get(self, "component_configurations")

    @component_configurations.setter
    def component_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3ComponentConfigurationArgs']]]]):
    ...
    def encryption_config(self) -> Optional[pulumi.Input['ClusterV3EncryptionConfigArgs']]:
        return pulumi.get(self, "encryption_config")

    @encryption_config.setter
    def encryption_config(self, value: Optional[pulumi.Input['ClusterV3EncryptionConfigArgs']]):
    ...
    def extend_params(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3ExtendParamArgs']]]]:
        return pulumi.get(self, "extend_params")

    @extend_params.setter
    def extend_params(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3ExtendParamArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def masters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3MasterArgs']]]]:
        return pulumi.get(self, "masters")

    @masters.setter
    def masters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3MasterArgs']]]]):
...
class _ClusterV3State:
    def __init__(__self__, *,
                 ...
                 certificate_clusters: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3CertificateClusterArgs']]]] = None,
                 certificate_users: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3CertificateUserArgs']]]] = None,
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 cluster_type: Optional[pulumi.Input[_builtins.str]] = None,
                 cluster_version: Optional[pulumi.Input[_builtins.str]] = None,
                 component_configurations: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3ComponentConfigurationArgs']]]] = None,
    ...
    def certificate_clusters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3CertificateClusterArgs']]]]:
        return pulumi.get(self, "certificate_clusters")

    @certificate_clusters.setter
    def certificate_clusters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3CertificateClusterArgs']]]]):
        pulumi.set(self, "certificate_clusters", value)

    @_builtins.property
    @pulumi.getter(name="certificateUsers")
    def certificate_users(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3CertificateUserArgs']]]]:
        return pulumi.get(self, "certificate_users")

    @certificate_users.setter
    def certificate_users(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV3CertificateUserArgs']]]]):
...
@pulumi.type_token("huaweicloud:Cce/clusterV3:ClusterV3")
class ClusterV3(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 cluster_type: Optional[pulumi.Input[_builtins.str]] = None,
                 cluster_version: Optional[pulumi.Input[_builtins.str]] = None,
                 component_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterV3ComponentConfigurationArgs', 'ClusterV3ComponentConfigurationArgsDict']]]]] = None,
                 container_network_cidr: Optional[pulumi.Input[_builtins.str]] = None,
                 container_network_type: Optional[pulumi.Input[_builtins.str]] = None,
                 custom_sans: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 delete_all: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 eip: Optional[pulumi.Input[_builtins.str]] = None,
                 enable_distribute_management: Optional[pulumi.Input[_builtins.bool]] = None,
                 encryption_config: Optional[pulumi.Input[Union['ClusterV3EncryptionConfigArgs', 'ClusterV3EncryptionConfigArgsDict']]] = None,
                 eni_subnet_cidr: Optional[pulumi.Input[_builtins.str]] = None,
                 eni_subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 extend_param: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 extend_params: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterV3ExtendParamArgs', 'ClusterV3ExtendParamArgsDict']]]]] = None,
                 flavor_id: Optional[pulumi.Input[_builtins.str]] = None,
                 hibernate: Optional[pulumi.Input[_builtins.bool]] = None,
                 highway_subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
                 ipv6_enable: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 lts_reclaim_policy: Optional[pulumi.Input[_builtins.str]] = None,
                 masters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterV3MasterArgs', 'ClusterV3MasterArgsDict']]]]] = None,
                 multi_az: Optional[pulumi.Input[_builtins.bool]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 period: Optional[pulumi.Input[_builtins.int]] = None,
                 period_unit: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ClusterV3Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ClusterV3Args.__new__(ClusterV3Args)
        ...
        super(ClusterV3, __self__).__init__(
            'huaweicloud:Cce/clusterV3:ClusterV3',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            billing_mode: Optional[pulumi.Input[_builtins.int]] = None,
            category: Optional[pulumi.Input[_builtins.str]] = None,
            certificate_clusters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterV3CertificateClusterArgs', 'ClusterV3CertificateClusterArgsDict']]]]] = None,
            certificate_users: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterV3CertificateUserArgs', 'ClusterV3CertificateUserArgsDict']]]]] = None,
            charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
            cluster_type: Optional[pulumi.Input[_builtins.str]] = None,
            cluster_version: Optional[pulumi.Input[_builtins.str]] = None,
            component_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterV3ComponentConfigurationArgs', 'ClusterV3ComponentConfigurationArgsDict']]]]] = None,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            timezone: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ClusterV3':
        """
        Get an existing ClusterV3 resource's state with the given name, id, and optional extra
        ...
        __props__ = _ClusterV3State.__new__(_ClusterV3State)
        ...
        __props__.__dict__["timezone"] = timezone
        __props__.__dict__["vpc_id"] = vpc_id
        return ClusterV3(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="certificateClusters")
    def certificate_clusters(self) -> pulumi.Output[Sequence['outputs.ClusterV3CertificateCluster']]:
        return pulumi.get(self, "certificate_clusters")

    @_builtins.property
    @pulumi.getter(name="certificateUsers")
    def certificate_users(self) -> pulumi.Output[Sequence['outputs.ClusterV3CertificateUser']]:
        return pulumi.get(self, "certificate_users")
    ...
    @_builtins.property
    @pulumi.getter(name="componentConfigurations")
    def component_configurations(self) -> pulumi.Output[Optional[Sequence['outputs.ClusterV3ComponentConfiguration']]]:
        return pulumi.get(self, "component_configurations")
    ...
    @_builtins.property
    @pulumi.getter(name="encryptionConfig")
    def encryption_config(self) -> pulumi.Output['outputs.ClusterV3EncryptionConfig']:
        return pulumi.get(self, "encryption_config")
    ...
    @_builtins.property
    @pulumi.getter(name="extendParams")
    def extend_params(self) -> pulumi.Output[Optional[Sequence['outputs.ClusterV3ExtendParam']]]:
        return pulumi.get(self, "extend_params")
    ...
    @_builtins.property
    @pulumi.getter
    def masters(self) -> pulumi.Output[Sequence['outputs.ClusterV3Master']]:
        return pulumi.get(self, "masters")
