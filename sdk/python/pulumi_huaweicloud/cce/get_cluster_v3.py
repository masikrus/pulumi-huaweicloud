...
__all__ = [
    'GetClusterV3Result',
    'AwaitableGetClusterV3Result',
    'get_cluster_v3',
    'get_cluster_v3_output',
]

@pulumi.output_type
class GetClusterV3Result:
    """
    A collection of values returned by getClusterV3.
    """
    ...
    def certificate_clusters(self) -> Sequence['outputs.GetClusterV3CertificateClusterResult']:
        return pulumi.get(self, "certificate_clusters")

    @_builtins.property
    @pulumi.getter(name="certificateUsers")
    def certificate_users(self) -> Sequence['outputs.GetClusterV3CertificateUserResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> Sequence['outputs.GetClusterV3EndpointResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def masters(self) -> Sequence['outputs.GetClusterV3MasterResult']:
...
class AwaitableGetClusterV3Result(GetClusterV3Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetClusterV3Result(
...
def get_cluster_v3(cluster_type: Optional[_builtins.str] = None,
                   id: Optional[_builtins.str] = None,
                   name: Optional[_builtins.str] = None,
                   region: Optional[_builtins.str] = None,
                   status: Optional[_builtins.str] = None,
                   vpc_id: Optional[_builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClusterV3Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cce/getClusterV3:getClusterV3', __args__, opts=opts, typ=GetClusterV3Result).value

    return AwaitableGetClusterV3Result(
...
def get_cluster_v3_output(cluster_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          vpc_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetClusterV3Result]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cce/getClusterV3:getClusterV3', __args__, opts=opts, typ=GetClusterV3Result)
    return __ret__.apply(lambda __response__: GetClusterV3Result(
