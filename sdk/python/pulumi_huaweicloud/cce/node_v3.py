...
class NodeV3Args:
    def __init__(__self__, *,
                 ...
                 root_volume: pulumi.Input['NodeV3RootVolumeArgs'],
                 ...
                 data_volumes: Optional[pulumi.Input[Sequence[pulumi.Input['NodeV3DataVolumeArgs']]]] = None,
                 ...
                 extend_params: Optional[pulumi.Input['NodeV3ExtendParamsArgs']] = None,
                 extension_nics: Optional[pulumi.Input[Sequence[pulumi.Input['NodeV3ExtensionNicArgs']]]] = None,
                 fixed_ip: Optional[pulumi.Input[_builtins.str]] = None,
                 hostname_config: Optional[pulumi.Input['NodeV3HostnameConfigArgs']] = None,
                 ...
                 storage: Optional[pulumi.Input['NodeV3StorageArgs']] = None,
    ...
    def root_volume(self) -> pulumi.Input['NodeV3RootVolumeArgs']:
        return pulumi.get(self, "root_volume")

    @root_volume.setter
    def root_volume(self, value: pulumi.Input['NodeV3RootVolumeArgs']):
    ...
    def data_volumes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['NodeV3DataVolumeArgs']]]]:
        return pulumi.get(self, "data_volumes")

    @data_volumes.setter
    def data_volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['NodeV3DataVolumeArgs']]]]):
    ...
    def extend_params(self) -> Optional[pulumi.Input['NodeV3ExtendParamsArgs']]:
        return pulumi.get(self, "extend_params")

    @extend_params.setter
    def extend_params(self, value: Optional[pulumi.Input['NodeV3ExtendParamsArgs']]):
        pulumi.set(self, "extend_params", value)

    @_builtins.property
    @pulumi.getter(name="extensionNics")
    def extension_nics(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['NodeV3ExtensionNicArgs']]]]:
        return pulumi.get(self, "extension_nics")

    @extension_nics.setter
    def extension_nics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['NodeV3ExtensionNicArgs']]]]):
    ...
    def hostname_config(self) -> Optional[pulumi.Input['NodeV3HostnameConfigArgs']]:
        return pulumi.get(self, "hostname_config")

    @hostname_config.setter
    def hostname_config(self, value: Optional[pulumi.Input['NodeV3HostnameConfigArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def storage(self) -> Optional[pulumi.Input['NodeV3StorageArgs']]:
        return pulumi.get(self, "storage")

    @storage.setter
    def storage(self, value: Optional[pulumi.Input['NodeV3StorageArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def taints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['NodeV3TaintArgs']]]]:
        return pulumi.get(self, "taints")

    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['NodeV3TaintArgs']]]]):
...
class _NodeV3State:
    def __init__(__self__, *,
                 ...
                 public_key: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 root_volume: Optional[pulumi.Input['NodeV3RootVolumeArgs']] = None,
                 runtime: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="rootVolume")
    def root_volume(self) -> Optional[pulumi.Input['NodeV3RootVolumeArgs']]:
        return pulumi.get(self, "root_volume")

    @root_volume.setter
    def root_volume(self, value: Optional[pulumi.Input['NodeV3RootVolumeArgs']]):
        pulumi.set(self, "root_volume", value)
...
@pulumi.type_token("huaweicloud:Cce/nodeV3:NodeV3")
class NodeV3(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                 data_volumes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NodeV3DataVolumeArgs', 'NodeV3DataVolumeArgsDict']]]]] = None,
                 dedicated_host_id: Optional[pulumi.Input[_builtins.str]] = None,
                 ecs_group_id: Optional[pulumi.Input[_builtins.str]] = None,
                 ecs_performance_type: Optional[pulumi.Input[_builtins.str]] = None,
                 eip_id: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 extend_param: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 extend_param_charging_mode: Optional[pulumi.Input[_builtins.int]] = None,
                 extend_params: Optional[pulumi.Input[Union['NodeV3ExtendParamsArgs', 'NodeV3ExtendParamsArgsDict']]] = None,
                 extension_nics: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NodeV3ExtensionNicArgs', 'NodeV3ExtensionNicArgsDict']]]]] = None,
                 fixed_ip: Optional[pulumi.Input[_builtins.str]] = None,
                 flavor_id: Optional[pulumi.Input[_builtins.str]] = None,
                 hostname_config: Optional[pulumi.Input[Union['NodeV3HostnameConfigArgs', 'NodeV3HostnameConfigArgsDict']]] = None,
                 initialized_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 iptype: Optional[pulumi.Input[_builtins.str]] = None,
                 keep_ecs: Optional[pulumi.Input[_builtins.bool]] = None,
                 key_pair: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 public_key: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 root_volume: Optional[pulumi.Input[Union['NodeV3RootVolumeArgs', 'NodeV3RootVolumeArgsDict']]] = None,
                 runtime: Optional[pulumi.Input[_builtins.str]] = None,
                 sharetype: Optional[pulumi.Input[_builtins.str]] = None,
                 storage: Optional[pulumi.Input[Union['NodeV3StorageArgs', 'NodeV3StorageArgsDict']]] = None,
                 subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 taints: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NodeV3TaintArgs', 'NodeV3TaintArgsDict']]]]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NodeV3Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NodeV3Args.__new__(NodeV3Args)
        ...
        super(NodeV3, __self__).__init__(
            'huaweicloud:Cce/nodeV3:NodeV3',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            taints: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NodeV3TaintArgs', 'NodeV3TaintArgsDict']]]]] = None) -> 'NodeV3':
        """
        Get an existing NodeV3 resource's state with the given name, id, and optional extra
        ...
        __props__ = _NodeV3State.__new__(_NodeV3State)
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["taints"] = taints
        return NodeV3(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="dataVolumes")
    def data_volumes(self) -> pulumi.Output[Sequence['outputs.NodeV3DataVolume']]:
        return pulumi.get(self, "data_volumes")
    ...
    @_builtins.property
    @pulumi.getter(name="extendParams")
    def extend_params(self) -> pulumi.Output[Optional['outputs.NodeV3ExtendParams']]:
        return pulumi.get(self, "extend_params")

    @_builtins.property
    @pulumi.getter(name="extensionNics")
    def extension_nics(self) -> pulumi.Output[Optional[Sequence['outputs.NodeV3ExtensionNic']]]:
        return pulumi.get(self, "extension_nics")
    ...
    @_builtins.property
    @pulumi.getter(name="hostnameConfig")
    def hostname_config(self) -> pulumi.Output['outputs.NodeV3HostnameConfig']:
        return pulumi.get(self, "hostname_config")
    ...
    @_builtins.property
    @pulumi.getter(name="rootVolume")
    def root_volume(self) -> pulumi.Output['outputs.NodeV3RootVolume']:
        return pulumi.get(self, "root_volume")
    ...
    @_builtins.property
    @pulumi.getter
    def storage(self) -> pulumi.Output[Optional['outputs.NodeV3Storage']]:
        return pulumi.get(self, "storage")
    ...
    @_builtins.property
    @pulumi.getter
    def taints(self) -> pulumi.Output[Optional[Sequence['outputs.NodeV3Taint']]]:
        return pulumi.get(self, "taints")
