...
__all__ = [
    'GetAutopilotClusterCertificateResult',
    'AwaitableGetAutopilotClusterCertificateResult',
    'get_autopilot_cluster_certificate',
    'get_autopilot_cluster_certificate_output',
]

@pulumi.output_type
class GetAutopilotClusterCertificateResult:
    """
    A collection of values returned by getAutopilotClusterCertificate.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def clusters(self) -> Sequence['outputs.GetAutopilotClusterCertificateClusterResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def contexts(self) -> Sequence['outputs.GetAutopilotClusterCertificateContextResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetAutopilotClusterCertificateUserResult']:
        """
...
class AwaitableGetAutopilotClusterCertificateResult(GetAutopilotClusterCertificateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAutopilotClusterCertificateResult(
...
def get_autopilot_cluster_certificate(cluster_id: Optional[_builtins.str] = None,
                                      duration: Optional[_builtins.int] = None,
                                      region: Optional[_builtins.str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAutopilotClusterCertificateResult:
    """
    ...
    test = huaweicloud.Cce.get_autopilot_cluster_certificate(cluster_id=cluster_id,
        duration=30)
    ```


    :param _builtins.str cluster_id: Specifies the cluster ID to which the cluster certificate belongs.
    :param _builtins.int duration: Specifies the duration of the cluster certificate.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cce/getAutopilotClusterCertificate:getAutopilotClusterCertificate', __args__, opts=opts, typ=GetAutopilotClusterCertificateResult).value

    return AwaitableGetAutopilotClusterCertificateResult(
...
def get_autopilot_cluster_certificate_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                                             duration: Optional[pulumi.Input[_builtins.int]] = None,
                                             region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAutopilotClusterCertificateResult]:
    """
    Use this data source to get the certificate of a CCE Autopilot cluster within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cce/getAutopilotClusterCertificate:getAutopilotClusterCertificate', __args__, opts=opts, typ=GetAutopilotClusterCertificateResult)
    return __ret__.apply(lambda __response__: GetAutopilotClusterCertificateResult(
