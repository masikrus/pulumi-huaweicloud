...
class ZoneV2Args:
    def __init__(__self__, *,
                 ...
                 routers: Optional[pulumi.Input[Sequence[pulumi.Input['ZoneV2RouterArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def routers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZoneV2RouterArgs']]]]:
        return pulumi.get(self, "routers")

    @routers.setter
    def routers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZoneV2RouterArgs']]]]):
...
class _ZoneV2State:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 dnssec: Optional[pulumi.Input[_builtins.str]] = None,
                 dnssec_infos: Optional[pulumi.Input[Sequence[pulumi.Input['ZoneV2DnssecInfoArgs']]]] = None,
                 email: Optional[pulumi.Input[_builtins.str]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def dnssec_infos(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZoneV2DnssecInfoArgs']]]]:
        """
    ...
    @dnssec_infos.setter
    def dnssec_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZoneV2DnssecInfoArgs']]]]):
...
@pulumi.type_token("huaweicloud:Dns/zoneV2:ZoneV2")
class ZoneV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 proxy_pattern: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 routers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ZoneV2RouterArgs', 'ZoneV2RouterArgsDict']]]]] = None,
                 status: Optional[pulumi.Input[_builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 ttl: Optional[pulumi.Input[_builtins.int]] = None,
                 zone_type: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ZoneV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ZoneV2Args.__new__(ZoneV2Args)
        ...
        super(ZoneV2, __self__).__init__(
            'huaweicloud:Dns/zoneV2:ZoneV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[_builtins.str]] = None,
            dnssec: Optional[pulumi.Input[_builtins.str]] = None,
            dnssec_infos: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ZoneV2DnssecInfoArgs', 'ZoneV2DnssecInfoArgsDict']]]]] = None,
            email: Optional[pulumi.Input[_builtins.str]] = None,
            enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
            masters: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            ttl: Optional[pulumi.Input[_builtins.int]] = None,
            zone_type: Optional[pulumi.Input[_builtins.str]] = None) -> 'ZoneV2':
        """
        Get an existing ZoneV2 resource's state with the given name, id, and optional extra
        ...
        :param pulumi.Input[_builtins.str] description: The description of the zone.
        :param pulumi.Input[_builtins.str] dnssec: Specifies whether to enable DNSSEC for a public zone.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ZoneV2DnssecInfoArgs', 'ZoneV2DnssecInfoArgsDict']]]] dnssec_infos: Indicates the DNSSEC infos.
        :param pulumi.Input[_builtins.str] email: The email address of the administrator managing the zone.
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project ID of the zone.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] masters: The list of the masters of the DNS server.
        :param pulumi.Input[_builtins.str] name: The name of the zone.
        ...
        __props__ = _ZoneV2State.__new__(_ZoneV2State)
        ...
        __props__.__dict__["ttl"] = ttl
        __props__.__dict__["zone_type"] = zone_type
        return ZoneV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="dnssecInfos")
    def dnssec_infos(self) -> pulumi.Output[Sequence['outputs.ZoneV2DnssecInfo']]:
        """
        Indicates the DNSSEC infos.
        """
        return pulumi.get(self, "dnssec_infos")
    ...
    @_builtins.property
    @pulumi.getter
    def routers(self) -> pulumi.Output[Optional[Sequence['outputs.ZoneV2Router']]]:
        return pulumi.get(self, "routers")
