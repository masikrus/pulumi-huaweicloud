...
__all__ = ['RecordsetV2Args', 'RecordsetV2']

@pulumi.input_type
class RecordsetV2Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a RecordsetV2 resource.
        """
...
class _RecordsetV2State:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering RecordsetV2 resources.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if name is not None:
...
@pulumi.type_token("huaweicloud:Dns/recordsetV2:RecordsetV2")
class RecordsetV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RecordsetV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RecordsetV2Args.__new__(RecordsetV2Args)
        ...
        super(RecordsetV2, __self__).__init__(
            'huaweicloud:Dns/recordsetV2:RecordsetV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ttl: Optional[pulumi.Input[_builtins.int]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            zone_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'RecordsetV2':
        """
        Get an existing RecordsetV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _RecordsetV2State.__new__(_RecordsetV2State)
        ...
        __props__.__dict__["type"] = type
        __props__.__dict__["zone_id"] = zone_id
        return RecordsetV2(resource_name, opts=opts, __props__=__props__)
