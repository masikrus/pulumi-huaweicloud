...
class NetworkV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the CCI network.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: Specifies the security group IDs of the CCI network.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkV2SubnetArgs']]] subnets: Specifies the subnets of the CCI network.
        """
    ...
    def annotations(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Specifies the annotations of the CCI network.
        """
    ...
    def ip_families(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Specifies the IP families of the CCI network.
        """
    ...
    def name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the name of the CCI network.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def subnets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['NetworkV2SubnetArgs']]]]:
        """
        Specifies the subnets of the CCI network.
        """
        return pulumi.get(self, "subnets")

    @subnets.setter
    def subnets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkV2SubnetArgs']]]]):
...
class _NetworkV2State:
    def __init__(__self__, *,
                 ...
                 security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 statuses: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkV2StatusArgs']]]] = None,
                 subnets: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkV2SubnetArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_families: Specifies the IP families of the CCI network.
        :param pulumi.Input[_builtins.str] kind: The kind of the CCI network.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the CCI network.
        :param pulumi.Input[_builtins.str] namespace: Specifies the namespace.
        :param pulumi.Input[_builtins.str] resource_version: The resource version of the namespace.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: Specifies the security group IDs of the CCI network.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkV2StatusArgs']]] statuses: The status of the namespace.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkV2SubnetArgs']]] subnets: Specifies the subnets of the CCI network.
    ...
    @_builtins.property
    @pulumi.getter
    def statuses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['NetworkV2StatusArgs']]]]:
        """
    ...
    @statuses.setter
    def statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkV2StatusArgs']]]]):
...
@pulumi.type_token("huaweicloud:Cci/networkV2:NetworkV2")
class NetworkV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 subnets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkV2SubnetArgs', 'NetworkV2SubnetArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] namespace: Specifies the namespace.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: Specifies the security group IDs of the CCI network.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NetworkV2SubnetArgs', 'NetworkV2SubnetArgsDict']]]] subnets: Specifies the subnets of the CCI network.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        super(NetworkV2, __self__).__init__(
            'huaweicloud:Cci/networkV2:NetworkV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            resource_version: Optional[pulumi.Input[_builtins.str]] = None,
            security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            statuses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkV2StatusArgs', 'NetworkV2StatusArgsDict']]]]] = None,
            subnets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkV2SubnetArgs', 'NetworkV2SubnetArgsDict']]]]] = None,
            uid: Optional[pulumi.Input[_builtins.str]] = None) -> 'NetworkV2':
        """
        ...
        :param pulumi.Input[_builtins.str] resource_version: The resource version of the namespace.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: Specifies the security group IDs of the CCI network.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NetworkV2StatusArgs', 'NetworkV2StatusArgsDict']]]] statuses: The status of the namespace.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NetworkV2SubnetArgs', 'NetworkV2SubnetArgsDict']]]] subnets: Specifies the subnets of the CCI network.
        :param pulumi.Input[_builtins.str] uid: The uid of the namespace.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="ipFamilies")
    def ip_families(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Specifies the IP families of the CCI network.
        """
        return pulumi.get(self, "ip_families")
    ...
    @_builtins.property
    @pulumi.getter
    def statuses(self) -> pulumi.Output[Sequence['outputs.NetworkV2Status']]:
        """
        The status of the namespace.
        """
        return pulumi.get(self, "statuses")
    ...
    @_builtins.property
    @pulumi.getter
    def subnets(self) -> pulumi.Output[Optional[Sequence['outputs.NetworkV2Subnet']]]:
        """
        Specifies the subnets of the CCI network.
        """
        return pulumi.get(self, "subnets")
