...
class PvcArgs:
    def __init__(__self__, *,
                 ...
                 device_mount_path: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the PVC resource. If omitted, the
               provider-level region will be used. Changing this will create a new PVC resource.
        :param pulumi.Input[_builtins.str] volume_type: Specifies the type of the storage bound to the CCI Namespace. The valid
    ...
    def device_mount_path(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def device_mount_path(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _PvcState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] device_mount_path: Specifies the share path of the SFS storage bound to the CCI
               Namespace. Required if `volume_type` is **nfs-rw**, **efs-standard** or **efs-performance**.
               Changing this will create a new PVC resource.
        :param pulumi.Input[_builtins.bool] enable: Whether the PVC is available.
        :param pulumi.Input[_builtins.str] name: Specifies the unique name of the PVC resource. This parameter can contain a
               maximum of 63 characters, which may consist of lowercase letters, digits and hyphens, and must start and end with
               lowercase letters and digits. Changing this will create a new PVC resource.
        :param pulumi.Input[_builtins.str] namespace: Specifies the namespace to logically divide your cloud container instances
...
@pulumi.type_token("huaweicloud:Cci/pvc:Pvc")
class Pvc(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            volume_id: Optional[pulumi.Input[_builtins.str]] = None,
            volume_type: Optional[pulumi.Input[_builtins.str]] = None) -> 'Pvc':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="deviceMountPath")
    def device_mount_path(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the share path of the SFS storage bound to the CCI
        Namespace. Required if `volume_type` is **nfs-rw**, **efs-standard** or **efs-performance**.
        Changing this will create a new PVC resource.
