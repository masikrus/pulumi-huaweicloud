...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 auto_expend_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 container_network_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 rbac_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 recycling_interval: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the unique name of the CCI namespace.  
               ...
               Changing this will create a new CCI namespace resource.
        :param pulumi.Input[_builtins.bool] rbac_enabled: Specifies whether Role-based access control is enabled.
        ...
        :param pulumi.Input[_builtins.int] recycling_interval: Specifies the IP address recycling interval, in hour.
               The idle IP resources from the elastic expansion of the IP resource pool can be recycled within this time.
               Changing this will create a new CCI namespace resource.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the CCI namespace resource.
               If omitted, the provider-level region will be used. Changing this will create a new CCI namespace resource.
        :param pulumi.Input[_builtins.int] warmup_pool_size: Specifies the size of IP pool to warm-up.  
    ...
    def auto_expend_enabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def auto_expend_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "auto_expend_enabled", value)

    @_builtins.property
    @pulumi.getter(name="containerNetworkEnabled")
    def container_network_enabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def container_network_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def rbac_enabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @rbac_enabled.setter
    def rbac_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "rbac_enabled", value)

    @_builtins.property
    @pulumi.getter(name="recyclingInterval")
    def recycling_interval(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def recycling_interval(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def warmup_pool_size(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def warmup_pool_size(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _NamespaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] container_network_enabled: Specifies whether container network is enabled.
               ...
               network as soon as they are started. Default to **false**.
               Changing this will create a new CCI namespace resource.
        :param pulumi.Input[_builtins.str] created_at: The time when the namespace was created, in UTC format, e.g., **2021-09-27T01:30:39Z**.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies a unique ID in UUID format of enterprise project.
               Changing this will create a new CCI namespace resource.
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the CCI namespace resource.
               If omitted, the provider-level region will be used. Changing this will create a new CCI namespace resource.
        :param pulumi.Input[_builtins.str] status: Namespace status.
        :param pulumi.Input[_builtins.str] type: Specifies the CCI namespace type.
               The valid values are **general-computing** and **gpu-accelerated**.
               Changing this will create a new CCI namespace resource.
        :param pulumi.Input[_builtins.int] warmup_pool_size: Specifies the size of IP pool to warm-up.  
...
@pulumi.type_token("huaweicloud:Cci/namespace:Namespace")
class Namespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            warmup_pool_size: Optional[pulumi.Input[_builtins.int]] = None) -> 'Namespace':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="autoExpendEnabled")
    def auto_expend_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Specifies whether elastic scheduling is enabled.
        Changing this will create a new CCI namespace resource.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="containerNetworkEnabled")
    def container_network_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Specifies whether container network is enabled.
        Enable this option if you want CCI to start the container network in advance so that containers can connect to the
        network as soon as they are started. Default to **false**.
    ...
    @_builtins.property
    @pulumi.getter(name="rbacEnabled")
    def rbac_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether Role-based access control is enabled.
        After the RBAC permission is enabled, the user's use of resources under the namespace will be controlled by the RBAC
        permission. Changing this will create a new CCI namespace resource.
    ...
    @_builtins.property
    @pulumi.getter(name="recyclingInterval")
    def recycling_interval(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the IP address recycling interval, in hour.
        The idle IP resources from the elastic expansion of the IP resource pool can be recycled within this time.
        Changing this will create a new CCI namespace resource.
    ...
    @_builtins.property
    @pulumi.getter(name="warmupPoolSize")
    def warmup_pool_size(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the size of IP pool to warm-up.  
        The valid value is range from `1` to `500`.
        Changing this will create a new CCI namespace resource.
