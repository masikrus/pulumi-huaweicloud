...
def get_quotas(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQuotasResult:
    ...
    test = huaweicloud.Ram.get_quotas()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ram/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult).value
...
def get_quotas_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetQuotasResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ram/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult)
