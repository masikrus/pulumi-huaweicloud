...
def get_tags(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTagsResult:
    ...
    test = huaweicloud.Ram.get_tags()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ram/getTags:getTags', __args__, opts=opts, typ=GetTagsResult).value
...
def get_tags_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTagsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ram/getTags:getTags', __args__, opts=opts, typ=GetTagsResult)
