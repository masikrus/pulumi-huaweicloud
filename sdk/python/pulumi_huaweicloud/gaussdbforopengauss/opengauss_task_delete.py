...
__all__ = ['OpengaussTaskDeleteArgs', 'OpengaussTaskDelete']

@pulumi.input_type
class OpengaussTaskDeleteArgs:
...
@pulumi.input_type
class _OpengaussTaskDeleteState:
    def __init__(__self__, *,
...
@pulumi.type_token("huaweicloud:GaussDBforOpenGauss/opengaussTaskDelete:OpengaussTaskDelete")
class OpengaussTaskDelete(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OpengaussTaskDeleteArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OpengaussTaskDeleteArgs.__new__(OpengaussTaskDeleteArgs)

            if job_id is None and not opts.urn:
                raise TypeError("Missing required property 'job_id'")
            __props__.__dict__["job_id"] = job_id
            __props__.__dict__["region"] = region
        super(OpengaussTaskDelete, __self__).__init__(
            'huaweicloud:GaussDBforOpenGauss/opengaussTaskDelete:OpengaussTaskDelete',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            job_id: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'OpengaussTaskDelete':
        """
        Get an existing OpengaussTaskDelete resource's state with the given name, id, and optional extra
        ...
        __props__ = _OpengaussTaskDeleteState.__new__(_OpengaussTaskDeleteState)

        __props__.__dict__["job_id"] = job_id
        __props__.__dict__["region"] = region
        return OpengaussTaskDelete(resource_name, opts=opts, __props__=__props__)
