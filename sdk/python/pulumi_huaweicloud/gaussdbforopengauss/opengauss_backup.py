...
__all__ = ['OpengaussBackupArgs', 'OpengaussBackup']

@pulumi.input_type
class OpengaussBackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the GaussDB OpenGauss instance resource. If omitted,
    ...
    def description(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the description of the backup. It contains up to `256` characters
        and cannot contain the following special characters: **>!<"&'=**.
        """
    ...
    def region(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The region in which to create the GaussDB OpenGauss instance resource. If omitted,
        the provider-level region will be used. Changing this creates a new instance resource.
        """
...
@pulumi.input_type
class _OpengaussBackupState:
    def __init__(__self__, *,
                 begin_time: Optional[pulumi.Input[_builtins.str]] = None,
                 datastores: Optional[pulumi.Input[Sequence[pulumi.Input['OpengaussBackupDatastoreArgs']]]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def datastores(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OpengaussBackupDatastoreArgs']]]]:
        """
    ...
    @datastores.setter
    def datastores(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OpengaussBackupDatastoreArgs']]]]):
...
@pulumi.type_token("huaweicloud:GaussDBforOpenGauss/opengaussBackup:OpengaussBackup")
class OpengaussBackup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.gaussdbforopengauss.OpengaussBackup("test",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OpengaussBackupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OpengaussBackupArgs.__new__(OpengaussBackupArgs)
        ...
        super(OpengaussBackup, __self__).__init__(
            'huaweicloud:GaussDBforOpenGauss/opengaussBackup:OpengaussBackup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            begin_time: Optional[pulumi.Input[_builtins.str]] = None,
            datastores: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OpengaussBackupDatastoreArgs', 'OpengaussBackupDatastoreArgsDict']]]]] = None,
            description: Optional[pulumi.Input[_builtins.str]] = None,
            end_time: Optional[pulumi.Input[_builtins.str]] = None,
            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            size: Optional[pulumi.Input[_builtins.float]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'OpengaussBackup':
        """
        Get an existing OpengaussBackup resource's state with the given name, id, and optional extra
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.str] begin_time: Indicates the backup start time in the **yyyy-mm-ddThh:mm:ssZ** format.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OpengaussBackupDatastoreArgs', 'OpengaussBackupDatastoreArgsDict']]]] datastores: Indicates the database information.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the backup. It contains up to `256` characters
               and cannot contain the following special characters: **>!<"&'=**.
        :param pulumi.Input[_builtins.str] end_time: Indicates the backup end time in the **yyyy-mm-ddThh:mm:ssZ** format.
        :param pulumi.Input[_builtins.str] instance_id: Specifies the ID of the GaussDB OpenGauss instance.
        ...
        __props__ = _OpengaussBackupState.__new__(_OpengaussBackupState)
        ...
        return OpengaussBackup(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def datastores(self) -> pulumi.Output[Sequence['outputs.OpengaussBackupDatastore']]:
        """
        Indicates the database information.
        """
        return pulumi.get(self, "datastores")
