...
class OpengaussInstanceArgs:
    def __init__(__self__, *,
                 ...
                 mysql_compatibility_port: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 sharding_num: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of opengauss instance.
    ...
    def coordinator_num(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def enable_force_switch(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "enable_force_switch", value)

    @_builtins.property
    @pulumi.getter(name="enableSingleFloatIp")
    def enable_single_float_ip(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def enable_single_float_ip(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def mysql_compatibility_port(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def mysql_compatibility_port(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @sharding_num.setter
    def sharding_num(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _OpengaussInstanceState:
    def __init__(__self__, *,
                 ...
                 backup_strategy: Optional[pulumi.Input['OpengaussInstanceBackupStrategyArgs']] = None,
                 balance_status: Optional[pulumi.Input[_builtins.bool]] = None,
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
                 coordinator_num: Optional[pulumi.Input[_builtins.int]] = None,
                 datastore: Optional[pulumi.Input['OpengaussInstanceDatastoreArgs']] = None,
                 ...
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 error_log_switch_status: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] port: Specifies the port information. Defaults to `8,000`.
               The valid values are as follows:
               + `2,378` to `2,380`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] private_ips: Indicates the private IP address of the DB instance.
    ...
    def balance_status(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def balance_status(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def error_log_switch_status(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def error_log_switch_status(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("huaweicloud:GaussDBforOpenGauss/opengaussInstance:OpengaussInstance")
class OpengaussInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 advance_features: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OpengaussInstanceAdvanceFeatureArgs', 'OpengaussInstanceAdvanceFeatureArgsDict']]]]] = None,
                 auto_renew: Optional[pulumi.Input[_builtins.str]] = None,
                 availability_zone: Optional[pulumi.Input[_builtins.str]] = None,
                 backup_strategy: Optional[pulumi.Input[Union['OpengaussInstanceBackupStrategyArgs', 'OpengaussInstanceBackupStrategyArgsDict']]] = None,
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
                 coordinator_num: Optional[pulumi.Input[_builtins.int]] = None,
                 ...
                 flavor: Optional[pulumi.Input[_builtins.str]] = None,
                 force_import: Optional[pulumi.Input[_builtins.bool]] = None,
                 ha: Optional[pulumi.Input[Union['OpengaussInstanceHaArgs', 'OpengaussInstanceHaArgsDict']]] = None,
                 mysql_compatibility_port: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OpengaussInstanceParameterArgs', 'OpengaussInstanceParameterArgsDict']]]]] = None,
                 password: Optional[pulumi.Input[_builtins.str]] = None,
                 period: Optional[pulumi.Input[_builtins.int]] = None,
                 period_unit: Optional[pulumi.Input[_builtins.str]] = None,
                 port: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 time_zone: Optional[pulumi.Input[_builtins.str]] = None,
                 volume: Optional[pulumi.Input[Union['OpengaussInstanceVolumeArgs', 'OpengaussInstanceVolumeArgsDict']]] = None,
                 vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['OpengaussInstanceAdvanceFeatureArgs', 'OpengaussInstanceAdvanceFeatureArgsDict']]]] advance_features: Specifies the advanced features.
               The advance_features structure is documented below.
        :param pulumi.Input[_builtins.str] auto_renew: Specifies whether auto renew is enabled.
               Valid values are **true** and **false**. Defaults to **false**.
        ...
        :param pulumi.Input[_builtins.str] mysql_compatibility_port: Specifies the port for MySQL compatibility. Value range: **0** or
               ...
               **[Database port, Database port + 10]**.
               + If the value is **0**, the MySQL compatibility port is disabled.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the advance feature.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OpengaussInstanceParameterArgs', 'OpengaussInstanceParameterArgsDict']]]] parameters: Specifies an array of one or more parameters to be set to the instance after launched.
               The parameters structure is documented below.
        :param pulumi.Input[_builtins.str] password: Specifies the database password. The value must be `8` to `32` characters in length,
               including uppercase and lowercase letters, digits, and special characters, such as **~!@#%^*-_=+?**. You are advised
               to enter a strong password to improve security, preventing security risks such as brute force cracking.
    ...
    def get(resource_name: str,
            ...
            mysql_compatibility_port: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            nodes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OpengaussInstanceNodeArgs', 'OpengaussInstanceNodeArgsDict']]]]] = None,
            parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OpengaussInstanceParameterArgs', 'OpengaussInstanceParameterArgsDict']]]]] = None,
            password: Optional[pulumi.Input[_builtins.str]] = None,
            period: Optional[pulumi.Input[_builtins.int]] = None,
            period_unit: Optional[pulumi.Input[_builtins.str]] = None,
            ...
            type: Optional[pulumi.Input[_builtins.str]] = None,
            volume: Optional[pulumi.Input[Union['OpengaussInstanceVolumeArgs', 'OpengaussInstanceVolumeArgsDict']]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'OpengaussInstance':
        """
        ...
        :param pulumi.Input[_builtins.str] mysql_compatibility_port: Specifies the port for MySQL compatibility. Value range: **0** or
               ...
               **[Database port, Database port + 10]**.
               + If the value is **0**, the MySQL compatibility port is disabled.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the advance feature.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OpengaussInstanceNodeArgs', 'OpengaussInstanceNodeArgsDict']]]] nodes: Indicates the instance nodes information. Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OpengaussInstanceParameterArgs', 'OpengaussInstanceParameterArgsDict']]]] parameters: Specifies an array of one or more parameters to be set to the instance after launched.
               The parameters structure is documented below.
        :param pulumi.Input[_builtins.str] password: Specifies the database password. The value must be `8` to `32` characters in length,
               including uppercase and lowercase letters, digits, and special characters, such as **~!@#%^*-_=+?**. You are advised
    ...
    @_builtins.property
    @pulumi.getter(name="balanceStatus")
    def balance_status(self) -> pulumi.Output[_builtins.bool]:
        """
        Indicates whether the host load is balanced due to a primary/standby switchover.
        """
        return pulumi.get(self, "balance_status")
    ...
    @_builtins.property
    @pulumi.getter(name="enableSingleFloatIp")
    def enable_single_float_ip(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether to enable single floating IP address policy,
        which is only suitable for primary/standby instances. Value options:
        + **true**: This function is enabled. Only one floating IP address is bound to the primary node of a DB instance. If a
    ...
    @_builtins.property
    @pulumi.getter(name="errorLogSwitchStatus")
    def error_log_switch_status(self) -> pulumi.Output[_builtins.str]:
        """
        Indicates whether error log collection is enabled. The value can be:
        + **ON**: enabled
        + **OFF**: disabled
    ...
    @_builtins.property
    @pulumi.getter(name="mysqlCompatibilityPort")
    def mysql_compatibility_port(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the port for MySQL compatibility. Value range: **0** or
        **1024** to **39989**.
        + The following ports are used by the system and cannot be used: **2378**, **2379**, **2380**, **2400**, **4999**,
