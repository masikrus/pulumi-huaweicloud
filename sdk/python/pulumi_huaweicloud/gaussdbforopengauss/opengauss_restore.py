...
__all__ = ['OpengaussRestoreArgs', 'OpengaussRestore']

@pulumi.input_type
class OpengaussRestoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] backup_id: Specifies the ID of the backup to be restored. It indicates the ID of the
               ...
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] region: The region in which to create the GaussDB OpenGauss restore resource. If omitted,
               the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] restore_time: Specifies the time point of data restoration in the UNIX timestamp format.
    ...
    def backup_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the ID of the backup to be restored. It indicates the ID of the
        full backup corresponding to schema_type. This parameter must be specified when the backup file is used for restoration.
    ...
    def region(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The region in which to create the GaussDB OpenGauss restore resource. If omitted,
        the provider-level region will be used. Changing this creates a new resource.
        """
...
@pulumi.type_token("huaweicloud:GaussDBforOpenGauss/opengaussRestore:OpengaussRestore")
class OpengaussRestore(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.gaussdbforopengauss.OpengaussRestore("test",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OpengaussRestoreArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OpengaussRestoreArgs.__new__(OpengaussRestoreArgs)
        ...
        super(OpengaussRestore, __self__).__init__(
            'huaweicloud:GaussDBforOpenGauss/opengaussRestore:OpengaussRestore',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            source_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            target_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'OpengaussRestore':
        """
        Get an existing OpengaussRestore resource's state with the given name, id, and optional extra
        ...
        __props__ = _OpengaussRestoreState.__new__(_OpengaussRestoreState)
        ...
        __props__.__dict__["target_instance_id"] = target_instance_id
        __props__.__dict__["type"] = type
        return OpengaussRestore(resource_name, opts=opts, __props__=__props__)
