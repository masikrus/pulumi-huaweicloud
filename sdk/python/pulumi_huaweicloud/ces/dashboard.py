...
@pulumi.type_token("huaweicloud:Ces/dashboard:Dashboard")
class Dashboard(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.Dashboard("test",
            name=name,
        ...
        ```sh
        $ pulumi import huaweicloud:Ces/dashboard:Dashboard test <id>
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Dashboard, __self__).__init__(
            'huaweicloud:Ces/dashboard:Dashboard',
            resource_name,
            __props__,
            opts)
