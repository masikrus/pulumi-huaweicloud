...
@pulumi.type_token("huaweicloud:Ces/oneClickAlarmReset:OneClickAlarmReset")
class OneClickAlarmReset(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.OneClickAlarmReset("test", one_click_alarm_id=one_click_alarm_id)
        ```
    ...
    def _internal_init(__self__,
        ...
        super(OneClickAlarmReset, __self__).__init__(
            'huaweicloud:Ces/oneClickAlarmReset:OneClickAlarmReset',
            resource_name,
            __props__,
            opts)
