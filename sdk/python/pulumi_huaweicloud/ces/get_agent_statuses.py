...
def get_agent_statuses(extension_name: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_agent_statuses(instance_ids=[instance_id])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getAgentStatuses:getAgentStatuses', __args__, opts=opts, typ=GetAgentStatusesResult).value
...
def get_agent_statuses_output(extension_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getAgentStatuses:getAgentStatuses', __args__, opts=opts, typ=GetAgentStatusesResult)
