...
def get_one_click_alarm_rules(one_click_alarm_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_one_click_alarm_rules(one_click_alarm_id=one_click_alarm_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getOneClickAlarmRules:getOneClickAlarmRules', __args__, opts=opts, typ=GetOneClickAlarmRulesResult).value
...
def get_one_click_alarm_rules_output(one_click_alarm_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getOneClickAlarmRules:getOneClickAlarmRules', __args__, opts=opts, typ=GetOneClickAlarmRulesResult)
