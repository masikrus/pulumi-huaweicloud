...
__all__ = [
    ...
    'ResourceGroupAlarmTemplateAsyncAssociateAlarmNotificationArgs',
    'ResourceGroupAlarmTemplateAsyncAssociateAlarmNotificationArgsDict',
    'ResourceGroupAlarmTemplateAsyncAssociateOkNotificationArgs',
    'ResourceGroupAlarmTemplateAsyncAssociateOkNotificationArgsDict',
...
class ResourceGroupAlarmTemplateAsyncAssociateAlarmNotificationArgsDict(TypedDict):
    notification_lists: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
    """
...
@pulumi.input_type
class ResourceGroupAlarmTemplateAsyncAssociateAlarmNotificationArgs:
    def __init__(__self__, *,
                 notification_lists: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] notification_lists: Specifies the list of recipients to be notified when the alarm status changes.
               + When `type` is **notification**, the value cannot be empty.
               + When `type` is **autoscaling**, the value must be **[]**.
               + When `type` is **autoscaling**, the value must be **[]**.
               + When `notification_enabled` is **true**, either `alarm_notifications` or `ok_notifications` must be non-empty.
...
class ResourceGroupAlarmTemplateAsyncAssociateOkNotificationArgsDict(TypedDict):
    notification_lists: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
    """
    Specifies the list of recipients to be notified when the alarm status changes.
    + When `type` is **notification**, the value cannot be empty.
...
@pulumi.input_type
class ResourceGroupAlarmTemplateAsyncAssociateOkNotificationArgs:
    def __init__(__self__, *,
                 notification_lists: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 type: pulumi.Input[_builtins.str]):
        """
