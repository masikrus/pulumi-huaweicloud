...
def get_event_details(from_: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_event_details(name=name,
        type=type)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getEventDetails:getEventDetails', __args__, opts=opts, typ=GetEventDetailsResult).value
...
def get_event_details_output(from_: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getEventDetails:getEventDetails', __args__, opts=opts, typ=GetEventDetailsResult)
