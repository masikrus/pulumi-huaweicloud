...
def get_alarm_templates(dimension_name: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_alarm_templates()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getAlarmTemplates:getAlarmTemplates', __args__, opts=opts, typ=GetAlarmTemplatesResult).value
...
def get_alarm_templates_output(dimension_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getAlarmTemplates:getAlarmTemplates', __args__, opts=opts, typ=GetAlarmTemplatesResult)
