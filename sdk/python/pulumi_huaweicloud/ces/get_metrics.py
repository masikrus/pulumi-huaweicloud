...
def get_metrics(dim0: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_metrics(namespace=namespace,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getMetrics:getMetrics', __args__, opts=opts, typ=GetMetricsResult).value
...
def get_metrics_output(dim0: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getMetrics:getMetrics', __args__, opts=opts, typ=GetMetricsResult)
