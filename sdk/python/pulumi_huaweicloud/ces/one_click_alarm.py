...
@pulumi.type_token("huaweicloud:Ces/oneClickAlarm:OneClickAlarm")
class OneClickAlarm(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.OneClickAlarm("test",
        ...
        ```sh
        $ pulumi import huaweicloud:Ces/oneClickAlarm:OneClickAlarm test <id>
        ```
    ...
    def _internal_init(__self__,
        ...
        super(OneClickAlarm, __self__).__init__(
            'huaweicloud:Ces/oneClickAlarm:OneClickAlarm',
            resource_name,
            __props__,
            opts)
