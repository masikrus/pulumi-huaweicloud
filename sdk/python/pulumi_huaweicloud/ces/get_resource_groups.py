...
def get_resource_groups(enterprise_project_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getResourceGroups:getResourceGroups', __args__, opts=opts, typ=GetResourceGroupsResult).value
...
def get_resource_groups_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getResourceGroups:getResourceGroups', __args__, opts=opts, typ=GetResourceGroupsResult)
