...
def get_events(from_: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_events()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getEvents:getEvents', __args__, opts=opts, typ=GetEventsResult).value
...
def get_events_output(from_: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getEvents:getEvents', __args__, opts=opts, typ=GetEventsResult)
