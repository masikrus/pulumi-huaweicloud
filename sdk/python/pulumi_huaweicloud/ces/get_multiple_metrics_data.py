...
def get_multiple_metrics_data(filter: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_multiple_metrics_data(metrics=[
            {
                "namespace": "YOU.APP",
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getMultipleMetricsData:getMultipleMetricsData', __args__, opts=opts, typ=GetMultipleMetricsDataResult).value
...
def get_multiple_metrics_data_output(filter: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getMultipleMetricsData:getMultipleMetricsData', __args__, opts=opts, typ=GetMultipleMetricsDataResult)
