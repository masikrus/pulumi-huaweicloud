...
def get_one_click_alarms(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_one_click_alarms()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getOneClickAlarms:getOneClickAlarms', __args__, opts=opts, typ=GetOneClickAlarmsResult).value
...
def get_one_click_alarms_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getOneClickAlarms:getOneClickAlarms', __args__, opts=opts, typ=GetOneClickAlarmsResult)
