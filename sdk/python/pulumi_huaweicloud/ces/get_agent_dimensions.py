...
def get_agent_dimensions(dim_name: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_agent_dimensions(instance_id=instance_id,
        dim_name=dim_name)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getAgentDimensions:getAgentDimensions', __args__, opts=opts, typ=GetAgentDimensionsResult).value
...
def get_agent_dimensions_output(dim_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getAgentDimensions:getAgentDimensions', __args__, opts=opts, typ=GetAgentDimensionsResult)
