...
@pulumi.type_token("huaweicloud:Ces/alarmrule:Alarmrule")
class Alarmrule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.Alarmrule("test",
        ...
        ```sh
        $ pulumi import huaweicloud:Ces/alarmrule:Alarmrule alarm_rule al1619578509719Ga0X1RGWv
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Alarmrule, __self__).__init__(
            'huaweicloud:Ces/alarmrule:Alarmrule',
            resource_name,
            __props__,
            opts)
