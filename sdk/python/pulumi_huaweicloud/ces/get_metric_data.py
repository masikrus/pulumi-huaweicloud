...
def get_metric_data(dim0: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_metric_data(namespace="You.APP",
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getMetricData:getMetricData', __args__, opts=opts, typ=GetMetricDataResult).value
...
def get_metric_data_output(dim0: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getMetricData:getMetricData', __args__, opts=opts, typ=GetMetricDataResult)
