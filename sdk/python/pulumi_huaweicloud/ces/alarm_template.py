...
@pulumi.type_token("huaweicloud:Ces/alarmTemplate:AlarmTemplate")
class AlarmTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.AlarmTemplate("test",
            name=name,
            policies=[{
                "namespace": "SYS.APIG",
        ...
        ```sh
        $ pulumi import huaweicloud:Ces/alarmTemplate:AlarmTemplate test <template_id>
        ```
    ...
    def _internal_init(__self__,
        ...
        super(AlarmTemplate, __self__).__init__(
            'huaweicloud:Ces/alarmTemplate:AlarmTemplate',
            resource_name,
            __props__,
            opts)
