...
__all__ = [
    ...
    'ResourceGroupAlarmTemplateAsyncAssociateAlarmNotification',
    'ResourceGroupAlarmTemplateAsyncAssociateOkNotification',
    ...
    'GetBatchMetricDataDataPointResult',
    'GetBatchMetricDataDataPointDimensionResult',
    ...
    'GetHostConfigurationsDatapointResult',
...
@pulumi.output_type
class ResourceGroupAlarmTemplateAsyncAssociateAlarmNotification(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "notificationLists":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ResourceGroupAlarmTemplateAsyncAssociateAlarmNotification. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ResourceGroupAlarmTemplateAsyncAssociateAlarmNotification.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param Sequence[_builtins.str] notification_lists: Specifies the list of recipients to be notified when the alarm status changes.
    ...
    def notification_lists(self) -> Sequence[_builtins.str]:
        """
        Specifies the list of recipients to be notified when the alarm status changes.
        + When `type` is **notification**, the value cannot be empty.
        + When `type` is **autoscaling**, the value must be **[]**.
        + When `type` is **autoscaling**, the value must be **[]**.
        + When `notification_enabled` is **true**, either `alarm_notifications` or `ok_notifications` must be non-empty.
...
@pulumi.output_type
class ResourceGroupAlarmTemplateAsyncAssociateOkNotification(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "notificationLists":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ResourceGroupAlarmTemplateAsyncAssociateOkNotification. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ResourceGroupAlarmTemplateAsyncAssociateOkNotification.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class GetBatchMetricDataDataPointResult(dict):
    def __init__(__self__, *,
                 dimensions: Sequence['outputs.GetBatchMetricDataDataPointDimensionResult'],
                 timestamp: _builtins.int,
                 unit: _builtins.str,
                 value: _builtins.float):
        """
        :param Sequence['GetBatchMetricDataDataPointDimensionArgs'] dimensions: Indicates the dimension information.
               The dimensions structure is documented below.
        :param _builtins.int timestamp: Indicates the metric collection time.
        :param _builtins.str unit: Indicates the data unit.
        :param _builtins.float value: Indicates the metric dimension value.
        """
        pulumi.set(__self__, "dimensions", dimensions)
    ...
    @_builtins.property
    @pulumi.getter
    def dimensions(self) -> Sequence['outputs.GetBatchMetricDataDataPointDimensionResult']:
        """
        Indicates the dimension information.
        The dimensions structure is documented below.
        """
        return pulumi.get(self, "dimensions")
    ...
    def value(self) -> _builtins.float:
        """
        Indicates the metric dimension value.
        """
        return pulumi.get(self, "value")


@pulumi.output_type
class GetBatchMetricDataDataPointDimensionResult(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 value: _builtins.str):
        """
        :param _builtins.str name: Indicates the metric dimension name.
        :param _builtins.str value: Indicates the metric dimension value.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
    ...
    def name(self) -> _builtins.str:
        """
        Indicates the metric dimension name.
        """
        return pulumi.get(self, "name")
...
@pulumi.output_type
class GetHostConfigurationsDatapointResult(dict):
    def __init__(__self__, *,
                 timestamp: _builtins.int,
                 type: _builtins.str,
                 value: _builtins.str):
        """
        :param _builtins.int timestamp: Indicates the time the incident was reported.
        :param _builtins.str type: Specifies the event type. It can contain only letters, underscores (_), and hyphens (-).
        :param _builtins.str value: Indicates the host configuration information.
        """
        pulumi.set(__self__, "timestamp", timestamp)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
    ...
    def timestamp(self) -> _builtins.int:
        """
        Indicates the time the incident was reported.
        """
        return pulumi.get(self, "timestamp")
    ...
    def type(self) -> _builtins.str:
        """
        Specifies the event type. It can contain only letters, underscores (_), and hyphens (-).
        """
        return pulumi.get(self, "type")
