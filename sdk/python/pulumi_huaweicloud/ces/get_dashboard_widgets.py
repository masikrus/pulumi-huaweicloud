...
def get_dashboard_widgets(dashboard_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_dashboard_widgets(dashboard_id=dashboard_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getDashboardWidgets:getDashboardWidgets', __args__, opts=opts, typ=GetDashboardWidgetsResult).value
...
def get_dashboard_widgets_output(dashboard_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getDashboardWidgets:getDashboardWidgets', __args__, opts=opts, typ=GetDashboardWidgetsResult)
