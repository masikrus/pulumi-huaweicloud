...
def get_resource_group_service_resources(dim_name: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_resource_group_service_resources(group_id=group_id,
        service=service)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getResourceGroupServiceResources:getResourceGroupServiceResources', __args__, opts=opts, typ=GetResourceGroupServiceResourcesResult).value
...
def get_resource_group_service_resources_output(dim_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getResourceGroupServiceResources:getResourceGroupServiceResources', __args__, opts=opts, typ=GetResourceGroupServiceResourcesResult)
