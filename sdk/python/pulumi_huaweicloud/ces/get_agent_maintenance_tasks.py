...
def get_agent_maintenance_tasks(instance_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_agent_maintenance_tasks()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getAgentMaintenanceTasks:getAgentMaintenanceTasks', __args__, opts=opts, typ=GetAgentMaintenanceTasksResult).value
...
def get_agent_maintenance_tasks_output(instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getAgentMaintenanceTasks:getAgentMaintenanceTasks', __args__, opts=opts, typ=GetAgentMaintenanceTasksResult)
