...
def get_dashboards(dashboard_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_dashboards()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getDashboards:getDashboards', __args__, opts=opts, typ=GetDashboardsResult).value
...
def get_dashboards_output(dashboard_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getDashboards:getDashboards', __args__, opts=opts, typ=GetDashboardsResult)
