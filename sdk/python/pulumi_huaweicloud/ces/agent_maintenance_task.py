...
@pulumi.type_token("huaweicloud:Ces/agentMaintenanceTask:AgentMaintenanceTask")
class AgentMaintenanceTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.AgentMaintenanceTask("test",
    ...
    def _internal_init(__self__,
        ...
        super(AgentMaintenanceTask, __self__).__init__(
            'huaweicloud:Ces/agentMaintenanceTask:AgentMaintenanceTask',
            resource_name,
            __props__,
            opts)
