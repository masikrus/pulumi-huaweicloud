...
def get_alarm_histories(alarm_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_alarm_histories()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getAlarmHistories:getAlarmHistories', __args__, opts=opts, typ=GetAlarmHistoriesResult).value
...
def get_alarm_histories_output(alarm_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getAlarmHistories:getAlarmHistories', __args__, opts=opts, typ=GetAlarmHistoriesResult)
