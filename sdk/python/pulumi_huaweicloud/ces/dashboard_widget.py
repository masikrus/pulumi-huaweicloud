...
@pulumi.type_token("huaweicloud:Ces/dashboardWidget:DashboardWidget")
class DashboardWidget(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.DashboardWidget("test",
        ...
        ```sh
        $ pulumi import huaweicloud:Ces/dashboardWidget:DashboardWidget test <id>
        ```
    ...
    def _internal_init(__self__,
        ...
        super(DashboardWidget, __self__).__init__(
            'huaweicloud:Ces/dashboardWidget:DashboardWidget',
            resource_name,
            __props__,
            opts)
