...
@pulumi.type_token("huaweicloud:Ces/resourceGroup:ResourceGroup")
class ResourceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.ResourceGroup("test",
            name="test",
            resources=[
                {
                    "namespace": "SYS.ECS",
        ...
        ```sh
        $ pulumi import huaweicloud:Ces/resourceGroup:ResourceGroup test 0ce123456a00f2591fabc00385ff1234
        ```
    ...
    def _internal_init(__self__,
        ...
        super(ResourceGroup, __self__).__init__(
            'huaweicloud:Ces/resourceGroup:ResourceGroup',
            resource_name,
            __props__,
            opts)
