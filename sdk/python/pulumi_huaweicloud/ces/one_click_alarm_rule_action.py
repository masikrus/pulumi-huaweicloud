...
@pulumi.type_token("huaweicloud:Ces/oneClickAlarmRuleAction:OneClickAlarmRuleAction")
class OneClickAlarmRuleAction(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.OneClickAlarmRuleAction("test",
    ...
    def _internal_init(__self__,
        ...
        super(OneClickAlarmRuleAction, __self__).__init__(
            'huaweicloud:Ces/oneClickAlarmRuleAction:OneClickAlarmRuleAction',
            resource_name,
            __props__,
            opts)
