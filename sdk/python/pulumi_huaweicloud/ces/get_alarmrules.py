...
def get_alarmrules(alarm_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Ces.get_alarmrules()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ces/getAlarmrules:getAlarmrules', __args__, opts=opts, typ=GetAlarmrulesResult).value
...
def get_alarmrules_output(alarm_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ces/getAlarmrules:getAlarmrules', __args__, opts=opts, typ=GetAlarmrulesResult)
