...
@pulumi.type_token("huaweicloud:Ces/notificationMask:NotificationMask")
class NotificationMask(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.ces.NotificationMask("test",
        ...
        ```sh
        $ pulumi import huaweicloud:Ces/notificationMask:NotificationMask test <relation_type>/<id>
        ```
        ...
        ```sh
        $ pulumi import huaweicloud:Ces/notificationMask:NotificationMask test <relation_type>/<relation_id>
        ```
    ...
    def _internal_init(__self__,
        ...
        super(NotificationMask, __self__).__init__(
            'huaweicloud:Ces/notificationMask:NotificationMask',
            resource_name,
            __props__,
            opts)
