...
def get_flavors(region: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: The region in which to obtain the CDM flavors.
...
def get_flavors_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cdm/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult)
