...
class GetResourceTagsResult:
    ...
    def tags(self) -> Sequence['outputs.GetResourceTagsTagResult']:
        """
        The list of tags that matched filter parameters.  
...
def get_resource_tags(region: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cts/getResourceTags:getResourceTags', __args__, opts=opts, typ=GetResourceTagsResult).value
...
def get_resource_tags_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cts/getResourceTags:getResourceTags', __args__, opts=opts, typ=GetResourceTagsResult)
