...
@pulumi.type_token("huaweicloud:Cts/notification:Notification")
class Notification(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] agency_name: Specifies the cloud service agency name. The value can only be **cts_admin_trust**.
        :param pulumi.Input[_builtins.bool] enabled: Specifies whether notification is enabled, defaults to true.
        :param pulumi.Input[Union['NotificationFilterArgs', 'NotificationFilterArgsDict']] filter: Specifies the filtering rules for notification.
               The filter structure is documented below.
