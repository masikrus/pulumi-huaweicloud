...
def get_tags(region: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cts/getTags:getTags', __args__, opts=opts, typ=GetTagsResult).value
...
def get_tags_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cts/getTags:getTags', __args__, opts=opts, typ=GetTagsResult)
