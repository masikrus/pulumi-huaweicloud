...
class TrackerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] delete_tracker: Specifies whether the tracker can be deleted.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] exclude_services: Specifies the names of the cloud services for which traces don't need to be transferred.
        ...
        :param pulumi.Input[_builtins.bool] is_sort_by_service: Specifies whether to divide the path of the trace file by cloud service.
        ...
        :param pulumi.Input[_builtins.bool] organization_enabled: Specifies whether to apply the tracker configuration to the organization.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the CTS tracker.
...
class _TrackerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] compress_type: Specifies the compression type of trace files. The value can be
               **gzip** or **json**. The default value is **gzip**.
        :param pulumi.Input[_builtins.int] create_time: The creation time of the tracker.
        :param pulumi.Input[_builtins.bool] delete_tracker: Specifies whether the tracker can be deleted.
               
               > **NOTE:** By default, resource deletion only clears parameters without removing the system tracker.
               To delete the system tracker, set `delete_tracker` to true. Note that this will disable the CTS service.
        :param pulumi.Input[_builtins.str] detail: It indicates the cause of the abnormal status.
        ...
        :param pulumi.Input[_builtins.str] file_prefix: Specifies the file name prefix to mark trace files that need to be stored
               in an OBS bucket. The value contains `0` to `64` characters. Only letters, numbers, hyphens (-), underscores (_),
               and periods (.) are allowed.
        :param pulumi.Input[_builtins.str] group_id: The LTS log group ID.
        :param pulumi.Input[_builtins.bool] is_authorized_bucket: Whether CTS has been granted permissions to perform operations on the OBS bucket.
        :param pulumi.Input[_builtins.bool] is_sort_by_service: Specifies whether to divide the path of the trace file by cloud service.
               The default value is **true**.
        :param pulumi.Input[_builtins.str] kms_id: Specifies the ID of KMS key used for trace file encryption.
        :param pulumi.Input[_builtins.str] log_group_name: The name of the log group that CTS creates in LTS.
        :param pulumi.Input[_builtins.str] log_topic_name: The name of the log topic that CTS creates in LTS.
        :param pulumi.Input[_builtins.bool] lts_enabled: Specifies whether trace analysis is enabled.
        ...
        :param pulumi.Input[_builtins.str] stream_id: The LTS log stream ID.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the CTS tracker.
...
@pulumi.type_token("huaweicloud:Cts/tracker:Tracker")
