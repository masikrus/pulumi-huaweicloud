...
def get_resources(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cts.get_resources()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cts/getResources:getResources', __args__, opts=opts, typ=GetResourcesResult).value

    return AwaitableGetResourcesResult(
        id=pulumi.get(__ret__, 'id'),
        region=pulumi.get(__ret__, 'region'),
        resources=pulumi.get(__ret__, 'resources'))
def get_resources_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cts/getResources:getResources', __args__, opts=opts, typ=GetResourcesResult)
