...
class DataTrackerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] compress_type: Specifies the compression type of trace files. The value can be **gzip**
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the CTS data tracker.
...
@pulumi.type_token("huaweicloud:Cts/dataTracker:DataTracker")
