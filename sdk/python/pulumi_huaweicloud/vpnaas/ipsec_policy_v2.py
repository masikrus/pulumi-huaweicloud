...
__all__ = ['IpsecPolicyV2Args', 'IpsecPolicyV2']

@pulumi.input_type
class IpsecPolicyV2Args:
    def __init__(__self__, *,
                 ...
                 lifetimes: Optional[pulumi.Input[Sequence[pulumi.Input['IpsecPolicyV2LifetimeArgs']]]] = None,
        ...
        """
        The set of arguments for constructing a IpsecPolicyV2 resource.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IpsecPolicyV2LifetimeArgs']]] lifetimes: The lifetime of the security association. Consists of Unit and Value.
        ...
        :param pulumi.Input[_builtins.str] transform_protocol: The transform protocol. Valid values are ESP, AH and AH-ESP. Changing this updates
    ...
    @_builtins.property
    @pulumi.getter
    def lifetimes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['IpsecPolicyV2LifetimeArgs']]]]:
        """
    ...
    @lifetimes.setter
    def lifetimes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['IpsecPolicyV2LifetimeArgs']]]]):
    ...
    def transform_protocol(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The transform protocol. Valid values are ESP, AH and AH-ESP. Changing this updates
        the existing policy. Default is ESP.
        """
...
class _IpsecPolicyV2State:
    def __init__(__self__, *,
                 ...
                 value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering IpsecPolicyV2 resources.
        :param pulumi.Input[_builtins.str] auth_algorithm: The authentication hash algorithm. Valid values are md5, sha1, sha2-256, sha2-384,
               sha2-512. Default is sha1. Changing this updates the algorithm of the existing policy.
        :param pulumi.Input[_builtins.str] description: The human-readable description for the policy. Changing this updates the description of the
               existing policy.
...
@pulumi.type_token("huaweicloud:vpnaas/ipsecPolicyV2:IpsecPolicyV2")
class IpsecPolicyV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 encapsulation_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 encryption_algorithm: Optional[pulumi.Input[_builtins.str]] = None,
                 lifetimes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IpsecPolicyV2LifetimeArgs', 'IpsecPolicyV2LifetimeArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 pfs: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 tenant_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        policy1 = huaweicloud.vpnaas.IpsecPolicyV2("policy_1", name="my_policy")
        ```
        ...
        ```sh
        $ pulumi import huaweicloud:vpnaas/ipsecPolicyV2:IpsecPolicyV2 policy_1 832cb7f3-59fe-40cf-8f64-8350ffc03272
        ```
        ...
        :param pulumi.Input[_builtins.str] encryption_algorithm: The encryption algorithm. Valid values are 3des, aes-128, aes-192 and so on. The
               default value is aes-128. Changing this updates the existing policy.
        :param pulumi.Input[Sequence[pulumi.Input[Union['IpsecPolicyV2LifetimeArgs', 'IpsecPolicyV2LifetimeArgsDict']]]] lifetimes: The lifetime of the security association. Consists of Unit and Value.
        :param pulumi.Input[_builtins.str] name: The name of the policy. Changing this updates the name of the existing policy.
        :param pulumi.Input[_builtins.str] pfs: The perfect forward secrecy mode. Valid values are Group2, Group5 and Group14. Default is Group5.
               Changing this updates the existing policy.
        :param pulumi.Input[_builtins.str] region: The region in which to create the V2 Networking client. A Networking client is needed to create
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IpsecPolicyV2Args] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a V2 IPSec policy resource within HuaweiCloud.
        ...
        :param str resource_name: The name of the resource.
        :param IpsecPolicyV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IpsecPolicyV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IpsecPolicyV2Args.__new__(IpsecPolicyV2Args)
        ...
        super(IpsecPolicyV2, __self__).__init__(
            'huaweicloud:vpnaas/ipsecPolicyV2:IpsecPolicyV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[_builtins.str]] = None,
            transform_protocol: Optional[pulumi.Input[_builtins.str]] = None,
            value_specs: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'IpsecPolicyV2':
        """
        Get an existing IpsecPolicyV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _IpsecPolicyV2State.__new__(_IpsecPolicyV2State)
        ...
        __props__.__dict__["transform_protocol"] = transform_protocol
        __props__.__dict__["value_specs"] = value_specs
        return IpsecPolicyV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def lifetimes(self) -> pulumi.Output[Sequence['outputs.IpsecPolicyV2Lifetime']]:
        """
        The lifetime of the security association. Consists of Unit and Value.
        """
        return pulumi.get(self, "lifetimes")
