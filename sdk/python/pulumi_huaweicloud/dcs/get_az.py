...
def get_az(code: Optional[_builtins.str] = None,
    ...
    az1 = huaweicloud.Dcs.get_az(code="cn-north-1a")
    ```


    :param _builtins.str code: Specifies the code of an AZ, e.g. "cn-north-1a".
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dcs/getAz:getAz', __args__, opts=opts, typ=GetAzResult).value
...
def get_az_output(code: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dcs/getAz:getAz', __args__, opts=opts, typ=GetAzResult)
