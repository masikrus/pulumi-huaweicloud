...
def get_product(region: Optional[_builtins.str] = None,
    ...
    product1 = huaweicloud.Dcs.get_product(spec_code="redis.cluster.xu1.large.r2.4")
    ```


    :param _builtins.str region: Specifies the region in which to obtain the dcs products.
           If omitted, the provider-level region will be used.
    :param _builtins.str spec_code: Specifies the DCS instance specification code. You can query the code as follows:
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dcs/getProduct:getProduct', __args__, opts=opts, typ=GetProductResult).value
...
def get_product_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dcs/getProduct:getProduct', __args__, opts=opts, typ=GetProductResult)
