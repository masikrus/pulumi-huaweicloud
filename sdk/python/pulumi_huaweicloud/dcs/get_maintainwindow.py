...
def get_maintainwindow(begin: Optional[_builtins.str] = None,
    ...
    :param _builtins.str begin: Specifies the time at which a maintenance time window starts.
    :param _builtins.bool default: Specifies whether a maintenance time window is set to the default time segment.
    :param _builtins.str end: Specifies the time at which a maintenance time window ends.
    :param _builtins.str region: The region in which to obtain the dcs maintenance windows. If omitted, the provider-level
           region will be used.
    :param _builtins.int seq: Specifies the sequential number of a maintenance time window.
    """
    __args__ = dict()
...
def get_maintainwindow_output(begin: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dcs/getMaintainwindow:getMaintainwindow', __args__, opts=opts, typ=GetMaintainwindowResult)
