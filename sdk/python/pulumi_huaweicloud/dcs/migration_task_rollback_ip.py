...
__all__ = ['MigrationTaskRollbackIpArgs', 'MigrationTaskRollbackIp']

@pulumi.input_type
class MigrationTaskRollbackIpArgs:
    ...
    def task_id(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the ID of the data migration task.
        """
...
@pulumi.input_type
class _MigrationTaskRollbackIpState:
    def __init__(__self__, *,
                 enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
...
@pulumi.type_token("huaweicloud:Dcs/migrationTaskRollbackIp:MigrationTaskRollbackIp")
class MigrationTaskRollbackIp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: MigrationTaskRollbackIpArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a DCS IP addresses exchange rollback of the source and target instances during incremental data migration
        resource within HuaweiCloud.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MigrationTaskRollbackIpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MigrationTaskRollbackIpArgs.__new__(MigrationTaskRollbackIpArgs)
        ...
        super(MigrationTaskRollbackIp, __self__).__init__(
            'huaweicloud:Dcs/migrationTaskRollbackIp:MigrationTaskRollbackIp',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            task_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'MigrationTaskRollbackIp':
        """
        Get an existing MigrationTaskRollbackIp resource's state with the given name, id, and optional extra
        ...
        __props__ = _MigrationTaskRollbackIpState.__new__(_MigrationTaskRollbackIpState)

        __props__.__dict__["enable_force_new"] = enable_force_new
        __props__.__dict__["region"] = region
        __props__.__dict__["task_id"] = task_id
        return MigrationTaskRollbackIp(resource_name, opts=opts, __props__=__props__)
