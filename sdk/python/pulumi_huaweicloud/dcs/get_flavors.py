...
class GetFlavorsResult:
    ...
    def engine(self) -> Optional[_builtins.str]:
        """
        The engine of the cache instance.
        """
...
def get_flavors(cache_mode: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance_id: The ID of the DCS instance.
...
def get_flavors_output(cache_mode: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dcs/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult)
