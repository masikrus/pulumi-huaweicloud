...
def get_product_v1(region: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dcs/getProductV1:getProductV1', __args__, opts=opts, typ=GetProductV1Result).value
...
def get_product_v1_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dcs/getProductV1:getProductV1', __args__, opts=opts, typ=GetProductV1Result)
