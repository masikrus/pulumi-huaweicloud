...
__all__ = ['ResourceAggregatorArgs', 'ResourceAggregator']

@pulumi.input_type
class ResourceAggregatorArgs:
    ...
    def account_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Specifies the source account list being aggregated.
        This parameter is only valid in **ACCOUNT** type.
        """
...
class ResourceAggregator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        source_account_list = config.require_object("sourceAccountList")
        account = huaweicloud.rms.ResourceAggregator("account",
            name=name,
            type="ACCOUNT",
            account_ids=source_account_list)
        ```
        ...
        config = pulumi.Config()
        name = config.require_object("name")
        organization = huaweicloud.rms.ResourceAggregator("organization",
            name=name,
            type="ORGANIZATION")
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceAggregatorArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceAggregatorArgs.__new__(ResourceAggregatorArgs)
