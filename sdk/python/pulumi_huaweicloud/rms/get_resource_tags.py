...
def get_resource_tags(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.rms.get_resource_tags(resource_type=resource_type)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:rms/getResourceTags:getResourceTags', __args__, opts=opts, typ=GetResourceTagsResult).value
...
def get_resource_tags_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:rms/getResourceTags:getResourceTags', __args__, opts=opts, typ=GetResourceTagsResult)
