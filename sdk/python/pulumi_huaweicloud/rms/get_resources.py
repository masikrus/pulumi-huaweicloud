...
class GetResourcesResult:
    ...
    """
    def __init__(__self__, enterprise_project_id=None, id=None, name=None, region_id=None, resource_deleted=None, resource_id=None, resources=None, tags=None, tracked=None, type=None):
    ...
    def enterprise_project_id(self) -> Optional[_builtins.str]:
        """
        The ID of enterprise project to which the resource belongs.
        """
...
def get_resources(enterprise_project_id: Optional[_builtins.str] = None,
...
def get_resources_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
