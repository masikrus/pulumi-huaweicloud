...
__all__ = [
    'GetQpsCurveResult',
    'AwaitableGetQpsCurveResult',
    'get_qps_curve',
    'get_qps_curve_output',
]

@pulumi.output_type
class GetQpsCurveResult:
    """
    A collection of values returned by getQpsCurve.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def curves(self) -> Sequence['outputs.GetQpsCurveCurveResult']:
        """
        The list of QPS curve detail.
...
class AwaitableGetQpsCurveResult(GetQpsCurveResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetQpsCurveResult(
            curves=self.curves,
...
def get_qps_curve(domains: Optional[_builtins.str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQpsCurveResult:
    """
    ...
    test = huaweicloud.AdvancedAntiDDos.get_qps_curve(value_type="mean",
        recent="today")
    ```


    :param _builtins.str domains: Specifies the domain name to query. If not specified, data for all domains will be returned.
    :param _builtins.str end_time: Specifies the end time of the query.
    :param _builtins.str overseas_type: Specifies the instance type.
           The valid values are:
           + **0**: Mainland China.
           + **1**: Outside Mainland China.
    :param _builtins.str recent: Specifies the recent time range.
           The valid values are:
           + **yesterday**
           + **today**
           + **3days**
           + **1week**
           + **1month**
    :param _builtins.str start_time: Specifies the start time of the query.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:AdvancedAntiDDos/getQpsCurve:getQpsCurve', __args__, opts=opts, typ=GetQpsCurveResult).value

    return AwaitableGetQpsCurveResult(
...
def get_qps_curve_output(domains: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetQpsCurveResult]:
    """
    Use this data source to get the list of Advanced Anti-DDoS QPS curve within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:AdvancedAntiDDos/getQpsCurve:getQpsCurve', __args__, opts=opts, typ=GetQpsCurveResult)
    return __ret__.apply(lambda __response__: GetQpsCurveResult(
