...
class ForwardRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: Specifies the ID of advanced Anti-DDoS instance.
               Changing this will create a new rule resource.
        :param pulumi.Input[_builtins.str] ip: Specifies the public IP address to which Advanced Anti-DDoS instance
               belongs. Changing this will create a new rule resource.
        :param pulumi.Input[_builtins.str] source_ip: Specifies the source IP addresses, separated by commas (,).
        :param pulumi.Input[_builtins.int] source_port: Specifies the source port.
               The valid value is range from `1` to `65,535`.
        """
...
class _ForwardRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip: Specifies the public IP address to which Advanced Anti-DDoS instance
               belongs. Changing this will create a new rule resource.
        :param pulumi.Input[_builtins.str] lb_method: The LVS forward policy.
        :param pulumi.Input[_builtins.str] rule_id: schema: Deprecated
        :param pulumi.Input[_builtins.str] source_ip: Specifies the source IP addresses, separated by commas (,).
        :param pulumi.Input[_builtins.int] source_port: Specifies the source port.
               The valid value is range from `1` to `65,535`.
        :param pulumi.Input[_builtins.int] status: The status of forward rule.
        """
...
@pulumi.type_token("huaweicloud:AdvancedAntiDDos/forwardRule:ForwardRule")
class ForwardRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_ip: Optional[pulumi.Input[_builtins.str]] = None,
            source_port: Optional[pulumi.Input[_builtins.int]] = None,
            status: Optional[pulumi.Input[_builtins.int]] = None) -> 'ForwardRule':
        """
