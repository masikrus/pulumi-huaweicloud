...
class TranscodingTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of a transcoding template.
        :param pulumi.Input[_builtins.str] region: The region in which to create the transcoding template resource. If omitted,
...
@pulumi.type_token("huaweicloud:Mpc/transcodingTemplate:TranscodingTemplate")
class TranscodingTemplate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 audio: Optional[pulumi.Input[Union['TranscodingTemplateAudioArgs', 'TranscodingTemplateAudioArgsDict']]] = None,
                 dash_segment_duration: Optional[pulumi.Input[_builtins.int]] = None,
                 hls_segment_duration: Optional[pulumi.Input[_builtins.int]] = None,
                 low_bitrate_hd: Optional[pulumi.Input[_builtins.bool]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 output_format: Optional[pulumi.Input[_builtins.int]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 video: Optional[pulumi.Input[Union['TranscodingTemplateVideoArgs', 'TranscodingTemplateVideoArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['TranscodingTemplateAudioArgs', 'TranscodingTemplateAudioArgsDict']] audio: Specifies the audio parameters. The object structure is documented below.
        :param pulumi.Input[_builtins.int] dash_segment_duration: Specifies the dash segment duration, in second.  
               The valid value is range from `2` to `10`, and it is used only when `output_format` is set to `1` or `3`.
               The default value is `5`.
        :param pulumi.Input[_builtins.int] hls_segment_duration: Specifies the HLS segment duration, in second.  
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the transcoding template resource. If omitted,
               the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[Union['TranscodingTemplateVideoArgs', 'TranscodingTemplateVideoArgsDict']] video: Specifies the video parameters. The object structure is documented below.
    ...
    def get(resource_name: str,
            ...
            output_format: Optional[pulumi.Input[_builtins.int]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            video: Optional[pulumi.Input[Union['TranscodingTemplateVideoArgs', 'TranscodingTemplateVideoArgsDict']]] = None) -> 'TranscodingTemplate':
        """
