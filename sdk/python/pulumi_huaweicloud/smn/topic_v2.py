...
@pulumi.type_token("huaweicloud:Smn/topicV2:TopicV2")
class TopicV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TopicV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TopicV2Args.__new__(TopicV2Args)
        ...
        super(TopicV2, __self__).__init__(
            'huaweicloud:Smn/topicV2:TopicV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            topic_urn: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None,
            users_publish_allowed: Optional[pulumi.Input[_builtins.str]] = None) -> 'TopicV2':
        """
        ...
        __props__ = _TopicV2State.__new__(_TopicV2State)
        ...
        __props__.__dict__["users_publish_allowed"] = users_publish_allowed
        return TopicV2(resource_name, opts=opts, __props__=__props__)
