...
def get_resources_by_tags(action: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Smn.get_resources_by_tags(resource_type=resource_type,
        action="filter")
    ```


    :param _builtins.str action: Specifies the operation to be performed. Value options:
    ...
    :param Sequence[Union['GetResourcesByTagsMatchArgs', 'GetResourcesByTagsMatchArgsDict']] matches: Specifies the key-value pair to be matched. The key can only be **resource_name**. The
    ...
    :param _builtins.str resource_type: Specifies the resource type. Value options:
           + **smn_topic**: topic
           + **smn_sms**: SMS
    ...
    :param _builtins.str without_any_tag: Specifies no tag is contained. If this parameter is set to **true**, all resources
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Smn/getResourcesByTags:getResourcesByTags', __args__, opts=opts, typ=GetResourcesByTagsResult).value
...
def get_resources_by_tags_output(action: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Smn/getResourcesByTags:getResourcesByTags', __args__, opts=opts, typ=GetResourcesByTagsResult)
