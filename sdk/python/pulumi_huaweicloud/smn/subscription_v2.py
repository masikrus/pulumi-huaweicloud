...
__all__ = ['SubscriptionV2Args', 'SubscriptionV2']

@pulumi.input_type
class SubscriptionV2Args:
    def __init__(__self__, *,
                 endpoint: pulumi.Input[_builtins.str],
                 protocol: pulumi.Input[_builtins.str],
                 topic_urn: pulumi.Input[_builtins.str],
                 extension: Optional[pulumi.Input['SubscriptionV2ExtensionArgs']] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 remark: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a SubscriptionV2 resource.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def extension(self) -> Optional[pulumi.Input['SubscriptionV2ExtensionArgs']]:
        return pulumi.get(self, "extension")

    @extension.setter
    def extension(self, value: Optional[pulumi.Input['SubscriptionV2ExtensionArgs']]):
...
@pulumi.input_type
class _SubscriptionV2State:
    def __init__(__self__, *,
                 endpoint: Optional[pulumi.Input[_builtins.str]] = None,
                 extension: Optional[pulumi.Input['SubscriptionV2ExtensionArgs']] = None,
                 filter_policies: Optional[pulumi.Input[Sequence[pulumi.Input['SubscriptionV2FilterPolicyArgs']]]] = None,
    ...
    def filter_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SubscriptionV2FilterPolicyArgs']]]]:
        """
    ...
    def filter_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SubscriptionV2FilterPolicyArgs']]]]):
...
@pulumi.type_token("huaweicloud:Smn/subscriptionV2:SubscriptionV2")
class SubscriptionV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 endpoint: Optional[pulumi.Input[_builtins.str]] = None,
                 extension: Optional[pulumi.Input[Union['SubscriptionV2ExtensionArgs', 'SubscriptionV2ExtensionArgsDict']]] = None,
                 protocol: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 remark: Optional[pulumi.Input[_builtins.str]] = None,
                 topic_urn: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SubscriptionV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SubscriptionV2Args.__new__(SubscriptionV2Args)
        ...
        super(SubscriptionV2, __self__).__init__(
            'huaweicloud:Smn/subscriptionV2:SubscriptionV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            endpoint: Optional[pulumi.Input[_builtins.str]] = None,
            extension: Optional[pulumi.Input[Union['SubscriptionV2ExtensionArgs', 'SubscriptionV2ExtensionArgsDict']]] = None,
            filter_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SubscriptionV2FilterPolicyArgs', 'SubscriptionV2FilterPolicyArgsDict']]]]] = None,
            owner: Optional[pulumi.Input[_builtins.str]] = None,
            protocol: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            remark: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.int]] = None,
            subscription_urn: Optional[pulumi.Input[_builtins.str]] = None,
            topic_urn: Optional[pulumi.Input[_builtins.str]] = None) -> 'SubscriptionV2':
        """
        Get an existing SubscriptionV2 resource's state with the given name, id, and optional extra
        properties used to qualify the lookup.

        :param str resource_name: The unique name of the resulting resource.
        :param pulumi.Input[str] id: The unique provider ID of the resource to lookup.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SubscriptionV2FilterPolicyArgs', 'SubscriptionV2FilterPolicyArgsDict']]]] filter_policies: The message filter policies of a subscriber.
        """
        opts = pulumi.ResourceOptions.merge(opts, pulumi.ResourceOptions(id=id))

        __props__ = _SubscriptionV2State.__new__(_SubscriptionV2State)
        ...
        __props__.__dict__["topic_urn"] = topic_urn
        return SubscriptionV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def extension(self) -> pulumi.Output['outputs.SubscriptionV2Extension']:
        return pulumi.get(self, "extension")

    @_builtins.property
    @pulumi.getter(name="filterPolicies")
    def filter_policies(self) -> pulumi.Output[Sequence['outputs.SubscriptionV2FilterPolicy']]:
        """
        The message filter policies of a subscriber.
        """
        return pulumi.get(self, "filter_policies")
