...
class NotebookMountStorageInitArgs:
    def __init__(__self__, *,
                 local_mount_directory: pulumi.Input[_builtins.str],
                 notebook_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] notebook_id: Specifies ID of notebook which the storage be mounted to.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] storage_path: Specifies the path of Parallel File System (PFS) or its folders in OBS.
    ...
    def local_mount_directory(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def local_mount_directory(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "local_mount_directory", value)

    @_builtins.property
    @pulumi.getter(name="notebookId")
    def notebook_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @notebook_id.setter
    def notebook_id(self, value: pulumi.Input[_builtins.str]):
...
class _NotebookMountStorageState:
    def __init__(__self__, *,
                 local_mount_directory: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] local_mount_directory: Specifies the local mount directory.
               Only the subdirectory of `/data/` can be mounted. The format is : `/data/dir1/`.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] mount_id: The mount ID.
        :param pulumi.Input[_builtins.str] notebook_id: Specifies ID of notebook which the storage be mounted to.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] region: The region in which to create the resource. If omitted, the
               provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] status: mount status. Valid values include: `MOUNTING`, `MOUNT_FAILED`, `MOUNTED`, `UNMOUNTING`,
               `UNMOUNT_FAILED`, `UNMOUNTED`.
        :param pulumi.Input[_builtins.str] storage_path: Specifies the path of Parallel File System (PFS) or its folders in OBS.
               The format is : `obs://obs-bucket/folder/`. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] type: The type of storage system.  The value is `OBSFS`.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="localMountDirectory")
    def local_mount_directory(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the local mount directory.
        Only the subdirectory of `/data/` can be mounted. The format is : `/data/dir1/`.
        Changing this parameter will create a new resource.
    ...
    @local_mount_directory.setter
    def local_mount_directory(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "local_mount_directory", value)
...
@pulumi.type_token("huaweicloud:ModelArts/notebookMountStorage:NotebookMountStorage")
class NotebookMountStorage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.modelarts.NotebookMountStorage("test",
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            storage_path: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'NotebookMountStorage':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="localMountDirectory")
    def local_mount_directory(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the local mount directory.
        Only the subdirectory of `/data/` can be mounted. The format is : `/data/dir1/`.
        Changing this parameter will create a new resource.
    ...
    @_builtins.property
    @pulumi.getter(name="notebookId")
    def notebook_id(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies ID of notebook which the storage be mounted to.
        Changing this parameter will create a new resource.
        """
