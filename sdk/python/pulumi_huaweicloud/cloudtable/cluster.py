...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 hbase_version: pulumi.Input[_builtins.str],
                 ...
                 opentsdb_num: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] hbase_version: Specifies the version of HBase datastore.
        :param pulumi.Input[_builtins.str] network_id: Specifies the ID of the network to which the cluster belongs.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] security_group_id: Specifies the security group ID of the cluster.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] storage_type: Specifies the storage type.
               The valid values are **COMMON** and **ULTRAHIGH**. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the VPC ID to which the cluster belongs.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.bool] iam_auth_enabled: Specifies whether IAM authorization is enabled.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] name: Specifies the cluster name.  
               The name consists of `4` to `64` characters, including lowercase letters, numbers and hyphens (-).
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] opentsdb_num: Specifies the TSD nodes number of the cluster.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the cluster.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] rs_num: Specifies the compute nodes number of the cluster.
    ...
    def hbase_version(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def hbase_version(self, value: pulumi.Input[_builtins.str]):
    ...
    def opentsdb_num(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @opentsdb_num.setter
    def opentsdb_num(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def rs_num(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @rs_num.setter
    def rs_num(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 ...
                 hbase_public_endpoint: Optional[pulumi.Input[_builtins.str]] = None,
                 hbase_version: Optional[pulumi.Input[_builtins.str]] = None,
                 iam_auth_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 network_id: Optional[pulumi.Input[_builtins.str]] = None,
                 open_tsdb_link: Optional[pulumi.Input[_builtins.str]] = None,
                 opentsdb_num: Optional[pulumi.Input[_builtins.int]] = None,
                 opentsdb_public_endpoint: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 rs_num: Optional[pulumi.Input[_builtins.int]] = None,
                 security_group_id: Optional[pulumi.Input[_builtins.str]] = None,
                 status: Optional[pulumi.Input[_builtins.str]] = None,
                 storage_size: Optional[pulumi.Input[_builtins.int]] = None,
                 storage_size_used: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] availability_zone: Specifies the availability zone in which to create the cluster.
               Please following [reference](https://developer.huaweicloud.com/en-us/endpoint/?CloudTable) for the values.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] created_at: The time (UTC) when the cluster was created.
        :param pulumi.Input[_builtins.str] hbase_public_endpoint: The HBase public network endpoint address.
        :param pulumi.Input[_builtins.str] hbase_version: Specifies the version of HBase datastore.
        :param pulumi.Input[_builtins.bool] iam_auth_enabled: Specifies whether IAM authorization is enabled.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] name: Specifies the cluster name.  
        ...
        :param pulumi.Input[_builtins.str] network_id: Specifies the ID of the network to which the cluster belongs.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] open_tsdb_link: The intranet OpenTSDB connection access address.
        :param pulumi.Input[_builtins.int] opentsdb_num: Specifies the TSD nodes number of the cluster.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] opentsdb_public_endpoint: The OpenTSDB public network endpoint address.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the cluster.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] rs_num: Specifies the compute nodes number of the cluster.
               The valid values must be at least `2`. Defaults to `2`.
        ...
        :param pulumi.Input[_builtins.int] storage_size: The storage size, in GB.
        :param pulumi.Input[_builtins.int] storage_size_used: The currently used storage, in GB.
        :param pulumi.Input[_builtins.str] storage_type: Specifies the storage type.
               The valid values are **COMMON** and **ULTRAHIGH**. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the VPC ID to which the cluster belongs.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] zookeeper_link: The intranet zookeeper connection access address.
        """
    ...
    def hbase_public_endpoint(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def hbase_public_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "hbase_public_endpoint", value)

    @_builtins.property
    @pulumi.getter(name="hbaseVersion")
    def hbase_version(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the version of HBase datastore.
        """
        return pulumi.get(self, "hbase_version")
    ...
    @hbase_version.setter
    def hbase_version(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "hbase_version", value)
    ...
    def open_tsdb_link(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def open_tsdb_link(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def opentsdb_public_endpoint(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def opentsdb_public_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def storage_size_used(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def storage_size_used(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def zookeeper_link(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def zookeeper_link(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "zookeeper_link", value)


@pulumi.type_token("huaweicloud:CloudTable/cluster:Cluster")
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_type: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            zookeeper_link: Optional[pulumi.Input[_builtins.str]] = None) -> 'Cluster':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="hbasePublicEndpoint")
    def hbase_public_endpoint(self) -> pulumi.Output[_builtins.str]:
        """
        The HBase public network endpoint address.
        """
        return pulumi.get(self, "hbase_public_endpoint")
    ...
    @_builtins.property
    @pulumi.getter(name="hbaseVersion")
    def hbase_version(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the version of HBase datastore.
        """
        return pulumi.get(self, "hbase_version")
    ...
    @_builtins.property
    @pulumi.getter(name="iamAuthEnabled")
    def iam_auth_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Specifies whether IAM authorization is enabled.
        Changing this parameter will create a new resource.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="openTsdbLink")
    def open_tsdb_link(self) -> pulumi.Output[_builtins.str]:
        """
        The intranet OpenTSDB connection access address.
        """
        return pulumi.get(self, "open_tsdb_link")
    ...
    @_builtins.property
    @pulumi.getter(name="opentsdbNum")
    def opentsdb_num(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the TSD nodes number of the cluster.
        Changing this parameter will create a new resource.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="opentsdbPublicEndpoint")
    def opentsdb_public_endpoint(self) -> pulumi.Output[_builtins.str]:
        """
        The OpenTSDB public network endpoint address.
        """
        return pulumi.get(self, "opentsdb_public_endpoint")
    ...
    @_builtins.property
    @pulumi.getter(name="rsNum")
    def rs_num(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the compute nodes number of the cluster.
        The valid values must be at least `2`. Defaults to `2`.
        Changing this parameter will create a new resource.
    ...
    @_builtins.property
    @pulumi.getter(name="storageSizeUsed")
    def storage_size_used(self) -> pulumi.Output[_builtins.int]:
        """
        The currently used storage, in GB.
        """
        return pulumi.get(self, "storage_size_used")
    ...
    @_builtins.property
    @pulumi.getter(name="zookeeperLink")
    def zookeeper_link(self) -> pulumi.Output[_builtins.str]:
        """
        The intranet zookeeper connection access address.
        """
        return pulumi.get(self, "zookeeper_link")
