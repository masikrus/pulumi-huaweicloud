...
class AlarmRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] evaluation_periods: Specifies the alarm checking evaluation periods.
               The value can be `1`, `2`, `3`, `4` and `5`.
        :param pulumi.Input[_builtins.str] metric_name: Specifies the alarm metric name. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] namespace: Specifies the alarm namespace. Changing this creates a new resource.
        :param pulumi.Input[_builtins.int] period: Specifies the alarm checking period in milliseconds.
               The value can be **60,000**, **300,000**, **900,000** and **3,600,000**.
        :param pulumi.Input[_builtins.str] statistic: Specifies the data rollup methods. The value can be **maximum**,
               **minimum**, **average**, **sum** and **sampleCount**. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] threshold: Specifies the alarm threshold.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] alarm_actions: Specifies the action triggered by an alarm. This is a list of strings.
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.int] alarm_level: Specifies the alarm severity. The value can be `1`, `2`, `3` or `4`,
               which indicates *critical*, *major*, *minor*, and *informational*, respectively.
               The default value is `2`.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the alarm rule.
               The value can be a string of `0` to `1,000` characters.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] insufficient_data_actions: Specifies the action triggered when the data is not enough.
               This is a list of strings. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] name: Specifies the name of an alarm rule. The value can be a string of `1` to `100`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ok_actions: Specifies the action triggered by the clearing of an alarm.
               This is a list of strings. Changing this creates a new resource.
    ...
    def name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the name of an alarm rule. The value can be a string of `1` to `100`
        characters that can consist of letters, digits, underscores (_), hyphens (-) and chinese characters,
        and it must start and end with letters, digits or chinese characters. Changing this creates a new resource.
        """
...
class _AlarmRuleState:
    def __init__(__self__, *,
                 ...
                 state_value: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] alarm_actions: Specifies the action triggered by an alarm. This is a list of strings.
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.bool] alarm_enabled: Indicates whether the alarm rule is enabled.
        :param pulumi.Input[_builtins.int] alarm_level: Specifies the alarm severity. The value can be `1`, `2`, `3` or `4`,
               which indicates *critical*, *major*, *minor*, and *informational*, respectively.
               The default value is `2`.
        :param pulumi.Input[_builtins.str] comparison_operator: Specifies the comparison condition of alarm thresholds.
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the alarm rule resource. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] state_reason: Indicates the reason of alarm status.
        :param pulumi.Input[_builtins.str] state_value: Indicates the alarm status.
        :param pulumi.Input[_builtins.str] statistic: Specifies the data rollup methods. The value can be **maximum**,
               **minimum**, **average**, **sum** and **sampleCount**. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] threshold: Specifies the alarm threshold.
        :param pulumi.Input[_builtins.str] unit: Specifies the data unit.  
    ...
    def state_value(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @state_value.setter
    def state_value(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("huaweicloud:Aom/alarmRule:AlarmRule")
class AlarmRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 comparison_operator: Optional[pulumi.Input[_builtins.str]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlarmRuleDimensionArgs', 'AlarmRuleDimensionArgsDict']]]]] = None,
                 evaluation_periods: Optional[pulumi.Input[_builtins.int]] = None,
                 insufficient_data_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 metric_name: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        alarm_rule = huaweicloud.aom.AlarmRule("alarm_rule",
            name="test-rule",
            alarm_level=3,
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description of the alarm rule.
               The value can be a string of `0` to `1,000` characters.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AlarmRuleDimensionArgs', 'AlarmRuleDimensionArgsDict']]]] dimensions: Specifies the list of metric dimensions. The structure is described below.
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.int] evaluation_periods: Specifies the alarm checking evaluation periods.
               The value can be `1`, `2`, `3`, `4` and `5`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] insufficient_data_actions: Specifies the action triggered when the data is not enough.
    ...
    def get(resource_name: str,
            ...
            statistic: Optional[pulumi.Input[_builtins.str]] = None,
            threshold: Optional[pulumi.Input[_builtins.str]] = None,
            unit: Optional[pulumi.Input[_builtins.str]] = None) -> 'AlarmRule':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="stateValue")
    def state_value(self) -> pulumi.Output[_builtins.str]:
        """
        Indicates the alarm status.
        """
        return pulumi.get(self, "state_value")
