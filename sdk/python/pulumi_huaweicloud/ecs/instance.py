...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] hostname: The hostname of the instance.
        ...
        :param pulumi.Input[_builtins.int] spot_duration: Specifies the service duration of the spot ECS in hours.  
               The valid value is range from `1` to `6`.
               This parameter takes effect only when `charging_mode` is set to *spot*.
               Changing this creates a new instance.
        :param pulumi.Input[_builtins.int] spot_duration_count: Specifies the number of time periods in the service duration.
        ...
        :param pulumi.Input[_builtins.int] system_disk_iops: Specifies the IOPS(Input/Output Operations Per Second) for the disk.
               ...
               Changing this creates a new instance.
        :param pulumi.Input[_builtins.str] system_disk_kms_key_id: Specifies the ID of a KMS key used to encrypt the system disk.
               Changing this creates a new instance.
        ...
        :param pulumi.Input[_builtins.int] system_disk_throughput: Specifies the throughput for the disk. The Unit is MiB/s.
        ...
        :param pulumi.Input[_builtins.str] user_data: Specifies the user data to be injected to the instance during the creation. Text
...
@pulumi.type_token("huaweicloud:Ecs/instance:Instance")
