...
@pulumi.type_token("huaweicloud:Ecs/floatingipV2:FloatingipV2")
class FloatingipV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FloatingipV2 resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        super(FloatingipV2, __self__).__init__(
            'huaweicloud:Ecs/floatingipV2:FloatingipV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            pool: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'FloatingipV2':
        """
