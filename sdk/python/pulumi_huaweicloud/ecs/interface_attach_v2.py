...
__all__ = ['InterfaceAttachV2Args', 'InterfaceAttachV2']
...
@pulumi.type_token("huaweicloud:Ecs/interfaceAttachV2:InterfaceAttachV2")
class InterfaceAttachV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InterfaceAttachV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            source_dest_check: Optional[pulumi.Input[_builtins.bool]] = None) -> 'InterfaceAttachV2':
        """
        Get an existing InterfaceAttachV2 resource's state with the given name, id, and optional extra
