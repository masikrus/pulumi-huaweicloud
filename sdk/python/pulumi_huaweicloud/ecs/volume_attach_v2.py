...
@pulumi.type_token("huaweicloud:Ecs/volumeAttachV2:VolumeAttachV2")
class VolumeAttachV2(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VolumeAttachV2, __self__).__init__(
            'huaweicloud:Ecs/volumeAttachV2:VolumeAttachV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            pci_address: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            volume_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'VolumeAttachV2':
        """
