...
def get_instance(enterprise_project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: The region in which to obtain the instance.
           If omitted, the provider-level region will be used.
    :param Mapping[str, _builtins.str] tags: Specifies the tags to qurey the instance.
    """
    __args__ = dict()
...
def get_instance_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ecs/getInstance:getInstance', __args__, opts=opts, typ=GetInstanceResult)
