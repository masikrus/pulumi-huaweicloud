...
__all__ = ['ServergroupV2Args', 'ServergroupV2']

@pulumi.input_type
class ServergroupV2Args:
...
@pulumi.type_token("huaweicloud:Ecs/servergroupV2:ServergroupV2")
class ServergroupV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ServergroupV2Args] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ServergroupV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServergroupV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServergroupV2Args.__new__(ServergroupV2Args)
        ...
        super(ServergroupV2, __self__).__init__(
            'huaweicloud:Ecs/servergroupV2:ServergroupV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            policies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'ServergroupV2':
        """
        Get an existing ServergroupV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _ServergroupV2State.__new__(_ServergroupV2State)
        ...
        __props__.__dict__["policies"] = policies
        __props__.__dict__["region"] = region
        return ServergroupV2(resource_name, opts=opts, __props__=__props__)
