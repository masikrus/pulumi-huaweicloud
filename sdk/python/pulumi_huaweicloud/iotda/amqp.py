...
class AmqpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the IoTDA AMQP queue resource.
...
class _AmqpState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the IoTDA AMQP queue resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] updated_at: The latest update time of the AMQP queue.
               The format is **yyyyMMdd'T'HHmmss'Z'**. e.g. **20151212T121212Z**.
        """
...
@pulumi.type_token("huaweicloud:IoTDA/amqp:Amqp")
class Amqp(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.iotda.Amqp("test", name=queue_name)
        ```
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'Amqp':
        """
