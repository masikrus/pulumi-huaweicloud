...
class DeviceLinkageRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: Specifies whether to enable the device linkage rule. Defaults to **true**.
        ...
        :param pulumi.Input[_builtins.str] trigger_logic: Specifies the logical relationship between multiple triggers.
    ...
    def trigger_logic(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def trigger_logic(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("huaweicloud:IoTDA/deviceLinkageRule:DeviceLinkageRule")
class DeviceLinkageRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 actions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DeviceLinkageRuleActionArgs', 'DeviceLinkageRuleActionArgsDict']]]]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 effective_period: Optional[pulumi.Input[Union['DeviceLinkageRuleEffectivePeriodArgs', 'DeviceLinkageRuleEffectivePeriodArgsDict']]] = None,
                 enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 space_id: Optional[pulumi.Input[_builtins.str]] = None,
                 trigger_logic: Optional[pulumi.Input[_builtins.str]] = None,
                 triggers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DeviceLinkageRuleTriggerArgs', 'DeviceLinkageRuleTriggerArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        **9bc34xxxxx.st1.iotda-app.ap-southeast-1.myhuaweicloud.com**, then you need to configure the
        ...
        topic = huaweicloud.smn.Topic("topic", name="iot-demo")
        test = huaweicloud.iotda.DeviceLinkageRule("test",
            space_id=space_id,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['DeviceLinkageRuleActionArgs', 'DeviceLinkageRuleActionArgsDict']]]] actions: Specifies the list of the actions, at most 10 actions.
               The actions structure is documented below.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the alarm.  
               The value can contain a maximum of `256` characters.
               ...
               <a name="IoTDA_effective_period"></a>
               The `effective_period` block supports:
        :param pulumi.Input[Union['DeviceLinkageRuleEffectivePeriodArgs', 'DeviceLinkageRuleEffectivePeriodArgsDict']] effective_period: Specifies the effective period of the device linkage rule. Always effectives
               by default. The effective_period structure is documented below.
        ...
        :param pulumi.Input[_builtins.str] trigger_logic: Specifies the logical relationship between multiple triggers.
               ...
               Defaults to `and`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DeviceLinkageRuleTriggerArgs', 'DeviceLinkageRuleTriggerArgsDict']]]] triggers: Specifies the list of the triggers, at most 10 triggers.
               The triggers structure is documented below.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            space_id: Optional[pulumi.Input[_builtins.str]] = None,
            trigger_logic: Optional[pulumi.Input[_builtins.str]] = None,
            triggers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DeviceLinkageRuleTriggerArgs', 'DeviceLinkageRuleTriggerArgsDict']]]]] = None) -> 'DeviceLinkageRule':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="triggerLogic")
    def trigger_logic(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the logical relationship between multiple triggers.
        The options are as follows:
        + **and**: All of the triggers are met.
