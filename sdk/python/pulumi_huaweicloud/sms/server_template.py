...
class ServerTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] flavor: Specifies the flavor ID for the target server.
        :param pulumi.Input[_builtins.str] name: Specifies the server template name.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: Specifies an array of one or more security group IDs to associate with
               the target server.
               If omitted or set to ["autoCreate"], a new security group will be created automatically during migration.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subnet_ids: Specifies an array of one or more subnet IDs to attach to the target server.
               If omitted or set to ["autoCreate"], a new subnet will be created automatically during migration.
        :param pulumi.Input[_builtins.str] target_server_name: Specifies the name of the target server. Defaults to the template name.
        :param pulumi.Input[_builtins.str] volume_type: Specifies the disk type of the target server.
               Available values are: **SAS**, **SSD**, defaults to **SAS**.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the ID of the VPC which the target server belongs to.
...
class _ServerTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the ID of the VPC which the target server belongs to.
               If omitted or set to "autoCreate", a new VPC will be created automatically during migration.
        :param pulumi.Input[_builtins.str] vpc_name: The name of the VPC which the target server belongs to.
        """
...
@pulumi.type_token("huaweicloud:Sms/serverTemplate:ServerTemplate")
class ServerTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_type: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'ServerTemplate':
        """
