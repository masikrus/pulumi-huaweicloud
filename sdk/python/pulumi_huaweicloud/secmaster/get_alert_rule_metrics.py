...
__all__ = [
    'GetAlertRuleMetricsResult',
    'AwaitableGetAlertRuleMetricsResult',
    'get_alert_rule_metrics',
    'get_alert_rule_metrics_output',
]

@pulumi.output_type
class GetAlertRuleMetricsResult:
    """
    A collection of values returned by getAlertRuleMetrics.
    """
    def __init__(__self__, id=None, metrics=None, region=None, workspace_id=None):
...
class AwaitableGetAlertRuleMetricsResult(GetAlertRuleMetricsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAlertRuleMetricsResult(
            id=self.id,
...
def get_alert_rule_metrics(region: Optional[_builtins.str] = None,
                           workspace_id: Optional[_builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAlertRuleMetricsResult:
    """
...
def get_alert_rule_metrics_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  workspace_id: Optional[pulumi.Input[_builtins.str]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAlertRuleMetricsResult]:
    """
    Use this data source to get the list of SecMaster alert rule metrics.
