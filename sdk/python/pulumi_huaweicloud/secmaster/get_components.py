...
class GetComponentsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def records(self) -> Sequence['outputs.GetComponentsRecordResult']:
        """
        The components list.
        """
...
def get_components(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Secmaster.get_components(workspace_id=workspace_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Secmaster/getComponents:getComponents', __args__, opts=opts, typ=GetComponentsResult).value
...
def get_components_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Secmaster/getComponents:getComponents', __args__, opts=opts, typ=GetComponentsResult)
