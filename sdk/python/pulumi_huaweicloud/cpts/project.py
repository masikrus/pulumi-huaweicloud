...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the project resource. If omitted, the
...
@pulumi.type_token("huaweicloud:Cpts/project:Project")
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.cpts.Project("test",
            name="project_name",
    ...
    def _internal_init(__self__,
        ...
        super(Project, __self__).__init__(
            'huaweicloud:Cpts/project:Project',
            resource_name,
            __props__,
            opts)
