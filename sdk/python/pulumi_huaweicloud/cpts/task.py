...
class TaskArgs:
    def __init__(__self__, *,
                 ...
                 benchmark_concurrency: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.int] cluster_id: Specifies a cluster ID of the CPTS resource group. If the number of concurrent users
               is less than 1000, you can use a shared resource group for testing and do not have to create a resource group.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the task, which can contain a maximum of `42` characters.
        :param pulumi.Input[_builtins.str] operation: Specifies whether to enable the task or stop the task. The options are as follows:
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the task resource. If omitted, the
    ...
    def benchmark_concurrency(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def benchmark_concurrency(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class _TaskState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the task resource. If omitted, the
               provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] status: The status of the task. The options are as follows:
...
@pulumi.type_token("huaweicloud:Cpts/task:Task")
class Task(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.cpts.Project("test", name="tf_demo_project")
        test_task = huaweicloud.cpts.Task("test",
            name="tf_demo_task",
            project_id=test.id)
        ```
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[_builtins.int]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.int]] = None) -> 'Task':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="benchmarkConcurrency")
    def benchmark_concurrency(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies benchmark concurrency of the task, the value range is `0` to
        `2,000,000`. The default value is `100`. Reference for the calculation of the number of concurrent users.
        `Number of concurrent users` = `benchmark concurrency` * `concurrency ratio`.
    ...
    @_builtins.property
    @pulumi.getter(name="clusterId")
    def cluster_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies a cluster ID of the CPTS resource group. If the number of concurrent users
        is less than 1000, you can use a shared resource group for testing and do not have to create a resource group.
        """
