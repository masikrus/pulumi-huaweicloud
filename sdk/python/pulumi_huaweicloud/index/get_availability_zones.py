...
def get_availability_zones(region: Optional[_builtins.str] = None,
    ...
    """
    ## # index_get_availability_zones

    layout: "huaweicloud"
    page_title: "HuaweiCloud: index_get_availability_zones"
    description: ""
    ...
    zones = huaweicloud.Index.get_availability_zones()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Index/getAvailabilityZones:getAvailabilityZones', __args__, opts=opts, typ=GetAvailabilityZonesResult).value
...
def get_availability_zones_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Index/getAvailabilityZones:getAvailabilityZones', __args__, opts=opts, typ=GetAvailabilityZonesResult)
