...
class SnatRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] floating_ip_id: Specifies the IDs of floating IPs connected by SNAT rule.  
               Multiple floating IPs are separated using commas (,). The number of floating IP IDs cannot exceed `20`.
        :param pulumi.Input[_builtins.str] global_eip_id: Specifies the IDs of global EIPs connected by SNAT rule.  
        ...
        :param pulumi.Input[_builtins.int] source_type: Specifies the resource scenario.  
...
@pulumi.type_token("huaweicloud:Nat/snatRule:SnatRule")
