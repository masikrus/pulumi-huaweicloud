...
__all__ = ['SnatRuleV2Args', 'SnatRuleV2']

@pulumi.input_type
class SnatRuleV2Args:
...
@pulumi.type_token("huaweicloud:Nat/snatRuleV2:SnatRuleV2")
class SnatRuleV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SnatRuleV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SnatRuleV2Args.__new__(SnatRuleV2Args)
        ...
        super(SnatRuleV2, __self__).__init__(
            'huaweicloud:Nat/snatRuleV2:SnatRuleV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            source_type: Optional[pulumi.Input[_builtins.int]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SnatRuleV2':
        """
        Get an existing SnatRuleV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _SnatRuleV2State.__new__(_SnatRuleV2State)
        ...
        __props__.__dict__["subnet_id"] = subnet_id
        return SnatRuleV2(resource_name, opts=opts, __props__=__props__)
