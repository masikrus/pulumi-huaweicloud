...
__all__ = ['DnatRuleV2Args', 'DnatRuleV2']

@pulumi.input_type
class DnatRuleV2Args:
...
@pulumi.type_token("huaweicloud:Nat/dnatRuleV2:DnatRuleV2")
class DnatRuleV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DnatRuleV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DnatRuleV2Args.__new__(DnatRuleV2Args)
        ...
        super(DnatRuleV2, __self__).__init__(
            'huaweicloud:Nat/dnatRuleV2:DnatRuleV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            protocol: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'DnatRuleV2':
        """
        Get an existing DnatRuleV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _DnatRuleV2State.__new__(_DnatRuleV2State)
        ...
        return DnatRuleV2(resource_name, opts=opts, __props__=__props__)
