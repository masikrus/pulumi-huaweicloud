...
def get_gateway(description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str description: Specifies the description of the NAT gateway. The value contains 0 to 255
           characters, and angle brackets (<)
           and (>) are not allowed.
    :param _builtins.str enterprise_project_id: Specifies the enterprise project ID of the NAT gateway.
    :param _builtins.str id: Specifies the ID of the NAT gateway.
    :param _builtins.str name: Specifies the public NAT gateway name.  
           The valid length is limited from `1` to `64`, only letters, digits, hyphens (-) and underscores (_) are allowed.
    :param _builtins.str region: Specifies the region in which to create the NAT gateway resource. If omitted, the
           provider-level region will be used.
    :param _builtins.str spec: The public NAT gateway type. The valid values are as follows:
           + **1**: Small type, which supports up to `10,000` SNAT connections.
           + **2**: Medium type, which supports up to `50,000` SNAT connections.
           + **3**: Large type, which supports up to `200,000` SNAT connections.
           + **4**: Extra-large type, which supports up to `1,000,000` SNAT connections.
    :param _builtins.str status: Specifies the status of the NAT gateway.
    :param _builtins.str subnet_id: Specifies the subnet ID of the downstream interface (the next hop of the DVR) of the
           public NAT gateway.
    :param _builtins.str vpc_id: Specifies the ID of the VPC this public NAT gateway belongs to.
    """
    __args__ = dict()
...
def get_gateway_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Nat/getGateway:getGateway', __args__, opts=opts, typ=GetGatewayResult)
