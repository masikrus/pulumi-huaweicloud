...
class DnatRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] external_service_port: Specifies port used by ECSs or BMSs to provide services for
               external systems.
        ...
        :param pulumi.Input[_builtins.str] global_eip_id: Specifies the ID of the global EIP connected by the DNAT rule.
               
               > Fields `floating_ip_id` and `global_eip_id` cannot be set or empty simultaneously.
        :param pulumi.Input[_builtins.int] internal_service_port: Specifies port used by Floating IP provide services for external
               systems.
        ...
        :param pulumi.Input[_builtins.str] internal_service_port_range: Specifies port range used by Floating IP provide services
               ...
               The valid value for range is **1~65535** and the port ranges can only be concatenated with the `-` character.
        :param pulumi.Input[_builtins.str] port_id: Specifies the port ID of network. This parameter is mandatory in VPC scenario.  
               Use Vpc.Port to get the port if just know a fixed IP addresses
               on the port.
        :param pulumi.Input[_builtins.str] private_ip: Specifies the private IP address of a user. This parameter is mandatory in
...
@pulumi.type_token("huaweicloud:Nat/dnatRule:DnatRule")
