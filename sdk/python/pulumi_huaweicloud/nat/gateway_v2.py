...
__all__ = ['GatewayV2Args', 'GatewayV2']
...
class GatewayV2Args:
    def __init__(__self__, *,
                 ...
                 session_conf: Optional[pulumi.Input['GatewayV2SessionConfArgs']] = None,
        ...
        :param pulumi.Input['GatewayV2SessionConfArgs'] session_conf: The session configuration of the NAT gateway.
        """
    ...
    def session_conf(self) -> Optional[pulumi.Input['GatewayV2SessionConfArgs']]:
        """
    ...
    @session_conf.setter
    def session_conf(self, value: Optional[pulumi.Input['GatewayV2SessionConfArgs']]):
...
@pulumi.type_token("huaweicloud:Nat/gatewayV2:GatewayV2")
class GatewayV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 period_unit: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 session_conf: Optional[pulumi.Input[Union['GatewayV2SessionConfArgs', 'GatewayV2SessionConfArgsDict']]] = None,
                 spec: Optional[pulumi.Input[_builtins.str]] = None,
                 subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] ngport_ip_address: The IP address used for the NG port of the NAT gateway.
        :param pulumi.Input[_builtins.str] region: The region where the NAT gateway is located.
        :param pulumi.Input[Union['GatewayV2SessionConfArgs', 'GatewayV2SessionConfArgsDict']] session_conf: The session configuration of the NAT gateway.
        :param pulumi.Input[_builtins.str] spec: The specification of the NAT gateway.
        :param pulumi.Input[_builtins.str] subnet_id: The network ID of the downstream interface (the next hop of the DVR) of the NAT gateway.
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC to which the NAT gateway belongs.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GatewayV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GatewayV2Args.__new__(GatewayV2Args)
        ...
        super(GatewayV2, __self__).__init__(
            'huaweicloud:Nat/gatewayV2:GatewayV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'GatewayV2':
        """
        Get an existing GatewayV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _GatewayV2State.__new__(_GatewayV2State)
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["vpc_id"] = vpc_id
        return GatewayV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="sessionConf")
    def session_conf(self) -> pulumi.Output['outputs.GatewayV2SessionConf']:
        """
        The session configuration of the NAT gateway.
        """
        return pulumi.get(self, "session_conf")
