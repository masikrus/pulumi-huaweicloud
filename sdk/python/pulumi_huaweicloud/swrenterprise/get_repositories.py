...
class GetRepositoriesResult:
    ...
    """
    def __init__(__self__, id=None, instance_id=None, namespace_id=None, order_column=None, order_type=None, region=None, repositories=None, total=None):
...
def get_repositories(instance_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.SwrEnterprise.get_repositories(instance_id=instance_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:SwrEnterprise/getRepositories:getRepositories', __args__, opts=opts, typ=GetRepositoriesResult).value
...
def get_repositories_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:SwrEnterprise/getRepositories:getRepositories', __args__, opts=opts, typ=GetRepositoriesResult)
