...
def get_flavors(engine_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str engine_version: Specifies the DB version number. Value options: **3.4**, **4.0**, **4.2** and **4.4**.
    :param _builtins.str memory: Specifies the memory size in GB.
    :param _builtins.str region: Specifies the region in which to obtain the flavors. If omitted,
...
def get_flavors_output(engine_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dds/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult)
