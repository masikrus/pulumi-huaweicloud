...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] balancer_active_begin: Specifies the start time of the balancing activity time window.
               The format is **HH:MM**. It's required with `balancer_active_end`.
        :param pulumi.Input[_builtins.str] balancer_active_end: Specifies the end time of the balancing activity time window.
        ...
        :param pulumi.Input[_builtins.str] balancer_status: Specifies the status of the balancer.
        ...
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the instance.
               ...
               Changing this creates a new instance.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] client_network_ranges: Specifies the CIDR block where the client is located. Cross-CIDR access is
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description of the DDS instance.
        ...
        :param pulumi.Input[_builtins.str] maintain_begin: Specifies begin time of the time range within which you are allowed to start a
        ...
        :param pulumi.Input[_builtins.str] maintain_end: Specifies end time of the time range within which you are allowed to start a
               task that affects the running of database instances. It must be a valid value in the format of **hh:mm** in UTC+0,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region of the DDS instance. Changing this creates a new
               instance.
        :param pulumi.Input[_builtins.str] replica_set_name: Specifies the name of the replica set in the connection address.
        ...
        :param pulumi.Input[_builtins.bool] second_level_monitoring_enabled: Specifies whether to enable second level monitoring.
        :param pulumi.Input[_builtins.str] slow_log_desensitization: Specifies whether to enable slow original log.
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InstanceDatastoreArgs'] datastore: Specifies database information. The structure is described below. Changing
               this creates a new instance.
        :param pulumi.Input[_builtins.str] db_username: Indicates the DB Administrator name.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the DDS instance.
        :param pulumi.Input[_builtins.str] disk_encryption_id: Specifies the disk encryption ID of the instance. Changing this
               creates a new instance.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project id of the DDS instance.
...
@pulumi.type_token("huaweicloud:Dds/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceFlavorArgs', 'InstanceFlavorArgsDict']]]] flavors: Specifies the flavors information. The structure is described below. Changing
               this creates a new instance.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceGroupArgs', 'InstanceGroupArgsDict']]]] groups: Indicates the instance groups information.
               The groups structure is documented below.
        :param pulumi.Input[_builtins.str] maintain_begin: Specifies begin time of the time range within which you are allowed to start a
               task that affects the running of database instances. It must be a valid value in the format of **hh:mm** in UTC+0,
               such as **02:00**, meanwhile, this time in console displays in the format of **hh:mm** in UTC+08:00, e.g. **10:00**.
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the DB instance name. The DB instance name of the same type is unique in the
               same tenant.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceNodeArgs', 'InstanceNodeArgsDict']]]] nodes: Indicates the nodes info.
               The nodes structure is documented below.
        :param pulumi.Input[_builtins.str] password: Specifies the Administrator password of the database instance.
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the instance.
               If `period_unit` is set to *month*, the value ranges from 1 to 9.
