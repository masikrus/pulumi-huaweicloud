...
class _ParameterTemplateState:
    def __init__(__self__, *,
                 ...
                 parameter_values: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['ParameterTemplateParameterArgs']]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameter_values: Specifies the mapping between parameter names and parameter values.
               You can customize parameter values based on the parameters in the default parameter template.
        :param pulumi.Input[Sequence[pulumi.Input['ParameterTemplateParameterArgs']]] parameters: Indicates the parameters defined by users based on the default parameter templates.
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ParameterTemplateParameterArgs']]]]:
        """
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ParameterTemplateParameterArgs']]]]):
...
@pulumi.type_token("huaweicloud:Dds/parameterTemplate:ParameterTemplate")
class ParameterTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dds.ParameterTemplate("test",
            name=name,
    ...
    def _internal_init(__self__,
        ...
        super(ParameterTemplate, __self__).__init__(
            'huaweicloud:Dds/parameterTemplate:ParameterTemplate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            node_version: Optional[pulumi.Input[_builtins.str]] = None,
            parameter_values: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ParameterTemplateParameterArgs', 'ParameterTemplateParameterArgsDict']]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'ParameterTemplate':
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameter_values: Specifies the mapping between parameter names and parameter values.
               You can customize parameter values based on the parameters in the default parameter template.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ParameterTemplateParameterArgs', 'ParameterTemplateParameterArgsDict']]]] parameters: Indicates the parameters defined by users based on the default parameter templates.
               The Parameter structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] updated_at: The update time of the parameter template.
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> pulumi.Output[Sequence['outputs.ParameterTemplateParameter']]:
        """
        Indicates the parameters defined by users based on the default parameter templates.
        The Parameter structure is documented below.
        """
