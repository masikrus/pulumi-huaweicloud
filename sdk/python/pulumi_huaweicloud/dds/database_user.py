...
@pulumi.type_token("huaweicloud:Dds/databaseUser:DatabaseUser")
class DatabaseUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region where the DDS instance is located.
               Changing this parameter will create a new user.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseUserRoleArgs', 'DatabaseUserRoleArgsDict']]]] roles: Specifies the list of roles owned by the current user.
               The roles structure is documented below. Changing this parameter will create a new user.
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            db_name: Optional[pulumi.Input[_builtins.str]] = None,
            inherited_privileges: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatabaseUserInheritedPrivilegeArgs', 'DatabaseUserInheritedPrivilegeArgsDict']]]]] = None,
            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            password: Optional[pulumi.Input[_builtins.str]] = None,
            privileges: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatabaseUserPrivilegeArgs', 'DatabaseUserPrivilegeArgsDict']]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatabaseUserRoleArgs', 'DatabaseUserRoleArgsDict']]]]] = None) -> 'DatabaseUser':
        """
        ...
        :param pulumi.Input[_builtins.str] db_name: Specifies the database name to which this owned role belongs.
               Changing this parameter will create a new user.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseUserInheritedPrivilegeArgs', 'DatabaseUserInheritedPrivilegeArgsDict']]]] inherited_privileges: The list of database privileges owned by the current user, includes all privileges
               inherited by owned roles. The inherited_privileges structure is documented below.
        :param pulumi.Input[_builtins.str] instance_id: Specifies the DDS instance ID to which the user belongs.
               Changing this parameter will create a new user.
        :param pulumi.Input[_builtins.str] name: Specifies the name of role owned by the current user.
        ...
        :param pulumi.Input[_builtins.str] password: Specifies the user password.
               The password content must meet the following conditions:
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseUserPrivilegeArgs', 'DatabaseUserPrivilegeArgsDict']]]] privileges: The list of database privileges owned by the current user.
               The privileges structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region where the DDS instance is located.
               Changing this parameter will create a new user.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseUserRoleArgs', 'DatabaseUserRoleArgsDict']]]] roles: Specifies the list of roles owned by the current user.
