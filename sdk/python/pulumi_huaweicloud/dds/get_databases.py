...
def get_databases(instance_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Dds.get_databases(instance_id=instance_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dds/getDatabases:getDatabases', __args__, opts=opts, typ=GetDatabasesResult).value
...
def get_databases_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dds/getDatabases:getDatabases', __args__, opts=opts, typ=GetDatabasesResult)
