...
class GetDatabaseUsersResult:
    ...
    """
    def __init__(__self__, db_name=None, id=None, instance_id=None, name=None, region=None, users=None):
    ...
    def name(self) -> Optional[_builtins.str]:
        """
        Indicates the name of role owned by the current user.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetDatabaseUsersUserResult']:
        """
...
def get_database_users(db_name: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Dds.get_database_users(instance_id=instance_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dds/getDatabaseUsers:getDatabaseUsers', __args__, opts=opts, typ=GetDatabaseUsersResult).value
...
def get_database_users_output(db_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dds/getDatabaseUsers:getDatabaseUsers', __args__, opts=opts, typ=GetDatabaseUsersResult)
