...
class GetRestoreTimeRangesResult:
    ...
    def restore_times(self) -> Sequence['outputs.GetRestoreTimeRangesRestoreTimeResult']:
        """
        Indicates the restoration time ranges.
        """
...
def get_restore_time_ranges(date: Optional[_builtins.str] = None,
    ...
    date = config.require_object("date")
    test = huaweicloud.Dds.get_restore_time_ranges(instance_id=instance_id,
        date=date)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dds/getRestoreTimeRanges:getRestoreTimeRanges', __args__, opts=opts, typ=GetRestoreTimeRangesResult).value
...
def get_restore_time_ranges_output(date: Optional[pulumi.Input[_builtins.str]] = None,
                                   instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                   region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRestoreTimeRangesResult]:
    """
    Use this data source to get the list of DDS instance restore time ranges.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dds/getRestoreTimeRanges:getRestoreTimeRanges', __args__, opts=opts, typ=GetRestoreTimeRangesResult)
    return __ret__.apply(lambda __response__: GetRestoreTimeRangesResult(
