...
class DatabaseRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region where the DDS instance is located.
               Changing this parameter will create a new role.
...
@pulumi.type_token("huaweicloud:Dds/databaseRole:DatabaseRole")
class DatabaseRole(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 roles: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRoleRoleArgs', 'DatabaseRoleRoleArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region where the DDS instance is located.
               Changing this parameter will create a new role.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRoleRoleArgs', 'DatabaseRoleRoleArgsDict']]]] roles: Specifies the list of roles owned by the current role.
               The roles structure is documented below.
               Changing this parameter will create a new role.
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            db_name: Optional[pulumi.Input[_builtins.str]] = None,
            inherited_privileges: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRoleInheritedPrivilegeArgs', 'DatabaseRoleInheritedPrivilegeArgsDict']]]]] = None,
            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            privileges: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRolePrivilegeArgs', 'DatabaseRolePrivilegeArgsDict']]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRoleRoleArgs', 'DatabaseRoleRoleArgsDict']]]]] = None) -> 'DatabaseRole':
        """
        ...
        :param pulumi.Input[_builtins.str] db_name: Specifies the database name to which this owned role belongs.
               Changing this parameter will create a new role.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRoleInheritedPrivilegeArgs', 'DatabaseRoleInheritedPrivilegeArgsDict']]]] inherited_privileges: The list of database privileges owned by the current role, includes all privileges
               inherited by owned roles. The inherited_privileges structure is documented below.
        :param pulumi.Input[_builtins.str] instance_id: Specifies the DDS instance ID to which the role belongs.
               Changing this parameter will create a new role.
        :param pulumi.Input[_builtins.str] name: Specifies the name of role owned by the current role.
               The name can contain `1` to `64` characters, only letters, digits, underscores (_), hyphens (-) and dots (.) are
               allowed. Changing this parameter will create a new role.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRolePrivilegeArgs', 'DatabaseRolePrivilegeArgsDict']]]] privileges: The list of database privileges owned by the current role.
               The privileges structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region where the DDS instance is located.
               Changing this parameter will create a new role.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRoleRoleArgs', 'DatabaseRoleRoleArgsDict']]]] roles: Specifies the list of roles owned by the current role.
