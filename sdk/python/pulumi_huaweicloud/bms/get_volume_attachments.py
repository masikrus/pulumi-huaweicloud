...
class GetVolumeAttachmentsResult:
    ...
    def server_id(self) -> _builtins.str:
        """
        Indicates the ID of the BMS that disks are attached to.
        """
    ...
    def volume_attachments(self) -> Sequence['outputs.GetVolumeAttachmentsVolumeAttachmentResult']:
        """
        Indicates disks attached to a BMS.
        """
...
def get_volume_attachments(region: Optional[_builtins.str] = None,
    ...
    demo = huaweicloud.Bms.get_volume_attachments(server_id=server_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Bms/getVolumeAttachments:getVolumeAttachments', __args__, opts=opts, typ=GetVolumeAttachmentsResult).value
...
def get_volume_attachments_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Bms/getVolumeAttachments:getVolumeAttachments', __args__, opts=opts, typ=GetVolumeAttachmentsResult)
