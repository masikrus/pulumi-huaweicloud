...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 eip_charge_mode: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] bandwidth_charge_mode: Bandwidth billing type. Available options are:
        :param pulumi.Input[_builtins.int] bandwidth_size: Bandwidth size. Changing this creates a new instance.
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the instance. Valid value is *prePaid*.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceDataDiskArgs']]] data_disks: Specifies an array of one or more data disks to attach to the instance. The
               ...
               instance.
        :param pulumi.Input[_builtins.str] eip_charge_mode: Elastic IP billing type. If the bandwidth billing mode is bandwidth,
        ...
        :param pulumi.Input[_builtins.str] eip_id: The ID of the EIP. Changing this creates a new instance.
        ...
        :param pulumi.Input[_builtins.str] name: Specifies a unique name for the instance. The name consists of 1 to 63 characters,
        ...
        :param pulumi.Input[_builtins.str] sharetype: Bandwidth sharing type. Changing this creates a new instance. Available
               options are:
               + `PER`: indicates dedicated bandwidth.
               + `WHOLE`: indicates shared bandwidth.
        :param pulumi.Input[_builtins.int] system_disk_size: Specifies the system disk size in GB. The value ranges from 40 to 1024.
               The system disk size must be greater than or equal to the minimum system disk size of the image. Changing this creates
               a new instance.
        :param pulumi.Input[_builtins.str] system_disk_type: Specifies the system disk type of the instance. For details about
               disk types, see
    ...
    def eip_charge_mode(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def eip_charge_mode(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] disk_ids: The ID of disks attached.
        :param pulumi.Input[_builtins.str] eip_charge_mode: Elastic IP billing type. If the bandwidth billing mode is bandwidth,
               both prePaid and postPaid are supported. If the bandwidth billing mode is traffic, only postPaid is supported.
               Changing this creates a new instance. Available options are:
               + `prePaid`: indicates the yearly/monthly billing mode.
...
@pulumi.type_token("huaweicloud:Bms/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the instance. Valid value is *prePaid*.
               Changing this creates a new instance.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceDataDiskArgs', 'InstanceDataDiskArgsDict']]]] data_disks: Specifies an array of one or more data disks to attach to the instance. The
               data_disks object structure is documented below. A maximum of 59 disks can be mounted. Changing this creates a new
               instance.
        :param pulumi.Input[_builtins.str] eip_charge_mode: Elastic IP billing type. If the bandwidth billing mode is bandwidth,
               both prePaid and postPaid are supported. If the bandwidth billing mode is traffic, only postPaid is supported.
        ...
        :param pulumi.Input[_builtins.str] name: Specifies a unique name for the instance. The name consists of 1 to 63 characters,
               including letters, digits, underscores (_), hyphens (-), and periods (.).
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceNicArgs', 'InstanceNicArgsDict']]]] nics: Specifies an array of one or more networks to attach to the instance. The network
               object structure is documented below.
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the instance. If `period_unit` is set to *month*
               , the value ranges from 1 to 9. If `period_unit` is set to *year*, the value is 1. This parameter is mandatory
               if `charging_mode` is set to *prePaid*. Changing this creates a new instance.
    ...
    @_builtins.property
    @pulumi.getter(name="eipChargeMode")
    def eip_charge_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Elastic IP billing type. If the bandwidth billing mode is bandwidth,
        both prePaid and postPaid are supported. If the bandwidth billing mode is traffic, only postPaid is supported.
        Changing this creates a new instance. Available options are:
