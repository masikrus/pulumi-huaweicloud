...
def get_firewalls(fw_instance_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cfw.get_firewalls(service_type=0)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cfw/getFirewalls:getFirewalls', __args__, opts=opts, typ=GetFirewallsResult).value
...
def get_firewalls_output(fw_instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getFirewalls:getFirewalls', __args__, opts=opts, typ=GetFirewallsResult)
