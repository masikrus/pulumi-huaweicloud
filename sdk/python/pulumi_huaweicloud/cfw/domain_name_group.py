...
@pulumi.type_token("huaweicloud:Cfw/domainNameGroup:DomainNameGroup")
class DomainNameGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.cfw.DomainNameGroup("test",
    ...
    def _internal_init(__self__,
        ...
        super(DomainNameGroup, __self__).__init__(
            'huaweicloud:Cfw/domainNameGroup:DomainNameGroup',
            resource_name,
            __props__,
            opts)
