...
@pulumi.type_token("huaweicloud:Cfw/serviceGroup:ServiceGroup")
class ServiceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.Cfw.get_firewalls()
        test_service_group = huaweicloud.cfw.ServiceGroup("test",
    ...
    def _internal_init(__self__,
        ...
        super(ServiceGroup, __self__).__init__(
            'huaweicloud:Cfw/serviceGroup:ServiceGroup',
            resource_name,
            __props__,
            opts)
