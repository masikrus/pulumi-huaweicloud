...
def get_domain_name_parse_ip_list_output(address_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getDomainNameParseIpList:getDomainNameParseIpList', __args__, opts=opts, typ=GetDomainNameParseIpListResult)
