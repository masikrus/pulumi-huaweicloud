...
def get_address_groups(address: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cfw.get_address_groups(object_id=object_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cfw/getAddressGroups:getAddressGroups', __args__, opts=opts, typ=GetAddressGroupsResult).value
...
def get_address_groups_output(address: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getAddressGroups:getAddressGroups', __args__, opts=opts, typ=GetAddressGroupsResult)
