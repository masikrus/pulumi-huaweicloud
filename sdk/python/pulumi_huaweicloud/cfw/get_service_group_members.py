...
def get_service_group_members(dest_port: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cfw.get_service_group_members(group_id=group_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cfw/getServiceGroupMembers:getServiceGroupMembers', __args__, opts=opts, typ=GetServiceGroupMembersResult).value
...
def get_service_group_members_output(dest_port: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getServiceGroupMembers:getServiceGroupMembers', __args__, opts=opts, typ=GetServiceGroupMembersResult)
