...
@pulumi.type_token("huaweicloud:Cfw/ipsRuleModeChange:IpsRuleModeChange")
class IpsRuleModeChange(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.cfw.IpsRuleModeChange("test",
            object_id=object_id,
            ips_ids=ips_ids,
            status=status)
        ```
    ...
    def _internal_init(__self__,
        ...
        super(IpsRuleModeChange, __self__).__init__(
            'huaweicloud:Cfw/ipsRuleModeChange:IpsRuleModeChange',
            resource_name,
            __props__,
            opts)
