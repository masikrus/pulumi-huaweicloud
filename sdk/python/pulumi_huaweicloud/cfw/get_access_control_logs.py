...
def get_access_control_logs(action: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cfw.get_access_control_logs(fw_instance_id=fw_instance_id,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cfw/getAccessControlLogs:getAccessControlLogs', __args__, opts=opts, typ=GetAccessControlLogsResult).value
...
def get_access_control_logs_output(action: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getAccessControlLogs:getAccessControlLogs', __args__, opts=opts, typ=GetAccessControlLogsResult)
