...
def get_flow_logs(app: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cfw.get_flow_logs(fw_instance_id=fw_instance_id,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cfw/getFlowLogs:getFlowLogs', __args__, opts=opts, typ=GetFlowLogsResult).value
...
def get_flow_logs_output(app: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getFlowLogs:getFlowLogs', __args__, opts=opts, typ=GetFlowLogsResult)
