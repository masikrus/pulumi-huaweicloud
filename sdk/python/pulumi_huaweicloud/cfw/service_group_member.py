...
@pulumi.type_token("huaweicloud:Cfw/serviceGroupMember:ServiceGroupMember")
class ServiceGroupMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.cfw.ServiceGroupMember("test",
            group_id=group_id,
            protocol=protocol,
    ...
    def _internal_init(__self__,
        ...
        super(ServiceGroupMember, __self__).__init__(
            'huaweicloud:Cfw/serviceGroupMember:ServiceGroupMember',
            resource_name,
            __props__,
            opts)
