...
def get_address_group_members(address: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cfw.get_address_group_members(group_id=group_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cfw/getAddressGroupMembers:getAddressGroupMembers', __args__, opts=opts, typ=GetAddressGroupMembersResult).value
...
def get_address_group_members_output(address: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getAddressGroupMembers:getAddressGroupMembers', __args__, opts=opts, typ=GetAddressGroupMembersResult)
