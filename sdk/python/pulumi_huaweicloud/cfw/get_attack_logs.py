...
def get_attack_logs(app: Optional[_builtins.str] = None,
                    attack_rule: Optional[_builtins.str] = None,
                    attack_rule_id: Optional[_builtins.str] = None,
                    attack_type: Optional[_builtins.str] = None,
    ...
    return AwaitableGetAttackLogsResult(
        ...
        attack_rule=pulumi.get(__ret__, 'attack_rule'),
        attack_rule_id=pulumi.get(__ret__, 'attack_rule_id'),
...
def get_attack_logs_output(app: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           attack_rule: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           attack_rule_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           attack_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getAttackLogs:getAttackLogs', __args__, opts=opts, typ=GetAttackLogsResult)
    return __ret__.apply(lambda __response__: GetAttackLogsResult(
        app=pulumi.get(__response__, 'app'),
        attack_rule=pulumi.get(__response__, 'attack_rule'),
        attack_rule_id=pulumi.get(__response__, 'attack_rule_id'),
