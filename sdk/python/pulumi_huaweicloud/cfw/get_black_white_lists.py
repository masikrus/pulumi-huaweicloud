...
def get_black_white_lists(address: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cfw.get_black_white_lists(object_id=object_id,
        list_type=list_type)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cfw/getBlackWhiteLists:getBlackWhiteLists', __args__, opts=opts, typ=GetBlackWhiteListsResult).value
...
def get_black_white_lists_output(address: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cfw/getBlackWhiteLists:getBlackWhiteLists', __args__, opts=opts, typ=GetBlackWhiteListsResult)
