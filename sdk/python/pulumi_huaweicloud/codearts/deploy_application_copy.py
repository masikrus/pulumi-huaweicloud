...
__all__ = ['DeployApplicationCopyArgs', 'DeployApplicationCopy']

@pulumi.input_type
class DeployApplicationCopyArgs:
    def __init__(__self__, *,
                 source_app_id: pulumi.Input[_builtins.str],
                 ...
                 operation_lists: Optional[pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyOperationListArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyOperationListArgs']]] operation_lists: Specifies the deployment orchestration list information.
        ...
        """
        pulumi.set(__self__, "source_app_id", source_app_id)
    ...
    @_builtins.property
    @pulumi.getter(name="sourceAppId")
    def source_app_id(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the source application ID.
        Changing this creates a new resource.
        """
        return pulumi.get(self, "source_app_id")

    @source_app_id.setter
    def source_app_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "source_app_id", value)
    ...
    def operation_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyOperationListArgs']]]]:
        """
    ...
    def operation_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyOperationListArgs']]]]):
...
@pulumi.input_type
class _DeployApplicationCopyState:
    def __init__(__self__, *,
                 artifact_source_system: Optional[pulumi.Input[_builtins.str]] = None,
                 artifact_type: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 operation_lists: Optional[pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyOperationListArgs']]]] = None,
                 permission_level: Optional[pulumi.Input[_builtins.str]] = None,
                 permission_matrices: Optional[pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyPermissionMatrixArgs']]]] = None,
                 project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 project_name: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 resource_pool_id: Optional[pulumi.Input[_builtins.str]] = None,
                 source_app_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] permission_level: Specifies the permission level.
               ...
               <a name="DeployApplication_operation_list"></a>
               The `operation_list` block supports:
        :param pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyPermissionMatrixArgs']]] permission_matrices: Indicates the permission matrix.
    ...
    def permission_matrices(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyPermissionMatrixArgs']]]]:
        """
    ...
    def permission_matrices(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DeployApplicationCopyPermissionMatrixArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="sourceAppId")
    def source_app_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the source application ID.
        Changing this creates a new resource.
        """
    ...
    @source_app_id.setter
    def source_app_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "source_app_id", value)
...
class DeployApplicationCopy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 is_draft: Optional[pulumi.Input[_builtins.bool]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 operation_lists: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DeployApplicationCopyOperationListArgs', 'DeployApplicationCopyOperationListArgsDict']]]]] = None,
                 permission_level: Optional[pulumi.Input[_builtins.str]] = None,
                 project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 resource_pool_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        source_app_id = config.require_object("sourceAppId")
        test = huaweicloud.codearts.DeployApplicationCopy("test", source_app_id=source_app_id)
        ```
        ...
        test = huaweicloud.codearts.DeployApplicationCopy("test",
        ...
        :param pulumi.Input[_builtins.bool] is_draft: Specifies whether the application is in draft status.
               ...
               If `operation_list` is not specified, this field can only be set to **true**.
        :param pulumi.Input[_builtins.str] name: Specifies the step name.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DeployApplicationCopyOperationListArgs', 'DeployApplicationCopyOperationListArgsDict']]]] operation_lists: Specifies the deployment orchestration list information.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DeployApplicationCopyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a CodeArts deploy application copy resource within HuaweiCloud.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DeployApplicationCopyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DeployApplicationCopyArgs.__new__(DeployApplicationCopyArgs)
            ...
            if source_app_id is None and not opts.urn:
                raise TypeError("Missing required property 'source_app_id'")
            __props__.__dict__["source_app_id"] = source_app_id
    ...
    def get(resource_name: str,
            ...
            operation_lists: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DeployApplicationCopyOperationListArgs', 'DeployApplicationCopyOperationListArgsDict']]]]] = None,
            permission_level: Optional[pulumi.Input[_builtins.str]] = None,
            permission_matrices: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DeployApplicationCopyPermissionMatrixArgs', 'DeployApplicationCopyPermissionMatrixArgsDict']]]]] = None,
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            project_name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            resource_pool_id: Optional[pulumi.Input[_builtins.str]] = None,
            ...
            task_name: Optional[pulumi.Input[_builtins.str]] = None,
            trigger_source: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'DeployApplicationCopy':
        """
        Get an existing DeployApplicationCopy resource's state with the given name, id, and optional extra
        ...
        :param pulumi.Input[_builtins.str] permission_level: Specifies the permission level.
               ...
               <a name="DeployApplication_operation_list"></a>
               The `operation_list` block supports:
        :param pulumi.Input[Sequence[pulumi.Input[Union['DeployApplicationCopyPermissionMatrixArgs', 'DeployApplicationCopyPermissionMatrixArgsDict']]]] permission_matrices: Indicates the permission matrix.
               The permission_matrix structure is documented below.
        :param pulumi.Input[_builtins.str] project_id: Specifies the project ID for CodeArts service.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] project_name: The project name.
        ...
        __props__ = _DeployApplicationCopyState.__new__(_DeployApplicationCopyState)
        ...
        return DeployApplicationCopy(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="isDisable")
    def is_disable(self) -> pulumi.Output[_builtins.bool]:
        """
        Specifies whether to disable the application. Defaults to **false**.
    ...
    @_builtins.property
    @pulumi.getter(name="operationLists")
    def operation_lists(self) -> pulumi.Output[Optional[Sequence['outputs.DeployApplicationCopyOperationList']]]:
        """
        Specifies the deployment orchestration list information.
    ...
    @_builtins.property
    @pulumi.getter(name="permissionMatrices")
    def permission_matrices(self) -> pulumi.Output[Sequence['outputs.DeployApplicationCopyPermissionMatrix']]:
        """
        Indicates the permission matrix.
        The permission_matrix structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sourceAppId")
    def source_app_id(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the source application ID.
        Changing this creates a new resource.
        """
