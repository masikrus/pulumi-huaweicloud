...
__all__ = ['InspectorHostGroupArgs', 'InspectorHostGroup']

@pulumi.input_type
class InspectorHostGroupArgs:
...
@pulumi.input_type
class _InspectorHostGroupState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[_builtins.str]] = None):
        """
...
class InspectorHostGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.codearts.InspectorHostGroup("test", name=name)
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[InspectorHostGroupArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a CodeArts inspector host group resource within HuaweiCloud.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(InspectorHostGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = InspectorHostGroupArgs.__new__(InspectorHostGroupArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None) -> 'InspectorHostGroup':
        """
        Get an existing InspectorHostGroup resource's state with the given name, id, and optional extra
        ...
        __props__ = _InspectorHostGroupState.__new__(_InspectorHostGroupState)

        __props__.__dict__["name"] = name
        return InspectorHostGroup(resource_name, opts=opts, __props__=__props__)
