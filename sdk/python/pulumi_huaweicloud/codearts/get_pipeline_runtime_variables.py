...
__all__ = [
    'GetPipelineRuntimeVariablesResult',
    'AwaitableGetPipelineRuntimeVariablesResult',
    'get_pipeline_runtime_variables',
    'get_pipeline_runtime_variables_output',
]

@pulumi.output_type
class GetPipelineRuntimeVariablesResult:
    """
    A collection of values returned by getPipelineRuntimeVariables.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def variables(self) -> Sequence['outputs.GetPipelineRuntimeVariablesVariableResult']:
        """
...
class AwaitableGetPipelineRuntimeVariablesResult(GetPipelineRuntimeVariablesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPipelineRuntimeVariablesResult(
            id=self.id,
...
def get_pipeline_runtime_variables(pipeline_id: Optional[_builtins.str] = None,
                                   project_id: Optional[_builtins.str] = None,
                                   region: Optional[_builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPipelineRuntimeVariablesResult:
    """
...
def get_pipeline_runtime_variables_output(pipeline_id: Optional[pulumi.Input[_builtins.str]] = None,
                                          project_id: Optional[pulumi.Input[_builtins.str]] = None,
                                          region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPipelineRuntimeVariablesResult]:
    """
    Use this data source to get a list of CodeArts pipeline custom parameters required for pipeline running.
