...
__all__ = [
    'GetPipelineQueueingRecordsResult',
    'AwaitableGetPipelineQueueingRecordsResult',
    'get_pipeline_queueing_records',
    'get_pipeline_queueing_records_output',
]

@pulumi.output_type
class GetPipelineQueueingRecordsResult:
    """
    A collection of values returned by getPipelineQueueingRecords.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def records(self) -> Sequence['outputs.GetPipelineQueueingRecordsRecordResult']:
        """
...
class AwaitableGetPipelineQueueingRecordsResult(GetPipelineQueueingRecordsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPipelineQueueingRecordsResult(
            id=self.id,
...
def get_pipeline_queueing_records(pipeline_id: Optional[_builtins.str] = None,
                                  project_id: Optional[_builtins.str] = None,
                                  region: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPipelineQueueingRecordsResult:
    """
...
def get_pipeline_queueing_records_output(pipeline_id: Optional[pulumi.Input[_builtins.str]] = None,
                                         project_id: Optional[pulumi.Input[_builtins.str]] = None,
                                         region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPipelineQueueingRecordsResult]:
    """
    Use this data source to get a list of CodeArts pipeline queueing records.
