...
def get_pools(description: Optional[_builtins.str] = None,
...
def get_pools_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Elb/getPools:getPools', __args__, opts=opts, typ=GetPoolsResult)
