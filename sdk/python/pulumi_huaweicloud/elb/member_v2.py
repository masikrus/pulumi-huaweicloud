...
@pulumi.type_token("huaweicloud:Elb/memberV2:MemberV2")
class MemberV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MemberV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MemberV2Args.__new__(MemberV2Args)
        ...
        super(MemberV2, __self__).__init__(
            'huaweicloud:Elb/memberV2:MemberV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[_builtins.str]] = None,
            weight: Optional[pulumi.Input[_builtins.int]] = None) -> 'MemberV2':
        """
        Get an existing MemberV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _MemberV2State.__new__(_MemberV2State)
        ...
        __props__.__dict__["tenant_id"] = tenant_id
        __props__.__dict__["weight"] = weight
        return MemberV2(resource_name, opts=opts, __props__=__props__)
