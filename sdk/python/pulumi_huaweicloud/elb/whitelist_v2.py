...
__all__ = ['WhitelistV2Args', 'WhitelistV2']

@pulumi.input_type
class WhitelistV2Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a WhitelistV2 resource.
        """
...
class _WhitelistV2State:
    def __init__(__self__, *,
                 ...
                 whitelist: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering WhitelistV2 resources.
        """
        if enable_whitelist is not None:
            pulumi.set(__self__, "enable_whitelist", enable_whitelist)
...
@pulumi.type_token("huaweicloud:Elb/whitelistV2:WhitelistV2")
class WhitelistV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WhitelistV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WhitelistV2Args.__new__(WhitelistV2Args)
        ...
        super(WhitelistV2, __self__).__init__(
            'huaweicloud:Elb/whitelistV2:WhitelistV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[_builtins.str]] = None,
            whitelist: Optional[pulumi.Input[_builtins.str]] = None) -> 'WhitelistV2':
        """
        Get an existing WhitelistV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _WhitelistV2State.__new__(_WhitelistV2State)
        ...
        __props__.__dict__["tenant_id"] = tenant_id
        __props__.__dict__["whitelist"] = whitelist
        return WhitelistV2(resource_name, opts=opts, __props__=__props__)
