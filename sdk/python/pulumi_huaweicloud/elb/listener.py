...
class ListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] protection_reason: The reason to enable modification protection. This parameter is valid only when
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the reason to enable modification protection.
               
               <a name="insert_headers_struct"></a>
               The `insert_headers` block supports:
        :param pulumi.Input[_builtins.str] tls_ciphers_policy: Specifies the security policy used by the listener. This parameter takes effect
...
@pulumi.type_token("huaweicloud:Elb/listener:Listener")
class Listener(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        listener1 = huaweicloud.elb.Listener("listener_1",
            protocol="HTTP",
            protocol_port=8080,
        ...
        :param pulumi.Input[_builtins.bool] http2_enable: Specifies whether to use HTTP/2. The default value is false. This parameter is valid
               only when the `protocol` is set to **TERMINATED_HTTPS**.
        :param pulumi.Input[Union['ListenerInsertHeadersArgs', 'ListenerInsertHeadersArgsDict']] insert_headers: Specifies whether to insert HTTP extension headers and sent them to backend servers.
               All headers are synchronized. If this parameter is not set, default values are used. Information required by backend
               servers can be written into HTTP headers and passed to backend servers. This parameter is mandatory when `protocol` is
               set to **TERMINATED_HTTPS**.
               The insert_headers structure is documented below.
