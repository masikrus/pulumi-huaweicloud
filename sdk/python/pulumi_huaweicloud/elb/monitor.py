...
class MonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] port: Specifies the health check port. The port number ranges from `1` to `65,535`. If not specified,
...
@pulumi.type_token("huaweicloud:Elb/monitor:Monitor")
class Monitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        monitor_tcp = huaweicloud.elb.Monitor("monitor_tcp",
            pool_id=pool_id,
            type="TCP",
            delay=5,
            timeout=3,
        ...
        monitor_udp = huaweicloud.elb.Monitor("monitor_udp",
            pool_id=pool_id,
            type="UDP_CONNECT",
            delay=5,
            timeout=3,
        ...
        monitor_http = huaweicloud.elb.Monitor("monitor_http",
            pool_id=pool_id,
            type="HTTP",
            delay=5,
            timeout=3,
