...
class PoolV2Args:
    def __init__(__self__, *,
                 ...
                 persistences: Optional[pulumi.Input[Sequence[pulumi.Input['PoolV2PersistenceArgs']]]] = None,
        ...
        """
        The set of arguments for constructing a PoolV2 resource.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def persistences(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['PoolV2PersistenceArgs']]]]:
        return pulumi.get(self, "persistences")

    @persistences.setter
    def persistences(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['PoolV2PersistenceArgs']]]]):
...
class _PoolV2State:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering PoolV2 resources.
        """
        if admin_state_up is not None:
            warnings.warn("""this field is deprecated""", DeprecationWarning)
            pulumi.log.warn("""admin_state_up is deprecated: this field is deprecated""")
...
@pulumi.type_token("huaweicloud:Elb/poolV2:PoolV2")
class PoolV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 loadbalancer_id: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 persistences: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PoolV2PersistenceArgs', 'PoolV2PersistenceArgsDict']]]]] = None,
                 protection_reason: Optional[pulumi.Input[_builtins.str]] = None,
                 protection_status: Optional[pulumi.Input[_builtins.str]] = None,
                 protocol: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PoolV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PoolV2Args.__new__(PoolV2Args)
        ...
        super(PoolV2, __self__).__init__(
            'huaweicloud:Elb/poolV2:PoolV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            protocol: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'PoolV2':
        """
        Get an existing PoolV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _PoolV2State.__new__(_PoolV2State)
        ...
        __props__.__dict__["region"] = region
        __props__.__dict__["tenant_id"] = tenant_id
        return PoolV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def persistences(self) -> pulumi.Output[Optional[Sequence['outputs.PoolV2Persistence']]]:
        return pulumi.get(self, "persistences")
