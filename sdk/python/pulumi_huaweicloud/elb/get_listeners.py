...
def get_listeners(client_ca_tls_container_ref: Optional[_builtins.str] = None,
    ...
    :param _builtins.str http2_enable: Whether the ELB listener uses HTTP/2. Value options: **true**, **false**.
    :param _builtins.str listener_id: ID of the listener.
    :param _builtins.str loadbalancer_id: The ID of the load balancer that the listener is added to.
...
def get_listeners_output(client_ca_tls_container_ref: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Elb/getListeners:getListeners', __args__, opts=opts, typ=GetListenersResult)
