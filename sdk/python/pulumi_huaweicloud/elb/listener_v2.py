...
__all__ = ['ListenerV2Args', 'ListenerV2']

@pulumi.input_type
class ListenerV2Args:
    def __init__(__self__, *,
                 ...
                 insert_headers: Optional[pulumi.Input['ListenerV2InsertHeadersArgs']] = None,
        ...
        """
        The set of arguments for constructing a ListenerV2 resource.
        """
    ...
    def insert_headers(self) -> Optional[pulumi.Input['ListenerV2InsertHeadersArgs']]:
        return pulumi.get(self, "insert_headers")

    @insert_headers.setter
    def insert_headers(self, value: Optional[pulumi.Input['ListenerV2InsertHeadersArgs']]):
...
class _ListenerV2State:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering ListenerV2 resources.
        """
        if admin_state_up is not None:
            warnings.warn("""admin_state_up is deprecated""", DeprecationWarning)
            pulumi.log.warn("""admin_state_up is deprecated: admin_state_up is deprecated""")
...
@pulumi.type_token("huaweicloud:Elb/listenerV2:ListenerV2")
class ListenerV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 http2_enable: Optional[pulumi.Input[_builtins.bool]] = None,
                 insert_headers: Optional[pulumi.Input[Union['ListenerV2InsertHeadersArgs', 'ListenerV2InsertHeadersArgsDict']]] = None,
                 loadbalancer_id: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 protection_reason: Optional[pulumi.Input[_builtins.str]] = None,
                 protection_status: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 __props__=None):
        """
        Create a ListenerV2 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a ListenerV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ListenerV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ListenerV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ListenerV2Args.__new__(ListenerV2Args)
        ...
        super(ListenerV2, __self__).__init__(
            'huaweicloud:Elb/listenerV2:ListenerV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[_builtins.str]] = None,
            tls_ciphers_policy: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'ListenerV2':
        """
        Get an existing ListenerV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _ListenerV2State.__new__(_ListenerV2State)
        ...
        return ListenerV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="insertHeaders")
    def insert_headers(self) -> pulumi.Output['outputs.ListenerV2InsertHeaders']:
        return pulumi.get(self, "insert_headers")
