...
__all__ = ['MonitorV2Args', 'MonitorV2']
...
class MonitorV2Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a MonitorV2 resource.
        """
...
class _MonitorV2State:
    def __init__(__self__, *,
                 ...
                 url_path: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering MonitorV2 resources.
        """
        if admin_state_up is not None:
            warnings.warn("""tenant_id is deprecated""", DeprecationWarning)
            pulumi.log.warn("""admin_state_up is deprecated: tenant_id is deprecated""")
...
@pulumi.type_token("huaweicloud:Elb/monitorV2:MonitorV2")
class MonitorV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a MonitorV2 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a MonitorV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param MonitorV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MonitorV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MonitorV2Args.__new__(MonitorV2Args)
        ...
        super(MonitorV2, __self__).__init__(
            'huaweicloud:Elb/monitorV2:MonitorV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            timeout: Optional[pulumi.Input[_builtins.int]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            url_path: Optional[pulumi.Input[_builtins.str]] = None) -> 'MonitorV2':
        """
        Get an existing MonitorV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _MonitorV2State.__new__(_MonitorV2State)
        ...
        __props__.__dict__["type"] = type
        __props__.__dict__["url_path"] = url_path
        return MonitorV2(resource_name, opts=opts, __props__=__props__)
