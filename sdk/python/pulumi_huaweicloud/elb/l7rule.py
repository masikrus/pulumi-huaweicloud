...
@pulumi.type_token("huaweicloud:Elb/l7rule:L7rule")
class L7rule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        loadbalancer1 = huaweicloud.elb.Loadbalancer("loadbalancer_1",
            name="loadbalancer_1",
        ...
        pool1 = huaweicloud.elb.Pool("pool_1",
            name="pool_1",
            protocol="HTTP",
            lb_method="ROUND_ROBIN",
            loadbalancer_id=loadbalancer1.id)
        l7policy1 = huaweicloud.elb.L7policy("l7policy_1",
            name="test",
        ...
        l7rule1 = huaweicloud.elb.L7rule("l7rule_1",
