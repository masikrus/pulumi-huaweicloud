...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project ID of the certificate. Changing this
        ...
        :param pulumi.Input[_builtins.str] protection_reason: Specifies why the modification protection is enabled.
        :param pulumi.Input[_builtins.str] protection_status: Specifies the protection status. Value options:
        ...
        :param pulumi.Input[_builtins.str] source: Specifies the source of the certificate.
...
@pulumi.type_token("huaweicloud:Elb/certificate:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        certificate1 = huaweicloud.elb.Certificate("certificate_1",
            name="certificate_1",
