...
__all__ = ['ConnectionHealthCheckArgs', 'ConnectionHealthCheck']

@pulumi.input_type
class ConnectionHealthCheckArgs:
...
@pulumi.input_type
class _ConnectionHealthCheckState:
    def __init__(__self__, *,
...
class ConnectionHealthCheck(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.vpn.ConnectionHealthCheck("test", connection_id=connection_id)
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ConnectionHealthCheckArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a VPN connection health check resource within HuaweiCloud.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ConnectionHealthCheckArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ConnectionHealthCheckArgs.__new__(ConnectionHealthCheckArgs)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            source_ip: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'ConnectionHealthCheck':
        """
        Get an existing ConnectionHealthCheck resource's state with the given name, id, and optional extra
        ...
        __props__ = _ConnectionHealthCheckState.__new__(_ConnectionHealthCheckState)
        ...
        return ConnectionHealthCheck(resource_name, opts=opts, __props__=__props__)
