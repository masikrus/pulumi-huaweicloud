...
__all__ = [
    'GetGatewayAvailabilityZonesResult',
    'AwaitableGetGatewayAvailabilityZonesResult',
    'get_gateway_availability_zones',
    'get_gateway_availability_zones_output',
]

@pulumi.output_type
class GetGatewayAvailabilityZonesResult:
    """
    A collection of values returned by getGatewayAvailabilityZones.
    """
...
class AwaitableGetGatewayAvailabilityZonesResult(GetGatewayAvailabilityZonesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayAvailabilityZonesResult(
...
def get_gateway_availability_zones(attachment_type: Optional[_builtins.str] = None,
                                   flavor: Optional[_builtins.str] = None,
                                   region: Optional[_builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayAvailabilityZonesResult:
    """
...
def get_gateway_availability_zones_output(attachment_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          flavor: Optional[pulumi.Input[_builtins.str]] = None,
                                          region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGatewayAvailabilityZonesResult]:
    """
    Use this data source to get the list of VPN gateway availability zones.
