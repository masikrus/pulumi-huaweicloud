...
class GatewayArgs:
    def __init__(__self__, *,
                 ...
                 certificate: Optional[pulumi.Input['GatewayCertificateArgs']] = None,
                 ...
                 eip1: Optional[pulumi.Input['GatewayEip1Args']] = None,
                 eip2: Optional[pulumi.Input['GatewayEip2Args']] = None,
                 ...
                 master_eip: Optional[pulumi.Input['GatewayMasterEipArgs']] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 network_type: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 slave_eip: Optional[pulumi.Input['GatewaySlaveEipArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] access_vpc_id: The access VPC ID.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] asn: The ASN number of BGP. The value ranges from `1` to `4,294,967,295`.
               Defaults to `64,512`.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] attachment_type: The attachment type. The value can be **vpc** or **er**.
               Defaults to **vpc**.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input['GatewayCertificateArgs'] certificate: The GM certificate of the **GM** flavor gateway.
        ...
        :param pulumi.Input['GatewayEip1Args'] eip1: The master 1 IP in active-active VPN gateway or the master IP
               in active-standby VPN gateway. This parameter is mandatory when `network_type` is **public** or left empty.
               The object structure is documented below.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input['GatewayEip2Args'] eip2: The master 2 IP in active-active VPN gateway or the slave IP
               in active-standby VPN gateway. This parameter is mandatory when `network_type` is **public** or left empty.
               The object structure is documented below.
        ...
        :param pulumi.Input[_builtins.str] network_type: The network type. The value can be **public** or **private**.
               Defaults to **public**.
    ...
    def attachment_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The attachment type. The value can be **vpc** or **er**.
        Defaults to **vpc**.
    ...
    @_builtins.property
    @pulumi.getter
    def certificate(self) -> Optional[pulumi.Input['GatewayCertificateArgs']]:
        """
    ...
    @certificate.setter
    def certificate(self, value: Optional[pulumi.Input['GatewayCertificateArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def eip1(self) -> Optional[pulumi.Input['GatewayEip1Args']]:
        """
    ...
    @eip1.setter
    def eip1(self, value: Optional[pulumi.Input['GatewayEip1Args']]):
        pulumi.set(self, "eip1", value)

    @_builtins.property
    @pulumi.getter
    def eip2(self) -> Optional[pulumi.Input['GatewayEip2Args']]:
        """
    ...
    @eip2.setter
    def eip2(self, value: Optional[pulumi.Input['GatewayEip2Args']]):
    ...
    def master_eip(self) -> Optional[pulumi.Input['GatewayMasterEipArgs']]:
        return pulumi.get(self, "master_eip")

    @master_eip.setter
    def master_eip(self, value: Optional[pulumi.Input['GatewayMasterEipArgs']]):
    ...
    def network_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The network type. The value can be **public** or **private**.
        Defaults to **public**.
    ...
    def slave_eip(self) -> Optional[pulumi.Input['GatewaySlaveEipArgs']]:
        return pulumi.get(self, "slave_eip")

    @slave_eip.setter
    def slave_eip(self, value: Optional[pulumi.Input['GatewaySlaveEipArgs']]):
...
class Gateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 attachment_type: Optional[pulumi.Input[_builtins.str]] = None,
                 availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 certificate: Optional[pulumi.Input[Union['GatewayCertificateArgs', 'GatewayCertificateArgsDict']]] = None,
                 connect_subnet: Optional[pulumi.Input[_builtins.str]] = None,
                 delete_eip_on_termination: Optional[pulumi.Input[_builtins.bool]] = None,
                 eip1: Optional[pulumi.Input[Union['GatewayEip1Args', 'GatewayEip1ArgsDict']]] = None,
                 eip2: Optional[pulumi.Input[Union['GatewayEip2Args', 'GatewayEip2ArgsDict']]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 er_id: Optional[pulumi.Input[_builtins.str]] = None,
                 flavor: Optional[pulumi.Input[_builtins.str]] = None,
                 ha_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 local_subnets: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 master_eip: Optional[pulumi.Input[Union['GatewayMasterEipArgs', 'GatewayMasterEipArgsDict']]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 network_type: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 slave_eip: Optional[pulumi.Input[Union['GatewaySlaveEipArgs', 'GatewaySlaveEipArgsDict']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] availability_zones: The list of availability zone IDs.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[Union['GatewayCertificateArgs', 'GatewayCertificateArgsDict']] certificate: The GM certificate of the **GM** flavor gateway.
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] connect_subnet: The Network ID of the VPC subnet used by the VPN gateway.
               This parameter is mandatory when `attachment_type` is **vpc**.
        ...
        :param pulumi.Input[_builtins.bool] delete_eip_on_termination: Whether to delete the EIP when the VPN gateway is deleted.
               ...
               <a name="Gateway_CreateRequestEip"></a>
               The `eip1` or `eip2` block supports:
        :param pulumi.Input[Union['GatewayEip1Args', 'GatewayEip1ArgsDict']] eip1: The master 1 IP in active-active VPN gateway or the master IP
               in active-standby VPN gateway. This parameter is mandatory when `network_type` is **public** or left empty.
               The object structure is documented below.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input[Union['GatewayEip2Args', 'GatewayEip2ArgsDict']] eip2: The master 2 IP in active-active VPN gateway or the slave IP
               in active-standby VPN gateway. This parameter is mandatory when `network_type` is **public** or left empty.
               The object structure is documented below.
    ...
    @_builtins.property
    @pulumi.getter
    def certificate(self) -> pulumi.Output['outputs.GatewayCertificate']:
        """
        The GM certificate of the **GM** flavor gateway.
        The object structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def eip1(self) -> pulumi.Output['outputs.GatewayEip1']:
        """
        The master 1 IP in active-active VPN gateway or the master IP
        in active-standby VPN gateway. This parameter is mandatory when `network_type` is **public** or left empty.
        The object structure is documented below.
    ...
    @_builtins.property
    @pulumi.getter
    def eip2(self) -> pulumi.Output['outputs.GatewayEip2']:
        """
        The master 2 IP in active-active VPN gateway or the slave IP
        in active-standby VPN gateway. This parameter is mandatory when `network_type` is **public** or left empty.
        The object structure is documented below.
    ...
    @_builtins.property
    @pulumi.getter(name="masterEip")
    def master_eip(self) -> pulumi.Output['outputs.GatewayMasterEip']:
        return pulumi.get(self, "master_eip")
    ...
    @_builtins.property
    @pulumi.getter(name="slaveEip")
    def slave_eip(self) -> pulumi.Output['outputs.GatewaySlaveEip']:
        return pulumi.get(self, "slave_eip")
