...
class ConnectionArgs:
    def __init__(__self__, *,
                 ...
                 ikepolicy: Optional[pulumi.Input['ConnectionIkepolicyArgs']] = None,
                 ipsecpolicy: Optional[pulumi.Input['ConnectionIpsecpolicyArgs']] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 peer_subnets: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 policy_rules: Optional[pulumi.Input[Sequence[pulumi.Input['ConnectionPolicyRuleArgs']]]] = None,
        ...
        :param pulumi.Input['ConnectionIkepolicyArgs'] ikepolicy: The IKE policy configurations.
               The ikepolicy structure is documented below.
        :param pulumi.Input['ConnectionIpsecpolicyArgs'] ipsecpolicy: The IPsec policy configurations.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ConnectionPolicyRuleArgs']]] policy_rules: The policy rules. Only works when vpn_type is set to **policy**
    ...
    @_builtins.property
    @pulumi.getter
    def ikepolicy(self) -> Optional[pulumi.Input['ConnectionIkepolicyArgs']]:
        """
    ...
    @ikepolicy.setter
    def ikepolicy(self, value: Optional[pulumi.Input['ConnectionIkepolicyArgs']]):
        pulumi.set(self, "ikepolicy", value)

    @_builtins.property
    @pulumi.getter
    def ipsecpolicy(self) -> Optional[pulumi.Input['ConnectionIpsecpolicyArgs']]:
        """
    ...
    @ipsecpolicy.setter
    def ipsecpolicy(self, value: Optional[pulumi.Input['ConnectionIpsecpolicyArgs']]):
    ...
    def policy_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ConnectionPolicyRuleArgs']]]]:
        """
    ...
    @policy_rules.setter
    def policy_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ConnectionPolicyRuleArgs']]]]):
...
class Connection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 gateway_ip: Optional[pulumi.Input[_builtins.str]] = None,
                 ha_role: Optional[pulumi.Input[_builtins.str]] = None,
                 ikepolicy: Optional[pulumi.Input[Union['ConnectionIkepolicyArgs', 'ConnectionIkepolicyArgsDict']]] = None,
                 ipsecpolicy: Optional[pulumi.Input[Union['ConnectionIpsecpolicyArgs', 'ConnectionIpsecpolicyArgsDict']]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 peer_subnets: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 policy_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ConnectionPolicyRuleArgs', 'ConnectionPolicyRuleArgsDict']]]]] = None,
                 psk: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 tunnel_local_address: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        test = huaweicloud.vpn.Connection("test",
            name=name,
        ...
        :param pulumi.Input[_builtins.str] ha_role: Specifies the mode of the VPN connection.
               ...
               <a name="Connection_CreateRequestIkePolicy"></a>
               The `ikepolicy` block supports:
        :param pulumi.Input[Union['ConnectionIkepolicyArgs', 'ConnectionIkepolicyArgsDict']] ikepolicy: The IKE policy configurations.
               The ikepolicy structure is documented below.
        :param pulumi.Input[Union['ConnectionIpsecpolicyArgs', 'ConnectionIpsecpolicyArgsDict']] ipsecpolicy: The IPsec policy configurations.
               The ipsecpolicy structure is documented below.
        :param pulumi.Input[_builtins.str] name: The name of the VPN connection.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] peer_subnets: The CIDR list of customer subnets. This parameter must be empty
               when the `attachment_type` of the VPN gateway is set to **er** and `vpn_type` is set to **policy** or **bgp**.
               This parameter is mandatory in other scenarios.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ConnectionPolicyRuleArgs', 'ConnectionPolicyRuleArgsDict']]]] policy_rules: The policy rules. Only works when vpn_type is set to **policy**
               The policy_rules structure is documented below.
        :param pulumi.Input[_builtins.str] psk: The pre-shared key.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
    ...
    def get(resource_name: str,
            ...
            tunnel_peer_address: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            vpn_type: Optional[pulumi.Input[_builtins.str]] = None) -> 'Connection':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def ikepolicy(self) -> pulumi.Output['outputs.ConnectionIkepolicy']:
        """
        The IKE policy configurations.
        The ikepolicy structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def ipsecpolicy(self) -> pulumi.Output['outputs.ConnectionIpsecpolicy']:
        """
        The IPsec policy configurations.
        The ipsecpolicy structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="policyRules")
    def policy_rules(self) -> pulumi.Output[Sequence['outputs.ConnectionPolicyRule']]:
        """
        The policy rules. Only works when vpn_type is set to **policy**
        The policy_rules structure is documented below.
        """
