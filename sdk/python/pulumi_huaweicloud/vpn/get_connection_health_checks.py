...
__all__ = [
    'GetConnectionHealthChecksResult',
    'AwaitableGetConnectionHealthChecksResult',
    'get_connection_health_checks',
    'get_connection_health_checks_output',
]

@pulumi.output_type
class GetConnectionHealthChecksResult:
    """
    A collection of values returned by getConnectionHealthChecks.
    """
    ...
    def connection_health_checks(self) -> Sequence['outputs.GetConnectionHealthChecksConnectionHealthCheckResult']:
        """
...
class AwaitableGetConnectionHealthChecksResult(GetConnectionHealthChecksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetConnectionHealthChecksResult(
...
def get_connection_health_checks(connection_id: Optional[_builtins.str] = None,
                                 destination_ip: Optional[_builtins.str] = None,
                                 region: Optional[_builtins.str] = None,
                                 source_ip: Optional[_builtins.str] = None,
                                 status: Optional[_builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectionHealthChecksResult:
    """
...
def get_connection_health_checks_output(connection_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetConnectionHealthChecksResult]:
    """
    Manages a VPN connection health checks data source within HuaweiCloud.
