...
class MysqlDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: Specifies the ID of the GaussDB MySQL instance.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] description: Specifies the database remarks. The value can consist of up to 512 characters,
               and cannot contain the carriage return characters or special characters (!<"='>&).
        :param pulumi.Input[_builtins.str] name: Specifies the database name. The name can contain 1 to 64 characters.
    ...
    def description(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the database remarks. The value can consist of up to 512 characters,
        and cannot contain the carriage return characters or special characters (!<"='>&).
        """
    ...
    def name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the database name. The name can contain 1 to 64 characters.
        Only letters, digits, hyphens (-), and underscores (_) are allowed. The total number of hyphens (-) cannot exceed 10.
...
@pulumi.type_token("huaweicloud:GaussDB/mysqlDatabase:MysqlDatabase")
class MysqlDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        character_set = config.require_object("characterSet")
        test = huaweicloud.gaussdb.MysqlDatabase("test",
    ...
    def _internal_init(__self__,
        ...
        super(MysqlDatabase, __self__).__init__(
            'huaweicloud:GaussDB/mysqlDatabase:MysqlDatabase',
            resource_name,
            __props__,
            opts)
