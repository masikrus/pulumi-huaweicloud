...
def get_mysql_configurations(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.GaussDB.get_mysql_configurations()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:GaussDB/getMysqlConfigurations:getMysqlConfigurations', __args__, opts=opts, typ=GetMysqlConfigurationsResult).value

    return AwaitableGetMysqlConfigurationsResult(
        configurations=pulumi.get(__ret__, 'configurations'),
        id=pulumi.get(__ret__, 'id'),
        region=pulumi.get(__ret__, 'region'))
def get_mysql_configurations_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:GaussDB/getMysqlConfigurations:getMysqlConfigurations', __args__, opts=opts, typ=GetMysqlConfigurationsResult)
