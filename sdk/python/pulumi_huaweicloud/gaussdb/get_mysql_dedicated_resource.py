...
def get_mysql_dedicated_resource(region: Optional[_builtins.str] = None,
...
def get_mysql_dedicated_resource_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                        resource_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMysqlDedicatedResourceResult]:
    """
    Use this data source to get available HuaweiCloud gaussdb mysql dedicated resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:GaussDB/getMysqlDedicatedResource:getMysqlDedicatedResource', __args__, opts=opts, typ=GetMysqlDedicatedResourceResult)
    return __ret__.apply(lambda __response__: GetMysqlDedicatedResourceResult(
