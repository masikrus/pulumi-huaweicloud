...
__all__ = ['MysqlParameterTemplateCompareArgs', 'MysqlParameterTemplateCompare']

@pulumi.input_type
class MysqlParameterTemplateCompareArgs:
    def __init__(__self__, *,
                 source_configuration_id: pulumi.Input[_builtins.str],
                 target_configuration_id: pulumi.Input[_builtins.str],
                 region: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a MysqlParameterTemplateCompare resource.
...
@pulumi.input_type
class _MysqlParameterTemplateCompareState:
    def __init__(__self__, *,
                 differences: Optional[pulumi.Input[Sequence[pulumi.Input['MysqlParameterTemplateCompareDifferenceArgs']]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        """
        Input properties used for looking up and filtering MysqlParameterTemplateCompare resources.
        :param pulumi.Input[Sequence[pulumi.Input['MysqlParameterTemplateCompareDifferenceArgs']]] differences: Indicates the differences between parameters.
    ...
    @_builtins.property
    @pulumi.getter
    def differences(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MysqlParameterTemplateCompareDifferenceArgs']]]]:
        """
    ...
    @differences.setter
    def differences(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MysqlParameterTemplateCompareDifferenceArgs']]]]):
...
@pulumi.type_token("huaweicloud:GaussDB/mysqlParameterTemplateCompare:MysqlParameterTemplateCompare")
class MysqlParameterTemplateCompare(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.gaussdb.MysqlParameterTemplateCompare("test",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: MysqlParameterTemplateCompareArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a GaussDB MySQL parameter template compare resource within HuaweiCloud.
        ...
        :param str resource_name: The name of the resource.
        :param MysqlParameterTemplateCompareArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MysqlParameterTemplateCompareArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MysqlParameterTemplateCompareArgs.__new__(MysqlParameterTemplateCompareArgs)
        ...
        super(MysqlParameterTemplateCompare, __self__).__init__(
            'huaweicloud:GaussDB/mysqlParameterTemplateCompare:MysqlParameterTemplateCompare',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            differences: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MysqlParameterTemplateCompareDifferenceArgs', 'MysqlParameterTemplateCompareDifferenceArgsDict']]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            source_configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
            target_configuration_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'MysqlParameterTemplateCompare':
        """
        Get an existing MysqlParameterTemplateCompare resource's state with the given name, id, and optional extra
        properties used to qualify the lookup.

        :param str resource_name: The unique name of the resulting resource.
        :param pulumi.Input[str] id: The unique provider ID of the resource to lookup.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MysqlParameterTemplateCompareDifferenceArgs', 'MysqlParameterTemplateCompareDifferenceArgsDict']]]] differences: Indicates the differences between parameters.
               The differences structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] source_configuration_id: Specifies the ID of the source parameter template to be
        ...
        __props__ = _MysqlParameterTemplateCompareState.__new__(_MysqlParameterTemplateCompareState)

        __props__.__dict__["differences"] = differences
        __props__.__dict__["region"] = region
        __props__.__dict__["source_configuration_id"] = source_configuration_id
        __props__.__dict__["target_configuration_id"] = target_configuration_id
        return MysqlParameterTemplateCompare(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def differences(self) -> pulumi.Output[Sequence['outputs.MysqlParameterTemplateCompareDifference']]:
        """
        Indicates the differences between parameters.
        The differences structure is documented below.
        """
