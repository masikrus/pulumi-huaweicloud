...
class TranscodingArgs:
    def __init__(__self__, *,
                 ...
                 video_encoding: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] video_encoding: Specifies the video codec. The valid values are **H264** and **H265**.
        :param pulumi.Input[_builtins.bool] low_bitrate_hd: Specifies whether to enable low bitrate HD rates. If enabled
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create this resource.
               If omitted, the provider-level region will be used.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] trans_type: Specifies the transcoding stream trigger mode.
    ...
    def video_encoding(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def video_encoding(self, value: pulumi.Input[_builtins.str]):
    ...
    def trans_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @trans_type.setter
    def trans_type(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _TranscodingState:
    ...
    @_builtins.property
    @pulumi.getter(name="videoEncoding")
    def video_encoding(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the video codec. The valid values are **H264** and **H265**.
        """
        return pulumi.get(self, "video_encoding")
    ...
    @video_encoding.setter
    def video_encoding(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "video_encoding", value)


@pulumi.type_token("huaweicloud:Live/transcoding:Transcoding")
class Transcoding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 low_bitrate_hd: Optional[pulumi.Input[_builtins.bool]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 templates: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TranscodingTemplateArgs', 'TranscodingTemplateArgsDict']]]]] = None,
                 trans_type: Optional[pulumi.Input[_builtins.str]] = None,
                 video_encoding: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create this resource.
               If omitted, the provider-level region will be used.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['TranscodingTemplateArgs', 'TranscodingTemplateArgsDict']]]] templates: Specifies the video quality templates. A maximum of `4` templates can be added.
               The templates structure is documented below.
               For resolution and bitrate settings in the presets,
               please refer to the [document](https://support.huaweicloud.com/intl/en-us/usermanual-live/live01000802.html).
        :param pulumi.Input[_builtins.str] trans_type: Specifies the transcoding stream trigger mode.
    ...
    def get(resource_name: str,
            ...
            templates: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TranscodingTemplateArgs', 'TranscodingTemplateArgsDict']]]]] = None,
            trans_type: Optional[pulumi.Input[_builtins.str]] = None,
            video_encoding: Optional[pulumi.Input[_builtins.str]] = None) -> 'Transcoding':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="lowBitrateHd")
    def low_bitrate_hd(self) -> pulumi.Output[_builtins.bool]:
        """
        Specifies whether to enable low bitrate HD rates. If enabled
        the output media will have a lower bitrate with the same image quality. Defaults to **false**.
    ...
    @_builtins.property
    @pulumi.getter(name="transType")
    def trans_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the transcoding stream trigger mode.
        The valid values are as follows:
        + **play**: Pull stream triggers transcoding.
    ...
    @_builtins.property
    @pulumi.getter(name="videoEncoding")
    def video_encoding(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the video codec. The valid values are **H264** and **H265**.
        """
        return pulumi.get(self, "video_encoding")
