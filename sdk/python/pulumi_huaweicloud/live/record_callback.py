...
class RecordCallbackArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] url: Specifies the callback URL for sending recording notifications, which must start with
        ...
        :param pulumi.Input[_builtins.str] sign_type: Specifies the sign type.
               The valid values are as follows:
               + **HMACSHA256**
               + **MD5**
    ...
    def sign_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @sign_type.setter
    def sign_type(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("huaweicloud:Live/recordCallback:RecordCallback")
class RecordCallback(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sign_type: Optional[pulumi.Input[_builtins.str]] = None,
            types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            url: Optional[pulumi.Input[_builtins.str]] = None) -> 'RecordCallback':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="signType")
    def sign_type(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the sign type.
        The valid values are as follows:
        + **HMACSHA256**
    ...
    @_builtins.property
    @pulumi.getter
    def types(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Specifies the types of recording notifications.
        The valid values are as follows:
        + **RECORD_NEW_FILE_START**: Recording started.
