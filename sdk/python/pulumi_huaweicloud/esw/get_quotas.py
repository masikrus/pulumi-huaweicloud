...
class GetQuotasResult:
    ...
    def quotas(self) -> Sequence['outputs.GetQuotasQuotaResult']:
        """
        Indicates the ESW instance quotas.
...
def get_quotas(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Esw.get_quotas()
    ```


    :param _builtins.str region: The region in which to obtain the quotas. If omitted, the provider-level region will be
           used.
    """
    __args__ = dict()
    __args__['region'] = region
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('huaweicloud:Esw/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult).value
...
def get_quotas_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Esw/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult)
