...
def get_flavors(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Esw.get_flavors()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Esw/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult).value

    return AwaitableGetFlavorsResult(
        flavors=pulumi.get(__ret__, 'flavors'),
        id=pulumi.get(__ret__, 'id'),
        region=pulumi.get(__ret__, 'region'))
def get_flavors_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Esw/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult)
