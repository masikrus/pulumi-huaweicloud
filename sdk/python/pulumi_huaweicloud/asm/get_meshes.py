...
class GetMeshesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetMeshesItemResult']:
        """
        The list of meshes.
        """
...
def get_meshes(region: Optional[_builtins.str] = None,
...
def get_meshes_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMeshesResult]:
    """
    Use this data source to get a list of ASM meshes within HuaweiCloud.
