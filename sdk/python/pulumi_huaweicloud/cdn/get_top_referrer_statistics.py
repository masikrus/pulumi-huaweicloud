...
__all__ = [
    'GetTopReferrerStatisticsResult',
    'AwaitableGetTopReferrerStatisticsResult',
    'get_top_referrer_statistics',
    'get_top_referrer_statistics_output',
]

@pulumi.output_type
class GetTopReferrerStatisticsResult:
    """
    A collection of values returned by getTopReferrerStatistics.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def statistics(self) -> Sequence['outputs.GetTopReferrerStatisticsStatisticResult']:
        """
        The list of TOP100 referrer statistics that matched filter parameters.  
        The statistics structure is documented below.
        """
        return pulumi.get(self, "statistics")


class AwaitableGetTopReferrerStatisticsResult(GetTopReferrerStatisticsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTopReferrerStatisticsResult(
...
def get_top_referrer_statistics(domain_name: Optional[_builtins.str] = None,
                                end_time: Optional[_builtins.str] = None,
                                enterprise_project_id: Optional[_builtins.str] = None,
                                service_area: Optional[_builtins.str] = None,
                                start_time: Optional[_builtins.str] = None,
                                stat_type: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTopReferrerStatisticsResult:
    """
    ...
    test = huaweicloud.Cdn.get_top_referrer_statistics(domain_name=domain_name,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cdn/getTopReferrerStatistics:getTopReferrerStatistics', __args__, opts=opts, typ=GetTopReferrerStatisticsResult).value

    return AwaitableGetTopReferrerStatisticsResult(
...
def get_top_referrer_statistics_output(domain_name: Optional[pulumi.Input[_builtins.str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTopReferrerStatisticsResult]:
    """
    Use this data source to get the TOP100 referrer statistics of CDN domain within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cdn/getTopReferrerStatistics:getTopReferrerStatistics', __args__, opts=opts, typ=GetTopReferrerStatisticsResult)
    return __ret__.apply(lambda __response__: GetTopReferrerStatisticsResult(
