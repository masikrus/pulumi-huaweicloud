...
__all__ = ['UpdateBackupArgs', 'UpdateBackup']
...
@pulumi.type_token("huaweicloud:Cbr/updateBackup:UpdateBackup")
class UpdateBackup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.cbr.UpdateBackup("test",
            backup_id=backup_id,
            name=name)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(UpdateBackupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = UpdateBackupArgs.__new__(UpdateBackupArgs)
        ...
        super(UpdateBackup, __self__).__init__(
            'huaweicloud:Cbr/updateBackup:UpdateBackup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'UpdateBackup':
        """
        Get an existing UpdateBackup resource's state with the given name, id, and optional extra
        ...
        __props__ = _UpdateBackupState.__new__(_UpdateBackupState)

        __props__.__dict__["backup_id"] = backup_id
        __props__.__dict__["enable_force_new"] = enable_force_new
        __props__.__dict__["name"] = name
        __props__.__dict__["region"] = region
        return UpdateBackup(resource_name, opts=opts, __props__=__props__)
