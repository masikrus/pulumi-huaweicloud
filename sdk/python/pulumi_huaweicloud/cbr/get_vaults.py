...
def get_vaults(auto_expand_enabled: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str region: Specifies the region in which to query the vaults.
...
def get_vaults_output(auto_expand_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cbr/getVaults:getVaults', __args__, opts=opts, typ=GetVaultsResult)
