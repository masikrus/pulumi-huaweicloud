...
class GetBackupResult:
    ...
    @_builtins.property
    @pulumi.getter
    def childrens(self) -> Sequence['outputs.GetBackupChildrenResult']:
        """
    ...
    def extend_infos(self) -> Sequence['outputs.GetBackupExtendInfoResult']:
        """
    ...
    def replication_records(self) -> Sequence['outputs.GetBackupReplicationRecordResult']:
        """
...
def get_backup(id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Cbr.get_backup(id="backup_id")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Cbr/getBackup:getBackup', __args__, opts=opts, typ=GetBackupResult).value
...
def get_backup_output(id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Cbr/getBackup:getBackup', __args__, opts=opts, typ=GetBackupResult)
