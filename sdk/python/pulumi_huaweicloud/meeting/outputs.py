...
class ConferenceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 allow_guest_start: Optional[_builtins.bool] = None,
                 callin_restriction: Optional[_builtins.int] = None,
                 guest_password: Optional[_builtins.str] = None,
                 is_auto_mute: Optional[_builtins.bool] = None,
                 is_guest_free_password: Optional[_builtins.bool] = None,
                 is_hard_terminal_auto_mute: Optional[_builtins.bool] = None,
                 is_send_calendar: Optional[_builtins.bool] = None,
                 is_send_notify: Optional[_builtins.bool] = None,
                 is_send_sms: Optional[_builtins.bool] = None,
                 prolong_time: Optional[_builtins.int] = None,
                 waiting_room_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool allow_guest_start: Specifies whether to allow guests to start conferences (only valid for random
               ID conferences).
        :param _builtins.int callin_restriction: Specifies the range to allow incoming calls.
               + **0**: All users.
               + **2**: Users within the enterprise.
               + **3**: The invited user.
        :param _builtins.str guest_password: Specifies the guest password (pure number which is `4` to `16` digits long).
        :param _builtins.bool is_auto_mute: Specifies whether the soft terminal is automatically muted when the guest joins the
               conference.
        :param _builtins.bool is_guest_free_password: Specifies whether the guest is password-free (only valid for random
               conferences).
        :param _builtins.bool is_hard_terminal_auto_mute: Specifies whether the guest joins the conference, whether the hard
               terminal is automatically muted.
        :param _builtins.bool is_send_calendar: Specifies whether to send conference calendar notifications.
        :param _builtins.bool is_send_notify: Specifies whether to send conference email notification.
        :param _builtins.bool is_send_sms: Specifies whether to send conference SMS notification.
        :param _builtins.int prolong_time: Specifies the Automatically extend duration, the valid value is range from `0` to
               `60`.
        :param _builtins.bool waiting_room_enabled: Specifies whether to open the waiting room (only valid for RTC enterprises).
        """
    ...
    def allow_guest_start(self) -> Optional[_builtins.bool]:
        """
    ...
    def callin_restriction(self) -> Optional[_builtins.int]:
        """
    ...
    def guest_password(self) -> Optional[_builtins.str]:
        """
    ...
    def is_auto_mute(self) -> Optional[_builtins.bool]:
        """
    ...
    def is_guest_free_password(self) -> Optional[_builtins.bool]:
        """
    ...
    def is_hard_terminal_auto_mute(self) -> Optional[_builtins.bool]:
        """
    ...
    def is_send_calendar(self) -> Optional[_builtins.bool]:
        """
    ...
    def is_send_notify(self) -> Optional[_builtins.bool]:
        """
    ...
    def is_send_sms(self) -> Optional[_builtins.bool]:
        """
    ...
    def prolong_time(self) -> Optional[_builtins.int]:
        """
    ...
    def waiting_room_enabled(self) -> Optional[_builtins.bool]:
        """
...
class ConferenceCycleParams(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pre_remind: _builtins.int,
                 start_date: _builtins.str,
                 interval: Optional[_builtins.int] = None,
                 points: Optional[Sequence[_builtins.int]] = None):
        """
        :param _builtins.str cycle: Specifies the period type. The valid values are as follows:
               + **Day**
               + **Week**
               + **Month**
        :param _builtins.str end_date: Specifies the end date of the recurring conference.
               The format is `YYYY-MM-DD`.
        :param _builtins.int pre_remind: Specifies the number of days for advance conference notice.
               The valid value is range from `0` to `30`, defaults to `1`.
        :param _builtins.str start_date: Specifies the start date of the recurring conference.
               The format is `YYYY-MM-DD`.
        :param _builtins.int interval: Specifies the cycle interval.
        ...
        :param Sequence[_builtins.int] points: Specifies the conference point in the cycle. Only valid by **Week** and **Month**.
    ...
    def pre_remind(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def points(self) -> Optional[Sequence[_builtins.int]]:
        """
...
class ConferenceJoinPassword(dict):
    def __init__(__self__, *,
                 guest: Optional[_builtins.str] = None,
                 host: Optional[_builtins.str] = None):
        """
        :param _builtins.str guest: The password of the common participant.
        :param _builtins.str host: The password of the meeting host.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def guest(self) -> Optional[_builtins.str]:
        """
...
class ConferenceParticipant(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_auto_invite: Optional[_builtins.int] = None,
                 is_mute: Optional[_builtins.int] = None,
                 name: Optional[_builtins.str] = None,
                 phone: Optional[_builtins.str] = None,
                 role: Optional[_builtins.int] = None,
                 sms: Optional[_builtins.str] = None,
                 type: Optional[_builtins.str] = None,
                 user_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str account_id: Specifies the account ID of the participant.
        :param _builtins.str email: Specifies the email address.
        :param _builtins.int is_auto_invite: Specifies whether to automatically invite this participant when the conference
        ...
        :param _builtins.int is_mute: Specifies whether the user needs to be automatically muted when joining the conference
               (only effective when invited in the conference). The valid values are as follows:
               + **0**: No mute.
               + **1**: Mute.
               
               The default value is `0`.
        :param _builtins.str name: Specifies the attendee name or nickname.  
               The valid length is limited from `1` to `96`.
        :param _builtins.str phone: Specifies the SIP or TEL number, maximum of 127 characters.
        :param _builtins.int role: Specifies the role in the conference. The valid values are as follows:
               + **0**: Normal attendee.
               + **1**: The conference chair.
        :param _builtins.str sms: Specifies the mobile number for SMS notification, maximum of 32 characters.
               
               > At least one of `phone`, `email` and `sms` must be set.
               
               <a name="conference_cycle_params"></a>
               The `cycle_params` block supports:
        :param _builtins.str type: Specifies the call-in type. The valid values are as follows:
               ...
               + **ideahub**: The ideahub.
        :param _builtins.str user_id: Specifies the user ID of the participant.
        """
    ...
    def is_auto_invite(self) -> Optional[_builtins.int]:
        """
    ...
    def is_mute(self) -> Optional[_builtins.int]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def sms(self) -> Optional[_builtins.str]:
        """
...
class ConferenceSubconference(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_auto_record: Optional[_builtins.int] = None,
                 media_types: Optional[Sequence[_builtins.str]] = None,
                 record_auth_type: Optional[_builtins.int] = None,
                 start_time: Optional[_builtins.str] = None,
                 subconfigurations: Optional[Sequence['outputs.ConferenceSubconferenceSubconfiguration']] = None):
        """
        :param _builtins.str end_time: The sub-conference end time.
        :param _builtins.str id: The sub-conference ID.
        :param _builtins.int is_auto_record: Specifies whether the conference automatically starts recording, it only takes
        ...
        :param Sequence[_builtins.str] media_types: Specifies the conference media type list.
        ...
        :param _builtins.int record_auth_type: Specifies the recording authentication method.
        ...
        :param _builtins.str start_time: Specifies the conference start time (UTC time).
    ...
    def is_auto_record(self) -> Optional[_builtins.int]:
        """
    ...
    def media_types(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def record_auth_type(self) -> Optional[_builtins.int]:
        """
...
class ConferenceSubconferenceSubconfiguration(dict):
    ...
    def __init__(__self__, *,
                 allow_guest_start: Optional[_builtins.bool] = None,
                 audience_callin_restriction: Optional[_builtins.int] = None,
                 callin_restriction: Optional[_builtins.int] = None,
        ...
        :param _builtins.bool allow_guest_start: Specifies whether to allow guests to start conferences (only valid for random
               ID conferences).
        :param _builtins.int audience_callin_restriction: The range that the webinar audience is allowed to call in.
    ...
    def audience_callin_restriction(self) -> Optional[_builtins.int]:
        """
...
class ConferenceSubconferenceSubconfigurationShowAudiencePolicy(dict):
    ...
    def __init__(__self__, *,
                 base_audience_count: Optional[_builtins.int] = None,
                 mode: Optional[_builtins.int] = None,
                 multiple: Optional[_builtins.float] = None):
        """
        :param _builtins.int base_audience_count: Specifies the basic number of people, the valid values is range from `0` to `10,000`.
        :param _builtins.int mode: Audience display strategy: The server is used to calculate the number of audiences and send it to the client
        ...
        :param _builtins.float multiple: Specifies the multiplier. The valid values is range from `0` to `10`, it can be set to 1 decimal place.
        """
    ...
    def base_audience_count(self) -> Optional[_builtins.int]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def multiple(self) -> Optional[_builtins.float]:
        """
