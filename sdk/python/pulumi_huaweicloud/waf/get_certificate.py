...
class GetCertificateResult:
    ...
    @_utilities.deprecated("""Use 'expiration_status' instead. """)
...
def get_certificate(enterprise_project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: Specifies the region in which to obtain the WAF. If omitted, the provider-level region
           will be used.
    """
    __args__ = dict()
...
def get_certificate_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           expiration_status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           expire_status: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Waf/getCertificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
    return __ret__.apply(lambda __response__: GetCertificateResult(
        ...
        expire_status=pulumi.get(__response__, 'expire_status'),
