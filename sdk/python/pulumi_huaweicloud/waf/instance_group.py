...
class _InstanceGroupState:
    def __init__(__self__, *,
                 body_limit: Optional[pulumi.Input[_builtins.int]] = None,
                 connection_timeout: Optional[pulumi.Input[_builtins.int]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 header_limit: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def body_limit(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "body_limit")

    @body_limit.setter
    def body_limit(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def header_limit(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "header_limit")

    @header_limit.setter
    def header_limit(self, value: Optional[pulumi.Input[_builtins.int]]):
...
@pulumi.type_token("huaweicloud:Waf/instanceGroup:InstanceGroup")
class InstanceGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            write_timeout: Optional[pulumi.Input[_builtins.int]] = None) -> 'InstanceGroup':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="bodyLimit")
    def body_limit(self) -> pulumi.Output[_builtins.int]:
        return pulumi.get(self, "body_limit")
    ...
    @_builtins.property
    @pulumi.getter(name="headerLimit")
    def header_limit(self) -> pulumi.Output[_builtins.int]:
        return pulumi.get(self, "header_limit")
    ...
    @_builtins.property
    @pulumi.getter(name="writeTimeout")
    def write_timeout(self) -> pulumi.Output[_builtins.int]:
        return pulumi.get(self, "write_timeout")
