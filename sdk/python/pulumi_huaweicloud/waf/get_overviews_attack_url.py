...
__all__ = [
    'GetOverviewsAttackUrlResult',
    'AwaitableGetOverviewsAttackUrlResult',
    'get_overviews_attack_url',
    'get_overviews_attack_url_output',
]

@pulumi.output_type
class GetOverviewsAttackUrlResult:
    """
    A collection of values returned by getOverviewsAttackUrl.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetOverviewsAttackUrlItemResult']:
        """
...
class AwaitableGetOverviewsAttackUrlResult(GetOverviewsAttackUrlResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOverviewsAttackUrlResult(
...
def get_overviews_attack_url(enterprise_project_id: Optional[_builtins.str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOverviewsAttackUrlResult:
    """
    ...
    test = huaweicloud.Waf.get_overviews_attack_url(from_=start_time,
        to=end_time)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Waf/getOverviewsAttackUrl:getOverviewsAttackUrl', __args__, opts=opts, typ=GetOverviewsAttackUrlResult).value

    return AwaitableGetOverviewsAttackUrlResult(
...
def get_overviews_attack_url_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOverviewsAttackUrlResult]:
    """
    Use this data source to query attacked URLs.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Waf/getOverviewsAttackUrl:getOverviewsAttackUrl', __args__, opts=opts, typ=GetOverviewsAttackUrlResult)
    return __ret__.apply(lambda __response__: GetOverviewsAttackUrlResult(
