...
@pulumi.type_token("huaweicloud:DedicatedElb/certificatePrivateKeyEcho:CertificatePrivateKeyEcho")
class CertificatePrivateKeyEcho(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dedicatedelb.CertificatePrivateKeyEcho("test")
        ```
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'CertificatePrivateKeyEcho':
        """
