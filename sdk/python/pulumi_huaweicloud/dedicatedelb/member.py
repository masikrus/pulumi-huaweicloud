...
class MemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] protocol_port: The port on which to listen for client traffic. It must be set to `0` for gateway
...
class _MemberState:
    def __init__(__self__, *,
                 ...
                 protocol_port: Optional[pulumi.Input[_builtins.int]] = None,
                 reasons: Optional[pulumi.Input[Sequence[pulumi.Input['MemberReasonArgs']]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 statuses: Optional[pulumi.Input[Sequence[pulumi.Input['MemberStatusArgs']]]] = None,
                 subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] instance_id: The ID of the instance associated with the backend server. If this parameter is left blank, the backend
               server is not a real device. It may be an IP address.
        :param pulumi.Input[_builtins.str] ip_version: The IP version supported by the backend server. The value can be **v4 (IPv4)** or **v6 (IPv6)**, depending
               on the value of address returned by the system.
        :param pulumi.Input[_builtins.str] member_type: The type of the backend server. The value can be:
        ...
        :param pulumi.Input[_builtins.int] protocol_port: The port on which to listen for client traffic. It must be set to `0` for gateway
               load balancers with IP backend server groups associated. It can be left blank because it does not take effect if
               `any_port_enable` is set to **true** for a backend server group.
        :param pulumi.Input[Sequence[pulumi.Input['MemberReasonArgs']]] reasons: Why health check fails.
               The reason structure is documented below.
        :param pulumi.Input[_builtins.str] region: The region in which to create the ELB member resource. If omitted, the the
               provider-level region will be used. Changing this creates a new member.
        :param pulumi.Input[Sequence[pulumi.Input['MemberStatusArgs']]] statuses: The health status of the backend server if `listener_id` under status is specified. If `listener_id` under
        ...
        :param pulumi.Input[_builtins.str] subnet_id: The **IPv4 or IPv6 subnet ID** of the subnet in which to access the member.
               ...
               In this case, cross-VPC backend servers must use private IPv4 addresses,
               and the protocol of the backend server group must be TCP, HTTP, or HTTPS.
        :param pulumi.Input[_builtins.str] updated_at: The time when the backend server was updated. The format is **yyyy-MM-dd'T'HH:mm:ss'Z' (UTC time)**.
        :param pulumi.Input[_builtins.int] weight: A positive integer value that indicates the relative portion of traffic that this member
               should receive from the pool. For example, a member with a weight of 10 receives five times as much traffic as a
               member with a weight of 2.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def reasons(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MemberReasonArgs']]]]:
        """
    ...
    @reasons.setter
    def reasons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MemberReasonArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def statuses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MemberStatusArgs']]]]:
        """
    ...
    @statuses.setter
    def statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MemberStatusArgs']]]]):
...
@pulumi.type_token("huaweicloud:DedicatedElb/member:Member")
class Member(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        member1 = huaweicloud.dedicatedelb.Member("member_1",
    ...
    def get(resource_name: str,
            ...
            pool_id: Optional[pulumi.Input[_builtins.str]] = None,
            protocol_port: Optional[pulumi.Input[_builtins.int]] = None,
            reasons: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MemberReasonArgs', 'MemberReasonArgsDict']]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            statuses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MemberStatusArgs', 'MemberStatusArgsDict']]]]] = None,
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.int] protocol_port: The port on which to listen for client traffic. It must be set to `0` for gateway
               load balancers with IP backend server groups associated. It can be left blank because it does not take effect if
               `any_port_enable` is set to **true** for a backend server group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MemberReasonArgs', 'MemberReasonArgsDict']]]] reasons: Why health check fails.
               The reason structure is documented below.
        :param pulumi.Input[_builtins.str] region: The region in which to create the ELB member resource. If omitted, the the
               provider-level region will be used. Changing this creates a new member.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MemberStatusArgs', 'MemberStatusArgsDict']]]] statuses: The health status of the backend server if `listener_id` under status is specified. If `listener_id` under
               `status` is not specified, `operating_status` of member takes precedence.
               The status structure is documented below.
        :param pulumi.Input[_builtins.str] subnet_id: The **IPv4 or IPv6 subnet ID** of the subnet in which to access the member.
               + The IPv4 or IPv6 subnet must be in the same VPC as the subnet of the load balancer.
    ...
    @_builtins.property
    @pulumi.getter
    def reasons(self) -> pulumi.Output[Sequence['outputs.MemberReason']]:
        """
        Why health check fails.
        The reason structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def statuses(self) -> pulumi.Output[Sequence['outputs.MemberStatus']]:
        """
        The health status of the backend server if `listener_id` under status is specified. If `listener_id` under
        `status` is not specified, `operating_status` of member takes precedence.
        The status structure is documented below.
