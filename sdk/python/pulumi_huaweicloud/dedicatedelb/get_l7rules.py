...
class GetL7rulesResult:
    ...
    def l7policy_id(self) -> _builtins.str:
        return pulumi.get(self, "l7policy_id")

    @_builtins.property
    @pulumi.getter(name="l7ruleId")
    def l7rule_id(self) -> Optional[_builtins.str]:
...
def get_l7rules(compare_type: Optional[_builtins.str] = None,
                enterprise_project_id: Optional[_builtins.str] = None,
                l7policy_id: Optional[_builtins.str] = None,
                l7rule_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str l7rule_id: Specifies the forwarding rule ID.
    ...
    return AwaitableGetL7rulesResult(
        ...
        l7rule_id=pulumi.get(__ret__, 'l7rule_id'),
        l7rules=pulumi.get(__ret__, 'l7rules'),
        region=pulumi.get(__ret__, 'region'),
        type=pulumi.get(__ret__, 'type'),
        value=pulumi.get(__ret__, 'value'))
def get_l7rules_output(compare_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       l7policy_id: Optional[pulumi.Input[_builtins.str]] = None,
                       l7rule_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedElb/getL7rules:getL7rules', __args__, opts=opts, typ=GetL7rulesResult)
    return __ret__.apply(lambda __response__: GetL7rulesResult(
        ...
        l7rule_id=pulumi.get(__response__, 'l7rule_id'),
        l7rules=pulumi.get(__response__, 'l7rules'),
