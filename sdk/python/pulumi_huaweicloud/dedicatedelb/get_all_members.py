...
class GetAllMembersResult:
    ...
    def member_ids(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def protocol_ports(self) -> Optional[Sequence[_builtins.int]]:
        """
    ...
    def subnet_cidr_ids(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def weights(self) -> Optional[Sequence[_builtins.int]]:
        """
...
def get_all_members(addresses: Optional[Sequence[_builtins.str]] = None,
                    ...
                    member_ids: Optional[Sequence[_builtins.str]] = None,
                    ...
                    protocol_ports: Optional[Sequence[_builtins.int]] = None,
                    region: Optional[_builtins.str] = None,
                    subnet_cidr_ids: Optional[Sequence[_builtins.str]] = None,
                    weights: Optional[Sequence[_builtins.int]] = None,
    ...
    :param Sequence[_builtins.str] addresses: Specifies the IP address of the backend server.
           Multiple IP addresses can be queried.
    :param Sequence[_builtins.str] enterprise_project_ids: Specifies the ID of the enterprise project.
    ...
    :param Sequence[_builtins.str] ip_versions: Specifies the IP address version supported by the backend server group.
           The value can be **v4** or **v6**.
           Multiple versions can be queried.
    :param Sequence[_builtins.str] loadbalancer_ids: Specifies the ID of the load balancer with which the load balancer is associated.
           Multiple IDs can be queried.
    :param Sequence[_builtins.str] member_ids: Specifies the backend server ID.
           Multiple IDs can be queried.
    :param Sequence[_builtins.str] names: Specifies the backend server name.
           Multiple IDs can be queried.
    :param Sequence[_builtins.str] operating_statuses: Specifies the operating status of the backend server.
           Value options:
           + **ONLINE**: The backend server is running normally.
           + **NO_MONITOR**: No health check is configured for the backend server group to which the backend server belongs.
           + **OFFLINE**: The cloud server used as the backend server is stopped or does not exist.
           Multiple statuses can be queried.
    :param Sequence[_builtins.str] pool_ids: Specifies the ID of the backend server group to which the backend server belongs.
           Multiple IDs can be queried.
    :param Sequence[_builtins.int] protocol_ports: Specifies the port used by the backend servers.
           Multiple ports can be queried.
    :param _builtins.str region: Specifies the region in which to query the resource.
           If omitted, the provider-level region will be used.
    :param Sequence[_builtins.str] subnet_cidr_ids: Specifies the ID of the subnet where the backend server works.
           Multiple IDs can be queried.
    :param Sequence[_builtins.int] weights: Specifies the weight of the backend server.
    ...
    return AwaitableGetAllMembersResult(
        ...
        subnet_cidr_ids=pulumi.get(__ret__, 'subnet_cidr_ids'),
        weights=pulumi.get(__ret__, 'weights'))
def get_all_members_output(addresses: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           enterprise_project_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           ip_versions: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           loadbalancer_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           member_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           ...
                           pool_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           protocol_ports: Optional[pulumi.Input[Optional[Sequence[_builtins.int]]]] = None,
                           region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           subnet_cidr_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           weights: Optional[pulumi.Input[Optional[Sequence[_builtins.int]]]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAllMembersResult]:
    """
    Use this data source to get the list of members under the current project.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedElb/getAllMembers:getAllMembers', __args__, opts=opts, typ=GetAllMembersResult)
    return __ret__.apply(lambda __response__: GetAllMembersResult(
        ...
        subnet_cidr_ids=pulumi.get(__response__, 'subnet_cidr_ids'),
        weights=pulumi.get(__response__, 'weights')))
