...
class GetActiveStandbyPoolsResult:
    ...
    def lb_algorithm(self) -> Optional[_builtins.str]:
        """
...
def get_active_standby_pools(connection_drain: Optional[_builtins.str] = None,
                             description: Optional[_builtins.str] = None,
                             healthmonitor_id: Optional[_builtins.str] = None,
                             ip_version: Optional[_builtins.str] = None,
                             lb_algorithm: Optional[_builtins.str] = None,
    ...
    :param _builtins.str healthmonitor_id: Specifies the ID of the health check configured for the active-standby pool.
    ...
    :param _builtins.str loadbalancer_id: Specifies the ID of the load balancer with which the active-standby pool is
           associated.
    :param _builtins.str member_address: Specifies the private IP address bound to the member. This parameter is used
           only as a query condition and is not included in the response.
    :param _builtins.str member_instance_id: Specifies the ID of the ECS used as the member. This parameter is used only
    ...
    :param _builtins.str pool_id: Specifies the ID of the active-standby pool.
...
def get_active_standby_pools_output(connection_drain: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    ...
                                    lb_algorithm: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetActiveStandbyPoolsResult]:
    """
    Use this data source to get the list of active standby ELB pools.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedElb/getActiveStandbyPools:getActiveStandbyPools', __args__, opts=opts, typ=GetActiveStandbyPoolsResult)
    return __ret__.apply(lambda __response__: GetActiveStandbyPoolsResult(
