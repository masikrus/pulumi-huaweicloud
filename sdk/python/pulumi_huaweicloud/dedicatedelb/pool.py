...
class PoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] protocol: Specifies the protocol used by the backend server group to receive requests.
        ...
        :param pulumi.Input[_builtins.int] connection_drain_timeout: Specifies the timeout of the delayed logout in seconds.  
        ...
        :param pulumi.Input[_builtins.str] public_border_group: Specifies the public border group.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the ELB pool resource. If omitted, the
               provider-level region will be used. Changing this creates a new pool.
        :param pulumi.Input[_builtins.int] slow_start_duration: Specifies the slow start duration, in seconds.  
               Value ranges from `30` to `1,200`. Defaults to `30`.
        :param pulumi.Input[_builtins.bool] slow_start_enabled: Specifies whether to enable slow start. After you enable slow start, new
        ...
        :param pulumi.Input[_builtins.str] type: Specifies the sticky session type. Value options: **SOURCE_IP**,
               ...
               **SOURCE_IP**.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the ID of the VPC where the backend server group works.
...
class _PoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] connection_drain_timeout: Specifies the timeout of the delayed logout in seconds.  
               Value ranges from `10` to `4000`.
        :param pulumi.Input[_builtins.str] created_at: The creation time of the pool.
        :param pulumi.Input[_builtins.bool] deletion_protection_enable: Specifies whether to enable deletion protection.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the pool.
        ...
        :param pulumi.Input[_builtins.str] type: Specifies the sticky session type. Value options: **SOURCE_IP**,
               **HTTP_COOKIE**, and **APP_COOKIE**.
               ...
               <br/> 3. If the backend server group protocol is **QUIC**, sticky session must be enabled with type set to
               **SOURCE_IP**.
        :param pulumi.Input[_builtins.str] updated_at: The update time of the pool.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the ID of the VPC where the backend server group works.
...
@pulumi.type_token("huaweicloud:DedicatedElb/pool:Pool")
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        pool1 = huaweicloud.dedicatedelb.Pool("pool_1",
            name="test",
            protocol="HTTP",
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'Pool':
        """
