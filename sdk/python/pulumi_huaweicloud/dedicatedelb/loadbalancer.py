...
class LoadbalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] auto_renew: Specifies whether auto-renew is enabled. Valid values are **true** and **false**.
               ...
               billing mode.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] backend_subnets: The IDs of subnets on the downstream plane.
        ...
        :param pulumi.Input[_builtins.str] bandwidth_charge_mode: Bandwidth billing type. Value options:
        ...
        :param pulumi.Input[_builtins.str] description: Human-readable description for the load balancer.
        ...
        :param pulumi.Input[_builtins.str] ipv4_subnet_id: The **IPv4 subnet ID** of the subnet on which to allocate the load balancer
               ipv4 address.
        ...
        :param pulumi.Input[_builtins.str] name: Human-readable name for the load balancer.
        ...
        :param pulumi.Input[_builtins.str] sharetype: Bandwidth sharing type. Value options:
...
class _LoadbalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] deletion_protection_enable: Specifies whether to enable deletion protection
               ...
               + **false**: Disable deletion protection.
        :param pulumi.Input[_builtins.str] description: Human-readable description for the load balancer.
        :param pulumi.Input[_builtins.str] elb_virsubnet_type: The type of the subnet on the downstream plane. The value can be:
               + **ipv4**: IPv4 subnet
               + **dualstack**: subnet that supports IPv4/IPv6 dual stack
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project id of the load balancer.
        :param pulumi.Input[_builtins.bool] force_delete: Specifies whether to forcibly delete the load balancer, remove the load balancer,
               listeners, unbind associated pools. Defaults to **false**.
        :param pulumi.Input[_builtins.str] frozen_scene: The scenario where the load balancer is frozen. Multiple values are separated using commas (,).
               The value can be:
        ...
        :param pulumi.Input[_builtins.bool] guaranteed: Indicates whether the load balancer is a dedicated load balancer.
        ...
        :param pulumi.Input[_builtins.str] ipv4_eip_id: The ID of the EIP. Changing this parameter will create a new resource.
               ...
               > **NOTE:** If the ipv4_eip_id parameter is configured, you do not need to configure the bandwidth parameters:
               `iptype`, `bandwidth_charge_mode`, `bandwidth_size`, `share_type` and `bandwidth_id`.
        :param pulumi.Input[_builtins.str] ipv4_port_id: The ID of the port bound to the private IPv4 address of the load balancer.
        :param pulumi.Input[_builtins.str] ipv4_subnet_id: The **IPv4 subnet ID** of the subnet on which to allocate the load balancer
               ipv4 address.
        :param pulumi.Input[_builtins.str] ipv6_address: The ipv6 address of the Load Balancer.
        :param pulumi.Input[_builtins.str] ipv6_bandwidth_id: The ipv6 bandwidth id. Only support shared bandwidth.
        :param pulumi.Input[_builtins.str] ipv6_eip: The ipv6 eip address of the load balancer.
        :param pulumi.Input[_builtins.str] ipv6_eip_id: The type of the subnet on the downstream plane. The value can be:
               + **ipv4**: IPv4 subnet
               + **dualstack**: subnet that supports IPv4/IPv6 dual stack
        :param pulumi.Input[_builtins.str] ipv6_network_id: The **ID** of the subnet on which to allocate the load balancer ipv6 address.
        :param pulumi.Input[_builtins.str] l4_flavor_id: The L4 flavor id of the load balancer.
        ...
        :param pulumi.Input[_builtins.str] loadbalancer_type: Specifies the type of the load balancer. Value options:
               ...
               <br/> 3. You cannot bind an EIP to gateway load balancers.
        :param pulumi.Input[_builtins.str] name: Human-readable name for the load balancer.
        :param pulumi.Input[_builtins.str] operating_status: The operating status of the load balancer. The value can be:
        ...
        :param pulumi.Input[_builtins.str] protection_status: The protection status for update. Value options:
               ...
               Defaults to **nonProtection**.
        :param pulumi.Input[_builtins.str] public_border_group: The AZ group to which the load balancer belongs.
        :param pulumi.Input[_builtins.str] region: The region in which to create the load balancer resource. If omitted, the
               provider-level region will be used. Changing this creates a new load balancer.
        :param pulumi.Input[_builtins.str] sharetype: Bandwidth sharing type. Value options:
               + **PER**: Dedicated bandwidth.
...
@pulumi.type_token("huaweicloud:DedicatedElb/loadbalancer:Loadbalancer")
class Loadbalancer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            waf_failure_action: Optional[pulumi.Input[_builtins.str]] = None) -> 'Loadbalancer':
        """
