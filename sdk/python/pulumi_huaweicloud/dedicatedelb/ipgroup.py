...
class _IpgroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IpgroupIpListArgs']]] ip_lists: Specifies an array of one or more ip addresses. The ip_list object structure is
               documented below. The ip_list structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] listener_ids: The listener IDs which the ip group associated with.
        :param pulumi.Input[_builtins.str] name: Human-readable name for the ip group.
        :param pulumi.Input[_builtins.str] region: The region in which to create the ip group resource. If omitted, the
               provider-level region will be used. Changing this creates a new ip group.
        :param pulumi.Input[_builtins.str] updated_at: The update time of the ip group.
        """
...
@pulumi.type_token("huaweicloud:DedicatedElb/ipgroup:Ipgroup")
class Ipgroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 ip_lists: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IpgroupIpListArgs', 'IpgroupIpListArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        basic = huaweicloud.dedicatedelb.Ipgroup("basic",
            name="basic",
        ...
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project id of the ip group. Changing this
               ...
               <a name="ELB_iplistResp"></a>
               The `ip_list` block supports:
        :param pulumi.Input[Sequence[pulumi.Input[Union['IpgroupIpListArgs', 'IpgroupIpListArgsDict']]]] ip_lists: Specifies an array of one or more ip addresses. The ip_list object structure is
               documented below. The ip_list structure is documented below.
        :param pulumi.Input[_builtins.str] name: Human-readable name for the ip group.
        :param pulumi.Input[_builtins.str] region: The region in which to create the ip group resource. If omitted, the
               provider-level region will be used. Changing this creates a new ip group.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'Ipgroup':
        """
