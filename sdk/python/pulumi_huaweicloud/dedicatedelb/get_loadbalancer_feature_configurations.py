...
def get_loadbalancer_feature_configurations(loadbalancer_id: Optional[_builtins.str] = None,
...
def get_loadbalancer_feature_configurations_output(loadbalancer_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                   region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLoadbalancerFeatureConfigurationsResult]:
    """
    Use this data source to get the list of feature configurations of a load balancer.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:DedicatedElb/getLoadbalancerFeatureConfigurations:getLoadbalancerFeatureConfigurations', __args__, opts=opts, typ=GetLoadbalancerFeatureConfigurationsResult)
    return __ret__.apply(lambda __response__: GetLoadbalancerFeatureConfigurationsResult(
