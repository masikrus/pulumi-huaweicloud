...
class LogtankArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] log_topic_id: Specifies the ID of the subscribe topic.
        :param pulumi.Input[_builtins.str] region: The region in which to create the logtank resource.
...
@pulumi.type_token("huaweicloud:DedicatedElb/logtank:Logtank")
class Logtank(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dedicatedelb.Logtank("test",
    ...
    def get(resource_name: str,
            ...
            log_group_id: Optional[pulumi.Input[_builtins.str]] = None,
            log_topic_id: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'Logtank':
        """
