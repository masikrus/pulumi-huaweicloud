...
def get_pools(any_port_enable: Optional[_builtins.str] = None,
    ...
    :param _builtins.str any_port_enable: Specifies whether forward to same port for a backend server group is enabled.
           Value options:
    ...
    :param _builtins.str member_deletion_protection_enable: Specifies whether deletion protection is enabled. Value options:
           + **false**: Disable this option.
           + **true**: Enable this option.
    ...
    :param _builtins.str pool_health: Specifies whether pool health is enabled. Value options:
    ...
    :param _builtins.int quic_cid_len: Specifies the QUIC connection ID len.
    :param _builtins.int quic_cid_offset: Specifies the QUIC connection ID offset.
