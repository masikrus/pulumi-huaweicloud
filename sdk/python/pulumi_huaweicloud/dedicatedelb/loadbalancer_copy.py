...
class LoadbalancerCopyArgs:
    def __init__(__self__, *,
                 ...
                 cross_vpc_backend: Optional[pulumi.Input[_builtins.str]] = None,
                 deletion_protection_enable: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 reuse_pool: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] availability_zones: Specifies the list of AZ names.
               ...
               operation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] backend_subnets: Specifies the ID of the backend subnet of the load balancer. If it is not specified,
        ...
        :param pulumi.Input[_builtins.str] cross_vpc_backend: Specifies whether to add backend servers that are not in the load balancer's
               VPC. Can only be **true** when updating. Value options: **true**, **false**.
        :param pulumi.Input[_builtins.str] deletion_protection_enable: Specifies whether to enable deletion protection for the load balancer.
               Value options:
               + **true**: Enable deletion protection.
               + **false**: Disable deletion protection.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the load balancer.
        ...
        :param pulumi.Input[_builtins.str] ipv4_address: Specifies the private IPv4 address of the load balancer.
        :param pulumi.Input[_builtins.str] ipv4_subnet_id: Specifies the ID of the IPv4 subnet where the load balancer works. If it is not
        ...
        :param pulumi.Input[_builtins.str] ipv6_address: Specifies the private IPv6 address of the load balancer.
        :param pulumi.Input[_builtins.str] ipv6_bandwidth_id: Specifies the ipv6 bandwidth ID. Only support shared bandwidth.
        :param pulumi.Input[_builtins.str] ipv6_network_id: Specifies the ID of the IPv6 subnet where the new load balancer works. If it is
        ...
        :param pulumi.Input[_builtins.str] l4_flavor_id: Specifies the Layer 4 specifications of the new load balancer. If it is not specified,
               the Layer 4 specifications of the original load balancer are used.
        :param pulumi.Input[_builtins.str] l7_flavor_id: Specifies the Layer 7 specifications of the new load balancer. If it is not specified,
               the Layer 7 specifications of the original load balancer are used.
        :param pulumi.Input[_builtins.str] name: Specifies the load balancer name.
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the ELB load balancer.
               If `period_unit` is set to **month**, the value ranges from `1` to `9`.
               If `period_unit` is set to **year**, the value ranges from `1` to `3`.
               This parameter is mandatory if `charging_mode` is set to **prePaid**.
        :param pulumi.Input[_builtins.str] period_unit: Specifies the charging period unit of the ELB load balancer.
               Valid values are **month** and **year**. This parameter is mandatory if `charging_mode` is set to **prePaid**.
        :param pulumi.Input[_builtins.str] protection_reason: Specifies the reason for update protection. Only valid when `protection_status`
               is **consoleProtection**.
        :param pulumi.Input[_builtins.str] protection_status: Specifies the protection status for update. Value options:
               + **nonProtection**: No protection.
               + **consoleProtection**: Console modification protection.
        :param pulumi.Input[_builtins.str] region: The region in which to create the load balancer resource. If omitted, the
               provider-level region will be used. Changing this creates a new load balancer.
        :param pulumi.Input[_builtins.str] reuse_pool: Specifies whether to reuse the backend server group and backend server
    ...
    def cross_vpc_backend(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def cross_vpc_backend(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "cross_vpc_backend", value)

    @_builtins.property
    @pulumi.getter(name="deletionProtectionEnable")
    def deletion_protection_enable(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def deletion_protection_enable(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def reuse_pool(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @reuse_pool.setter
    def reuse_pool(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _LoadbalancerCopyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] backend_subnets: Specifies the ID of the backend subnet of the load balancer. If it is not specified,
               the backend subnet of the original load balancer is used. The subnets where the original and new load balancers work must
               be in the same VPC.
        :param pulumi.Input[_builtins.str] charge_mode: Indicates the billing mode. The value can be:
        ...
        :param pulumi.Input[_builtins.str] deletion_protection_enable: Specifies whether to enable deletion protection for the load balancer.
               ...
               + **false**: Disable deletion protection.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the load balancer.
        :param pulumi.Input[_builtins.str] elb_virsubnet_type: Indicates the type of the subnet on the downstream plane. The value can be:
               + **ipv4**: IPv4 subnet
        ...
        :param pulumi.Input[_builtins.str] gw_flavor_id: Indicates the flavor ID of the gateway load balancer.
        :param pulumi.Input[_builtins.str] ipv4_address: Specifies the private IPv4 address of the load balancer.
        :param pulumi.Input[_builtins.str] ipv4_port_id: Indicates the ID of the port bound to the private IPv4 address of the load balancer.
        :param pulumi.Input[_builtins.str] ipv4_subnet_id: Specifies the ID of the IPv4 subnet where the load balancer works. If it is not
               specified, the IPv4 subnet of the original load balancer is used. The subnets where the original and new load balancers
               work must be in the same VPC.
        :param pulumi.Input[_builtins.str] ipv6_address: Specifies the private IPv6 address of the load balancer.
        ...
        :param pulumi.Input[_builtins.str] l7_flavor_id: Specifies the Layer 7 specifications of the new load balancer. If it is not specified,
               the Layer 7 specifications of the original load balancer are used.
        :param pulumi.Input[_builtins.str] loadbalancer_id: Specifies the source load balancer ID.
        :param pulumi.Input[_builtins.str] loadbalancer_type: Indicates the type of the load balancer.
        :param pulumi.Input[_builtins.str] name: Specifies the load balancer name.
        :param pulumi.Input[_builtins.str] operating_status: Indicates the operating status of the load balancer. The value can be:
        ...
        :param pulumi.Input[_builtins.str] protection_status: Specifies the protection status for update. Value options:
               + **nonProtection**: No protection.
               + **consoleProtection**: Console modification protection.
        :param pulumi.Input[_builtins.str] public_border_group: Indicates the AZ group to which the load balancer belongs.
        :param pulumi.Input[_builtins.str] region: The region in which to create the load balancer resource. If omitted, the
               provider-level region will be used. Changing this creates a new load balancer.
        :param pulumi.Input[_builtins.str] reuse_pool: Specifies whether to reuse the backend server group and backend server
               ID of the original load balancer.
        ...
        :param pulumi.Input[_builtins.str] vpc_id: Indicates the ID of the VPC where the load balancer resides.
        :param pulumi.Input[_builtins.str] waf_failure_action: Specifies traffic distributing policies when the WAF is faulty.
               Value options:
               + **discard**: Traffic will not be distributed.
               + **forward**: Traffic will be distributed to the default backend servers.
...
@pulumi.type_token("huaweicloud:DedicatedElb/loadbalancerCopy:LoadbalancerCopy")
class LoadbalancerCopy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dedicatedelb.LoadbalancerCopy("test",
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            waf_failure_action: Optional[pulumi.Input[_builtins.str]] = None) -> 'LoadbalancerCopy':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="crossVpcBackend")
    def cross_vpc_backend(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies whether to add backend servers that are not in the load balancer's
        VPC. Can only be **true** when updating. Value options: **true**, **false**.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="deletionProtectionEnable")
    def deletion_protection_enable(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies whether to enable deletion protection for the load balancer.
        Value options:
        + **true**: Enable deletion protection.
    ...
    @_builtins.property
    @pulumi.getter(name="ipv6NetworkId")
    def ipv6_network_id(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the ID of the IPv6 subnet where the new load balancer works. If it is
        not specified, the IPv6 subnet of the original load balancer is used. The subnets where the original and new load
        balancers work must be in the same VPC.
    ...
    @_builtins.property
    @pulumi.getter(name="reusePool")
    def reuse_pool(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies whether to reuse the backend server group and backend server
        ID of the original load balancer.
        + If it is set to **true**, the backend server group of the original load balancer will be used.
