...
class ListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] cps: Specifies the maximum number of new connections that a listener can handle per second.
        ...
        :param pulumi.Input[_builtins.bool] enable_member_retry: Specifies whether to enable health check retries for backend servers.
               The default value is true. It is available only when protocol is set to **HTTP**, **HTTPS**, or **QUIC**.
        :param pulumi.Input[_builtins.str] enable_quic_upgrade: Specifies whether to enable QUIC upgrade. Value options: **true** and **false**.
        :param pulumi.Input[_builtins.bool] force_delete: Specifies whether to forcibly delete the listener, remove the listener, l7 policies,
        ...
        :param pulumi.Input[_builtins.bool] forward_eip: Specifies whether transfer the load balancer EIP in the X-Forward-EIP header to
               ...
               **HTTPS**.
        :param pulumi.Input[_builtins.bool] forward_elb: Specifies whether to transfer the load balancer ID to backend servers through the HTTP
               header of the packet. The default value is false. This parameter is valid only when the protocol is set to **HTTP** or
               **HTTPS**.
        :param pulumi.Input[_builtins.bool] forward_host: Specifies whether to rewrite the X-Forwarded-Host header. If X-Forwarded-Host is
        ...
        :param pulumi.Input[_builtins.bool] forward_port: Specifies whether transfer the listening port of the load balancer in the
        ...
        :param pulumi.Input[_builtins.bool] forward_proto: Specifies whether to transfer the listener protocol of the load balancer to backend
               servers through the HTTP header of the packet. The default value is false. This parameter is valid only when the
               protocol is set to **HTTP** or **HTTPS**.
        :param pulumi.Input[_builtins.bool] forward_request_port: Specifies whether transfer the source port of the client in the
               X-Forwarded-For-Port header to backend servers. The default value is false. This parameter is valid only when the
               protocol is set to **HTTP** or **HTTPS**.
        :param pulumi.Input[_builtins.bool] forward_tls_certificate: Specifies whether to transfer the certificate ID of the load balancer to
        ...
        :param pulumi.Input[_builtins.bool] forward_tls_cipher: Specifies whether to transfer the algorithm suite of the load balancer to
               backend servers through the HTTP header of the packet. The default value is false. This parameter is valid only when
               the protocol is set to **HTTPS**.
        :param pulumi.Input[_builtins.bool] forward_tls_protocol: Specifies whether to transfer the algorithm protocol of the load balancer to
               backend servers through the HTTP header of the packet. The default value is false. This parameter is valid only when
               the protocol is set to **HTTPS**.
        :param pulumi.Input[_builtins.bool] gzip_enable: Specifies whether to enable gzip compression for a load balancer. The default value
        ...
        :param pulumi.Input[_builtins.str] ip_group_enable: Specifies whether access control is enabled. Value options: **true** and **false**.
        :param pulumi.Input[_builtins.int] max_connection: Specifies the maximum number of concurrent connections that a listener can handle per
        ...
        :param pulumi.Input[_builtins.str] protection_reason: The reason for update protection. Only valid when `protection_status` is
               **consoleProtection**.
        :param pulumi.Input[_builtins.str] protection_status: The protection status for update. Value options:
               + **nonProtection**: No protection.
               + **consoleProtection**: Console modification protection.
               
               Defaults to **nonProtection**.
        :param pulumi.Input[_builtins.int] protocol_port: Specifies the port used by the listener.
        ...
        :param pulumi.Input[_builtins.bool] proxy_protocol_enable: Specifies whether to enable the proxy protocol option to pass the source IP
        ...
        :param pulumi.Input[_builtins.str] quic_listener_id: Specifies the ID of the QUIC listener. If it is set, HTTPS listener will be
        ...
        :param pulumi.Input[_builtins.int] response_timeout: Specifies the response timeout for the listener. Value range: 1 to 300. This
               parameter is valid when protocol is set to **HTTP** or **HTTPS**.
        :param pulumi.Input[_builtins.str] security_policy_id: Specifies the ID of the custom security policy. This parameter is available
        ...
        :param pulumi.Input[_builtins.str] sni_match_algo: Specifies how wildcard domain name matches with the SNI certificates used by the
               listener. **longest_suffix** indicates longest suffix match. **wildcard** indicates wildcard match.
               The default value is **wildcard**.
        :param pulumi.Input[_builtins.bool] ssl_early_data_enable: Specifies whether to enable 0-RTT capability, it is available only when
...
class _ListenerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] tls_ciphers_policy: Specifies the TLS cipher policy for the listener. Valid options are:
               ...
               **tls-1-2-fs-with-1-3**, **hybrid-policy-1-0** and **tls-1-2-strict-no-cbc**. Defaults to **tls-1-0**.
               This parameter is valid when protocol is set to **HTTPS**.
        :param pulumi.Input[_builtins.str] updated_at: The update time of the listener.
        """
        if access_policy is not None:
            pulumi.set(__self__, "access_policy", access_policy)
        if advanced_forwarding_enabled is not None:
...
@pulumi.type_token("huaweicloud:DedicatedElb/listener:Listener")
class Listener(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        basic = huaweicloud.dedicatedelb.Listener("basic",
            name="basic",
        ...
        :param pulumi.Input[_builtins.int] max_connection: Specifies the maximum number of concurrent connections that a listener can handle per
               ...
               the number defined in the load balancer specifications, the latter is used as the limit.
        :param pulumi.Input[_builtins.str] name: Human-readable name for the listener.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ListenerPortRangeArgs', 'ListenerPortRangeArgsDict']]]] port_ranges: Specifies the port monitoring range (closed range), specify up to 10 port
               groups, each group range must not overlap. This field can only be passed in when `protocol_port` is `0` or empty.
               Only **TCP**, **UDP**, and **TLS** listener support this field. Changing this creates a new listener.
               The port_ranges structure is documented below.
        :param pulumi.Input[_builtins.str] protection_reason: The reason for update protection. Only valid when `protection_status` is
