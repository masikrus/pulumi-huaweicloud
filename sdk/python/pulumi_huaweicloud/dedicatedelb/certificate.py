...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enc_certificate: Specifies the body of the SM encryption certificate required by HTTPS listeners.
        ...
        :param pulumi.Input[_builtins.str] enc_private_key: Specifies the private key of the SM encryption certificate required by HTTPS listeners.
        ...
        :param pulumi.Input[_builtins.str] scm_certificate_id: Specifies the SM certificate ID.
        :param pulumi.Input[_builtins.str] type: Specifies the certificate type. Value options:
...
class _CertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] certificate: The public encrypted key of the Certificate, PEM format.
        :param pulumi.Input[_builtins.str] common_name: Indicates the primary domain name of the certificate.
        ...
        :param pulumi.Input[_builtins.str] enc_private_key: Specifies the private key of the SM encryption certificate required by HTTPS listeners.
               ...
               **server_sm.**.
        :param pulumi.Input[_builtins.str] enterprise_project_id: The enterprise project id of the certificate.
        :param pulumi.Input[_builtins.str] expire_time: Indicates the expiration time.
        :param pulumi.Input[_builtins.str] fingerprint: Indicates the fingerprint of the certificate.
        :param pulumi.Input[_builtins.str] name: Human-readable name for the Certificate. Does not have to be unique.
        :param pulumi.Input[_builtins.str] private_key: The private encrypted key of the Certificate, PEM format. This parameter is valid
               and mandatory only when `type` is set to **server**.
        :param pulumi.Input[_builtins.str] region: The region in which to create the ELB certificate resource. If omitted, the
               provider-level region will be used. Changing this creates a new certificate.
        :param pulumi.Input[_builtins.str] scm_certificate_id: Specifies the SM certificate ID.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subject_alternative_names: Indicates all the domain names of the certificate.
        :param pulumi.Input[_builtins.str] type: Specifies the certificate type. Value options:
               + **server**: indicates the server certificate.
               + **client**: indicates the CA certificate.
               + **server_sm**: indicates the server SM certificate.
...
@pulumi.type_token("huaweicloud:DedicatedElb/certificate:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        certificate1 = huaweicloud.dedicatedelb.Certificate("certificate_1",
            name="certificate_1",
        ...
        generally recommended running `pulumi preview` after importing a certificate. You can then decide if changes should be
