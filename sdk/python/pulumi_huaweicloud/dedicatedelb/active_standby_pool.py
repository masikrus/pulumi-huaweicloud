...
class ActiveStandbyPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] protocol: Specifies the protocol used by the active-standby pool to receive requests.
        ...
        :param pulumi.Input[_builtins.bool] any_port_enable: Specifies whether to enable forward to same port for active-standby
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.bool] connection_drain_enabled: Specifies whether to enable delayed logout. This parameter can
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] connection_drain_timeout: Specifies the timeout of the delayed logout in seconds. Value
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description of the active-standby pool. Changing this
        ...
        :param pulumi.Input[_builtins.str] lb_algorithm: Specifies the load balancing algorithm used by the load balancer to route
        ...
        :param pulumi.Input[_builtins.str] loadbalancer_id: Specifies the ID of the load balancer with which the active-standby
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the health check name. The length range of value is from `1` to `255`.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the ELB active-standby pool resource.
        ...
        :param pulumi.Input[_builtins.str] type: Specifies the health check protocol. Value options: **TCP**, **UDP_CONNECT**,
               **HTTP**, and **HTTPS**.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the ID of the VPC where the active-standby pool works. Changing this
               parameter will create a new resource.
...
class _ActiveStandbyPoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] connection_drain_timeout: Specifies the timeout of the delayed logout in seconds. Value
               ...
               <a name="ELB_members"></a>
               The `members` block supports:
        :param pulumi.Input[_builtins.str] created_at: The create time of the active-standby pool.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the active-standby pool. Changing this
               parameter will create a new resource.
        :param pulumi.Input['ActiveStandbyPoolHealthmonitorArgs'] healthmonitor: Specifies the health check configured for the active-standby pool.
               The healthmonitor structure is documented below. Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[_builtins.str] type: Specifies the health check protocol. Value options: **TCP**, **UDP_CONNECT**,
               **HTTP**, and **HTTPS**.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] updated_at: The update time of the active-standby pool.
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the ID of the VPC where the active-standby pool works. Changing this
               parameter will create a new resource.
...
@pulumi.type_token("huaweicloud:DedicatedElb/activeStandbyPool:ActiveStandbyPool")
class ActiveStandbyPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 connection_drain_timeout: Optional[pulumi.Input[_builtins.int]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 healthmonitor: Optional[pulumi.Input[Union['ActiveStandbyPoolHealthmonitorArgs', 'ActiveStandbyPoolHealthmonitorArgsDict']]] = None,
                 ip_version: Optional[pulumi.Input[_builtins.str]] = None,
                 lb_algorithm: Optional[pulumi.Input[_builtins.str]] = None,
                 listener_id: Optional[pulumi.Input[_builtins.str]] = None,
                 loadbalancer_id: Optional[pulumi.Input[_builtins.str]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ActiveStandbyPoolMemberArgs', 'ActiveStandbyPoolMemberArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 protocol: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 type: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        test = huaweicloud.dedicatedelb.ActiveStandbyPool("test",
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description of the active-standby pool. Changing this
               parameter will create a new resource.
        :param pulumi.Input[Union['ActiveStandbyPoolHealthmonitorArgs', 'ActiveStandbyPoolHealthmonitorArgsDict']] healthmonitor: Specifies the health check configured for the active-standby pool.
               The healthmonitor structure is documented below. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] ip_version: Specifies the IP address version supported by active-standby pool.
               The value can be **dualstack**, **v6**, or **v4**. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] lb_algorithm: Specifies the load balancing algorithm used by the load balancer to route
        ...
        :param pulumi.Input[_builtins.str] loadbalancer_id: Specifies the ID of the load balancer with which the active-standby
               pool is associated. Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ActiveStandbyPoolMemberArgs', 'ActiveStandbyPoolMemberArgsDict']]]] members: Specifies the members in the active-standby pool.
               The members structure is documented below. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] name: Specifies the health check name. The length range of value is from `1` to `255`.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] protocol: Specifies the protocol used by the active-standby pool to receive requests.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            protocol: Optional[pulumi.Input[_builtins.str]] = None,
            quic_cid_hash_strategies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ActiveStandbyPoolQuicCidHashStrategyArgs', 'ActiveStandbyPoolQuicCidHashStrategyArgsDict']]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ActiveStandbyPool':
        """
        ...
        :param pulumi.Input[_builtins.str] protocol: Specifies the protocol used by the active-standby pool to receive requests.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ActiveStandbyPoolQuicCidHashStrategyArgs', 'ActiveStandbyPoolQuicCidHashStrategyArgsDict']]]] quic_cid_hash_strategies: The multi-path distribution configuration based on destination connection IDs.
               The quic_cid_hash_strategy structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the ELB active-standby pool resource.
               If omitted, the provider-level region will be used.
        :param pulumi.Input[_builtins.str] type: Specifies the health check protocol. Value options: **TCP**, **UDP_CONNECT**,
    ...
    @_builtins.property
    @pulumi.getter(name="lbAlgorithm")
    def lb_algorithm(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the load balancing algorithm used by the load balancer to route
        requests to backend servers in the associated backend server group. Value options:
        + **ROUND_ROBIN**: weighted round robin.
