...
class MysqlProxyRestartArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] proxy_id: Specifies the ID of the RDS MySQL proxy.
    ...
    def proxy_id(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the ID of the RDS MySQL proxy.
        """
...
@pulumi.type_token("huaweicloud:Rds/mysqlProxyRestart:MysqlProxyRestart")
