...
class PgPluginParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the rds PostgreSQL plugin parameter resource.
...
@pulumi.type_token("huaweicloud:Rds/pgPluginParameter:PgPluginParameter")
