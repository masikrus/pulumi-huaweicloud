...
def get_pg_plugins(created: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str database_name: Specifies the database name of a PostgreSQL instance.
    :param _builtins.str instance_id: Specifies the ID of a PostgreSQL instance.
...
def get_pg_plugins_output(created: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getPgPlugins:getPgPlugins', __args__, opts=opts, typ=GetPgPluginsResult)
