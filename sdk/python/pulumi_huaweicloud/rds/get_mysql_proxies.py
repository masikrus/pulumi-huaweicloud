...
class GetMysqlProxiesResult:
    ...
    def max_proxy_node_num(self) -> _builtins.int:
        """
    ...
    def max_proxy_num(self) -> _builtins.int:
        """
    ...
    def support_balance_route_mode_for_favored_version(self) -> _builtins.bool:
        """
...
def get_mysql_proxies(instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance_id: Specifies the ID of RDS MySQL instance.
    ...
    return AwaitableGetMysqlProxiesResult(
        ...
        max_proxy_node_num=pulumi.get(__ret__, 'max_proxy_node_num'),
        max_proxy_num=pulumi.get(__ret__, 'max_proxy_num'),
        proxy_lists=pulumi.get(__ret__, 'proxy_lists'),
        region=pulumi.get(__ret__, 'region'),
        support_balance_route_mode_for_favored_version=pulumi.get(__ret__, 'support_balance_route_mode_for_favored_version'))
def get_mysql_proxies_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getMysqlProxies:getMysqlProxies', __args__, opts=opts, typ=GetMysqlProxiesResult)
    return __ret__.apply(lambda __response__: GetMysqlProxiesResult(
        id=pulumi.get(__response__, 'id'),
        instance_id=pulumi.get(__response__, 'instance_id'),
        max_proxy_node_num=pulumi.get(__response__, 'max_proxy_node_num'),
        max_proxy_num=pulumi.get(__response__, 'max_proxy_num'),
        proxy_lists=pulumi.get(__response__, 'proxy_lists'),
        region=pulumi.get(__response__, 'region'),
        support_balance_route_mode_for_favored_version=pulumi.get(__response__, 'support_balance_route_mode_for_favored_version')))
