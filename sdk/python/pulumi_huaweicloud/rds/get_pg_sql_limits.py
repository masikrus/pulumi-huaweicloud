...
def get_pg_sql_limits(db_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str db_name: Specifies the name of the database.
    :param _builtins.str instance_id: Specifies the ID of RDS PostgreSQL instance.
    :param _builtins.str is_effective: Specifies whether the SQL limit is effective.
    :param _builtins.str max_concurrency: Specifies the number of SQL statements executed simultaneously.
    :param _builtins.str max_waiting: Specifies the max waiting time in seconds.
    ...
    :param _builtins.str sql_limit_id: Specifies the ID of SQL limit.
    """
    __args__ = dict()
...
def get_pg_sql_limits_output(db_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getPgSqlLimits:getPgSqlLimits', __args__, opts=opts, typ=GetPgSqlLimitsResult)
