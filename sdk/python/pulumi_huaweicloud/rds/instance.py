...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the RDS DB instance. Valid values are **prePaid**
        ...
        :param pulumi.Input[_builtins.str] ha_replication_mode: Specifies the replication mode for the standby DB instance.
        ...
        :param pulumi.Input[_builtins.bool] is_flexus: Specifies whether to create flexus RDS instance. Defaults to **false**.
        ...
        :param pulumi.Input[_builtins.bool] minor_version_auto_upgrade_enabled: Specifies whether to enable minor version auto upgrade.
        ...
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the RDS DB instance. If `period_unit` is set to **month**,
        ...
        :param pulumi.Input[_builtins.str] period_unit: Specifies the charging period unit of the RDS DB instance. Valid values are **month**
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 storage_used_spaces: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceStorageUsedSpaceArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the DB instance name. The DB instance name of the same type must be unique for
               the same tenant. The value must be 4 to 64 characters in length and start with a letter. It is case-sensitive and can
               contain only letters, digits, hyphens (-), and underscores (_).
        :param pulumi.Input[Sequence[pulumi.Input['InstanceNodeArgs']]] nodes: Indicates the instance nodes information.
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the rds instance resource. If omitted, the
               provider-level region will be used. Changing this creates a new rds instance resource.
        :param pulumi.Input[_builtins.str] replication_status: Indicates the replication status of the instance.
        :param pulumi.Input['InstanceRestoreArgs'] restore: Specifies the restoration information. It only supported restore to postpaid
               instance. Structure is documented below. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] rotate_day: Specifies the rotation days of TDE rotation.
        :param pulumi.Input[_builtins.bool] seconds_level_monitoring_enabled: Specifies whether to enable seconds level monitoring.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceStorageUsedSpaceArgs']]] storage_used_spaces: Indicates the storage usage of the instance.
    ...
    def storage_used_spaces(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['InstanceStorageUsedSpaceArgs']]]]:
        """
    ...
    def storage_used_spaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceStorageUsedSpaceArgs']]]]):
...
@pulumi.type_token("huaweicloud:Rds/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_enable: Optional[pulumi.Input[_builtins.bool]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            storage_used_spaces: Optional[pulumi.Input[Sequence[pulumi.Input[Union['InstanceStorageUsedSpaceArgs', 'InstanceStorageUsedSpaceArgsDict']]]]] = None,
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
            switch_strategy: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tde_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the DB instance name. The DB instance name of the same type must be unique for
               the same tenant. The value must be 4 to 64 characters in length and start with a letter. It is case-sensitive and can
               contain only letters, digits, hyphens (-), and underscores (_).
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceNodeArgs', 'InstanceNodeArgsDict']]]] nodes: Indicates the instance nodes information.
               The nodes structure is documented below.
        :param pulumi.Input[_builtins.str] param_group_id: Specifies the parameter group ID.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceParameterArgs', 'InstanceParameterArgsDict']]]] parameters: Specify an array of one or more parameters to be set to the RDS instance after
               launched. You can check on console to see which parameters supported. Structure is documented below.
        ...
        :param pulumi.Input[_builtins.bool] ssl_enable: Specifies whether to enable the SSL for MySQL database.
        :param pulumi.Input[_builtins.str] status: Indicates the node status.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceStorageUsedSpaceArgs', 'InstanceStorageUsedSpaceArgsDict']]]] storage_used_spaces: Indicates the storage usage of the instance.
               The storage_used_space structure is documented below.
        :param pulumi.Input[_builtins.str] subnet_id: Specifies the network id of a subnet. Changing this parameter will create a
               new resource.
        :param pulumi.Input[_builtins.str] switch_strategy: Specifies the database switchover policy.
    ...
    @_builtins.property
    @pulumi.getter(name="storageUsedSpaces")
    def storage_used_spaces(self) -> pulumi.Output[Sequence['outputs.InstanceStorageUsedSpace']]:
        """
        Indicates the storage usage of the instance.
        The storage_used_space structure is documented below.
        """
