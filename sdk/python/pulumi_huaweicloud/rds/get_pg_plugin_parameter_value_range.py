...
def get_pg_plugin_parameter_value_range_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getPgPluginParameterValueRange:getPgPluginParameterValueRange', __args__, opts=opts, typ=GetPgPluginParameterValueRangeResult)
