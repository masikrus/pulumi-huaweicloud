...
def get_pg_roles(account: Optional[_builtins.str] = None,
    ...
    :param _builtins.str account: Specifies the username of the account.
           The list of authorized roles for this account when there is a value.
    :param _builtins.str instance_id: Specifies the ID of Instance.
...
def get_pg_roles_output(account: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getPgRoles:getPgRoles', __args__, opts=opts, typ=GetPgRolesResult)
