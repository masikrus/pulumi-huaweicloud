...
def get_storage_types(db_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str db_type: DB engine. The valid values are **MySQL**, **PostgreSQL**, **SQLServer**, **MariaDB**.
...
def get_storage_types_output(db_type: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getStorageTypes:getStorageTypes', __args__, opts=opts, typ=GetStorageTypesResult)
