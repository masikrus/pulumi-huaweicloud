...
class GetSqlserverCollationsResult:
    ...
    def char_sets(self) -> Sequence[_builtins.str]:
        """
...
def get_sqlserver_collations(region: Optional[_builtins.str] = None,
    ...
    return AwaitableGetSqlserverCollationsResult(
        char_sets=pulumi.get(__ret__, 'char_sets'),
        id=pulumi.get(__ret__, 'id'),
        region=pulumi.get(__ret__, 'region'))
def get_sqlserver_collations_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSqlserverCollationsResult]:
    """
    Use this data source to get the list of RDS SQLServer collations.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getSqlserverCollations:getSqlserverCollations', __args__, opts=opts, typ=GetSqlserverCollationsResult)
    return __ret__.apply(lambda __response__: GetSqlserverCollationsResult(
        char_sets=pulumi.get(__response__, 'char_sets'),
