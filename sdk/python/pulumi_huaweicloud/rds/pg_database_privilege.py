...
@pulumi.type_token("huaweicloud:Rds/pgDatabasePrivilege:PgDatabasePrivilege")
class PgDatabasePrivilege(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 users: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PgDatabasePrivilegeUserArgs', 'PgDatabasePrivilegeUserArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the RDS database privilege resource. If omitted,
               the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PgDatabasePrivilegeUserArgs', 'PgDatabasePrivilegeUserArgsDict']]]] users: Specifies the account that associated with the database.
               The users structure is documented below.
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PgDatabasePrivilegeUserArgs', 'PgDatabasePrivilegeUserArgsDict']]]]] = None) -> 'PgDatabasePrivilege':
        """
