...
class GetInstancesResult:
    ...
    """
    def __init__(__self__, datastore_type=None, enterprise_project_id=None, group_type=None, id=None, instances=None, name=None, region=None, subnet_id=None, type=None, vpc_id=None):
...
def get_instances(datastore_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str datastore_type: Specifies the type of the database. Valid values are **MySQL**, **PostgreSQL**,
           **SQLServer** and **MariaDB**.
    :param _builtins.str enterprise_project_id: Specifies the enterprise project id.
    :param _builtins.str group_type: Specifies whether query flexus RDS instances. Value options: **flexus**.
...
def get_instances_output(datastore_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
