...
def get_flavors_v3(availability_zone: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Rds/getFlavorsV3:getFlavorsV3', __args__, opts=opts, typ=GetFlavorsV3Result).value
...
def get_flavors_v3_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getFlavorsV3:getFlavorsV3', __args__, opts=opts, typ=GetFlavorsV3Result)
