...
class PgDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_revoke_public_privilege: Specifies whether to revoke the PUBLIC CREATE
...
@pulumi.type_token("huaweicloud:Rds/pgDatabase:PgDatabase")
class PgDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.rds.PgDatabase("test",
