...
def get_sql_audit_logs(end_time: Optional[_builtins.str] = None,
...
def get_sql_audit_logs_output(end_time: Optional[pulumi.Input[_builtins.str]] = None,
                              instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                              region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              start_time: Optional[pulumi.Input[_builtins.str]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSqlAuditLogsResult]:
    """
    Use this data source to get the list of RDS SQL audit logs.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getSqlAuditLogs:getSqlAuditLogs', __args__, opts=opts, typ=GetSqlAuditLogsResult)
    return __ret__.apply(lambda __response__: GetSqlAuditLogsResult(
