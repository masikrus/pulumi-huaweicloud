...
class GetFlavorsResult:
    ...
    """
    def __init__(__self__, availability_zone=None, db_type=None, db_version=None, flavors=None, group_type=None, id=None, instance_mode=None, is_flexus=None, memory=None, region=None, vcpus=None):
        ...
        if is_flexus and not isinstance(is_flexus, bool):
            raise TypeError("Expected argument 'is_flexus' to be a bool")
    ...
    def group_type(self) -> Optional[_builtins.str]:
        """
        Indicates the performance specification.
        """
    ...
    def instance_mode(self) -> Optional[_builtins.str]:
        """
        Indicates the mode of instance.
        """
        return pulumi.get(self, "instance_mode")

    @_builtins.property
    @pulumi.getter(name="isFlexus")
    def is_flexus(self) -> Optional[_builtins.bool]:
...
def get_flavors(availability_zone: Optional[_builtins.str] = None,
                ...
                is_flexus: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str db_type: Specifies the DB engine. The value can be **MySQL**, **PostgreSQL**, **SQLServer**,
           **MariaDB**.
    :param _builtins.str db_version: Specifies the database version.
    ...
    :param _builtins.bool is_flexus: Specifies whether to query flexus RDS instance specifications.
    ...
    return AwaitableGetFlavorsResult(
        ...
        is_flexus=pulumi.get(__ret__, 'is_flexus'),
...
def get_flavors_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       ...
                       is_flexus: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult)
    return __ret__.apply(lambda __response__: GetFlavorsResult(
        ...
        is_flexus=pulumi.get(__response__, 'is_flexus'),
