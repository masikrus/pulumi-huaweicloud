...
def get_restore_time_ranges_output(date: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Rds/getRestoreTimeRanges:getRestoreTimeRanges', __args__, opts=opts, typ=GetRestoreTimeRangesResult)
