...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterAnalysisTaskNodesArgs'] analysis_task_nodes: Specifies the informations about analysis task nodes in the
               MapReduce cluster.
               The analysis_task_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterCustomNodeArgs']]] custom_nodes: Specifies the informations about custom nodes in the MapReduce cluster.  
               The custom_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        ...
        :param pulumi.Input['ClusterStreamingCoreNodesArgs'] streaming_core_nodes: Specifies the informations about streaming core nodes in the
               MapReduce cluster.
               The streaming_core_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input['ClusterStreamingTaskNodesArgs'] streaming_task_nodes: Specifies the informations about streaming task nodes in the
               MapReduce cluster.
               The streaming_task_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
...
@pulumi.type_token("huaweicloud:Mrs/cluster:cluster")
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_cluster = huaweicloud.mrs.Cluster("test",
        ...
        :param pulumi.Input[Union['ClusterAnalysisCoreNodesArgs', 'ClusterAnalysisCoreNodesArgsDict']] analysis_core_nodes: Specifies the informations about analysis core nodes in the
               MapReduce cluster.
               The analysis_core_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[Union['ClusterAnalysisTaskNodesArgs', 'ClusterAnalysisTaskNodesArgsDict']] analysis_task_nodes: Specifies the informations about analysis task nodes in the
               MapReduce cluster.
               The analysis_task_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[_builtins.str] auto_renew: Specifies whether auto renew is enabled, defaults to **false**.  
        ...
        :param pulumi.Input[_builtins.str] availability_zone: Specifies the availability zone in which to create the cluster.
               Please following [reference](https://developer.huaweicloud.com/intl/en-us/endpoint?all)
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterBootstrapScriptArgs', 'ClusterBootstrapScriptArgsDict']]]] bootstrap_scripts: Specifies the bootstrap action scripts.
               Bootstrap action scripts will be executed on specified cluster nodes before or after big data components are
               started. You can execute bootstrap actions to install third-party software, modify the cluster running environment,
               and customize cluster configuration. [Learn more](https://support.huaweicloud.com/intl/en-us/usermanual-mrs/mrs_01_0414.html)
        ...
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the cluster.  
               Valid values are **prePaid** and **postPaid**, defaults to **postPaid**.
               Changing this parameter will create a new MapReduce cluster resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterComponentConfigArgs', 'ClusterComponentConfigArgsDict']]]] component_configs: Specifies the component configurations of the cluster.
               The object structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] component_lists: Specifies the list of component names. For the components supported by
               the cluster, please following [reference](https://support.huaweicloud.com/intl/en-us/productdesc-mrs/mrs_08_0005.html)
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterCustomNodeArgs', 'ClusterCustomNodeArgsDict']]]] custom_nodes: Specifies the informations about custom nodes in the MapReduce cluster.  
               The custom_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[_builtins.str] eip_id: Specifies the EIP ID which bound to the MapReduce cluster.
               The EIP must have been created and must be in the same region as the cluster.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies a unique ID in UUID format of enterprise project.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterExternalDatasourceArgs', 'ClusterExternalDatasourceArgsDict']]]] external_datasources: Specifies the external datasource configurations of the cluster.
               The object structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[_builtins.bool] log_collection: Specifies whether logs are collected when cluster installation fails.
               Defaults to true. If `log_collection` set true, the OBS buckets will be created and only used to collect logs that
        ...
        :param pulumi.Input[Union['ClusterStreamingCoreNodesArgs', 'ClusterStreamingCoreNodesArgsDict']] streaming_core_nodes: Specifies the informations about streaming core nodes in the
               ...
               The streaming_core_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[Union['ClusterStreamingTaskNodesArgs', 'ClusterStreamingTaskNodesArgsDict']] streaming_task_nodes: Specifies the informations about streaming task nodes in the
               MapReduce cluster.
               The streaming_task_nodes structure is documented below.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[_builtins.str] subnet_id: Specifies the network ID of a subnet which bound to the MapReduce cluster.
