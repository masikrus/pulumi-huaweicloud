...
class QueueV1Args:
    def __init__(__self__, *,
                 ...
                 scaling_policies: Optional[pulumi.Input[Sequence[pulumi.Input['QueueV1ScalingPolicyArgs']]]] = None,
                 spark_driver: Optional[pulumi.Input['QueueV1SparkDriverArgs']] = None,
    ...
    def scaling_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['QueueV1ScalingPolicyArgs']]]]:
        return pulumi.get(self, "scaling_policies")

    @scaling_policies.setter
    def scaling_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['QueueV1ScalingPolicyArgs']]]]):
        pulumi.set(self, "scaling_policies", value)

    @_builtins.property
    @pulumi.getter(name="sparkDriver")
    def spark_driver(self) -> Optional[pulumi.Input['QueueV1SparkDriverArgs']]:
        return pulumi.get(self, "spark_driver")

    @spark_driver.setter
    def spark_driver(self, value: Optional[pulumi.Input['QueueV1SparkDriverArgs']]):
...
@pulumi.type_token("huaweicloud:Dli/queueV1:QueueV1")
class QueueV1(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 resource_mode: Optional[pulumi.Input[_builtins.int]] = None,
                 scaling_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['QueueV1ScalingPolicyArgs', 'QueueV1ScalingPolicyArgsDict']]]]] = None,
                 spark_driver: Optional[pulumi.Input[Union['QueueV1SparkDriverArgs', 'QueueV1SparkDriverArgsDict']]] = None,
                 subnet_cidr: Optional[pulumi.Input[_builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 vpc_cidr: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
    ...
    def _internal_init(__self__,
        ...
        super(QueueV1, __self__).__init__(
            'huaweicloud:Dli/queueV1:QueueV1',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subnet_cidr: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vpc_cidr: Optional[pulumi.Input[_builtins.str]] = None) -> 'QueueV1':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="scalingPolicies")
    def scaling_policies(self) -> pulumi.Output[Sequence['outputs.QueueV1ScalingPolicy']]:
        return pulumi.get(self, "scaling_policies")

    @_builtins.property
    @pulumi.getter(name="sparkDriver")
    def spark_driver(self) -> pulumi.Output[Optional['outputs.QueueV1SparkDriver']]:
        return pulumi.get(self, "spark_driver")
