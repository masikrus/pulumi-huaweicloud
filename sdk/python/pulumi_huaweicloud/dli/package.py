...
class PackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to upload packages.
               ...
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the package.
        """
...
class _PackageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Specifies the package type.
               ...
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[_builtins.str] updated_at: The last time when the package configuration update has completed.
        """
...
@pulumi.type_token("huaweicloud:Dli/package:Package")
