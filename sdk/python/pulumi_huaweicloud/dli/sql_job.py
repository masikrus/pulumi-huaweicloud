...
class SqlJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] queue_name: Specifies queue which this job to be submitted belongs.
               Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies label of a Job. Changing this parameter will create a new resource.
        """
...
class _SqlJobState:
    def __init__(__self__, *,
                 ...
                 queue_name: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 rows: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]] = None,
                 schemas: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] database_name: Specifies the database where the SQL is executed. This argument does
               not need to be configured during database creation. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] duration: Job running duration (unit: millisecond).
        :param pulumi.Input[_builtins.str] job_type: Type of a job, Includes **DDL**, **DCL**, **IMPORT**, **EXPORT**, **QUERY**, **INSERT**,
               **DATA_MIGRATION**, **UPDATE**, **DELETE**, **RESTART_QUEUE** and **SCALE_QUEUE**.
        :param pulumi.Input[_builtins.str] owner: User who submits a job.
        :param pulumi.Input[_builtins.str] queue_name: Specifies queue which this job to be submitted belongs.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the DLI table resource. If omitted,
               the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]] rows: When the statement type is DDL, results of the DDL are displayed.
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]] schemas: When the statement type is DDL, the column name and type of DDL are displayed.
        :param pulumi.Input[_builtins.str] sql: Specifies SQL statement that you want to execute.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] start_time: Time when a job is started, in RFC-3339 format. e.g. `2019-10-12T07:20:50.52Z`
        :param pulumi.Input[_builtins.str] status: Status of a job, including **RUNNING**, **SCALING**, **LAUNCHING**, **FINISHED**, **FAILED**,
               and **CANCELLED.**
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies label of a Job. Changing this parameter will create a new resource.
        """
        if conf is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def rows(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]]:
        """
    ...
    @rows.setter
    def rows(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]]):
        pulumi.set(self, "rows", value)

    @_builtins.property
    @pulumi.getter
    def schemas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]]:
        """
    ...
    @schemas.setter
    def schemas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]]):
...
@pulumi.type_token("huaweicloud:Dli/sqlJob:SqlJob")
class SqlJob(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 conf: Optional[pulumi.Input[Union['SqlJobConfArgs', 'SqlJobConfArgsDict']]] = None,
                 database_name: Optional[pulumi.Input[_builtins.str]] = None,
                 queue_name: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 sql: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['SqlJobConfArgs', 'SqlJobConfArgsDict']] conf: Specifies the configuration parameters for the SQL job. Changing this parameter
               will create a new resource. Structure is documented below.
        :param pulumi.Input[_builtins.str] database_name: Specifies the database where the SQL is executed. This argument does
               not need to be configured during database creation. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] queue_name: Specifies queue which this job to be submitted belongs.
    ...
    def get(resource_name: str,
            ...
            start_time: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'SqlJob':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rows(self) -> pulumi.Output[Sequence[Sequence[_builtins.str]]]:
        """
        When the statement type is DDL, results of the DDL are displayed.
        """
        return pulumi.get(self, "rows")
    ...
    @_builtins.property
    @pulumi.getter
    def schemas(self) -> pulumi.Output[Sequence[Mapping[str, _builtins.str]]]:
        """
        When the statement type is DDL, the column name and type of DDL are displayed.
        """
        return pulumi.get(self, "schemas")
