...
class DatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the database.  
...
@pulumi.type_token("huaweicloud:Dli/database:Database")
