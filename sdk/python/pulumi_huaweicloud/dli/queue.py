...
class QueueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description of a queue. Changing this parameter will create a new
               resource.
        :param pulumi.Input[_builtins.str] elastic_resource_pool_name: Specifies the name of the elastic resource pool to which the queue
               belongs.
        ...
        :param pulumi.Input[_builtins.int] resource_mode: Specifies the queue resource mode.  
...
@pulumi.type_token("huaweicloud:Dli/queue:Queue")
class Queue(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.int] resource_mode: Specifies the queue resource mode.  
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['QueueScalingPolicyArgs', 'QueueScalingPolicyArgsDict']]]] scaling_policies: Specifies the list of scaling policies of the queue associated with
               an elastic resource pool.
               This parameter is only available if `resource_mode` is set to `1`.
               If you want to use this parameter, you must ensure that there is a scaling policy with a time period from `00:00` to `24:00`.
               The scaling_policies structure is documented below.
               ...
               For the default scaling policy, except for the `impact_start_time` and `impact_stop_time`, which are not allowed to
               be modified, other values can be modified according to the actual situation.
        :param pulumi.Input[Union['QueueSparkDriverArgs', 'QueueSparkDriverArgsDict']] spark_driver: Specifies spark driver configuration of the queue.
               This parameter is only available if `queue_type` is set to `sql`.
               The spark_driver structure is documented below.
