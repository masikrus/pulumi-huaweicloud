...
__all__ = [
    'GetFlinkjarJobsResult',
    'AwaitableGetFlinkjarJobsResult',
    'get_flinkjar_jobs',
    'get_flinkjar_jobs_output',
]

@pulumi.output_type
class GetFlinkjarJobsResult:
    """
    A collection of values returned by getFlinkjarJobs.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def jobs(self) -> Sequence['outputs.GetFlinkjarJobsJobResult']:
        """
...
class AwaitableGetFlinkjarJobsResult(GetFlinkjarJobsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFlinkjarJobsResult(
            cu_num=self.cu_num,
            id=self.id,
            job_id=self.job_id,
            jobs=self.jobs,
...
def get_flinkjar_jobs(cu_num: Optional[_builtins.int] = None,
                      ...
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFlinkjarJobsResult:
    """
    ...
    test = huaweicloud.Dli.get_flinkjar_jobs(queue_name=queue_name)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dli/getFlinkjarJobs:getFlinkjarJobs', __args__, opts=opts, typ=GetFlinkjarJobsResult).value

    return AwaitableGetFlinkjarJobsResult(
...
def get_flinkjar_jobs_output(cu_num: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                             ...
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFlinkjarJobsResult]:
    """
    Use this data source to get the list of the DLI flinkjar jobs.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dli/getFlinkjarJobs:getFlinkjarJobs', __args__, opts=opts, typ=GetFlinkjarJobsResult)
    return __ret__.apply(lambda __response__: GetFlinkjarJobsResult(
