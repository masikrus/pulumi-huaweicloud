...
class StackArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description of the resource stack, which contain maximum of
               `255` characters.
               Change this parameter will create a new resource.
        :param pulumi.Input[_builtins.bool] enable_auto_rollback: Specifies whether to enable automatic rollback.  
               If enabled, the stack resources will rollback automatically to the last stable state with deployment failure.
               The default value is **false**.
               Change this parameter will create a new resource.
        :param pulumi.Input[_builtins.bool] enable_deletion_protection: Specifies whether to enable delete protection.  
               The default value is **false**.
               Change this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] name: Specifies the name of IAM agency authorized to IAC account.  
               Change this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] region: Specifies the region where the RFS resource stack is located.  
               If omitted, the provider-level region will be used. Change this parameter will create a new resource.
        :param pulumi.Input[_builtins.bool] retain_all_resources: Specifies whether to reserve resources when deleting the resource stack.  
               The default value is **false**.
        ...
        :param pulumi.Input[_builtins.str] vars_uri: Specifies the OBS address where the variable (**.tfvars**) file corresponding to the
    ...
    def agencies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['StackAgencyArgs']]]]:
        """
        Specifies the configuration of the agencies authorized to IAC.  
        Change this parameter will create a new resource.
        The object structure is documented below.
        """
    ...
    def description(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the description of the resource stack, which contain maximum of
        `255` characters.
        Change this parameter will create a new resource.
        """
    ...
    def enable_auto_rollback(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Specifies whether to enable automatic rollback.  
        If enabled, the stack resources will rollback automatically to the last stable state with deployment failure.
        The default value is **false**.
        Change this parameter will create a new resource.
        """
    ...
    def enable_deletion_protection(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Specifies whether to enable delete protection.  
        The default value is **false**.
        Change this parameter will create a new resource.
        """
    ...
    def region(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the region where the RFS resource stack is located.  
        If omitted, the provider-level region will be used. Change this parameter will create a new resource.
        """
    ...
    def retain_all_resources(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Specifies whether to reserve resources when deleting the resource stack.  
        The default value is **false**.
    ...
    def vars_uri(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the OBS address where the variable (**.tfvars**) file corresponding to the
        HCL/JSON template located, which describes the target status of the deployment resources.
        """
...
class Stack(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        template_obs_uri = config.require_object("templateObsUri")
        variable_obs_uri = config.require_object("variableObsUri")
        test = huaweicloud.rfs.Stack("test",
            ...
            template_uri=template_obs_uri,
            vars_uri=variable_obs_uri,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['StackAgencyArgs', 'StackAgencyArgsDict']]]] agencies: Specifies the configuration of the agencies authorized to IAC.  
               Change this parameter will create a new resource.
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the resource stack, which contain maximum of
               `255` characters.
