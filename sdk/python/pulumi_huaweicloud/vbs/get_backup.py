...
def get_backup(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The id of the vbs backup.
    :param _builtins.str name: The name of the vbs backup.
    :param _builtins.str region: The region in which to obtain the VBS Backup. If omitted, the provider-level region will
           be used.
    :param _builtins.str snapshot_id: ID of the snapshot associated with the backup.
    :param _builtins.str status: The status of the VBS backup.
    :param _builtins.str volume_id: The source volume ID of the backup.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_backup_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
