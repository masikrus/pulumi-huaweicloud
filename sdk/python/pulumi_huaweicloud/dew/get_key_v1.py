...
__all__ = [
    'GetKeyV1Result',
    'AwaitableGetKeyV1Result',
    'get_key_v1',
    'get_key_v1_output',
]

@pulumi.output_type
class GetKeyV1Result:
    """
    A collection of values returned by getKeyV1.
    """
...
class AwaitableGetKeyV1Result(GetKeyV1Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKeyV1Result(
...
def get_key_v1(default_key_flag: Optional[_builtins.str] = None,
               ...
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKeyV1Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dew/getKeyV1:getKeyV1', __args__, opts=opts, typ=GetKeyV1Result).value

    return AwaitableGetKeyV1Result(
...
def get_key_v1_output(default_key_flag: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      ...
                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetKeyV1Result]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dew/getKeyV1:getKeyV1', __args__, opts=opts, typ=GetKeyV1Result)
    return __ret__.apply(lambda __response__: GetKeyV1Result(
