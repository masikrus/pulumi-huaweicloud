...
def get_data_key(datakey_length: Optional[_builtins.str] = None,
    ...
    :param _builtins.str datakey_length: Number of bits in the length of a DEK (data encryption keys). The maximum number
    ...
    :param _builtins.str key_id: The globally unique identifier for the key. Changing this gets the new data encryption
           key.
...
def get_data_key_output(datakey_length: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dew/getDataKey:getDataKey', __args__, opts=opts, typ=GetDataKeyResult)
