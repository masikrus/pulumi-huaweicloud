...
class _KeypairState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_managed: Whether the private key is managed by HuaweiCloud.
        :param pulumi.Input[_builtins.str] key_file: Specifies the path of the created private key.
               The private key file (**.pem**) is created only when creating a KPS keypair.
               Importing an existing keypair will not obtain the private key information.
...
@pulumi.type_token("huaweicloud:Dew/keypair:Keypair")
class Keypair(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dew.Keypair("test",
            name="test-name",
            scope="user",
            encryption_type="kms",
