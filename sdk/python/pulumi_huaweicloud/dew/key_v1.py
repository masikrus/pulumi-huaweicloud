...
class KeyV1Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a KeyV1 resource.
        """
...
class _KeyV1State:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering KeyV1 resources.
        """
...
@pulumi.type_token("huaweicloud:Dew/keyV1:KeyV1")
class KeyV1(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a KeyV1 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a KeyV1 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param KeyV1Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KeyV1Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KeyV1Args.__new__(KeyV1Args)
        ...
        super(KeyV1, __self__).__init__(
            'huaweicloud:Dew/keyV1:KeyV1',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            rotation_number: Optional[pulumi.Input[_builtins.int]] = None,
            scheduled_deletion_date: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'KeyV1':
        """
        Get an existing KeyV1 resource's state with the given name, id, and optional extra
        ...
        __props__ = _KeyV1State.__new__(_KeyV1State)
        ...
        __props__.__dict__["tags"] = tags
        return KeyV1(resource_name, opts=opts, __props__=__props__)
