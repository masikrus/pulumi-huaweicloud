...
class GetCsmsSecretVersionResult:
    ...
    def secret_text(self) -> _builtins.str:
        """
...
def get_csms_secret_version(region: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: Specifies the region in which to obtain the CSMS secrets.
           If omitted, the provider-level region will be used.
    :param _builtins.str secret_name: The name of the CSMS secret to query.
    :param _builtins.str version: The version ID of the CSMS secret version to query.
    ...
    return AwaitableGetCsmsSecretVersionResult(
        ...
        secret_text=pulumi.get(__ret__, 'secret_text'),
        statuses=pulumi.get(__ret__, 'statuses'),
        version=pulumi.get(__ret__, 'version'))
def get_csms_secret_version_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   secret_name: Optional[pulumi.Input[_builtins.str]] = None,
                                   version: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCsmsSecretVersionResult]:
    """
    Use this data source to query the version and plaintext of the CSMS(Cloud Secret Management Service) secret.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dew/getCsmsSecretVersion:getCsmsSecretVersion', __args__, opts=opts, typ=GetCsmsSecretVersionResult)
    return __ret__.apply(lambda __response__: GetCsmsSecretVersionResult(
        created_at=pulumi.get(__response__, 'created_at'),
        id=pulumi.get(__response__, 'id'),
        kms_key_id=pulumi.get(__response__, 'kms_key_id'),
        region=pulumi.get(__response__, 'region'),
        secret_name=pulumi.get(__response__, 'secret_name'),
        secret_text=pulumi.get(__response__, 'secret_text'),
