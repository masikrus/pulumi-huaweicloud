...
def get_key(default_key_flag: Optional[_builtins.str] = None,
    ...
    key1 = huaweicloud.Dew.get_key(key_alias="test_key",
    ...
    :param _builtins.str domain_id: The ID of a user domain for the key. Changing this gets a new key.
...
def get_key_output(default_key_flag: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dew/getKey:getKey', __args__, opts=opts, typ=GetKeyResult)
