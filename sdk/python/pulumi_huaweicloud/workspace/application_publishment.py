...
__all__ = ['ApplicationPublishmentArgs', 'ApplicationPublishment']

@pulumi.input_type
class ApplicationPublishmentArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a ApplicationPublishment resource.
        ...
        :param pulumi.Input[_builtins.str] work_path: Specifies the working directory of the application, e.g. `C:\\Program Files\\Internet Explorer`.
        """
    ...
    def work_path(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the working directory of the application, e.g. `C:\\Program Files\\Internet Explorer`.
        """
...
@pulumi.input_type
class _ApplicationPublishmentState:
    def __init__(__self__, *,
                 ...
                 work_path: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering ApplicationPublishment resources.
...
@pulumi.type_token("huaweicloud:Workspace/applicationPublishment:ApplicationPublishment")
class ApplicationPublishment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.workspace.ApplicationPublishment("test",
        ...
        ```sh
        $ pulumi import huaweicloud:Workspace/applicationPublishment:ApplicationPublishment test <app_group_id>/<name>
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ApplicationPublishmentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a Workspace APP publishing resource within HuaweiCloud.
        ...
        :param str resource_name: The name of the resource.
        :param ApplicationPublishmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApplicationPublishmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApplicationPublishmentArgs.__new__(ApplicationPublishmentArgs)
        ...
        super(ApplicationPublishment, __self__).__init__(
            'huaweicloud:Workspace/applicationPublishment:ApplicationPublishment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[_builtins.int]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None,
            work_path: Optional[pulumi.Input[_builtins.str]] = None) -> 'ApplicationPublishment':
        """
        Get an existing ApplicationPublishment resource's state with the given name, id, and optional extra
        ...
        __props__ = _ApplicationPublishmentState.__new__(_ApplicationPublishmentState)
        ...
        __props__.__dict__["version"] = version
        __props__.__dict__["work_path"] = work_path
        return ApplicationPublishment(resource_name, opts=opts, __props__=__props__)
