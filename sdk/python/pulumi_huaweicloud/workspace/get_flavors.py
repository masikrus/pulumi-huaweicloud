...
class GetFlavorsResult:
    ...
    """
    def __init__(__self__, availability_zone=None, flavors=None, id=None, memory=None, os_type=None, region=None, vcpus=None):
    ...
    def memory(self) -> Optional[_builtins.int]:
        """
        The Workspece flavor memory size in GB.
        """
    ...
    def vcpus(self) -> Optional[_builtins.int]:
        """
        CPU specifications of the Workspace flavor.
        """
...
def get_flavors(availability_zone: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Workspace.get_flavors(os_type=os_type)
    ```


    :param _builtins.str availability_zone: Specifies the availability zone to which the Workspace flavors belong.
    :param _builtins.int memory: Specifies the memory size of the Workspace flavors, in GB.
    :param _builtins.str os_type: Specifies the operating system type of the Workspace flavors.  
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Workspace/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult).value
...
def get_flavors_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Workspace/getFlavors:getFlavors', __args__, opts=opts, typ=GetFlavorsResult)
