...
class DesktopArgs:
    def __init__(__self__, *,
                 ...
                 delete_user: Optional[pulumi.Input[_builtins.bool]] = None,
                 email_notification: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 power_action_type: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] image_type: Specifies the image type. The valid values are as follows:
        ...
        :param pulumi.Input[_builtins.str] user_email: Specifies the user email.
               Some operations on the desktop (such as creation, deletion) will notify the user by sending an email.
               Changing this will create a new resource.
        :param pulumi.Input[_builtins.str] user_group: Specifies the user group to which the desktop belongs.
               ...
               Changing this will create a new resource.
        :param pulumi.Input[_builtins.str] user_name: Specifies the user name to which the desktop belongs.
        ...
        :param pulumi.Input[_builtins.str] vpc_id: Specifies the VPC ID to which the desktop belongs.
               Changing this will create a new resource.
        ...
        :param pulumi.Input[_builtins.bool] email_notification: Specifies whether to send emails to user mailbox during important
               operations.
        ...
        :param pulumi.Input[_builtins.str] power_action_type: Specifies the power action mechanisms for the desktop.
               The valid values are as follows:
               + **SOFT**: Normal operation.
               + **HARD**: Forced operation.
        :param pulumi.Input[_builtins.str] region: The region in which to create the Workspace desktop resource.
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_groups: Specifies the ID list of security groups.
               In addition to the custom security group, it must also contain a security group called **WorkspaceUserSecurityGroup**.
               Changing this will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs of the desktop.
        """
    ...
    def delete_user(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @delete_user.setter
    def delete_user(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "delete_user", value)

    @_builtins.property
    @pulumi.getter(name="emailNotification")
    def email_notification(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def email_notification(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def power_action_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def power_action_type(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _DesktopState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_groups: Specifies the ID list of security groups.
               In addition to the custom security group, it must also contain a security group called **WorkspaceUserSecurityGroup**.
               Changing this will create a new resource.
        :param pulumi.Input[_builtins.str] status: The current status of the desktop.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs of the desktop.
        :param pulumi.Input[_builtins.str] user_email: Specifies the user email.
               Some operations on the desktop (such as creation, deletion) will notify the user by sending an email.
               Changing this will create a new resource.
...
@pulumi.type_token("huaweicloud:Workspace/desktop:Desktop")
class Desktop(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 availability_zone: Optional[pulumi.Input[_builtins.str]] = None,
                 data_volumes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DesktopDataVolumeArgs', 'DesktopDataVolumeArgsDict']]]]] = None,
                 delete_user: Optional[pulumi.Input[_builtins.bool]] = None,
                 email_notification: Optional[pulumi.Input[_builtins.bool]] = None,
                 enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
                 flavor_id: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 image_type: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 nics: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DesktopNicArgs', 'DesktopNicArgsDict']]]]] = None,
                 power_action: Optional[pulumi.Input[_builtins.str]] = None,
                 power_action_type: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 root_volume: Optional[pulumi.Input[Union['DesktopRootVolumeArgs', 'DesktopRootVolumeArgsDict']]] = None,
                 security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 user_email: Optional[pulumi.Input[_builtins.str]] = None,
                 user_group: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the Workspace desktop resource.
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[Union['DesktopRootVolumeArgs', 'DesktopRootVolumeArgsDict']] root_volume: Specifies the configuration of system volume.
               The object structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_groups: Specifies the ID list of security groups.
               In addition to the custom security group, it must also contain a security group called **WorkspaceUserSecurityGroup**.
               Changing this will create a new resource.
    ...
    def get(resource_name: str,
            ...
            user_group: Optional[pulumi.Input[_builtins.str]] = None,
            user_name: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'Desktop':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="deleteUser")
    def delete_user(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether to delete user associated with this desktop after deleting it.
        The user can only be successfully deleted if the user has no other desktops.
    ...
    @_builtins.property
    @pulumi.getter(name="emailNotification")
    def email_notification(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether to send emails to user mailbox during important
        operations.
        Defaults to **false**. Changing this will create a new resource.
    ...
    @_builtins.property
    @pulumi.getter(name="powerActionType")
    def power_action_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the power action mechanisms for the desktop.
        The valid values are as follows:
        + **SOFT**: Normal operation.
