...
class GetTagsResult:
    ...
    def tags(self) -> Mapping[str, _builtins.str]:
        """
        The key/value tags information of all disks. Multiple key values are separated by commas.
        """
...
def get_tags(region: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Evs/getTags:getTags', __args__, opts=opts, typ=GetTagsResult).value
...
def get_tags_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Evs/getTags:getTags', __args__, opts=opts, typ=GetTagsResult)
