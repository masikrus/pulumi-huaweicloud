...
def get_volumes(availability_zone: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ids: Specifies the disk IDs. The value is in the ids=['id1','id2',...,'idx'] format.
    ...
    :param _builtins.str volume_type_id: Specifies the type ID for the disks.
    """
    __args__ = dict()
...
def get_volumes_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Evs/getVolumes:getVolumes', __args__, opts=opts, typ=GetVolumesResult)
