...
__all__ = ['DependencyVersionArgs', 'DependencyVersion']

@pulumi.input_type
class DependencyVersionArgs:
...
@pulumi.type_token("huaweicloud:FunctionGraph/dependencyVersion:DependencyVersion")
class DependencyVersion(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.functiongraph.DependencyVersion("test",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DependencyVersionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DependencyVersionArgs.__new__(DependencyVersionArgs)
        ...
        super(DependencyVersion, __self__).__init__(
            'huaweicloud:FunctionGraph/dependencyVersion:DependencyVersion',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[_builtins.int]] = None,
            version: Optional[pulumi.Input[_builtins.int]] = None,
            version_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'DependencyVersion':
        """
        Get an existing DependencyVersion resource's state with the given name, id, and optional extra
        ...
        __props__ = _DependencyVersionState.__new__(_DependencyVersionState)
        ...
        return DependencyVersion(resource_name, opts=opts, __props__=__props__)
