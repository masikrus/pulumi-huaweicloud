...
@pulumi.type_token("huaweicloud:FunctionGraph/dependency:Dependency")
class Dependency(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        > This resource will be deprecated in a future version. Please use `FunctionGraph.DependencyVersion` resource to
