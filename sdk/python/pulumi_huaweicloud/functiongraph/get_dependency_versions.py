...
__all__ = [
    'GetDependencyVersionsResult',
    'AwaitableGetDependencyVersionsResult',
    'get_dependency_versions',
    'get_dependency_versions_output',
]

@pulumi.output_type
class GetDependencyVersionsResult:
    """
    A collection of values returned by getDependencyVersions.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def versions(self) -> Sequence['outputs.GetDependencyVersionsVersionResult']:
        """
...
class AwaitableGetDependencyVersionsResult(GetDependencyVersionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDependencyVersionsResult(
...
def get_dependency_versions(dependency_id: Optional[_builtins.str] = None,
                            region: Optional[_builtins.str] = None,
                            runtime: Optional[_builtins.str] = None,
                            version: Optional[_builtins.int] = None,
                            version_id: Optional[_builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDependencyVersionsResult:
    """
    ...
    test = huaweicloud.FunctionGraph.get_dependency_versions(dependency_id=dependency_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:FunctionGraph/getDependencyVersions:getDependencyVersions', __args__, opts=opts, typ=GetDependencyVersionsResult).value

    return AwaitableGetDependencyVersionsResult(
...
def get_dependency_versions_output(dependency_id: Optional[pulumi.Input[_builtins.str]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDependencyVersionsResult]:
    """
    Use this data source to get the list of dependency package versions within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:FunctionGraph/getDependencyVersions:getDependencyVersions', __args__, opts=opts, typ=GetDependencyVersionsResult)
    return __ret__.apply(lambda __response__: GetDependencyVersionsResult(
