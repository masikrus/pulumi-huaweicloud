...
__all__ = ['FunctionV2Args', 'FunctionV2']

@pulumi.input_type
class FunctionV2Args:
    def __init__(__self__, *,
                 ...
                 custom_image: Optional[pulumi.Input['FunctionV2CustomImageArgs']] = None,
                 ...
                 network_controller: Optional[pulumi.Input['FunctionV2NetworkControllerArgs']] = None,
                 ...
                 reserved_instances: Optional[pulumi.Input[Sequence[pulumi.Input['FunctionV2ReservedInstanceArgs']]]] = None,
                 ...
                 versions: Optional[pulumi.Input[Sequence[pulumi.Input['FunctionV2VersionArgs']]]] = None,
        ...
        :param pulumi.Input['FunctionV2CustomImageArgs'] custom_image: The custom image configuration of the function.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FunctionV2ReservedInstanceArgs']]] reserved_instances: The reserved instance policies of the function.
    ...
    def custom_image(self) -> Optional[pulumi.Input['FunctionV2CustomImageArgs']]:
        """
    ...
    @custom_image.setter
    def custom_image(self, value: Optional[pulumi.Input['FunctionV2CustomImageArgs']]):
    ...
    def func_mounts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FunctionV2FuncMountArgs']]]]:
        """
    ...
    @func_mounts.setter
    def func_mounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FunctionV2FuncMountArgs']]]]):
    ...
    def network_controller(self) -> Optional[pulumi.Input['FunctionV2NetworkControllerArgs']]:
        """
    ...
    def network_controller(self, value: Optional[pulumi.Input['FunctionV2NetworkControllerArgs']]):
    ...
    def reserved_instances(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FunctionV2ReservedInstanceArgs']]]]:
        """
    ...
    def reserved_instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FunctionV2ReservedInstanceArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def versions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FunctionV2VersionArgs']]]]:
        """
    ...
    @versions.setter
    def versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FunctionV2VersionArgs']]]]):
...
@pulumi.type_token("huaweicloud:FunctionGraph/functionV2:FunctionV2")
class FunctionV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 code_url: Optional[pulumi.Input[_builtins.str]] = None,
                 concurrency_num: Optional[pulumi.Input[_builtins.int]] = None,
                 custom_image: Optional[pulumi.Input[Union['FunctionV2CustomImageArgs', 'FunctionV2CustomImageArgsDict']]] = None,
                 depend_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 dns_list: Optional[pulumi.Input[_builtins.str]] = None,
                 enable_auth_in_header: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 mount_user_id: Optional[pulumi.Input[_builtins.int]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 network_controller: Optional[pulumi.Input[Union['FunctionV2NetworkControllerArgs', 'FunctionV2NetworkControllerArgsDict']]] = None,
                 network_id: Optional[pulumi.Input[_builtins.str]] = None,
                 package: Optional[pulumi.Input[_builtins.str]] = None,
                 peering_cidr: Optional[pulumi.Input[_builtins.str]] = None,
                 pre_stop_handler: Optional[pulumi.Input[_builtins.str]] = None,
                 pre_stop_timeout: Optional[pulumi.Input[_builtins.int]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 reserved_instances: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FunctionV2ReservedInstanceArgs', 'FunctionV2ReservedInstanceArgsDict']]]]] = None,
                 restore_hook_handler: Optional[pulumi.Input[_builtins.str]] = None,
                 restore_hook_timeout: Optional[pulumi.Input[_builtins.int]] = None,
                 runtime: Optional[pulumi.Input[_builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 ...
                 user_data: Optional[pulumi.Input[_builtins.str]] = None,
                 user_data_encrypt_kms_key_id: Optional[pulumi.Input[_builtins.str]] = None,
                 versions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FunctionV2VersionArgs', 'FunctionV2VersionArgsDict']]]]] = None,
                 vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
                 xrole: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] code_url: The URL where the function code is stored in OBS.
        :param pulumi.Input[_builtins.int] concurrency_num: The number of concurrent requests of the function.
        :param pulumi.Input[Union['FunctionV2CustomImageArgs', 'FunctionV2CustomImageArgsDict']] custom_image: The custom image configuration of the function.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] depend_lists: The ID list of the dependencies.
        :param pulumi.Input[_builtins.str] description: The description of the function.
        :param pulumi.Input[_builtins.str] dns_list: The private DNS configuration of the function network.
        :param pulumi.Input[_builtins.bool] enable_auth_in_header: Whether the authentication in the request header is enabled.
        ...
        :param pulumi.Input[_builtins.int] pre_stop_timeout: The maximum duration that the function can be initialized.
        :param pulumi.Input[_builtins.str] region: The region where the function is located.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FunctionV2ReservedInstanceArgs', 'FunctionV2ReservedInstanceArgsDict']]]] reserved_instances: The reserved instance policies of the function.
        :param pulumi.Input[_builtins.str] restore_hook_handler: The restore hook handler of the function.
        :param pulumi.Input[_builtins.int] restore_hook_timeout: The timeout of the function restore hook.
        :param pulumi.Input[_builtins.str] runtime: The environment for executing the function.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The key/value pairs to associate with the function.
        ...
        :param pulumi.Input[_builtins.str] user_data: The key/value information defined for the function.
        :param pulumi.Input[_builtins.str] user_data_encrypt_kms_key_id: The KMS key ID for encrypting the user data.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FunctionV2VersionArgs', 'FunctionV2VersionArgsDict']]]] versions: The versions management of the function.
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC to which the function belongs.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FunctionV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FunctionV2Args.__new__(FunctionV2Args)
        ...
        super(FunctionV2, __self__).__init__(
            'huaweicloud:FunctionGraph/functionV2:FunctionV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            versions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FunctionV2VersionArgs', 'FunctionV2VersionArgsDict']]]]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            xrole: Optional[pulumi.Input[_builtins.str]] = None) -> 'FunctionV2':
        """
        Get an existing FunctionV2 resource's state with the given name, id, and optional extra
    ...
    @_builtins.property
    @pulumi.getter(name="customImage")
    def custom_image(self) -> pulumi.Output['outputs.FunctionV2CustomImage']:
        """
        The custom image configuration of the function.
        """
        return pulumi.get(self, "custom_image")
    ...
    @_builtins.property
    @pulumi.getter(name="funcMounts")
    def func_mounts(self) -> pulumi.Output[Sequence['outputs.FunctionV2FuncMount']]:
        """
        The list of function mount configuration.
        """
        return pulumi.get(self, "func_mounts")
    ...
    @_builtins.property
    @pulumi.getter(name="networkController")
    def network_controller(self) -> pulumi.Output[Optional['outputs.FunctionV2NetworkController']]:
        """
        The network configuration of the function.
        """
        return pulumi.get(self, "network_controller")
    ...
    @_builtins.property
    @pulumi.getter(name="reservedInstances")
    def reserved_instances(self) -> pulumi.Output[Optional[Sequence['outputs.FunctionV2ReservedInstance']]]:
        """
        The reserved instance policies of the function.
        """
        return pulumi.get(self, "reserved_instances")
    ...
    @_builtins.property
    @pulumi.getter
    def versions(self) -> pulumi.Output[Optional[Sequence['outputs.FunctionV2Version']]]:
        """
        The versions management of the function.
        """
        return pulumi.get(self, "versions")
