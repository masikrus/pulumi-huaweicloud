...
__all__ = ['AsyncInvokeConfigurationArgs', 'AsyncInvokeConfiguration']

@pulumi.input_type
class AsyncInvokeConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 on_failure: Optional[pulumi.Input['AsyncInvokeConfigurationOnFailureArgs']] = None,
                 on_success: Optional[pulumi.Input['AsyncInvokeConfigurationOnSuccessArgs']] = None,
        ...
        :param pulumi.Input['AsyncInvokeConfigurationOnFailureArgs'] on_failure: Specifies the target to be invoked when a function fails to be executed due to a
               system error or an internal error.
               The object structure is documented below.
        :param pulumi.Input['AsyncInvokeConfigurationOnSuccessArgs'] on_success: Specifies the target to be invoked when a function is successfully executed.  
               The object structure is documented below.
    ...
    def on_failure(self) -> Optional[pulumi.Input['AsyncInvokeConfigurationOnFailureArgs']]:
        """
    ...
    @on_failure.setter
    def on_failure(self, value: Optional[pulumi.Input['AsyncInvokeConfigurationOnFailureArgs']]):
        pulumi.set(self, "on_failure", value)

    @_builtins.property
    @pulumi.getter(name="onSuccess")
    def on_success(self) -> Optional[pulumi.Input['AsyncInvokeConfigurationOnSuccessArgs']]:
        """
    ...
    @on_success.setter
    def on_success(self, value: Optional[pulumi.Input['AsyncInvokeConfigurationOnSuccessArgs']]):
...
@pulumi.input_type
class _AsyncInvokeConfigurationState:
    def __init__(__self__, *,
...
@pulumi.type_token("huaweicloud:FunctionGraph/asyncInvokeConfiguration:AsyncInvokeConfiguration")
class AsyncInvokeConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 max_async_event_age_in_seconds: Optional[pulumi.Input[_builtins.int]] = None,
                 max_async_retry_attempts: Optional[pulumi.Input[_builtins.int]] = None,
                 on_failure: Optional[pulumi.Input[Union['AsyncInvokeConfigurationOnFailureArgs', 'AsyncInvokeConfigurationOnFailureArgsDict']]] = None,
                 on_success: Optional[pulumi.Input[Union['AsyncInvokeConfigurationOnSuccessArgs', 'AsyncInvokeConfigurationOnSuccessArgsDict']]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        test = huaweicloud.functiongraph.AsyncInvokeConfiguration("test",
        ...
        :param pulumi.Input[_builtins.int] max_async_retry_attempts: Specifies the maximum number of retry attempts to be made if
               asynchronous invocation fails.
               The valid value is range from `0` to `3`.
        :param pulumi.Input[Union['AsyncInvokeConfigurationOnFailureArgs', 'AsyncInvokeConfigurationOnFailureArgsDict']] on_failure: Specifies the target to be invoked when a function fails to be executed due to a
               system error or an internal error.
               The object structure is documented below.
        :param pulumi.Input[Union['AsyncInvokeConfigurationOnSuccessArgs', 'AsyncInvokeConfigurationOnSuccessArgsDict']] on_success: Specifies the target to be invoked when a function is successfully executed.  
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to configure the asynchronous invocation.  
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AsyncInvokeConfigurationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Using this resource to manage the configuration of the asynchronous invocation within HuaweiCloud.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AsyncInvokeConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AsyncInvokeConfigurationArgs.__new__(AsyncInvokeConfigurationArgs)
        ...
        super(AsyncInvokeConfiguration, __self__).__init__(
            'huaweicloud:FunctionGraph/asyncInvokeConfiguration:AsyncInvokeConfiguration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            on_success: Optional[pulumi.Input[Union['AsyncInvokeConfigurationOnSuccessArgs', 'AsyncInvokeConfigurationOnSuccessArgsDict']]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'AsyncInvokeConfiguration':
        """
        Get an existing AsyncInvokeConfiguration resource's state with the given name, id, and optional extra
        ...
        __props__ = _AsyncInvokeConfigurationState.__new__(_AsyncInvokeConfigurationState)
        ...
        return AsyncInvokeConfiguration(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="onFailure")
    def on_failure(self) -> pulumi.Output[Optional['outputs.AsyncInvokeConfigurationOnFailure']]:
        """
        Specifies the target to be invoked when a function fails to be executed due to a
        system error or an internal error.
        The object structure is documented below.
    ...
    @_builtins.property
    @pulumi.getter(name="onSuccess")
    def on_success(self) -> pulumi.Output[Optional['outputs.AsyncInvokeConfigurationOnSuccess']]:
        """
        Specifies the target to be invoked when a function is successfully executed.  
        The object structure is documented below.
        """
