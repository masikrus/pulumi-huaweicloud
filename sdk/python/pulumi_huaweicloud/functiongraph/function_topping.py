...
__all__ = ['FunctionToppingArgs', 'FunctionTopping']

@pulumi.input_type
class FunctionToppingArgs:
...
@pulumi.type_token("huaweicloud:FunctionGraph/functionTopping:FunctionTopping")
class FunctionTopping(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FunctionToppingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FunctionToppingArgs.__new__(FunctionToppingArgs)
        ...
        super(FunctionTopping, __self__).__init__(
            'huaweicloud:FunctionGraph/functionTopping:FunctionTopping',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            function_urn: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'FunctionTopping':
        """
        Get an existing FunctionTopping resource's state with the given name, id, and optional extra
        ...
        __props__ = _FunctionToppingState.__new__(_FunctionToppingState)

        __props__.__dict__["function_urn"] = function_urn
        __props__.__dict__["region"] = region
        return FunctionTopping(resource_name, opts=opts, __props__=__props__)
