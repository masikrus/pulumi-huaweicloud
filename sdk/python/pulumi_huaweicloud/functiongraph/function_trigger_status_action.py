...
__all__ = ['FunctionTriggerStatusActionArgs', 'FunctionTriggerStatusAction']

@pulumi.input_type
class FunctionTriggerStatusActionArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a FunctionTriggerStatusAction resource.
...
@pulumi.input_type
class _FunctionTriggerStatusActionState:
    def __init__(__self__, *,
                 enable_force_new: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        """
        Input properties used for looking up and filtering FunctionTriggerStatusAction resources.
        :param pulumi.Input[_builtins.str] event_data: The event data of the trigger.
        :param pulumi.Input[_builtins.str] function_urn: The URN of the function.
        :param pulumi.Input[_builtins.str] region: The region where the function trigger is located.
        :param pulumi.Input[_builtins.str] trigger_id: The trigger ID.
...
@pulumi.type_token("huaweicloud:FunctionGraph/functionTriggerStatusAction:FunctionTriggerStatusAction")
class FunctionTriggerStatusAction(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a FunctionTriggerStatusAction resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FunctionTriggerStatusActionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a FunctionTriggerStatusAction resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param FunctionTriggerStatusActionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FunctionTriggerStatusActionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FunctionTriggerStatusActionArgs.__new__(FunctionTriggerStatusActionArgs)
        ...
        super(FunctionTriggerStatusAction, __self__).__init__(
            'huaweicloud:FunctionGraph/functionTriggerStatusAction:FunctionTriggerStatusAction',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            trigger_id: Optional[pulumi.Input[_builtins.str]] = None,
            trigger_status: Optional[pulumi.Input[_builtins.str]] = None,
            trigger_type_code: Optional[pulumi.Input[_builtins.str]] = None) -> 'FunctionTriggerStatusAction':
        """
        Get an existing FunctionTriggerStatusAction resource's state with the given name, id, and optional extra
        ...
        __props__ = _FunctionTriggerStatusActionState.__new__(_FunctionTriggerStatusActionState)
        ...
        __props__.__dict__["trigger_status"] = trigger_status
        __props__.__dict__["trigger_type_code"] = trigger_type_code
        return FunctionTriggerStatusAction(resource_name, opts=opts, __props__=__props__)
