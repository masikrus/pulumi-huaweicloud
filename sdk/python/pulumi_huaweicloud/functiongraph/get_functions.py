...
def get_functions(enterprise_project_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.FunctionGraph.get_functions()
    ```
    ...
    test = huaweicloud.FunctionGraph.get_functions(package_name="default")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:FunctionGraph/getFunctions:getFunctions', __args__, opts=opts, typ=GetFunctionsResult).value
...
def get_functions_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:FunctionGraph/getFunctions:getFunctions', __args__, opts=opts, typ=GetFunctionsResult)
