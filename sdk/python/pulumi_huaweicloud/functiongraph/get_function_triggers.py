...
__all__ = [
    'GetFunctionTriggersResult',
    'AwaitableGetFunctionTriggersResult',
    'get_function_triggers',
    'get_function_triggers_output',
]

@pulumi.output_type
class GetFunctionTriggersResult:
    """
    A collection of values returned by getFunctionTriggers.
    """
...
class AwaitableGetFunctionTriggersResult(GetFunctionTriggersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFunctionTriggersResult(
...
def get_function_triggers(end_time: Optional[_builtins.str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFunctionTriggersResult:
    """
    ...
    test = huaweicloud.FunctionGraph.get_function_triggers(function_urn=function_urn)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:FunctionGraph/getFunctionTriggers:getFunctionTriggers', __args__, opts=opts, typ=GetFunctionTriggersResult).value

    return AwaitableGetFunctionTriggersResult(
...
def get_function_triggers_output(end_time: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFunctionTriggersResult]:
    """
    Use this data source to get the list of function triggers of FunctionGraph within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:FunctionGraph/getFunctionTriggers:getFunctionTriggers', __args__, opts=opts, typ=GetFunctionTriggersResult)
    return __ret__.apply(lambda __response__: GetFunctionTriggersResult(
