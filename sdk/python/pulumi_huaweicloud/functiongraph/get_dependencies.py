...
def get_dependencies(is_versions_query_allowed: Optional[_builtins.bool] = None,
    ...
    test = huaweicloud.FunctionGraph.get_dependencies(type="public",
        name="obssdk-3.0.2")
    ```
...
def get_dependencies_output(is_versions_query_allowed: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:FunctionGraph/getDependencies:getDependencies', __args__, opts=opts, typ=GetDependenciesResult)
