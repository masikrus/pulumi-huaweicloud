...
__all__ = ['PasswordResetArgs', 'PasswordReset']
...
class PasswordResetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] mode: Specifies the reset mode. Value options: **EMAIL**, **OTP**.
    ...
    def mode(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the reset mode. Value options: **EMAIL**, **OTP**.
        """
...
@pulumi.type_token("huaweicloud:Identitycenter/passwordReset:PasswordReset")
class PasswordReset(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.identitycenter.PasswordReset("test",
            mode="EMAIL",
            user_id=user_id,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PasswordResetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PasswordResetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PasswordResetArgs.__new__(PasswordResetArgs)
        ...
        super(PasswordReset, __self__).__init__(
            'huaweicloud:Identitycenter/passwordReset:PasswordReset',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            mode: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'PasswordReset':
        """
        Get an existing PasswordReset resource's state with the given name, id, and optional extra
        ...
        __props__ = _PasswordResetState.__new__(_PasswordResetState)
        ...
        __props__.__dict__["region"] = region
        __props__.__dict__["user_id"] = user_id
        return PasswordReset(resource_name, opts=opts, __props__=__props__)
