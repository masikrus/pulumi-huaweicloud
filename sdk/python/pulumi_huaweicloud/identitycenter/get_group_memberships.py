...
class GetGroupMembershipsResult:
    ...
    """
    def __init__(__self__, group_id=None, group_memberships=None, id=None, identity_store_id=None, region=None, user_id=None):
    ...
    def group_memberships(self) -> Sequence['outputs.GetGroupMembershipsGroupMembershipResult']:
        """
        The list of group membership.
        The group_memberships structure is documented below.
        """
...
def get_group_memberships(group_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Identitycenter.get_group_memberships(identity_store_id=identity_store_id,
        group_id=group_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Identitycenter/getGroupMemberships:getGroupMemberships', __args__, opts=opts, typ=GetGroupMembershipsResult).value
...
def get_group_memberships_output(group_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Identitycenter/getGroupMemberships:getGroupMemberships', __args__, opts=opts, typ=GetGroupMembershipsResult)
