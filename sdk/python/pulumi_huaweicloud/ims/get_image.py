...
def get_image(architecture: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool is_whole_image: Specifies whether it is a whole image. The valid value is **true** or **false**.
           Defaults to **false**.
    :param _builtins.bool most_recent: Specifies whether to return the latest updated image if the query returns more than
...
def get_image_output(architecture: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ims/getImage:getImage', __args__, opts=opts, typ=GetImageResult)
