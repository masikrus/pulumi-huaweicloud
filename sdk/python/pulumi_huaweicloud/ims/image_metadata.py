...
__all__ = ['ImageMetadataArgs', 'ImageMetadata']

@pulumi.input_type
class ImageMetadataArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] min_disk: Specifies the minimum disk required for image operation, in GB.
        ...
        :param pulumi.Input[_builtins.int] min_ram: Specifies the minimum memory required for image operation, in MB.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: Specifies image label list. The length ranges from `1` to `255` bits.
               Default is empty. The assignment method for the key in the tag is **"key=value"**.
        :param pulumi.Input[_builtins.str] visibility: Specifies whether other tenants are visible.
    ...
    def min_disk(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Specifies the minimum disk required for image operation, in GB.
        + Linux operating system values range from `10` to `1,024` GB.
        + Windows operating system values range from `20` to `1,024` GB.
    ...
    def min_ram(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Specifies the minimum memory required for image operation, in MB.
        Default is `0`. The parameter values are based on the specifications limitations of the cloud server.
        """
    ...
    def protected(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Specifies whether the image is protected, and the protected image cannot
        be deleted. The default value is **false**.
        """
    ...
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Specifies image label list. The length ranges from `1` to `255` bits.
        Default is empty. The assignment method for the key in the tag is **"key=value"**.
        """
    ...
    def visibility(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies whether other tenants are visible.
        The default value is **private**. When creating image metadata, the valid value can only be **private**.
        """
...
class _ImageMetadataState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] max_ram: The maximum memory supported by the image, measured in MB. The value can refer to the specifications of
    ...
    def max_ram(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The maximum memory supported by the image, measured in MB. The value can refer to the specifications of
        the cloud server and is generally not set.
        """
...
@pulumi.type_token("huaweicloud:Ims/imageMetadata:ImageMetadata")
class ImageMetadata(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.ims.ImageMetadata("test",
            name=name,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ImageMetadataArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages an IMS image metadata resource within HuaweiCloud.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ImageMetadataArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ImageMetadataArgs.__new__(ImageMetadataArgs)
        ...
        super(ImageMetadata, __self__).__init__(
            'huaweicloud:Ims/imageMetadata:ImageMetadata',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            virtual_env_type: Optional[pulumi.Input[_builtins.str]] = None,
            visibility: Optional[pulumi.Input[_builtins.str]] = None) -> 'ImageMetadata':
        """
        Get an existing ImageMetadata resource's state with the given name, id, and optional extra
        ...
        __props__ = _ImageMetadataState.__new__(_ImageMetadataState)
        ...
        __props__.__dict__["visibility"] = visibility
        return ImageMetadata(resource_name, opts=opts, __props__=__props__)
