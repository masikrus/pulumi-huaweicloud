...
def get_image_v2(architecture: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Ims/getImageV2:getImageV2', __args__, opts=opts, typ=GetImageV2Result).value
...
def get_image_v2_output(architecture: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Ims/getImageV2:getImageV2', __args__, opts=opts, typ=GetImageV2Result)
