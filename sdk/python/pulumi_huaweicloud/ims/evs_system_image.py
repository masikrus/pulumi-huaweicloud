...
__all__ = ['EvsSystemImageArgs', 'EvsSystemImage']

@pulumi.input_type
class EvsSystemImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] volume_id: Specifies the EVS volume ID used to create the image. When creating an ECS
    ...
    def os_version(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the operating system version of the image. Changing this
        parameter will create a new resource.
        For its values, see [API docs](https://support.huaweicloud.com/intl/en-us/api-ims/ims_03_0910.html).
    ...
    def volume_id(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the EVS volume ID used to create the image. When creating an ECS
        system image, the volume must be bound to the ECS instance. Changing this parameter will create a new resource.
        """
...
class _EvsSystemImageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] os_type: The operating system type of the image. The value can be **Linux** or **Windows**.
        :param pulumi.Input[_builtins.str] os_version: Specifies the operating system version of the image. Changing this
               parameter will create a new resource.
               For its values, see [API docs](https://support.huaweicloud.com/intl/en-us/api-ims/ims_03_0910.html).
    ...
    def os_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The operating system type of the image. The value can be **Linux** or **Windows**.
        """
...
@pulumi.type_token("huaweicloud:Ims/evsSystemImage:EvsSystemImage")
class EvsSystemImage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.ims.EvsSystemImage("test",
            name=name,
            volume_id=volume_id,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EvsSystemImageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EvsSystemImageArgs.__new__(EvsSystemImageArgs)
        ...
        super(EvsSystemImage, __self__).__init__(
            'huaweicloud:Ims/evsSystemImage:EvsSystemImage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            virtual_env_type: Optional[pulumi.Input[_builtins.str]] = None,
            visibility: Optional[pulumi.Input[_builtins.str]] = None,
            volume_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'EvsSystemImage':
        """
        Get an existing EvsSystemImage resource's state with the given name, id, and optional extra
        ...
        __props__ = _EvsSystemImageState.__new__(_EvsSystemImageState)
        ...
        __props__.__dict__["volume_id"] = volume_id
        return EvsSystemImage(resource_name, opts=opts, __props__=__props__)
