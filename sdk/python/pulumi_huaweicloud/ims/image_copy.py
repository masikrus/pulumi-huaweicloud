...
class ImageCopyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] agency_name: Specifies the agency name. It is required in the cross-region scene.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the copy image.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project ID of the image.
               Only copying scene within a region is supported, for enterprise users, if omitted, default enterprise project will
               be used.
        :param pulumi.Input[_builtins.str] kms_key_id: Specifies the master key used for encrypting an image.
               Only copying scene within a region is supported. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] max_ram: Specifies the maximum memory of the copy image in the unit of MB.
        :param pulumi.Input[_builtins.int] min_ram: Specifies the minimum memory of the copy image in the unit of MB. The default value is
               `0`, indicating that the memory is not restricted.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the copy image. The name can contain `1` to `128` characters,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region to which the source image belongs.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the copy image.
        ...
        :param pulumi.Input[_builtins.str] vault_id: Specifies the ID of the vault. It is used in the cross-region scene, it is
...
class _ImageCopyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] agency_name: Specifies the agency name. It is required in the cross-region scene.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] checksum: checksum is deprecated
        ...
        :param pulumi.Input[_builtins.str] data_origin: Indicates the image source.
        ...
        :param pulumi.Input[_builtins.str] instance_id: Indicates the ID of the ECS that needs to be converted into an image.
        :param pulumi.Input[_builtins.str] kms_key_id: Specifies the master key used for encrypting an image.
               Only copying scene within a region is supported. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.int] max_ram: Specifies the maximum memory of the copy image in the unit of MB.
...
@pulumi.type_token("huaweicloud:Ims/imageCopy:ImageCopy")
class ImageCopy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vault_id: Optional[pulumi.Input[_builtins.str]] = None,
            virtual_env_type: Optional[pulumi.Input[_builtins.str]] = None,
            visibility: Optional[pulumi.Input[_builtins.str]] = None) -> 'ImageCopy':
        """
