...
__all__ = ['CbrWholeImageArgs', 'CbrWholeImage']

@pulumi.input_type
class CbrWholeImageArgs:
...
class _CbrWholeImageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] data_origin: The image source. The format is **server_backup,backup_id**.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the image.
...
@pulumi.type_token("huaweicloud:Ims/cbrWholeImage:CbrWholeImage")
class CbrWholeImage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.ims.CbrWholeImage("test",
            name=name,
            backup_id=backup_id)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CbrWholeImageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CbrWholeImageArgs.__new__(CbrWholeImageArgs)
        ...
        super(CbrWholeImage, __self__).__init__(
            'huaweicloud:Ims/cbrWholeImage:CbrWholeImage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            virtual_env_type: Optional[pulumi.Input[_builtins.str]] = None,
            visibility: Optional[pulumi.Input[_builtins.str]] = None) -> 'CbrWholeImage':
        """
        Get an existing CbrWholeImage resource's state with the given name, id, and optional extra
        ...
        __props__ = _CbrWholeImageState.__new__(_CbrWholeImageState)
        ...
        return CbrWholeImage(resource_name, opts=opts, __props__=__props__)
