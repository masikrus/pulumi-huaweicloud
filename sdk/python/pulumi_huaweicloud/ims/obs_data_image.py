...
__all__ = ['ObsDataImageArgs', 'ObsDataImage']

@pulumi.input_type
class ObsDataImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] min_disk: Specifies the minimum size of the system disk, in GB unit. The value ranges
...
@pulumi.type_token("huaweicloud:Ims/obsDataImage:ObsDataImage")
class ObsDataImage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.ims.ObsDataImage("test",
            name=name,
            image_url=image_url,
            min_disk=min_disk)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ObsDataImageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ObsDataImageArgs.__new__(ObsDataImageArgs)
        ...
        super(ObsDataImage, __self__).__init__(
            'huaweicloud:Ims/obsDataImage:ObsDataImage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            virtual_env_type: Optional[pulumi.Input[_builtins.str]] = None,
            visibility: Optional[pulumi.Input[_builtins.str]] = None) -> 'ObsDataImage':
        """
        ...
        __props__ = _ObsDataImageState.__new__(_ObsDataImageState)
        ...
        return ObsDataImage(resource_name, opts=opts, __props__=__props__)
