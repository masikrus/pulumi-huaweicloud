...
class ImageShareAccepterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vault_id: Specifies the ID of a vault. This parameter is mandatory if you want
...
@pulumi.type_token("huaweicloud:Ims/imageShareAccepter:ImageShareAccepter")
class ImageShareAccepter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            image_id: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            vault_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ImageShareAccepter':
        """
