...
__all__ = ['QuickimportDataImageArgs', 'QuickimportDataImage']

@pulumi.input_type
class QuickimportDataImageArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a QuickimportDataImage resource.
        ...
        :param pulumi.Input[_builtins.int] min_disk: Specifies the minimum system disk size in GB.
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the image.
               ...
               [reference](https://support.huaweicloud.com/intl/en-us/api-ims/ims_03_0901.html).
        :param pulumi.Input[_builtins.str] os_type: Specifies the operating system version.
    ...
    def min_disk(self) -> pulumi.Input[_builtins.int]:
        """
        Specifies the minimum system disk size in GB.
        + When the operating system is Linux, the value ranges from `10` to `1,024`.
        + When the operating system is Windows, the value ranges from `20` to `1,024`.
        """
...
@pulumi.input_type
class _QuickimportDataImageState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering QuickimportDataImage resources.
...
@pulumi.type_token("huaweicloud:Ims/quickimportDataImage:QuickimportDataImage")
class QuickimportDataImage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.ims.QuickimportDataImage("test",
            name=name,
            image_url=image_url,
            min_disk=min_disk,
            type=type)
        ...
        ```sh
        $ pulumi import huaweicloud:Ims/quickimportDataImage:QuickimportDataImage test <id>
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param QuickimportDataImageArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(QuickimportDataImageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = QuickimportDataImageArgs.__new__(QuickimportDataImageArgs)
        ...
        super(QuickimportDataImage, __self__).__init__(
            'huaweicloud:Ims/quickimportDataImage:QuickimportDataImage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[_builtins.str]] = None,
            virtual_env_type: Optional[pulumi.Input[_builtins.str]] = None,
            visibility: Optional[pulumi.Input[_builtins.str]] = None) -> 'QuickimportDataImage':
        """
        Get an existing QuickimportDataImage resource's state with the given name, id, and optional extra
        ...
        __props__ = _QuickimportDataImageState.__new__(_QuickimportDataImageState)
        ...
        return QuickimportDataImage(resource_name, opts=opts, __props__=__props__)
