...
class ImageExportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] file_format: Specifies the format of the image file to be exported. The valid values
               are **qcow2**, **vhd**, **zvhd**, or **vmdk**. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.bool] is_quick_export: Specifies whether to use quick export. The valid value is **true** or
...
@pulumi.type_token("huaweicloud:Ims/imageExport:ImageExport")
class ImageExport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            image_id: Optional[pulumi.Input[_builtins.str]] = None,
            is_quick_export: Optional[pulumi.Input[_builtins.bool]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'ImageExport':
        """
