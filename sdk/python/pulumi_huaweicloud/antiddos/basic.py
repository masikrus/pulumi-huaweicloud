...
class BasicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] topic_urn: Specifies the SMN topic URN. When the value is not empty, it means turning on the alarm
...
class _BasicState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to manage the Cloud Native Anti-DDos Basic resource.
               If omitted, the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] status: The Anti-DDos status.
        :param pulumi.Input[_builtins.str] topic_urn: Specifies the SMN topic URN. When the value is not empty, it means turning on the alarm
               notification. When the value is empty, it means turning off the alarm notification.
        :param pulumi.Input[_builtins.int] traffic_threshold: Specifies the traffic cleaning threshold in Mbps.
               The value can be 10, 30, 50, 70, 100, 120, 150, 200, 250, 300, 1000 Mbps.
...
@pulumi.type_token("huaweicloud:AntiDDos/basic:Basic")
class Basic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        antiddos1 = huaweicloud.antiddos.Basic("antiddos_1",
            eip_id=eip_id,
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            topic_urn: Optional[pulumi.Input[_builtins.str]] = None,
            traffic_threshold: Optional[pulumi.Input[_builtins.int]] = None) -> 'Basic':
        """
