...
@pulumi.type_token("huaweicloud:Dms/rocketmqConsumerGroup:RocketmqConsumerGroup")
class RocketmqConsumerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.dms.RocketmqConsumerGroup("test",
    ...
    def _internal_init(__self__,
        ...
        super(RocketmqConsumerGroup, __self__).__init__(
            'huaweicloud:Dms/rocketmqConsumerGroup:RocketmqConsumerGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            retry_max_times: Optional[pulumi.Input[_builtins.int]] = None) -> 'RocketmqConsumerGroup':
        """
