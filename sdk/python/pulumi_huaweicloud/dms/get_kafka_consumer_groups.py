...
__all__ = [
    'GetKafkaConsumerGroupsResult',
    'AwaitableGetKafkaConsumerGroupsResult',
    'get_kafka_consumer_groups',
    'get_kafka_consumer_groups_output',
]

@pulumi.output_type
class GetKafkaConsumerGroupsResult:
    """
    A collection of values returned by getKafkaConsumerGroups.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetKafkaConsumerGroupsGroupResult']:
        """
        Indicates the consumer groups.
        """
...
class AwaitableGetKafkaConsumerGroupsResult(GetKafkaConsumerGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKafkaConsumerGroupsResult(
...
def get_kafka_consumer_groups(coordinator_id: Optional[_builtins.int] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKafkaConsumerGroupsResult:
    """
    ...
    test = huaweicloud.Dms.get_kafka_consumer_groups(instance_id=instance_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getKafkaConsumerGroups:getKafkaConsumerGroups', __args__, opts=opts, typ=GetKafkaConsumerGroupsResult).value

    return AwaitableGetKafkaConsumerGroupsResult(
...
def get_kafka_consumer_groups_output(coordinator_id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetKafkaConsumerGroupsResult]:
    """
    Use this data source to get the list of Kafka consumer groups.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getKafkaConsumerGroups:getKafkaConsumerGroups', __args__, opts=opts, typ=GetKafkaConsumerGroupsResult)
    return __ret__.apply(lambda __response__: GetKafkaConsumerGroupsResult(
