...
__all__ = [
    'GetKafkaExtendFlavorsResult',
    'AwaitableGetKafkaExtendFlavorsResult',
    'get_kafka_extend_flavors',
    'get_kafka_extend_flavors_output',
]

@pulumi.output_type
class GetKafkaExtendFlavorsResult:
    """
    A collection of values returned by getKafkaExtendFlavors.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def flavors(self) -> Sequence['outputs.GetKafkaExtendFlavorsFlavorResult']:
        """
        Indicates the flavor information for specification modification.
        """
    ...
    def versions(self) -> Sequence[_builtins.str]:
        """
        Indicates the versions supported by the message engine.
        """
        return pulumi.get(self, "versions")


class AwaitableGetKafkaExtendFlavorsResult(GetKafkaExtendFlavorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKafkaExtendFlavorsResult(
...
def get_kafka_extend_flavors(arch_type: Optional[_builtins.str] = None,
                             charging_mode: Optional[_builtins.str] = None,
                             instance_id: Optional[_builtins.str] = None,
                             region: Optional[_builtins.str] = None,
                             storage_spec_code: Optional[_builtins.str] = None,
                             type: Optional[_builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKafkaExtendFlavorsResult:
    """
    ...
    test = huaweicloud.Dms.get_kafka_extend_flavors(instance_id=instance_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getKafkaExtendFlavors:getKafkaExtendFlavors', __args__, opts=opts, typ=GetKafkaExtendFlavorsResult).value

    return AwaitableGetKafkaExtendFlavorsResult(
...
def get_kafka_extend_flavors_output(arch_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetKafkaExtendFlavorsResult]:
    """
    Use this data source to get the list of Kafka instance extend flavors.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getKafkaExtendFlavors:getKafkaExtendFlavors', __args__, opts=opts, typ=GetKafkaExtendFlavorsResult)
    return __ret__.apply(lambda __response__: GetKafkaExtendFlavorsResult(
