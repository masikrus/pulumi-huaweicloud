...
class GetRocketmqInstancesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def instances(self) -> Sequence['outputs.GetRocketmqInstancesInstanceResult']:
        """
...
def get_rocketmq_instances(exact_match_name: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Dms.get_rocketmq_instances(name="rocketmq_name_test")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRocketmqInstances:getRocketmqInstances', __args__, opts=opts, typ=GetRocketmqInstancesResult).value
...
def get_rocketmq_instances_output(exact_match_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRocketmqInstances:getRocketmqInstances', __args__, opts=opts, typ=GetRocketmqInstancesResult)
