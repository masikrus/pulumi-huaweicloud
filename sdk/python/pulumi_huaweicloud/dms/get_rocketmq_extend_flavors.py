...
__all__ = [
    'GetRocketmqExtendFlavorsResult',
    'AwaitableGetRocketmqExtendFlavorsResult',
    'get_rocketmq_extend_flavors',
    'get_rocketmq_extend_flavors_output',
]

@pulumi.output_type
class GetRocketmqExtendFlavorsResult:
    """
    A collection of values returned by getRocketmqExtendFlavors.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def flavors(self) -> Sequence['outputs.GetRocketmqExtendFlavorsFlavorResult']:
        """
...
class AwaitableGetRocketmqExtendFlavorsResult(GetRocketmqExtendFlavorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRocketmqExtendFlavorsResult(
...
def get_rocketmq_extend_flavors(arch_type: Optional[_builtins.str] = None,
                                charging_mode: Optional[_builtins.str] = None,
                                instance_id: Optional[_builtins.str] = None,
                                region: Optional[_builtins.str] = None,
                                storage_spec_code: Optional[_builtins.str] = None,
                                type: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRocketmqExtendFlavorsResult:
    """
    ...
    test = huaweicloud.Dms.get_rocketmq_extend_flavors(instance_id=instance_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRocketmqExtendFlavors:getRocketmqExtendFlavors', __args__, opts=opts, typ=GetRocketmqExtendFlavorsResult).value

    return AwaitableGetRocketmqExtendFlavorsResult(
...
def get_rocketmq_extend_flavors_output(arch_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRocketmqExtendFlavorsResult]:
    """
    Use this data source to get the list of RocketMQ extend available flavor details within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRocketmqExtendFlavors:getRocketmqExtendFlavors', __args__, opts=opts, typ=GetRocketmqExtendFlavorsResult)
    return __ret__.apply(lambda __response__: GetRocketmqExtendFlavorsResult(
