...
__all__ = [
    'GetRabbitmqExtendFlavorsResult',
    'AwaitableGetRabbitmqExtendFlavorsResult',
    'get_rabbitmq_extend_flavors',
    'get_rabbitmq_extend_flavors_output',
]

@pulumi.output_type
class GetRabbitmqExtendFlavorsResult:
    """
    A collection of values returned by getRabbitmqExtendFlavors.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def flavors(self) -> Sequence['outputs.GetRabbitmqExtendFlavorsFlavorResult']:
        """
...
class AwaitableGetRabbitmqExtendFlavorsResult(GetRabbitmqExtendFlavorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRabbitmqExtendFlavorsResult(
...
def get_rabbitmq_extend_flavors(arch_type: Optional[_builtins.str] = None,
                                charging_mode: Optional[_builtins.str] = None,
                                instance_id: Optional[_builtins.str] = None,
                                region: Optional[_builtins.str] = None,
                                storage_spec_code: Optional[_builtins.str] = None,
                                type: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRabbitmqExtendFlavorsResult:
    """
    ...
    test = huaweicloud.Dms.get_rabbitmq_extend_flavors(instance_id=instance_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRabbitmqExtendFlavors:getRabbitmqExtendFlavors', __args__, opts=opts, typ=GetRabbitmqExtendFlavorsResult).value

    return AwaitableGetRabbitmqExtendFlavorsResult(
...
def get_rabbitmq_extend_flavors_output(arch_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRabbitmqExtendFlavorsResult]:
    """
    Use this data source to get the list of RabbitMQ extend available flavor details within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRabbitmqExtendFlavors:getRabbitmqExtendFlavors', __args__, opts=opts, typ=GetRabbitmqExtendFlavorsResult)
    return __ret__.apply(lambda __response__: GetRabbitmqExtendFlavorsResult(
