...
__all__ = [
    'GetRocketmqConsumersResult',
    'AwaitableGetRocketmqConsumersResult',
    'get_rocketmq_consumers',
    'get_rocketmq_consumers_output',
]

@pulumi.output_type
class GetRocketmqConsumersResult:
    """
    A collection of values returned by getRocketmqConsumers.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def clients(self) -> Sequence['outputs.GetRocketmqConsumersClientResult']:
        """
...
class AwaitableGetRocketmqConsumersResult(GetRocketmqConsumersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRocketmqConsumersResult(
...
def get_rocketmq_consumers(group: Optional[_builtins.str] = None,
                           instance_id: Optional[_builtins.str] = None,
                           is_detail: Optional[_builtins.bool] = None,
                           region: Optional[_builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRocketmqConsumersResult:
    """
    ...
    test = huaweicloud.Dms.get_rocketmq_consumers(instance_id=instance_id,
        group=group,
        is_detail=True)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRocketmqConsumers:getRocketmqConsumers', __args__, opts=opts, typ=GetRocketmqConsumersResult).value

    return AwaitableGetRocketmqConsumersResult(
...
def get_rocketmq_consumers_output(group: Optional[pulumi.Input[_builtins.str]] = None,
                                  instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                  is_detail: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                  region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRocketmqConsumersResult]:
    """
    Use this data source to get the list of RocketMQ consumers.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRocketmqConsumers:getRocketmqConsumers', __args__, opts=opts, typ=GetRocketmqConsumersResult)
    return __ret__.apply(lambda __response__: GetRocketmqConsumersResult(
