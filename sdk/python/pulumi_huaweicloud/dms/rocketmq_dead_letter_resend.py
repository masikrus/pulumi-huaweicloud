...
__all__ = ['RocketmqDeadLetterResendArgs', 'RocketmqDeadLetterResend']

@pulumi.input_type
class RocketmqDeadLetterResendArgs:
...
@pulumi.input_type
class _RocketmqDeadLetterResendState:
    def __init__(__self__, *,
                 instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                 message_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 resend_results: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqDeadLetterResendResendResultArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used.
               Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input['RocketmqDeadLetterResendResendResultArgs']]] resend_results: Indicates the resend results.
    ...
    def resend_results(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqDeadLetterResendResendResultArgs']]]]:
        """
    ...
    def resend_results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqDeadLetterResendResendResultArgs']]]]):
...
@pulumi.type_token("huaweicloud:Dms/rocketmqDeadLetterResend:RocketmqDeadLetterResend")
class RocketmqDeadLetterResend(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.dms.RocketmqDeadLetterResend("test",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RocketmqDeadLetterResendArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a DMS RocketMQ dead letter messages resend resource within HuaweiCloud.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RocketmqDeadLetterResendArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RocketmqDeadLetterResendArgs.__new__(RocketmqDeadLetterResendArgs)
        ...
        super(RocketmqDeadLetterResend, __self__).__init__(
            'huaweicloud:Dms/rocketmqDeadLetterResend:RocketmqDeadLetterResend',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            message_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            resend_results: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqDeadLetterResendResendResultArgs', 'RocketmqDeadLetterResendResendResultArgsDict']]]]] = None,
            topic: Optional[pulumi.Input[_builtins.str]] = None) -> 'RocketmqDeadLetterResend':
        """
        Get an existing RocketmqDeadLetterResend resource's state with the given name, id, and optional extra
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used.
               Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RocketmqDeadLetterResendResendResultArgs', 'RocketmqDeadLetterResendResendResultArgsDict']]]] resend_results: Indicates the resend results.
               The resend_results structure is documented below.
        :param pulumi.Input[_builtins.str] topic: Specifies the dead letter topic name.
               Changing this creates a new resource.
        """
        ...
        __props__ = _RocketmqDeadLetterResendState.__new__(_RocketmqDeadLetterResendState)
        ...
        __props__.__dict__["topic"] = topic
        return RocketmqDeadLetterResend(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="resendResults")
    def resend_results(self) -> pulumi.Output[Sequence['outputs.RocketmqDeadLetterResendResendResult']]:
        """
        Indicates the resend results.
        The resend_results structure is documented below.
        """
