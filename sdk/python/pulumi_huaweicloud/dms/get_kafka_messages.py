...
__all__ = [
    'GetKafkaMessagesResult',
    'AwaitableGetKafkaMessagesResult',
    'get_kafka_messages',
    'get_kafka_messages_output',
]

@pulumi.output_type
class GetKafkaMessagesResult:
    """
    A collection of values returned by getKafkaMessages.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def messages(self) -> Sequence['outputs.GetKafkaMessagesMessageResult']:
        """
...
class AwaitableGetKafkaMessagesResult(GetKafkaMessagesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKafkaMessagesResult(
...
def get_kafka_messages(download: Optional[_builtins.bool] = None,
                       ...
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKafkaMessagesResult:
    """
    ...
    test = huaweicloud.Dms.get_kafka_messages(instance_id=instance_id,
        topic=topic,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getKafkaMessages:getKafkaMessages', __args__, opts=opts, typ=GetKafkaMessagesResult).value

    return AwaitableGetKafkaMessagesResult(
...
def get_kafka_messages_output(download: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetKafkaMessagesResult]:
    """
    Use this data source to get the list of Kafka messages.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getKafkaMessages:getKafkaMessages', __args__, opts=opts, typ=GetKafkaMessagesResult)
    return __ret__.apply(lambda __response__: GetKafkaMessagesResult(
