...
__all__ = [
    'GetRocketmqFlavorsResult',
    'AwaitableGetRocketmqFlavorsResult',
    'get_rocketmq_flavors',
    'get_rocketmq_flavors_output',
]

@pulumi.output_type
class GetRocketmqFlavorsResult:
    """
    A collection of values returned by getRocketmqFlavors.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def flavors(self) -> Sequence['outputs.GetRocketmqFlavorsFlavorResult']:
        """
...
class AwaitableGetRocketmqFlavorsResult(GetRocketmqFlavorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRocketmqFlavorsResult(
...
def get_rocketmq_flavors(arch_type: Optional[_builtins.str] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRocketmqFlavorsResult:
    """
    ...
    test = huaweicloud.Dms.get_rocketmq_flavors(availability_zones=[
            az1,
            az2,
        ],
        arch_type="X86",
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRocketmqFlavors:getRocketmqFlavors', __args__, opts=opts, typ=GetRocketmqFlavorsResult).value

    return AwaitableGetRocketmqFlavorsResult(
...
def get_rocketmq_flavors_output(arch_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRocketmqFlavorsResult]:
    """
    Use this data source to get the list of RocketMQ flavors within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRocketmqFlavors:getRocketmqFlavors', __args__, opts=opts, typ=GetRocketmqFlavorsResult)
    return __ret__.apply(lambda __response__: GetRocketmqFlavorsResult(
