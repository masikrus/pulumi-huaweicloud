...
__all__ = [
    'GetRocketmqConsumerGroupsResult',
    'AwaitableGetRocketmqConsumerGroupsResult',
    'get_rocketmq_consumer_groups',
    'get_rocketmq_consumer_groups_output',
]

@pulumi.output_type
class GetRocketmqConsumerGroupsResult:
    """
    A collection of values returned by getRocketmqConsumerGroups.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetRocketmqConsumerGroupsGroupResult']:
        """
...
class AwaitableGetRocketmqConsumerGroupsResult(GetRocketmqConsumerGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRocketmqConsumerGroupsResult(
...
def get_rocketmq_consumer_groups(broadcast: Optional[_builtins.bool] = None,
                                 enabled: Optional[_builtins.bool] = None,
                                 instance_id: Optional[_builtins.str] = None,
                                 name: Optional[_builtins.str] = None,
                                 region: Optional[_builtins.str] = None,
                                 retry_max_times: Optional[_builtins.int] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRocketmqConsumerGroupsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRocketmqConsumerGroups:getRocketmqConsumerGroups', __args__, opts=opts, typ=GetRocketmqConsumerGroupsResult).value

    return AwaitableGetRocketmqConsumerGroupsResult(
...
def get_rocketmq_consumer_groups_output(broadcast: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRocketmqConsumerGroupsResult]:
    """
    Use this data source to get the list of DMS rocketMQ consumer groups.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRocketmqConsumerGroups:getRocketmqConsumerGroups', __args__, opts=opts, typ=GetRocketmqConsumerGroupsResult)
    return __ret__.apply(lambda __response__: GetRocketmqConsumerGroupsResult(
