...
__all__ = ['RocketmqUserArgs', 'RocketmqUser']

@pulumi.input_type
class RocketmqUserArgs:
    def __init__(__self__, *,
                 ...
                 group_perms: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqUserGroupPermArgs']]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 topic_perms: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqUserTopicPermArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] default_topic_perm: Specifies the default topic permissions.
               Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
        :param pulumi.Input[Sequence[pulumi.Input['RocketmqUserGroupPermArgs']]] group_perms: Specifies the special consumer group permissions.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RocketmqUserTopicPermArgs']]] topic_perms: Specifies the special topic permissions.
               The permission structure is documented below.
    ...
    def group_perms(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqUserGroupPermArgs']]]]:
        """
    ...
    @group_perms.setter
    def group_perms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqUserGroupPermArgs']]]]):
    ...
    def topic_perms(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqUserTopicPermArgs']]]]:
        """
    ...
    @topic_perms.setter
    def topic_perms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqUserTopicPermArgs']]]]):
...
@pulumi.type_token("huaweicloud:Dms/rocketmqUser:RocketmqUser")
class RocketmqUser(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 default_group_perm: Optional[pulumi.Input[_builtins.str]] = None,
                 default_topic_perm: Optional[pulumi.Input[_builtins.str]] = None,
                 group_perms: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqUserGroupPermArgs', 'RocketmqUserGroupPermArgsDict']]]]] = None,
                 instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 secret_key: Optional[pulumi.Input[_builtins.str]] = None,
                 topic_perms: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqUserTopicPermArgs', 'RocketmqUserTopicPermArgsDict']]]]] = None,
                 white_remote_address: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        test = huaweicloud.dms.RocketmqUser("test",
        ...
        :param pulumi.Input[_builtins.str] default_topic_perm: Specifies the default topic permissions.
               Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RocketmqUserGroupPermArgs', 'RocketmqUserGroupPermArgsDict']]]] group_perms: Specifies the special consumer group permissions.
               The permission structure is documented below.
        ...
        :param pulumi.Input[_builtins.str] secret_key: Specifies the password of the user. Use 8 to 32 characters. Contain at
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RocketmqUserTopicPermArgs', 'RocketmqUserTopicPermArgsDict']]]] topic_perms: Specifies the special topic permissions.
               The permission structure is documented below.
        :param pulumi.Input[_builtins.str] white_remote_address: Specifies the IP address whitelist.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RocketmqUserArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RocketmqUserArgs.__new__(RocketmqUserArgs)
        ...
        super(RocketmqUser, __self__).__init__(
            'huaweicloud:Dms/rocketmqUser:RocketmqUser',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            secret_key: Optional[pulumi.Input[_builtins.str]] = None,
            topic_perms: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqUserTopicPermArgs', 'RocketmqUserTopicPermArgsDict']]]]] = None,
            white_remote_address: Optional[pulumi.Input[_builtins.str]] = None) -> 'RocketmqUser':
        """
        Get an existing RocketmqUser resource's state with the given name, id, and optional extra
        ...
        __props__ = _RocketmqUserState.__new__(_RocketmqUserState)
        ...
        __props__.__dict__["topic_perms"] = topic_perms
        __props__.__dict__["white_remote_address"] = white_remote_address
        return RocketmqUser(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="groupPerms")
    def group_perms(self) -> pulumi.Output[Sequence['outputs.RocketmqUserGroupPerm']]:
        """
        Specifies the special consumer group permissions.
        The permission structure is documented below.
    ...
    @_builtins.property
    @pulumi.getter(name="topicPerms")
    def topic_perms(self) -> pulumi.Output[Sequence['outputs.RocketmqUserTopicPerm']]:
        """
        Specifies the special topic permissions.
        The permission structure is documented below.
        """
