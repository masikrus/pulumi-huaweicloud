...
__all__ = [
    'GetRocketmqTopicsResult',
    'AwaitableGetRocketmqTopicsResult',
    'get_rocketmq_topics',
    'get_rocketmq_topics_output',
]

@pulumi.output_type
class GetRocketmqTopicsResult:
    """
    A collection of values returned by getRocketmqTopics.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def topics(self) -> Sequence['outputs.GetRocketmqTopicsTopicResult']:
        """
        The list of topics.
...
class AwaitableGetRocketmqTopicsResult(GetRocketmqTopicsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRocketmqTopicsResult(
            id=self.id,
...
def get_rocketmq_topics(instance_id: Optional[_builtins.str] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRocketmqTopicsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRocketmqTopics:getRocketmqTopics', __args__, opts=opts, typ=GetRocketmqTopicsResult).value

    return AwaitableGetRocketmqTopicsResult(
...
def get_rocketmq_topics_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRocketmqTopicsResult]:
    """
    Use this data source to get the list of DMS rocketMQ topics.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRocketmqTopics:getRocketmqTopics', __args__, opts=opts, typ=GetRocketmqTopicsResult)
    return __ret__.apply(lambda __response__: GetRocketmqTopicsResult(
