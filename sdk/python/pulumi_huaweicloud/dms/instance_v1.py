...
@pulumi.type_token("huaweicloud:Dms/instanceV1:InstanceV1")
class InstanceV1(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(InstanceV1, __self__).__init__(
            'huaweicloud:Dms/instanceV1:InstanceV1',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            user_id: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'InstanceV1':
        """
