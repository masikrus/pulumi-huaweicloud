...
class GetTagsResult:
    ...
    def tags(self) -> Sequence['outputs.GetTagsTagResult']:
        """
        The list of tags for all Kafka instances.
...
def get_tags(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Dms.get_tags()
    ```


    :param _builtins.str region: Specifies the region to which the resource tags belong.  
           If omitted, the provider-level region will be used.
    """
    __args__ = dict()
    __args__['region'] = region
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getTags:getTags', __args__, opts=opts, typ=GetTagsResult).value
...
def get_tags_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getTags:getTags', __args__, opts=opts, typ=GetTagsResult)
