...
class RocketmqInstanceArgs:
    def __init__(__self__, *,
                 ...
                 configs: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceConfigArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceConfigArgs']]] configs: Specifies the instance configs.
        ...
        :param pulumi.Input[_builtins.str] tls_mode: Specifies TLS mode of the instance.  
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceConfigArgs']]]]:
        """
    ...
    @configs.setter
    def configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceConfigArgs']]]]):
...
class _RocketmqInstanceState:
    def __init__(__self__, *,
                 ...
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 configs: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceConfigArgs']]]] = None,
                 cross_vpc_accesses: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceCrossVpcAccessArgs']]]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 enable_acl: Optional[pulumi.Input[_builtins.bool]] = None,
                 enable_publicip: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceConfigArgs']]] configs: Specifies the instance configs.
               The configs structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceCrossVpcAccessArgs']]] cross_vpc_accesses: Indicates the Access information of cross-VPC. The structure is documented below.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the DMS RocketMQ instance.
               The description can contain a maximum of `1,024` characters.
        :param pulumi.Input[_builtins.bool] enable_acl: Specifies whether access control is enabled.
        :param pulumi.Input[_builtins.bool] enable_publicip: Specifies whether to enable public access. By default, public access is disabled.
    ...
    def cross_vpc_accesses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceCrossVpcAccessArgs']]]]:
        """
    ...
    def cross_vpc_accesses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqInstanceCrossVpcAccessArgs']]]]):
...
@pulumi.type_token("huaweicloud:Dms/rocketmqInstance:RocketmqInstance")
class RocketmqInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 broker_num: Optional[pulumi.Input[_builtins.int]] = None,
                 charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqInstanceConfigArgs', 'RocketmqInstanceConfigArgsDict']]]]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 enable_acl: Optional[pulumi.Input[_builtins.bool]] = None,
                 enable_publicip: Optional[pulumi.Input[_builtins.bool]] = None,
                 engine_version: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        test = huaweicloud.dms.RocketmqInstance("test",
        ...
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the instance. Valid values are *prePaid*
               and *postPaid*, defaults to *postPaid*. Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RocketmqInstanceConfigArgs', 'RocketmqInstanceConfigArgsDict']]]] configs: Specifies the instance configs.
               The configs structure is documented below.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the DMS RocketMQ instance.
               The description can contain a maximum of `1,024` characters.
        :param pulumi.Input[_builtins.bool] enable_acl: Specifies whether access control is enabled.
    ...
    def _internal_init(__self__,
        ...
        super(RocketmqInstance, __self__).__init__(
            'huaweicloud:Dms/rocketmqInstance:RocketmqInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            charging_mode: Optional[pulumi.Input[_builtins.str]] = None,
            configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqInstanceConfigArgs', 'RocketmqInstanceConfigArgsDict']]]]] = None,
            cross_vpc_accesses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqInstanceCrossVpcAccessArgs', 'RocketmqInstanceCrossVpcAccessArgsDict']]]]] = None,
            description: Optional[pulumi.Input[_builtins.str]] = None,
            enable_acl: Optional[pulumi.Input[_builtins.bool]] = None,
            enable_publicip: Optional[pulumi.Input[_builtins.bool]] = None,
            engine_version: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['RocketmqInstanceConfigArgs', 'RocketmqInstanceConfigArgsDict']]]] configs: Specifies the instance configs.
               The configs structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RocketmqInstanceCrossVpcAccessArgs', 'RocketmqInstanceCrossVpcAccessArgsDict']]]] cross_vpc_accesses: Indicates the Access information of cross-VPC. The structure is documented below.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the DMS RocketMQ instance.
               The description can contain a maximum of `1,024` characters.
        :param pulumi.Input[_builtins.bool] enable_acl: Specifies whether access control is enabled.
        :param pulumi.Input[_builtins.bool] enable_publicip: Specifies whether to enable public access. By default, public access is disabled.
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> pulumi.Output[Sequence['outputs.RocketmqInstanceConfig']]:
        """
        Specifies the instance configs.
        The configs structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="crossVpcAccesses")
    def cross_vpc_accesses(self) -> pulumi.Output[Sequence['outputs.RocketmqInstanceCrossVpcAccess']]:
        """
        Indicates the Access information of cross-VPC. The structure is documented below.
        """
        return pulumi.get(self, "cross_vpc_accesses")
