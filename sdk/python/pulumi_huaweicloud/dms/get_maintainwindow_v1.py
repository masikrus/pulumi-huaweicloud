...
def get_maintainwindow_v1(begin: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getMaintainwindowV1:getMaintainwindowV1', __args__, opts=opts, typ=GetMaintainwindowV1Result).value
...
def get_maintainwindow_v1_output(begin: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getMaintainwindowV1:getMaintainwindowV1', __args__, opts=opts, typ=GetMaintainwindowV1Result)
