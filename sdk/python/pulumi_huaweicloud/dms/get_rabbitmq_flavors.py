...
__all__ = [
    'GetRabbitmqFlavorsResult',
    'AwaitableGetRabbitmqFlavorsResult',
    'get_rabbitmq_flavors',
    'get_rabbitmq_flavors_output',
]

@pulumi.output_type
class GetRabbitmqFlavorsResult:
    """
    A collection of values returned by getRabbitmqFlavors.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def flavors(self) -> Sequence['outputs.GetRabbitmqFlavorsFlavorResult']:
        """
...
class AwaitableGetRabbitmqFlavorsResult(GetRabbitmqFlavorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRabbitmqFlavorsResult(
...
def get_rabbitmq_flavors(arch_type: Optional[_builtins.str] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRabbitmqFlavorsResult:
    """
    ...
    test = huaweicloud.Dms.get_rabbitmq_flavors(type="cluster")
    ```
    ...
    test = huaweicloud.Dms.get_rabbitmq_flavors(type="cluster.professional")
    ```
    ...
    test = huaweicloud.Dms.get_rabbitmq_flavors(flavor_id="c6.2u4g.cluster")
    ```
    ...
    test = huaweicloud.Dms.get_rabbitmq_flavors(availability_zones=[
        az1,
        az2,
    ])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRabbitmqFlavors:getRabbitmqFlavors', __args__, opts=opts, typ=GetRabbitmqFlavorsResult).value

    return AwaitableGetRabbitmqFlavorsResult(
...
def get_rabbitmq_flavors_output(arch_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRabbitmqFlavorsResult]:
    """
    Use this data source to get the list of RabbitMQ available flavor details within HuaweiCloud.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRabbitmqFlavors:getRabbitmqFlavors', __args__, opts=opts, typ=GetRabbitmqFlavorsResult)
    return __ret__.apply(lambda __response__: GetRabbitmqFlavorsResult(
