...
class KafkaTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description of topic.
        :param pulumi.Input[_builtins.str] name: Specifies the configuration name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] new_partition_brokers: Specifies the integers list of brokers for new partitions.
        ...
        :param pulumi.Input[_builtins.int] replicas: Specifies the replica number.
...
class _KafkaTopicState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['KafkaTopicConfigArgs']]] configs: Specifies the other topic configurations.
               ...
               <a name="topics_configs_struct"></a>
               The `configs` block supports:
        :param pulumi.Input[_builtins.str] created_at: Indicates the topic create time.
        :param pulumi.Input[_builtins.str] description: Specifies the description of topic.
        :param pulumi.Input[_builtins.str] instance_id: Specifies the ID of the DMS kafka instance to which the topic belongs.
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] name: Specifies the configuration name.
        ...
        :param pulumi.Input[_builtins.int] partitions: Specifies the partition number. The value ranges from `1` to `200`.
               ...
               > Only support to add partitions.
        :param pulumi.Input[_builtins.bool] policies_only: Indicates whether this policy is the default policy.
        :param pulumi.Input[_builtins.str] region: The region in which to create the DMS kafka topic resource. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[_builtins.int] replicas: Specifies the replica number.
               The value ranges from `1` to `3` and defaults to `3`. Changing this creates a new resource.
        :param pulumi.Input[_builtins.bool] sync_flushing: Whether or not to enable synchronous flushing.
        :param pulumi.Input[_builtins.bool] sync_replication: Whether or not to enable synchronous replication.
        :param pulumi.Input[_builtins.str] type: Indicates the topic type.
        """
        if aging_time is not None:
            pulumi.set(__self__, "aging_time", aging_time)
        if configs is not None:
...
@pulumi.type_token("huaweicloud:Dms/kafkaTopic:KafkaTopic")
class KafkaTopic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.int] aging_time: Specifies the aging time in hours.
               The value ranges from `1` to `720` and defaults to `72`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['KafkaTopicConfigArgs', 'KafkaTopicConfigArgsDict']]]] configs: Specifies the other topic configurations.
