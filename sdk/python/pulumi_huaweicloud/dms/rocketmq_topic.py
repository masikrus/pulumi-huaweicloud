...
class RocketmqTopicArgs:
    def __init__(__self__, *,
                 ...
                 brokers: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqTopicBrokerArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RocketmqTopicQueueArgs']]] queues: Specifies the queues information of the topic.
               It's only valid when RocketMQ instance version is **4.8.0**.
    ...
    @_builtins.property
    @pulumi.getter
    def brokers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqTopicBrokerArgs']]]]:
        """
    ...
    @brokers.setter
    def brokers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocketmqTopicBrokerArgs']]]]):
...
@pulumi.type_token("huaweicloud:Dms/rocketmqTopic:RocketmqTopic")
class RocketmqTopic(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 brokers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqTopicBrokerArgs', 'RocketmqTopicBrokerArgsDict']]]]] = None,
                 instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                 message_type: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 permission: Optional[pulumi.Input[_builtins.str]] = None,
                 queue_num: Optional[pulumi.Input[_builtins.int]] = None,
                 queues: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RocketmqTopicQueueArgs', 'RocketmqTopicQueueArgsDict']]]]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 total_read_queue_num: Optional[pulumi.Input[_builtins.int]] = None,
                 total_write_queue_num: Optional[pulumi.Input[_builtins.int]] = None,
                 __props__=None):
        ...
        test = huaweicloud.dms.RocketmqTopic("test",
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['RocketmqTopicBrokerArgs', 'RocketmqTopicBrokerArgsDict']]]] brokers: Specifies the list of associated brokers of the topic.
               It's only valid when RocketMQ instance version is **4.8.0**.
               Changing this parameter will create a new resource.
               The brokers structure is documented below.
        :param pulumi.Input[_builtins.str] instance_id: Specifies the ID of the rocketMQ instance.
        ...
        :param pulumi.Input[_builtins.str] permission: Specifies the permissions of the topic.
               ...
               It's only valid when RocketMQ instance version is **4.8.0**.
        :param pulumi.Input[_builtins.int] queue_num: Specifies the number of the queues.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RocketmqTopicQueueArgs', 'RocketmqTopicQueueArgsDict']]]] queues: Specifies the queues information of the topic.
               It's only valid when RocketMQ instance version is **4.8.0**.
               The queues structure is documented below.
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
    ...
    def _internal_init(__self__,
        ...
        super(RocketmqTopic, __self__).__init__(
            'huaweicloud:Dms/rocketmqTopic:RocketmqTopic',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            total_read_queue_num: Optional[pulumi.Input[_builtins.int]] = None,
            total_write_queue_num: Optional[pulumi.Input[_builtins.int]] = None) -> 'RocketmqTopic':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def brokers(self) -> pulumi.Output[Sequence['outputs.RocketmqTopicBroker']]:
        """
        Specifies the list of associated brokers of the topic.
        It's only valid when RocketMQ instance version is **4.8.0**.
        Changing this parameter will create a new resource.
    ...
    @_builtins.property
    @pulumi.getter
    def queues(self) -> pulumi.Output[Optional[Sequence['outputs.RocketmqTopicQueue']]]:
        """
        Specifies the queues information of the topic.
        It's only valid when RocketMQ instance version is **4.8.0**.
        The queues structure is documented below.
