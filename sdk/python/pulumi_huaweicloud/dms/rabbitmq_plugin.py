...
__all__ = ['RabbitmqPluginArgs', 'RabbitmqPlugin']

@pulumi.input_type
class RabbitmqPluginArgs:
...
class _RabbitmqPluginState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.bool] running: Indicates whether the plugin is running.
        :param pulumi.Input[_builtins.str] version: Indicates the version of the plugin.
        """
...
@pulumi.type_token("huaweicloud:Dms/rabbitmqPlugin:RabbitmqPlugin")
class RabbitmqPlugin(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.dms.RabbitmqPlugin("test",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RabbitmqPluginArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RabbitmqPluginArgs.__new__(RabbitmqPluginArgs)
        ...
        super(RabbitmqPlugin, __self__).__init__(
            'huaweicloud:Dms/rabbitmqPlugin:RabbitmqPlugin',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            running: Optional[pulumi.Input[_builtins.bool]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None) -> 'RabbitmqPlugin':
        """
        Get an existing RabbitmqPlugin resource's state with the given name, id, and optional extra
        ...
        __props__ = _RabbitmqPluginState.__new__(_RabbitmqPluginState)
        ...
        return RabbitmqPlugin(resource_name, opts=opts, __props__=__props__)
