...
__all__ = [
    'GetProductV1Result',
    'AwaitableGetProductV1Result',
    'get_product_v1',
    'get_product_v1_output',
]

@pulumi.output_type
class GetProductV1Result:
    """
    A collection of values returned by getProductV1.
    """
...
class AwaitableGetProductV1Result(GetProductV1Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetProductV1Result(
...
def get_product_v1(availability_zones: Optional[Sequence[_builtins.str]] = None,
                   ...
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProductV1Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getProductV1:getProductV1', __args__, opts=opts, typ=GetProductV1Result).value

    return AwaitableGetProductV1Result(
...
def get_product_v1_output(availability_zones: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                          ...
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetProductV1Result]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getProductV1:getProductV1', __args__, opts=opts, typ=GetProductV1Result)
    return __ret__.apply(lambda __response__: GetProductV1Result(
