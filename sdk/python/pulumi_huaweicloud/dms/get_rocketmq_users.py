...
__all__ = [
    'GetRocketmqUsersResult',
    'AwaitableGetRocketmqUsersResult',
    'get_rocketmq_users',
    'get_rocketmq_users_output',
]

@pulumi.output_type
class GetRocketmqUsersResult:
    """
    A collection of values returned by getRocketmqUsers.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetRocketmqUsersUserResult']:
        """
        The list of users.
...
class AwaitableGetRocketmqUsersResult(GetRocketmqUsersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRocketmqUsersResult(
...
def get_rocketmq_users(access_key: Optional[_builtins.str] = None,
                       ...
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRocketmqUsersResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRocketmqUsers:getRocketmqUsers', __args__, opts=opts, typ=GetRocketmqUsersResult).value

    return AwaitableGetRocketmqUsersResult(
...
def get_rocketmq_users_output(access_key: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRocketmqUsersResult]:
    """
    Use this data source to get the list of DMS rocketMQ users.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRocketmqUsers:getRocketmqUsers', __args__, opts=opts, typ=GetRocketmqUsersResult)
    return __ret__.apply(lambda __response__: GetRocketmqUsersResult(
