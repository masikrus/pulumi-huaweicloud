...
def get_maintainwindow(begin: Optional[_builtins.str] = None,
    ...
    maintainwindow1 = huaweicloud.Dms.get_maintainwindow(seq=1)
    ```
    ...
    :param _builtins.str region: The region in which to obtain the dms maintenance windows. If omitted, the provider-level
           region will be used.
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getMaintainwindow:getMaintainwindow', __args__, opts=opts, typ=GetMaintainwindowResult).value
...
def get_maintainwindow_output(begin: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getMaintainwindow:getMaintainwindow', __args__, opts=opts, typ=GetMaintainwindowResult)
