...
class GetRocketmqMessagesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def messages(self) -> Sequence['outputs.GetRocketmqMessagesMessageResult']:
        """
...
def get_rocketmq_messages(end_time: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Dms.get_rocketmq_messages(instance_id=instance_id,
        topic=topic,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Dms/getRocketmqMessages:getRocketmqMessages', __args__, opts=opts, typ=GetRocketmqMessagesResult).value
...
def get_rocketmq_messages_output(end_time: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Dms/getRocketmqMessages:getRocketmqMessages', __args__, opts=opts, typ=GetRocketmqMessagesResult)
