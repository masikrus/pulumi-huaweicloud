...
__all__ = ['DataserviceApiPublishArgs', 'DataserviceApiPublish']

@pulumi.input_type
class DataserviceApiPublishArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a DataserviceApiPublish resource.
        :param pulumi.Input[_builtins.str] api_id: Specifies the ID of the API to be published.  
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] instance_id: Specifies the exclusive cluster ID to which the published API belongs on
               Data Service side.
               Changing this parameter will create a new resource.
    ...
    def instance_id(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the exclusive cluster ID to which the published API belongs on
        Data Service side.
        Changing this parameter will create a new resource.
        """
...
@pulumi.input_type
class _DataserviceApiPublishState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering DataserviceApiPublish resources.
        :param pulumi.Input[_builtins.str] api_id: Specifies the ID of the API to be published.  
               Changing this parameter will create a new resource.
        :param pulumi.Input[_builtins.str] apig_group_id: Specifies the APIG group ID to which the published API belongs.  
               Changing this parameter will create a new resource.
...
@pulumi.type_token("huaweicloud:DataArtsStudio/dataserviceApiPublish:DataserviceApiPublish")
class DataserviceApiPublish(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test = huaweicloud.dataartsstudio.DataserviceApiPublish("test",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DataserviceApiPublishArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Use this resource to publish an debugged API for DataArts Data Service within HuaweiCloud.
        ...
        :param str resource_name: The name of the resource.
        :param DataserviceApiPublishArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataserviceApiPublishArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataserviceApiPublishArgs.__new__(DataserviceApiPublishArgs)
        ...
        super(DataserviceApiPublish, __self__).__init__(
            'huaweicloud:DataArtsStudio/dataserviceApiPublish:DataserviceApiPublish',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            roma_app_id: Optional[pulumi.Input[_builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'DataserviceApiPublish':
        """
        Get an existing DataserviceApiPublish resource's state with the given name, id, and optional extra
        ...
        __props__ = _DataserviceApiPublishState.__new__(_DataserviceApiPublishState)
        ...
        __props__.__dict__["roma_app_id"] = roma_app_id
        __props__.__dict__["workspace_id"] = workspace_id
        return DataserviceApiPublish(resource_name, opts=opts, __props__=__props__)
