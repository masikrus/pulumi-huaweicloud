...
__all__ = ['ArchitectureBatchPublishArgs', 'ArchitectureBatchPublish']

@pulumi.input_type
class ArchitectureBatchPublishArgs:
    def __init__(__self__, *,
                 approver_user_id: pulumi.Input[_builtins.str],
                 approver_user_name: pulumi.Input[_builtins.str],
                 biz_infos: pulumi.Input[Sequence[pulumi.Input['ArchitectureBatchPublishBizInfoArgs']]],
        ...
        :param pulumi.Input[_builtins.str] approver_user_name: Specifies the user name of the architecture reviewer.
               Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input['ArchitectureBatchPublishBizInfoArgs']]] biz_infos: Specifies the list of objects to be published.
               Changing this creates a new resource.
    ...
    def biz_infos(self) -> pulumi.Input[Sequence[pulumi.Input['ArchitectureBatchPublishBizInfoArgs']]]:
        """
    ...
    @biz_infos.setter
    def biz_infos(self, value: pulumi.Input[Sequence[pulumi.Input['ArchitectureBatchPublishBizInfoArgs']]]):
...
@pulumi.input_type
class _ArchitectureBatchPublishState:
    def __init__(__self__, *,
                 approver_user_id: Optional[pulumi.Input[_builtins.str]] = None,
                 approver_user_name: Optional[pulumi.Input[_builtins.str]] = None,
                 biz_infos: Optional[pulumi.Input[Sequence[pulumi.Input['ArchitectureBatchPublishBizInfoArgs']]]] = None,
                 fast_approval: Optional[pulumi.Input[_builtins.bool]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 schedule_time: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="bizInfos")
    def biz_infos(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ArchitectureBatchPublishBizInfoArgs']]]]:
        """
        Specifies the list of objects to be published.
        Changing this creates a new resource.
        The biz_infos structure is documented below.
    ...
    @biz_infos.setter
    def biz_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ArchitectureBatchPublishBizInfoArgs']]]]):
        pulumi.set(self, "biz_infos", value)
...
@pulumi.type_token("huaweicloud:DataArtsStudio/architectureBatchPublish:ArchitectureBatchPublish")
class ArchitectureBatchPublish(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 approver_user_id: Optional[pulumi.Input[_builtins.str]] = None,
                 approver_user_name: Optional[pulumi.Input[_builtins.str]] = None,
                 biz_infos: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ArchitectureBatchPublishBizInfoArgs', 'ArchitectureBatchPublishBizInfoArgsDict']]]]] = None,
                 fast_approval: Optional[pulumi.Input[_builtins.bool]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 schedule_time: Optional[pulumi.Input[_builtins.str]] = None,
                 workspace_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] approver_user_name: Specifies the user name of the architecture reviewer.
               Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ArchitectureBatchPublishBizInfoArgs', 'ArchitectureBatchPublishBizInfoArgsDict']]]] biz_infos: Specifies the list of objects to be published.
               Changing this creates a new resource.
               The biz_infos structure is documented below.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ArchitectureBatchPublishArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a DataArts Architecture batch publish resource within HuaweiCloud.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ArchitectureBatchPublishArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ArchitectureBatchPublishArgs.__new__(ArchitectureBatchPublishArgs)
        ...
        super(ArchitectureBatchPublish, __self__).__init__(
            'huaweicloud:DataArtsStudio/architectureBatchPublish:ArchitectureBatchPublish',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            schedule_time: Optional[pulumi.Input[_builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ArchitectureBatchPublish':
        """
        Get an existing ArchitectureBatchPublish resource's state with the given name, id, and optional extra
        ...
        __props__ = _ArchitectureBatchPublishState.__new__(_ArchitectureBatchPublishState)
        ...
        __props__.__dict__["schedule_time"] = schedule_time
        __props__.__dict__["workspace_id"] = workspace_id
        return ArchitectureBatchPublish(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="bizInfos")
    def biz_infos(self) -> pulumi.Output[Sequence['outputs.ArchitectureBatchPublishBizInfo']]:
        """
        Specifies the list of objects to be published.
        Changing this creates a new resource.
        The biz_infos structure is documented below.
