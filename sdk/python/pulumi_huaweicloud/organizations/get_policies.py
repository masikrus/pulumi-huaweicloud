...
class GetPoliciesResult:
    ...
    """
    def __init__(__self__, build_type=None, id=None, name=None, policies=None, type=None):
    ...
    def build_type(self) -> Optional[_builtins.str]:
        """
        Indicates the build type of the policy.
        """
    ...
    def policies(self) -> Sequence['outputs.GetPoliciesPolicyResult']:
        """
        List of policies in an organization.
...
def get_policies(build_type: Optional[_builtins.str] = None,
...
def get_policies_output(build_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
