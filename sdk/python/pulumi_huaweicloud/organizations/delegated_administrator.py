...
class DelegatedAdministratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_principal: Specifies the name of the service principal.
...
class DelegatedAdministrator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.organizations.DelegatedAdministrator("test",
