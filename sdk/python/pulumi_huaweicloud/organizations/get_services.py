...
class GetServicesResult:
    ...
    def services(self) -> Sequence[_builtins.str]:
        """
        Indicates the list of cloud services that can be integrated with Organizations.
        """
...
def get_services(region: Optional[_builtins.str] = None,
...
def get_services_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
