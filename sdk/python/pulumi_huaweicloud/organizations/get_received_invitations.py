...
__all__ = [
    'GetReceivedInvitationsResult',
    'AwaitableGetReceivedInvitationsResult',
    'get_received_invitations',
    'get_received_invitations_output',
]

@pulumi.output_type
class GetReceivedInvitationsResult:
    """
    A collection of values returned by getReceivedInvitations.
    """
    ...
    @_builtins.property
    @pulumi.getter
    def handshakes(self) -> Sequence['outputs.GetReceivedInvitationsHandshakeResult']:
        """
...
class AwaitableGetReceivedInvitationsResult(GetReceivedInvitationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetReceivedInvitationsResult(
            handshakes=self.handshakes,
            id=self.id,
            region=self.region)


def get_received_invitations(region: Optional[_builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReceivedInvitationsResult:
    """
...
def get_received_invitations_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetReceivedInvitationsResult]:
    """
    Use this data source to get the list of received invitations.
