...
class GetDelegatedServicesResult:
    ...
    def delegated_services(self) -> Sequence['outputs.GetDelegatedServicesDelegatedServiceResult']:
        ...
        The delegated_services structure is documented below.
        """
...
def get_delegated_services(account_id: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Organizations.get_delegated_services(account_id=account_id)
    ```


    :param _builtins.str account_id: Unique ID of an account.
    """
    __args__ = dict()
    __args__['accountId'] = account_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('huaweicloud:Organizations/getDelegatedServices:getDelegatedServices', __args__, opts=opts, typ=GetDelegatedServicesResult).value
...
def get_delegated_services_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Organizations/getDelegatedServices:getDelegatedServices', __args__, opts=opts, typ=GetDelegatedServicesResult)
