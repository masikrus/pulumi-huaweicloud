...
class VipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip_address: Specifies the IP address desired in the subnet for this vip.
               ...
               Changing this parameter creates a new vip resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] port_ids: Specifies an array of IDs of the ports to attach the vip to.
        """
...
@pulumi.type_token("huaweicloud:Iec/vip:Vip")
class Vip(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vip_test = huaweicloud.iec.Vip("vip_test", subnet_id=iec_subnet_id)
        ```
    ...
    @_builtins.property
    @pulumi.getter(name="portIds")
    def port_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Specifies an array of IDs of the ports to attach the vip to.
        """
        return pulumi.get(self, "port_ids")
