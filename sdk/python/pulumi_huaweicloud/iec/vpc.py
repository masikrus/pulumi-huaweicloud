...
class VpcArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] mode: Specifies the mode of the IEC VPC. Possible values are "SYSTEM" and "CUSTOMER",
               defaults to "SYSTEM". Changing this creates a new IEC VPC.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the IEC VPC. The name can contain a maximum of 64 characters. Only
               letters, digits, underscores (_), hyphens (-), and periods (.) are allowed.
        :param pulumi.Input[_builtins.str] region: The region in which to create the IEC VPC. If omitted, the provider-level
...
class _VpcState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: The region in which to create the IEC VPC. If omitted, the provider-level
               region will be used. Changing this creates a new resource.
        :param pulumi.Input[_builtins.int] subnet_num: Indicates the number of subnets.
        """
        if cidr is not None:
            pulumi.set(__self__, "cidr", cidr)
        if mode is not None:
    ...
    def subnet_num(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @subnet_num.setter
    def subnet_num(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "subnet_num", value)


@pulumi.type_token("huaweicloud:Iec/vpc:Vpc")
class Vpc(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vpc = huaweicloud.iec.Vpc("vpc",
            name=vpc_name,
            cidr=vpc_cidr)
        vpc_by_customer = huaweicloud.iec.Vpc("vpc_by_customer",
            name=vpc_name,
            cidr=vpc_cidr,
            mode="CUSTOMER")
        ```
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            subnet_num: Optional[pulumi.Input[_builtins.int]] = None) -> 'Vpc':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="subnetNum")
    def subnet_num(self) -> pulumi.Output[_builtins.int]:
        """
        Indicates the number of subnets.
        """
        return pulumi.get(self, "subnet_num")
