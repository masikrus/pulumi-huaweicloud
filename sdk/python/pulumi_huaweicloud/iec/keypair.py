...
class KeypairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] public_key: Specifies a pregenerated OpenSSH-formatted public key. Changing this
               parameter creates a new keypair resource.
        :param pulumi.Input[_builtins.str] region: The region in which to create the keypair resource. If omitted, the
...
@pulumi.type_token("huaweicloud:Iec/keypair:Keypair")
class Keypair(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_keypair = huaweicloud.iec.Keypair("test_keypair", name="iec-keypair-demo")
        ```
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            public_key: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'Keypair':
        """
