...
class _NetworkAclState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkAclNetworkArgs']]] networks: Specifies an list of one or more networks. The networks object structure is documented
               below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] outbound_rules: A list of the IDs of egress rules associated with the iec network ACL.
        :param pulumi.Input[_builtins.str] status: The status of the iec network ACL.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
@pulumi.type_token("huaweicloud:Iec/networkAcl:NetworkAcl")
class NetworkAcl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkAclNetworkArgs', 'NetworkAclNetworkArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        acl_test = huaweicloud.iec.NetworkAcl("acl_test",
            name="acl_demo",
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the iec network ACL name. This parameter can contain a maximum of 64 characters,
               which may consist of letters, digits, dot (.), underscores (_), and hyphens (-).
        :param pulumi.Input[Sequence[pulumi.Input[Union['NetworkAclNetworkArgs', 'NetworkAclNetworkArgsDict']]]] networks: Specifies an list of one or more networks. The networks object structure is documented
               below.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkAclNetworkArgs', 'NetworkAclNetworkArgsDict']]]]] = None,
            outbound_rules: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'NetworkAcl':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="inboundRules")
    def inbound_rules(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        A list of the IDs of ingress rules associated with the iec network ACL.
        """
        return pulumi.get(self, "inbound_rules")
