...
class SecurityGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name for the security group. This parameter can contain a maximum
...
@pulumi.type_token("huaweicloud:Iec/securityGroup:SecurityGroup")
class SecurityGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        secgroup_test = huaweicloud.iec.SecurityGroup("secgroup_test", name=iec_secgroup_name)
        ```
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            security_group_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SecurityGroupSecurityGroupRuleArgs', 'SecurityGroupSecurityGroupRuleArgsDict']]]]] = None) -> 'SecurityGroup':
        """
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name for the security group. This parameter can contain a maximum
               of 64 characters, which may consist of letters, digits, dot (.), underscores (_), and hyphens (-). The iec security
               group allowed to have the same name. Changing this parameter will creates a new iec security group resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SecurityGroupSecurityGroupRuleArgs', 'SecurityGroupSecurityGroupRuleArgsDict']]]] security_group_rules: An Array of one or more security group rules. The security_group_rules object structure is
               documented below.
        """
