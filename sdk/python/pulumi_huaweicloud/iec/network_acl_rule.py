...
class NetworkAclRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: Specifies the Enabled status for the iec network ACL rule. The default value is true.
        :param pulumi.Input[_builtins.int] ip_version: The version of elastic IP address. IEC services only support IPv4(4) now.
        :param pulumi.Input[_builtins.str] protocol: Specifies the protocol supported by the iec network ACL rule.Valid values are: **tcp**,
               **udp**, **icmp** and **any**.
...
class _NetworkAclRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] ip_version: The version of elastic IP address. IEC services only support IPv4(4) now.
        :param pulumi.Input[_builtins.str] network_acl_id: Specifies a unique id for the iec network ACL.
        :param pulumi.Input[_builtins.str] policy_id: The ID of the firewall policy for the iec network ACL.
        :param pulumi.Input[_builtins.str] protocol: Specifies the protocol supported by the iec network ACL rule.Valid values are: **tcp**,
               **udp**, **icmp** and **any**.
        :param pulumi.Input[_builtins.str] source_ip_address: Specifies the source IP address that the traffic is allowed from. The default
               value is **0.0.0.0/0**. For example:
...
@pulumi.type_token("huaweicloud:Iec/networkAclRule:NetworkAclRule")
class NetworkAclRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        acl_test = huaweicloud.iec.NetworkAcl("acl_test", name="iec-network-acl-demo")
        rule_test = huaweicloud.iec.NetworkAclRule("rule_test",
    ...
    def get(resource_name: str,
            ...
            protocol: Optional[pulumi.Input[_builtins.str]] = None,
            source_ip_address: Optional[pulumi.Input[_builtins.str]] = None,
            source_port: Optional[pulumi.Input[_builtins.str]] = None) -> 'NetworkAclRule':
        """
