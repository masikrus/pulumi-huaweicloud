...
class ApprovalArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_id: Specifies the ID of the VPC endpoint service. Changing this creates a new
               resource.
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the VPC endpoint service. If omitted, the
...
@pulumi.type_token("huaweicloud:Vpcep/approval:Approval")
class Approval(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        demo_endpoint = huaweicloud.vpcep.Endpoint("demo",
            service_id=demo.id,
            vpc_id=vpc_id,
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            connections: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApprovalConnectionArgs', 'ApprovalConnectionArgsDict']]]]] = None,
            endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            service_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'Approval':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApprovalConnectionArgs', 'ApprovalConnectionArgsDict']]]] connections: An array of VPC endpoints connect to the VPC endpoint service. Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] endpoints: Specifies the list of VPC endpoint IDs which accepted to connect to VPC endpoint
               service. The VPC endpoints will be rejected when the resource was destroyed.
        :param pulumi.Input[_builtins.str] region: The region in which to obtain the VPC endpoint service. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
