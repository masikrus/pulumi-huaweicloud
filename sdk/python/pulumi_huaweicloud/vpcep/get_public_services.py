...
def get_public_services(region: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: The region in which to obtain the public VPC endpoint services. If omitted, the
           provider-level region will be used.
    :param _builtins.str service_id: Specifies the unique ID of the public VPC endpoint service.
...
def get_public_services_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpcep/getPublicServices:getPublicServices', __args__, opts=opts, typ=GetPublicServicesResult)
