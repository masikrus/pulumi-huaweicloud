...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 snat_network_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] ip_address: The IPv4 address or domain name of the server in the interface type VLAN scenario.
        :param pulumi.Input[_builtins.str] ip_version: Specifies the IP version of the VPC endpoint service.
        ...
        :param pulumi.Input[_builtins.str] pool_id: The dedicated cluster ID associated with the VPC endpoint service.
        ...
        :param pulumi.Input[_builtins.str] snat_network_id: Specifies the network ID of any subnet within the VPC used to create
        ...
        :param pulumi.Input[_builtins.str] tcp_proxy: Specifies whether to transfer client information (such as source IP address,
    ...
    def snat_network_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def snat_network_id(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def tcp_proxy(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @tcp_proxy.setter
    def tcp_proxy(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("huaweicloud:Vpcep/service:Service")
class Service(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="snatNetworkId")
    def snat_network_id(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the network ID of any subnet within the VPC used to create
        the VPC endpoint service.
    ...
    @_builtins.property
    @pulumi.getter(name="tcpProxy")
    def tcp_proxy(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies whether to transfer client information (such as source IP address,
        source port number and packet ID) to the server.
        The valid values are as follows:
