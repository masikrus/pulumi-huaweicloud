...
class EndpointArgs:
    def __init__(__self__, *,
                 ...
                 policy_statement: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 routetables: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.bool] enable_dns: Specifies whether to create a private domain name. The default value is
               **true**. This field is valid only when creating a VPC endpoint for connecting an interface VPC endpoint service.
               ...
               Changing this creates a new VPC endpoint.
        :param pulumi.Input[_builtins.bool] enable_whitelist: Specifies whether to enable access control. The default value is **false**.
        :param pulumi.Input[_builtins.str] ip_address: Specifies the IP address for accessing the associated VPC endpoint
               ...
               Changing this creates a new VPC endpoint.
        :param pulumi.Input[_builtins.str] ip_version: Specifies the IP version of the VPC endpoint.
        ...
        :param pulumi.Input[_builtins.str] ipv6_address: Specifies the IPv6 address for accessing the connected VPC
               endpoint service.
               Changing this will create a new resource.
        ...
        :param pulumi.Input[_builtins.str] network_id: Specifies the network ID of the subnet in the VPC specified by `vpc_id`.
               ...
               Changing this creates a new VPC endpoint.
        :param pulumi.Input[_builtins.str] policy_document: Specifies the policy of the interface VPC endpoint. The value is a string in
        ...
        :param pulumi.Input[_builtins.str] policy_statement: Specifies the policy of the gateway VPC endpoint. The value is a string in
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] routetables: Specifies the IDs of the route tables associated with the VPC endpoint.
    ...
    def policy_document(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the policy of the interface VPC endpoint. The value is a string in
        JSON array format. This parameter is only available when `enable_policy` set to **true**. This parameter is not
        available for Object Storage Service (OBS) and Scalable File Service (SFS).
    ...
    def policy_statement(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def policy_statement(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def routetables(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @routetables.setter
    def routetables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class _EndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] status: The status of the VPC endpoint. The value can be **pendingAcceptance**, **creating**, **accepted**,
...
@pulumi.type_token("huaweicloud:Vpcep/endpoint:Endpoint")
class Endpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vpc_id = config.require_object("vpcId")
        network_id = config.require_object("networkId")
        test = huaweicloud.vpcep.Service("test",
            name="demo-service",
            server_type="VM",
        ...
        test_endpoint = huaweicloud.vpcep.Endpoint("test",
            service_id=test.id,
            vpc_id=vpc_id,
            network_id=network_id,
            enable_dns=True,
    ...
    @_builtins.property
    @pulumi.getter(name="policyStatement")
    def policy_statement(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the policy of the gateway VPC endpoint. The value is a string in
        JSON array format. This parameter is only available when `enable_policy` of the VPC endpoint services for
        Object Storage Service (OBS) and Scalable File Service (SFS) is set to **true**.
    ...
    @_builtins.property
    @pulumi.getter
    def routetables(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Specifies the IDs of the route tables associated with the VPC endpoint.
        This field is valid only when creating a VPC endpoint for connecting a gateway VPC endpoint service.
        The default route table will be used when this field is not specified.
