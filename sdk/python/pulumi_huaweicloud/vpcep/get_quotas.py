...
class GetQuotasResult:
    ...
    def quotas(self) -> Sequence['outputs.GetQuotasQuotaResult']:
        """
        The list of the VPC endpoint resource quotas.
        """
...
def get_quotas(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Vpcep.get_quotas(type=type)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Vpcep/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult).value
...
def get_quotas_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpcep/getQuotas:getQuotas', __args__, opts=opts, typ=GetQuotasResult)
