...
@pulumi.type_token("huaweicloud:Swr/organizationPermissions:OrganizationPermissions")
class OrganizationPermissions(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 organization: Optional[pulumi.Input[_builtins.str]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None,
                 users: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OrganizationPermissionsUserArgs', 'OrganizationPermissionsUserArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OrganizationPermissionsUserArgs', 'OrganizationPermissionsUserArgsDict']]]] users: Specifies the users to access to the organization (namespace).
               Structure is documented below.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            organization: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            self_permissions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OrganizationPermissionsSelfPermissionArgs', 'OrganizationPermissionsSelfPermissionArgsDict']]]]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OrganizationPermissionsUserArgs', 'OrganizationPermissionsUserArgsDict']]]]] = None) -> 'OrganizationPermissions':
        """
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OrganizationPermissionsSelfPermissionArgs', 'OrganizationPermissionsSelfPermissionArgsDict']]]] self_permissions: The permission information of current user.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OrganizationPermissionsUserArgs', 'OrganizationPermissionsUserArgsDict']]]] users: Specifies the users to access to the organization (namespace).
               Structure is documented below.
        """
