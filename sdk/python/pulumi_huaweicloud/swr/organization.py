...
@pulumi.type_token("huaweicloud:Swr/organization:Organization")
class Organization(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = huaweicloud.swr.Organization("test", name="terraform-test")
        ```
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            permission: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'Organization':
        """
