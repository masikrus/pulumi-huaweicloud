...
class StreamV2Partition(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in StreamV2Partition. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        StreamV2Partition.__key_warning(key)
        return super().__getitem__(key)
