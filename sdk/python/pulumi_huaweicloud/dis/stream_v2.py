...
class StreamV2Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a StreamV2 resource.
        """
...
class _StreamV2State:
    def __init__(__self__, *,
                 ...
                 partitions: Optional[pulumi.Input[Sequence[pulumi.Input['StreamV2PartitionArgs']]]] = None,
        ...
        """
        Input properties used for looking up and filtering StreamV2 resources.
        """
        if auto_scale_max_partition_count is not None:
            pulumi.set(__self__, "auto_scale_max_partition_count", auto_scale_max_partition_count)
        if auto_scale_min_partition_count is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def partitions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['StreamV2PartitionArgs']]]]:
        return pulumi.get(self, "partitions")

    @partitions.setter
    def partitions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['StreamV2PartitionArgs']]]]):
...
@pulumi.type_token("huaweicloud:Dis/streamV2:StreamV2")
class StreamV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(StreamV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StreamV2Args.__new__(StreamV2Args)
        ...
        super(StreamV2, __self__).__init__(
            'huaweicloud:Dis/streamV2:StreamV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            enterprise_project_id: Optional[pulumi.Input[_builtins.str]] = None,
            partition_count: Optional[pulumi.Input[_builtins.int]] = None,
            partitions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['StreamV2PartitionArgs', 'StreamV2PartitionArgsDict']]]]] = None,
            readable_partition_count: Optional[pulumi.Input[_builtins.int]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            retention_period: Optional[pulumi.Input[_builtins.int]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            ...
            stream_type: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            writable_partition_count: Optional[pulumi.Input[_builtins.int]] = None) -> 'StreamV2':
        """
        Get an existing StreamV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _StreamV2State.__new__(_StreamV2State)
        ...
        return StreamV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def partitions(self) -> pulumi.Output[Sequence['outputs.StreamV2Partition']]:
        return pulumi.get(self, "partitions")
