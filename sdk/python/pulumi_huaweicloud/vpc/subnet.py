...
class SubnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dhcp_domain_name: Specifies the domain name configured for DNS and is used to obtain the IP address
        ...
        :param pulumi.Input[_builtins.str] dhcp_ipv6_lease_time: Specifies the DHCP lease expiration time of the IPv6 subnet. The value can
        ...
        :param pulumi.Input[_builtins.str] dhcp_lease_time: Specifies the DHCP lease expiration time. The value can be -1, which indicates
        ...
        :param pulumi.Input[_builtins.str] ntp_server_address: Specifies the NTP server address. Currently only IPv4 addresses are supported.
        ...
        :param pulumi.Input[_builtins.str] primary_dns: Specifies the IP address of DNS server 1 on the subnet. The value must be a valid
               IP address.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the vpc subnet. If omitted, the
...
@pulumi.type_token("huaweicloud:Vpc/subnet:Subnet")
class Subnet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        subnet_cidr = config.require_object("subnetCidr")
        subnet_gateway_ip = config.require_object("subnetGatewayIp")
        ...
        subnet_with_tags = huaweicloud.vpc.Subnet("subnet_with_tags",
            name=subnet_name,
            cidr=subnet_cidr,
            gateway_ip=subnet_gateway_ip,
            vpc_id=vpc.id,
        ...
        subnet_with_dhcp = huaweicloud.vpc.Subnet("subnet_with_dhcp",
            name=subnet_name,
            cidr=subnet_cidr,
            gateway_ip=subnet_gateway_ip,
            vpc_id=vpc.id,
