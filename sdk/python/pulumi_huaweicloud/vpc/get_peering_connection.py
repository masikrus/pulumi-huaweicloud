...
def get_peering_connection(id: Optional[_builtins.str] = None,
    ...
    vpc_route = huaweicloud.vpc.Route("vpc_route",
        type="peering",
        nexthop=peering.id,
...
def get_peering_connection_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getPeeringConnection:getPeeringConnection', __args__, opts=opts, typ=GetPeeringConnectionResult)
