...
__all__ = ['VipAssociateV2Args', 'VipAssociateV2']

@pulumi.input_type
class VipAssociateV2Args:
    def __init__(__self__, *,
                 port_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 vip_id: pulumi.Input[_builtins.str],
                 region: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a VipAssociateV2 resource.
        """
...
class _VipAssociateV2State:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering VipAssociateV2 resources.
        """
...
@pulumi.type_token("huaweicloud:Vpc/vipAssociateV2:VipAssociateV2")
class VipAssociateV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VipAssociateV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VipAssociateV2Args.__new__(VipAssociateV2Args)
        ...
        super(VipAssociateV2, __self__).__init__(
            'huaweicloud:Vpc/vipAssociateV2:VipAssociateV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            vip_id: Optional[pulumi.Input[_builtins.str]] = None,
            vip_ip_address: Optional[pulumi.Input[_builtins.str]] = None,
            vip_subnet_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'VipAssociateV2':
        """
        Get an existing VipAssociateV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _VipAssociateV2State.__new__(_VipAssociateV2State)
        ...
        return VipAssociateV2(resource_name, opts=opts, __props__=__props__)
