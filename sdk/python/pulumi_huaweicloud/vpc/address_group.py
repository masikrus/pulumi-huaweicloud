...
class AddressGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] force_destroy: Specifies whether to forcibly destroy the address group if it is associated with
        ...
        :param pulumi.Input[_builtins.int] ip_version: Specifies the IP version, either `4` (default) or `6`.
               Changing this creates a new address group.
        :param pulumi.Input[_builtins.int] max_capacity: Specifies the maximum number of addresses that an address group can contain.
...
@pulumi.type_token("huaweicloud:Vpc/addressGroup:AddressGroup")
class AddressGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ipv4 = huaweicloud.vpc.AddressGroup("ipv4",
            name="group-ipv4",
            addresses=[
                "192.168.10.10",
        ...
        :param pulumi.Input[_builtins.bool] force_destroy: Specifies whether to forcibly destroy the address group if it is associated with
               ...
               <a name="address_groups_ip_extra_set_struct"></a>
               The `ip_extra_set` block supports:
        :param pulumi.Input[Sequence[pulumi.Input[Union['AddressGroupIpExtraSetArgs', 'AddressGroupIpExtraSetArgsDict']]]] ip_extra_sets: Specifies the IP addresses and their remarks in an IP address group.
               The ip_extra_set structure is documented below.
               Only one of `addresses` and `ip_extra_set` can be specified.
        :param pulumi.Input[_builtins.int] ip_version: Specifies the IP version, either `4` (default) or `6`.
               Changing this creates a new address group.
