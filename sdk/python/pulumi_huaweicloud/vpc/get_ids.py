...
def get_ids(region: Optional[_builtins.str] = None,
...
def get_ids_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getIds:getIds', __args__, opts=opts, typ=GetIdsResult)
