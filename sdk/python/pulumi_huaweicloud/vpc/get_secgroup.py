...
def get_secgroup(enterprise_project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str secgroup_id: Specifies the ID of the security group.
    """
    __args__ = dict()
...
def get_secgroup_output(enterprise_project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getSecgroup:getSecgroup', __args__, opts=opts, typ=GetSecgroupResult)
