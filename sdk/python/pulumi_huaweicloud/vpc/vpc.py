...
class VpcArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enhanced_local_route: Specifies whether to enable local route enhancement function. It can not be
               closed if it has been open. Value options: **true** or **false**. Defaults to **true**.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project ID of the VPC.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] secondary_cidrs: Specifies the secondary CIDR blocks of the VPC.
...
@pulumi.type_token("huaweicloud:Vpc/vpc:Vpc")
class Vpc(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vpc = huaweicloud.vpc.Vpc("vpc",
            name=vpc_name,
            cidr=vpc_cidr)
        vpc_with_tags = huaweicloud.vpc.Vpc("vpc_with_tags",
            name=vpc_name,
            cidr=vpc_cidr,
            tags={
                "foo": "bar",
