...
__all__ = ['PeeringConnectionAccepterV2Args', 'PeeringConnectionAccepterV2']

@pulumi.input_type
class PeeringConnectionAccepterV2Args:
    def __init__(__self__, *,
                 vpc_peering_connection_id: pulumi.Input[_builtins.str],
                 accept: Optional[pulumi.Input[_builtins.bool]] = None,
                 region: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a PeeringConnectionAccepterV2 resource.
        """
...
@pulumi.input_type
class _PeeringConnectionAccepterV2State:
    def __init__(__self__, *,
                 accept: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        """
        Input properties used for looking up and filtering PeeringConnectionAccepterV2 resources.
        """
        if accept is not None:
            pulumi.set(__self__, "accept", accept)
...
@pulumi.type_token("huaweicloud:Vpc/peeringConnectionAccepterV2:PeeringConnectionAccepterV2")
class PeeringConnectionAccepterV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a PeeringConnectionAccepterV2 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: PeeringConnectionAccepterV2Args,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a PeeringConnectionAccepterV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param PeeringConnectionAccepterV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PeeringConnectionAccepterV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PeeringConnectionAccepterV2Args.__new__(PeeringConnectionAccepterV2Args)
        ...
        super(PeeringConnectionAccepterV2, __self__).__init__(
            'huaweicloud:Vpc/peeringConnectionAccepterV2:PeeringConnectionAccepterV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            vpc_peering_connection_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'PeeringConnectionAccepterV2':
        """
        Get an existing PeeringConnectionAccepterV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _PeeringConnectionAccepterV2State.__new__(_PeeringConnectionAccepterV2State)
        ...
        __props__.__dict__["vpc_peering_connection_id"] = vpc_peering_connection_id
        return PeeringConnectionAccepterV2(resource_name, opts=opts, __props__=__props__)
