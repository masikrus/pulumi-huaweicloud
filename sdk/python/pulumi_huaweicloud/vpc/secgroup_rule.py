...
class SecgroupRuleInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the security group rule resource. If
...
@pulumi.type_token("huaweicloud:Vpc/secgroupRule:SecgroupRule")
class SecgroupRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        security_group_id = config.require_object("securityGroupId")
        test = huaweicloud.vpc.AddressGroup("test",
            name=group_name,
            addresses=[
                "192.168.10.12",
                "192.168.11.0-192.168.11.240",
            ])
        test_secgroup_rule = huaweicloud.vpc.SecgroupRule("test",
            security_group_id=security_group_id,
            direction="ingress",
            action="allow",
            ethertype="IPv4",
