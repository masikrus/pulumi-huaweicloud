...
class PeeringConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the VPC peering connection. The value can contain 1 to 64
               characters.
        :param pulumi.Input[_builtins.str] peer_tenant_id: Specifies the tenant ID of the accepter tenant. Changing this creates
...
@pulumi.type_token("huaweicloud:Vpc/peeringConnection:PeeringConnection")
