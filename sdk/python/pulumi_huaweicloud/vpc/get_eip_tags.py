...
def get_eip_tags(region: Optional[_builtins.str] = None,
    ...
    test = huaweicloud.Vpc.get_eip_tags()
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Vpc/getEipTags:getEipTags', __args__, opts=opts, typ=GetEipTagsResult).value
...
def get_eip_tags_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getEipTags:getEipTags', __args__, opts=opts, typ=GetEipTagsResult)
