...
def get_port(admin_state_up: Optional[_builtins.bool] = None,
    ...
    port1 = huaweicloud.Vpc.get_port(network_id=network_id,
    ...
    :param _builtins.str fixed_ip: Specifies the port IP address filter.
    :param _builtins.str mac_address: Specifies the MAC address of the port.
    :param _builtins.str name: The name of the port.
    :param _builtins.str network_id: Specifies the ID of the network the port belongs to.
    :param _builtins.str port_id: Specifies the ID of the port.
    :param _builtins.str region: Specifies the region in which to obtain the port. If omitted, the provider-level region
           will be used.
    :param Sequence[_builtins.str] security_group_ids: The list of port security group IDs to filter.
    :param _builtins.str status: Specifies the status of the port.
    """
    __args__ = dict()
...
def get_port_output(admin_state_up: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getPort:getPort', __args__, opts=opts, typ=GetPortResult)
