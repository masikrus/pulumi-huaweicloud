...
def get_subnet(availability_zone: Optional[_builtins.str] = None,
    ...
    subnet = huaweicloud.Vpc.get_subnet(id=subnet_id)
...
def get_subnet_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    * `ipv6_gateway` - The IPv6 subnet gateway.
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getSubnet:getSubnet', __args__, opts=opts, typ=GetSubnetResult)
