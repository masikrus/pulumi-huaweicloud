...
class SubnetV1Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a SubnetV1 resource.
        """
...
@pulumi.type_token("huaweicloud:Vpc/subnetV1:SubnetV1")
class SubnetV1(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SubnetV1Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SubnetV1Args.__new__(SubnetV1Args)
        ...
        super(SubnetV1, __self__).__init__(
            'huaweicloud:Vpc/subnetV1:SubnetV1',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SubnetV1':
        """
        Get an existing SubnetV1 resource's state with the given name, id, and optional extra
        ...
        __props__ = _SubnetV1State.__new__(_SubnetV1State)
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["vpc_id"] = vpc_id
        return SubnetV1(resource_name, opts=opts, __props__=__props__)
