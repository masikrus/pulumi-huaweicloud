...
class SecgroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies a unique name for the security group.
        :param pulumi.Input[_builtins.str] region: The region in which to create the security group resource. If omitted, the
               provider-level region will be used. Changing this creates a new security group resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the security group.
...
@pulumi.type_token("huaweicloud:Vpc/secgroup:Secgroup")
