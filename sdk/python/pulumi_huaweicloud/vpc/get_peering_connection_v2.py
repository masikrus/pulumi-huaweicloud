...
__all__ = [
    'GetPeeringConnectionV2Result',
    'AwaitableGetPeeringConnectionV2Result',
    'get_peering_connection_v2',
    'get_peering_connection_v2_output',
]

@pulumi.output_type
class GetPeeringConnectionV2Result:
    """
    A collection of values returned by getPeeringConnectionV2.
    """
...
class AwaitableGetPeeringConnectionV2Result(GetPeeringConnectionV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPeeringConnectionV2Result(
...
def get_peering_connection_v2(id: Optional[_builtins.str] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPeeringConnectionV2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Vpc/getPeeringConnectionV2:getPeeringConnectionV2', __args__, opts=opts, typ=GetPeeringConnectionV2Result).value

    return AwaitableGetPeeringConnectionV2Result(
...
def get_peering_connection_v2_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPeeringConnectionV2Result]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getPeeringConnectionV2:getPeeringConnectionV2', __args__, opts=opts, typ=GetPeeringConnectionV2Result)
    return __ret__.apply(lambda __response__: GetPeeringConnectionV2Result(
