...
__all__ = ['SecgroupRuleV2Args', 'SecgroupRuleV2']

@pulumi.input_type
class SecgroupRuleV2Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a SecgroupRuleV2 resource.
        """
...
class _SecgroupRuleV2State:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering SecgroupRuleV2 resources.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
        if description is not None:
...
@pulumi.type_token("huaweicloud:Vpc/secgroupRuleV2:SecgroupRuleV2")
class SecgroupRuleV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SecgroupRuleV2 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SecgroupRuleV2Args,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SecgroupRuleV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SecgroupRuleV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SecgroupRuleV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SecgroupRuleV2Args.__new__(SecgroupRuleV2Args)
        ...
        super(SecgroupRuleV2, __self__).__init__(
            'huaweicloud:Vpc/secgroupRuleV2:SecgroupRuleV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            remote_group_id: Optional[pulumi.Input[_builtins.str]] = None,
            remote_ip_prefix: Optional[pulumi.Input[_builtins.str]] = None,
            security_group_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SecgroupRuleV2':
        """
        Get an existing SecgroupRuleV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _SecgroupRuleV2State.__new__(_SecgroupRuleV2State)
        ...
        __props__.__dict__["remote_ip_prefix"] = remote_ip_prefix
        __props__.__dict__["security_group_id"] = security_group_id
        return SecgroupRuleV2(resource_name, opts=opts, __props__=__props__)
