...
def get_route(destination: Optional[_builtins.str] = None,
    ...
    vpc_route = huaweicloud.Vpc.get_route(vpc_id=vpc_id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Vpc/getRoute:getRoute', __args__, opts=opts, typ=GetRouteResult).value
...
def get_route_output(destination: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getRoute:getRoute', __args__, opts=opts, typ=GetRouteResult)
