...
class _SubnetPrivateIpState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used.
               Changing this creates a new resource.
        :param pulumi.Input[_builtins.str] status: The status of the private IP address. Possible values are **ACTIVE** and **DOWN**.
        :param pulumi.Input[_builtins.str] subnet_id: Specifies the ID of the subnet to which the private IP belongs.
        """
...
@pulumi.type_token("huaweicloud:Vpc/subnetPrivateIp:SubnetPrivateIp")
class SubnetPrivateIp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SubnetPrivateIp':
        """
