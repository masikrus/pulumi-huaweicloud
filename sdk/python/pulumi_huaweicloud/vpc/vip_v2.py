...
class VipV2Args:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a VipV2 resource.
        """
...
class _VipV2State:
    def __init__(__self__, *,
                 ...
                 subnet_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering VipV2 resources.
        """
...
@pulumi.type_token("huaweicloud:Vpc/vipV2:VipV2")
class VipV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a VipV2 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a VipV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param VipV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VipV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VipV2Args.__new__(VipV2Args)
        ...
        super(VipV2, __self__).__init__(
            'huaweicloud:Vpc/vipV2:VipV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'VipV2':
        """
        Get an existing VipV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _VipV2State.__new__(_VipV2State)
        ...
        __props__.__dict__["subnet_id"] = subnet_id
        return VipV2(resource_name, opts=opts, __props__=__props__)
