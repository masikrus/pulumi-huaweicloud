...
class EipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the EIP.  
        ...
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project ID to which the EIP belongs.
        ...
        :param pulumi.Input[_builtins.int] period: Specifies the charging period of the EIP.
               + If `period_unit` is set to **month**, the value ranges from `1` to `9`.
               + If `period_unit` is set to **year**, the value ranges from `1` to `3`.
               
               This parameter is mandatory if `charging_mode` is set to **prePaid**.
        :param pulumi.Input[_builtins.str] period_unit: Specifies the charging period unit of the EIP.  
               Valid values are **month** and **year**. This parameter is mandatory if `charging_mode` is set to **prePaid**.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the EIP resource.  
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the EIP.
        """
...
class _EipState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the EIP.  
               ...
               > **NOTE:** Please update the `charge_mode` of `bandwidth` to **bandwidth** before changing to **prePaid** billing mode.
        :param pulumi.Input[_builtins.str] created_at: The create time of EIP.
        :param pulumi.Input[_builtins.str] enterprise_project_id: Specifies the enterprise project ID to which the EIP belongs.
        :param pulumi.Input[_builtins.str] instance_id: The instance id to which the port belongs. Return when `associate_type` is **PORT**.
        :param pulumi.Input[_builtins.str] instance_type: The instance type to which the port belongs. Return when `associate_type` is **PORT**.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the EIP.
        :param pulumi.Input[_builtins.str] updated_at: The update time of EIP.
        """
...
@pulumi.type_token("huaweicloud:Vpc/eip:Eip")
class Eip(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] auto_renew: Specifies whether auto renew is enabled.  
               ...
               <a name="vpc_eip_publicip"></a>
               The `publicip` block supports:
        :param pulumi.Input[Union['EipBandwidthArgs', 'EipBandwidthArgsDict']] bandwidth: Specifies the bandwidth configuration.  
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] charging_mode: Specifies the charging mode of the EIP.  
               The valid values are **prePaid** and **postPaid**, defaults to **postPaid**.
        ...
        :param pulumi.Input[_builtins.str] period_unit: Specifies the charging period unit of the EIP.  
               Valid values are **month** and **year**. This parameter is mandatory if `charging_mode` is set to **prePaid**.
        :param pulumi.Input[Union['EipPublicipArgs', 'EipPublicipArgsDict']] publicip: Specifies the EIP configuration.  
               The object structure is documented below.
        :param pulumi.Input[_builtins.str] region: Specifies the region in which to create the EIP resource.  
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Specifies the key/value pairs to associate with the EIP.
