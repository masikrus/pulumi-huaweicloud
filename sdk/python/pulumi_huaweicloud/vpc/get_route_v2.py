...
def get_route_v2(destination: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('huaweicloud:Vpc/getRouteV2:getRouteV2', __args__, opts=opts, typ=GetRouteV2Result).value
...
def get_route_v2_output(destination: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getRouteV2:getRouteV2', __args__, opts=opts, typ=GetRouteV2Result)
