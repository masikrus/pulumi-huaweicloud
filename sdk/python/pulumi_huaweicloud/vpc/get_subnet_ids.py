...
def get_subnet_ids(region: Optional[_builtins.str] = None,
    ...
    subnet = [huaweicloud.Vpc.get_subnet(id=subnet_ids.ids[__index]) for __index in len(subnet_ids.ids).apply(lambda length: range(length))]
...
def get_subnet_ids_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('huaweicloud:Vpc/getSubnetIds:getSubnetIds', __args__, opts=opts, typ=GetSubnetIdsResult)
