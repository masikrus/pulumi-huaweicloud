...
sed -i 's+<a href=https://github.com/masikrus/pulumi-huaweicloud/tree/main/examples>pulumi-huaweicloud repository</a>+<a target=_blank href=https://github.com/masikrus/pulumi-huaweicloud/tree/main/examples>pulumi-huaweicloud repository</a>+g' dist/registry/packages/huaweicloud/index.html
sed -i 's+<a href=https://github.com/masikrus/pulumi-huaweicloud/blob/main/README.md>HuaweiCloud provider</a>+<a target=_blank href=https://github.com/masikrus/pulumi-huaweicloud/blob/main/README.md>HuaweiCloud provider</a>+g' dist/registry/packages/huaweicloud/installation-configuration/index.html
...
find dist/registry/packages/huaweicloud/api-docs/ -type f -name "*.html" -exec sed -i 's+<a href=https://github.com/masikrus/pulumi-huaweicloud>+<a target=_blank href=https://github.com/masikrus/pulumi-huaweicloud>+g' {} +
